...
__all__ = [
    'GetNsxvDnatResult',
    'AwaitableGetNsxvDnatResult',
    'get_nsxv_dnat',
    'get_nsxv_dnat_output',
]

@pulumi.output_type
class GetNsxvDnatResult:
    """
    A collection of values returned by getNsxvDnat.
    """
    def __init__(__self__, description=None, edge_gateway=None, enabled=None, icmp_type=None, id=None, logging_enabled=None, network_name=None, network_type=None, org=None, original_address=None, original_port=None, protocol=None, rule_id=None, rule_tag=None, rule_type=None, translated_address=None, translated_port=None, vdc=None):
        ...
        if original_port and not isinstance(original_port, str):
            raise TypeError("Expected argument 'original_port' to be a str")
        ...
        if translated_port and not isinstance(translated_port, str):
            raise TypeError("Expected argument 'translated_port' to be a str")
...
class AwaitableGetNsxvDnatResult(GetNsxvDnatResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNsxvDnatResult(
...
def get_nsxv_dnat(edge_gateway: Optional[str] = None,
                  ...
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNsxvDnatResult:
    """
    ...
    :param str rule_id: ID of DNAT rule as shown in the UI.
    ...
    __ret__ = pulumi.runtime.invoke('vcd:index/getNsxvDnat:getNsxvDnat', __args__, opts=opts, typ=GetNsxvDnatResult).value

    return AwaitableGetNsxvDnatResult(
        ...
        original_port=pulumi.get(__ret__, 'original_port'),
...
def get_nsxv_dnat_output(edge_gateway: Optional[pulumi.Input[str]] = None,
                         ...
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetNsxvDnatResult]:
    """
    Provides a VMware Cloud Director DNAT data source for advanced edge gateways (NSX-V). This can be used to
    read existing rule by ID and use its attributes in other resources.
    ...
    __ret__ = pulumi.runtime.invoke_output('vcd:index/getNsxvDnat:getNsxvDnat', __args__, opts=opts, typ=GetNsxvDnatResult)
    return __ret__.apply(lambda __response__: GetNsxvDnatResult(
        ...
        original_port=pulumi.get(__response__, 'original_port'),
