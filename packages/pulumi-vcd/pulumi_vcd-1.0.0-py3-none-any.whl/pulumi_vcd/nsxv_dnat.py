...
class NsxvDnatArgs:
    def __init__(__self__, *,
                 ...
                 original_port: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] edge_gateway: The name of the edge gateway on which to apply the DNAT rule.
        :param pulumi.Input[str] network_name: The name of the network on which to apply the DNAT rule.
        :param pulumi.Input[str] network_type: Type of the network on which to apply the DNAT rule. Possible values
               `org` or `ext`.
        :param pulumi.Input[str] original_address: IP address, range or subnet. This address must be the public IP
        ...
        :param pulumi.Input[str] icmp_type: Only when `protocol` is set to `icmp`. One of `any`,
        ...
        :param pulumi.Input[str] original_port: Select the port or port range that the incoming traffic uses on the
        ...
        :param pulumi.Input[str] protocol: Select the protocol to which the rule applies. One of `tcp`, `udp`,
        ...
        :param pulumi.Input[str] translated_address: IP address, range or subnet. IP addresses to which destination
               ...
               external network.
        :param pulumi.Input[str] translated_port: Select the port or port range that inbound traffic is connecting
        ...
        if original_port is not None:
            pulumi.set(__self__, "original_port", original_port)
    ...
    @property
    @pulumi.getter(name="originalPort")
    def original_port(self) -> Optional[pulumi.Input[str]]:
        """
        Select the port or port range that the incoming traffic uses on the
        edge gateway to connect to the internal network on which the virtual machines are connected. This
        selection is not available when the Protocol is set to `icmp` or `any`. Default `any`.
        """
        return pulumi.get(self, "original_port")

    @original_port.setter
    def original_port(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "original_port", value)
...
class NsxvDnat(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a NsxvDnat resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a NsxvDnat resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param NsxvDnatArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NsxvDnatArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NsxvDnatArgs.__new__(NsxvDnatArgs)
            ...
            __props__.__dict__["original_port"] = original_port
            ...
            __props__.__dict__["translated_port"] = translated_port
            __props__.__dict__["vdc"] = vdc
        super(NsxvDnat, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            translated_address: Optional[pulumi.Input[str]] = None,
            translated_port: Optional[pulumi.Input[str]] = None,
            vdc: Optional[pulumi.Input[str]] = None) -> 'NsxvDnat':
        """
        ...
        __props__ = _NsxvDnatState.__new__(_NsxvDnatState)
        ...
        __props__.__dict__["translated_port"] = translated_port
        __props__.__dict__["vdc"] = vdc
        return NsxvDnat(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="originalPort")
    def original_port(self) -> pulumi.Output[Optional[str]]:
        """
        Select the port or port range that the incoming traffic uses on the
        edge gateway to connect to the internal network on which the virtual machines are connected. This
        selection is not available when the Protocol is set to `icmp` or `any`. Default `any`.
    ...
    @property
    @pulumi.getter(name="translatedPort")
    def translated_port(self) -> pulumi.Output[Optional[str]]:
        """
        Select the port or port range that inbound traffic is connecting
        to on the virtual machines on the internal network. These ports are the ones into which the DNAT
        rule is translating for the packets inbound to the virtual machines.
