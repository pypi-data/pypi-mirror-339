...
def get_rights_bundle(name: Optional[str] = None,
    ...
    :param str name: The name of the rights bundle.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_rights_bundle_output(name: Optional[pulumi.Input[str]] = None,
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRightsBundleResult]:
    """
    Provides a VMware Cloud Director rights bundle data source. This can be used to read rights bundles.
    ...
    __ret__ = pulumi.runtime.invoke_output('vcd:index/getRightsBundle:getRightsBundle', __args__, opts=opts, typ=GetRightsBundleResult)
    return __ret__.apply(lambda __response__: GetRightsBundleResult(
