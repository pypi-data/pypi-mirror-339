...
__all__ = ['RdeTypeBehaviorArgs', 'RdeTypeBehavior']

@pulumi.input_type
class RdeTypeBehaviorArgs:
    def __init__(__self__, *,
                 rde_interface_behavior_id: pulumi.Input[str],
        ...
        :param pulumi.Input[str] rde_interface_behavior_id: The ID of the [RDE Interface Behavior](https://www.terraform.io/providers/vmware/vcd/latest/docs/resources/rde_interface_behavior) to override
        :param pulumi.Input[str] rde_type_id: The ID of the RDE Type that owns the Behavior
        ...
        :param pulumi.Input[str] description: The description of the RDE Type Behavior.
        ...
        """
        pulumi.set(__self__, "rde_interface_behavior_id", rde_interface_behavior_id)
    ...
    @property
    @pulumi.getter(name="rdeInterfaceBehaviorId")
    def rde_interface_behavior_id(self) -> pulumi.Input[str]:
        """
        ...
        """
        return pulumi.get(self, "rde_interface_behavior_id")

    @rde_interface_behavior_id.setter
    def rde_interface_behavior_id(self, value: pulumi.Input[str]):
        pulumi.set(self, "rde_interface_behavior_id", value)
...
class _RdeTypeBehaviorState:
    def __init__(__self__, *,
                 ...
                 rde_interface_behavior_id: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] execution_json: A string representing a valid JSON that specifies the Behavior execution mechanism.
               ...
               and others [in the Extensibility SDK documentation](https://vmware.github.io/vcd-ext-sdk/docs/defined_entities_api/behaviors).
               One of `execution_json` or `execution` must be set.
        :param pulumi.Input[str] name: Name of the overridden Behavior
        :param pulumi.Input[str] rde_interface_behavior_id: The ID of the [RDE Interface Behavior](https://www.terraform.io/providers/vmware/vcd/latest/docs/resources/rde_interface_behavior) to override
        :param pulumi.Input[str] rde_type_id: The ID of the RDE Type that owns the Behavior
        ...
        if rde_interface_behavior_id is not None:
            pulumi.set(__self__, "rde_interface_behavior_id", rde_interface_behavior_id)
    ...
    @property
    @pulumi.getter(name="rdeInterfaceBehaviorId")
    def rde_interface_behavior_id(self) -> Optional[pulumi.Input[str]]:
        """
        The ID of the [RDE Interface Behavior](https://www.terraform.io/providers/vmware/vcd/latest/docs/resources/rde_interface_behavior) to override
        """
        return pulumi.get(self, "rde_interface_behavior_id")
    ...
    @rde_interface_behavior_id.setter
    def rde_interface_behavior_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "rde_interface_behavior_id", value)
...
class RdeTypeBehavior(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a RdeTypeBehavior resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a RdeTypeBehavior resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param RdeTypeBehaviorArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RdeTypeBehaviorArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RdeTypeBehaviorArgs.__new__(RdeTypeBehaviorArgs)
            ...
            if rde_interface_behavior_id is None and not opts.urn:
                raise TypeError("Missing required property 'rde_interface_behavior_id'")
            __props__.__dict__["rde_interface_behavior_id"] = rde_interface_behavior_id
        ...
        super(RdeTypeBehavior, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            rde_interface_behavior_id: Optional[pulumi.Input[str]] = None,
            rde_type_id: Optional[pulumi.Input[str]] = None,
            ref: Optional[pulumi.Input[str]] = None) -> 'RdeTypeBehavior':
        """
        ...
        __props__ = _RdeTypeBehaviorState.__new__(_RdeTypeBehaviorState)
        ...
        return RdeTypeBehavior(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="rdeInterfaceBehaviorId")
    def rde_interface_behavior_id(self) -> pulumi.Output[str]:
        """
        The ID of the [RDE Interface Behavior](https://www.terraform.io/providers/vmware/vcd/latest/docs/resources/rde_interface_behavior) to override
        """
        return pulumi.get(self, "rde_interface_behavior_id")
