...
class BaseModel(DbModel, SerializerMixin):
    ...
    id = mapped_column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4, comment="Первичный ключ")
    ...
    is_alive = mapped_column(db.Boolean(), default=True, nullable=False, comment="Указатель жива ли запись")
