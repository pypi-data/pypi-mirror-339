...
class User(BaseModel):
    ...
    provider_user_state: Optional[ZitadelUserState] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "provider_name", "provider_user_id", "user_type", "personal_access_tokens", "provider_user_state", "user_name", "display_name", "first_name", "last_name", "email", "machine_name", "machine_description"]
