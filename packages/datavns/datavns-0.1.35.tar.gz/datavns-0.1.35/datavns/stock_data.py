...
class stock(headers_list):
    ...
    def trading_structure(cls,stock = 'VCB'):
        ...
        try:
            ...
            ###
            df['proprietary'] = df['proprietary_buy_matched'] - df['proprietary_sell_matched']
            df['foreign'] = df['foreign_buy_matched'] - df['foreign_sell_matched']
            #
            df['local_individual'] = df['local_individual_buy_matched'] - df['local_individual_sell_matched']
            df['local_institutional'] = df['local_institutional_buy_matched'] - df['local_institutional_sell_matched']
            #
            df['foreign_individual'] = df['foreign_individual_buy_matched'] - df['foreign_individual_sell_matched']
            df['foreign_institutional'] = df['foreign_institutional_buy_matched'] - df['foreign_institutional_sell_matched']
            df = df[['code','trading_date','close_value','proprietary','foreign','local_individual','local_institutional','foreign_individual','foreign_institutional']]
