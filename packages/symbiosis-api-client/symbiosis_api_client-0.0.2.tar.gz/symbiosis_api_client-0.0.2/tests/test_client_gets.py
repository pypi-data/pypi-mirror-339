...
@pytest.fixture
def stuck_address():
    stuck_req = models.StuckedRequestSchema(address="0x1234567890abcdef1234567890abcdef12345678")
    return stuck_req
...
def test_client_get_tokens(client):
    ...
    assert all(isinstance(token, models.TokensResponseSchemaItem) for token in tokens.root)
