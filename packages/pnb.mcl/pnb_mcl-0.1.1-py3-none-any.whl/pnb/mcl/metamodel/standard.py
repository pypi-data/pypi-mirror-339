...
class Element:
    ...
    @property
    def info(self):
        return super().__repr__(self) # TODO
...
@_abstract
class Type(Namespace, PackageableElement):
...
class UnionDataType(DataType):
    ...
    def __init__(self, name: str, subTypes: T.Iterable[DataType]=()):
        super().__init__(name=name, superTypes=())
...
BUILTIN = MCL = Model('builtin', None)
...
Int = MCL.packagedElements.add(IntType('Int'))
UnsignedByte = MCL.packagedElements.add(IntType('UnsignedByte'))
