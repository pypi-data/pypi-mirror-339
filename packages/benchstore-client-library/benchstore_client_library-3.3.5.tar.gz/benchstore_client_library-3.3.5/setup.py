...
try:
    from benchstore_client_library.version._release import _package_name_, _package_version_
except Exception as e:
    _package_name_ = 'benchstore_client_library'
    _package_version_ = '3.3.5'
    pass
