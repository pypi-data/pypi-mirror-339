...
class RemoteFunctions:
    ...
    def __init__(self, password: str = None, is_queue:bool = False):
        ...
        self.qs.get_hexes = self.as_remote()(self.qs.get_hexes)
        self.qs.get_properties = self.as_remote()(self.qs.get_properties)
        self.qs.clear_hexes = self.as_remote()(self.qs.clear_hexes)
        self.qs.wait_until_finished = self.as_remote()(self.qs.wait_until_finished)
        self.qs.wait_until_hex_finished = self.as_remote()(self.qs.wait_until_hex_finished)
