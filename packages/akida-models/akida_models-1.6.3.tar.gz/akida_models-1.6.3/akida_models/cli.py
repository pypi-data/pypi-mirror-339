...
from .sparsity import display_sparsity
...
def main():
    ...
    sparsity_parser.add_argument("-v", "--verbose", action="store_true")
    ...
    if args.action == "create":
        ...
        display_sparsity(args.model, args.layer_names, None,
                         args.samples, args.n_samples, args.verbose)
