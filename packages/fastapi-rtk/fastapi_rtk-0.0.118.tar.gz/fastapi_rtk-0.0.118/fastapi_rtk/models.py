...
class PermissionApi(Model):
    ...
    id = Column(Integer, Sequence(PERMISSION_API_SEQUENCE), primary_key=True)
...
class Api(Model):
    ...
    id = Column(Integer, Sequence(API_SEQUENCE), primary_key=True)
...
class Permission(Model):
    ...
    id = Column(Integer, Sequence(PERMISSION_SEQUENCE), primary_key=True)
    name = Column(String, unique=True, nullable=False)
...
class Role(Model):
    ...
    id = Column(Integer, Sequence(ROLE_SEQUENCE), primary_key=True)
    name = Column(String, unique=True, nullable=False)
...
class OAuthAccount(SQLAlchemyBaseOAuthAccountTable[int], Model):
    ...
    id = Column(Integer, Sequence(OAUTH_SEQUENCE), primary_key=True)
