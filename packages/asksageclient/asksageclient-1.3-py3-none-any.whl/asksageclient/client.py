...
class AskSageClient:
    ...
    def query_with_file(self, message, file=None, persona='default', dataset='all', limit_references=None, temperature=0.0, live=0, model='openai_gpt', tools=None, tool_choice=None):
        return self.query(message, persona=persona, dataset=dataset, limit_references=limit_references, temperature=temperature, live=live, model=model, file=file, tools=tools, tool_choice=tool_choice)
