...
class TestFormPairConstraints(unittest.TestCase):

    def test_FormPair_constraints(self):
        ...
        self.assertEqual(sp.number_of_forms, 3)
        ...
        for r in range(sp.number_of_forms):
            for c in range(sp.number_of_forms):
                    if r < c:
                        ...
                        self.assertEqual(len(common_items), 2)
