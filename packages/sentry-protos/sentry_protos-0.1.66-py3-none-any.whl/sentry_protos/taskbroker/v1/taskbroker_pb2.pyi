...
class RetryState(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_at_most_once", b"_at_most_once", "at_most_once", b"at_most_once"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_at_most_once", b"_at_most_once", "at_most_once", b"at_most_once", "attempts", b"attempts", "max_attempts", b"max_attempts", "on_attempts_exceeded", b"on_attempts_exceeded"]) -> None: ...
...
class TaskActivation(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_expires", b"_expires", "expires", b"expires", "received_at", b"received_at", "retry_state", b"retry_state"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_expires", b"_expires", "expires", b"expires", "headers", b"headers", "id", b"id", "namespace", b"namespace", "parameters", b"parameters", "processing_deadline_duration", b"processing_deadline_duration", "received_at", b"received_at", "retry_state", b"retry_state", "taskname", b"taskname"]) -> None: ...
