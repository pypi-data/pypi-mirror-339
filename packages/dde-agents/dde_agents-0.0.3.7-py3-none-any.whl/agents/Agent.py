...
class Agent:
    def __init__(self, name: str, instruction: str, model: str = None, tools: list = None, handoffs: list = None, outputs: list = None, inputGuardrails: str = None, outputGuardrails: str = None, openAI: bool = False, images: list = None):
        self.name = name
...
#---------------------------------------------------------------------------------------------------
        ...
        # Local 
            ...
            # Run Tools
            if self.tools != []:
                response = self.runTools(self, prompt, debug)
