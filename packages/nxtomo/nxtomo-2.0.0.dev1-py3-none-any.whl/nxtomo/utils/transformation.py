...
class Transformation:
    ...
    :param transformation_type: type of the transformation. (Once created the type should not change.)
    :param vector: vector of the transformation. Expected as a tuple of three values or an instance of TransformationAxis.
    :param depends_on: name of another transformation on which this transformation depends.
    :warning: For rotations, a value given in radians is automatically converted to degree when comparing.
    """
...
class UDDetTransformation(DetYFlipTransformation):
    def __init__(self, axis_name="ry", depends_on=None, value=180):
        deprecated_warning(
            type_="class",
...
class LRDetTransformation(DetZFlipTransformation):
    def __init__(self, axis_name="rz", depends_on=None, value=180):
        deprecated_warning(
            type_="class",
...
class GravityTransformation(Transformation):
    ...
    The direction is set to -Z.
    The dimension will be unitless since we use it to solve the transformation chain.
    """
