...
def generate_data(data_model: dict, nb_rows: int, type_dataframe: pd.DataFrame | pl.DataFrame = pl.DataFrame):
    """
    Generate test data based on the provided data model and number of rows.
    Parameters:
        data_model (dict): The data model defining the structure of the generated data.
        nb_rows (int): The number of rows to generate.
        type_dataframe: The type of DataFrame to return (default is pandas DataFrame).
    Returns:
        pd.DataFrame | pl.DataFrame: A DataFrame containing the generated data.
    """
