...
def generate_test_data(data_model: dict, nb_rows: int, type_dataframe: pd.DataFrame | pl.DataFrame = pl.DataFrame):
    """
            ...
            for i in range(nb_rows):
                ...
                for col in values:
                    ...
                    if col['type'] == 'integer':
                        ...
                        min = col.get('min_length')  # Default min
                        max = col.get('min_length')  # Default max
