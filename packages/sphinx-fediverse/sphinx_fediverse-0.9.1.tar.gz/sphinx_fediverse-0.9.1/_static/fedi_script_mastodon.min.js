/*! license sphinx-fediverse 0.9.1 | (c) Olivia Appleton-Crocker & other contributors | Released under the GPLv3 | github.com/LivInTheLookingGlass/sphinx-fediverse/blob/0.9.1/LICENSE */
...
async function fetchSubcommentsMastodon(fediInstance, commentId) {
  try {
    ...
    return Promise.all(data.descendants.map(comment => extractCommentMastodon(fediInstance, comment)));
  } catch (error) {
