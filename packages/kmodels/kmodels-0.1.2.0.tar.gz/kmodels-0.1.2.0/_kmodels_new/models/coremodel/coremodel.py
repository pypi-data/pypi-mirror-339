...
from typing import Any, ClassVar, Type, Iterable, TypeVar, get_origin, Union, get_args
...
def generate_simple_cls_key(cls) -> str:
    """
...
class CoreModel(_PrivateCoreModel):
    ...
    def generate_cls_key(cls) -> str:
        ...
        Genera una key única para cada clase que va a funcionar incluso con tipos genéricos.
        """
        base_key = generate_simple_cls_key(cls)
