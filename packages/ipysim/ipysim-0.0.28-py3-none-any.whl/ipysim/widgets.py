...
def interactive_simulation(
    ...
    def create_maglev_animation(t, sol):
        ...
        try:
            ...
            <div style="max-width: 820px; margin: 0 auto; padding: 12px 18px; border: 1px solid #ddd; border-radius: 8px; background: #fafafa; box-shadow: 0 1px 5px rgba(0,0,0,0.04); font-family: sans-serif;">
                <style>
                    .maglev-container {{
                        display: flex;
                    ...
                    .maglev-buttons button,
                    .maglev-buttons input[type="radio"] {{
                        transform: scale(0.8);
                    }}
                    .maglev-canvas {{
                        max-width: 100%;
                ...
                <script>
                    const buttons = document.querySelectorAll('.maglev-container button');
                    buttons.forEach(btn => {{
