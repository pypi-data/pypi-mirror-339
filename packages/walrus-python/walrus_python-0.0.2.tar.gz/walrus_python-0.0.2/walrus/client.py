"""
Walrus client module for interacting with the Walrus publishing and aggregation APIs.

This module provides a client for uploading and retrieving blobs to/from Walrus.
"""
