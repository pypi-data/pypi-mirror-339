...
class ResponseEnum(Enum):
    ...
    Service_Timeout = ("Service_Timeout", "服务调用超时！", HttpStatus.REQUEST_TIMEOUT)
    Sign_Time_Is_Timeout = ("Sign_Time_Is_Timeout", "签名时间戳已超过 %s 分钟！", HttpStatus.REQUEST_TIMEOUT)
    ...
    Import_Xml_Success = ("Import_Xml_Success", "导入 XML 成功", HttpStatus.BAD_REQUEST)
    Import_Xml_Retry = ("Import_Xml_Retry", "导入 XML 重试", HttpStatus.BAD_REQUEST)
    Import_Xml_Retry_End = ("Import_Xml_Retry_End", "导入 XML 重试结束", HttpStatus.BAD_REQUEST)
    Import_Xml_Doing = ("Import_Xml_Doing", "导入 XML 进行中", HttpStatus.BAD_REQUEST)
    Import_Is_Doing = ("Import_Is_Doing", "导入正在进行", HttpStatus.BAD_REQUEST)
    ...
    Too_Retry_Request = ("Too_Retry_Request", "您已被限制，请稍后再试！", HttpStatus.OK)
