...
class FixedModelsAPI:
    ...
    def get_available_models(
        ...
        response = requests.get(f"{self.base_url}/fixed/available-models/", params=params)
        response.raise_for_status()
        adapter = TypeAdapter(List[AvailableModelModel])
        return adapter.validate_python(response.json())
    ...
    def get_available_model(self, available_model_id: int) -> AvailableModelModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/available-models/{available_model_id}")
        response.raise_for_status()
        adapter = TypeAdapter(AvailableModelModel)
        return adapter.validate_python(response.json())
    ...
    def get_providers(self, stage_name: str, model_type_name: Optional[str] = None,
        ...
        response = requests.get(f"{self.base_url}/fixed/providers/", params=params)
        response.raise_for_status()
        adapter = TypeAdapter(List[ProviderModel])
        return adapter.validate_python(response.json())
    ...
    def get_model_creators(self, stage_name: str, model_type_name: Optional[str] = None,
        ...
        response = requests.get(f"{self.base_url}/fixed/model-creators/", params=params)
        response.raise_for_status()
        adapter = TypeAdapter(List[ModelCreatorModel])
        return adapter.validate_python(response.json())
    ...
    def get_model_types(self) -> List[ModelTypeModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/model-types/")
        response.raise_for_status()
        adapter = TypeAdapter(List[ModelTypeModel])
        return adapter.validate_python(response.json())
    ...
    def get_model_creator(self, creator_id: int) -> ModelCreatorModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/model-creators/{creator_id}")
        response.raise_for_status()
        adapter = TypeAdapter(ModelCreatorModel)
        return adapter.validate_python(response.json())
    ...
    def get_user_statuses(self) -> List[UserStatusModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/user-statuses/")
        response.raise_for_status()
    ...
    def get_user_status(self, status_id: int) -> UserStatusModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/user-statuses/{status_id}")
        response.raise_for_status()
    ...
    def get_assistant_types(self) -> List[AssistantTypesModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/assistant-types/")
        response.raise_for_status()
    ...
    def get_assistant_type(self, type_id: int) -> AssistantTypesModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/assistant-types/{type_id}")
        response.raise_for_status()
    ...
    def get_assistant_scopes(self) -> List[AssistantScopesModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/assistant-scopes/")
        response.raise_for_status()
    ...
    def get_assistant_scope(self, scope_id: int) -> AssistantScopesModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/assistant-scopes/{scope_id}")
        response.raise_for_status()
    ...
    def get_service_types(self) -> List[ServiceTypesModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/service-types/")
        response.raise_for_status()
    ...
    def get_service_type(self, type_id: int) -> ServiceTypesModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/service-types/{type_id}")
        response.raise_for_status()
    ...
    def get_services(self) -> List[ServicesModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/services/")
        response.raise_for_status()
    ...
    def get_service(self, service_id: int) -> ServicesModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/services/{service_id}")
        response.raise_for_status()
    ...
    def get_data_source_types(self) -> List[DataSourceTypesModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/data-source-types/")
        response.raise_for_status()
    ...
    def get_data_source_type(self, type_id: int) -> DataSourceTypesModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/data-source-types/{type_id}")
        response.raise_for_status()
    ...
    def get_data_sources(self) -> List[DataSourcesModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/data-sources/")
        response.raise_for_status()
    ...
    def get_data_source(self, source_id: int) -> DataSourcesModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/data-sources/{source_id}")
        response.raise_for_status()
    ...
    def get_channels(self) -> List[ChannelsModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/channels/")
        response.raise_for_status()
    ...
    def get_channel(self, channel_id: int) -> ChannelsModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/channels/{channel_id}")
        response.raise_for_status()
    ...
    def get_assistant_types_service_types(self) -> List[AssistantTypesServiceTypesModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/assistant-types-service-types/")
        response.raise_for_status()
    ...
    def get_assistant_types_service_type(self, id: int) -> AssistantTypesServiceTypesModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/assistant-types-service-types/{id}")
        response.raise_for_status()
    ...
    def get_session_types(self) -> List[SessionTypesModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/session-types/")
        response.raise_for_status()
    ...
    def get_session_type(self, type_id: int) -> SessionTypesModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/session-types/{type_id}")
        response.raise_for_status()
    ...
    def get_connection_types(self) -> List[ConnectionTypesModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/connection-types/")
        response.raise_for_status()
    ...
    def get_connection_type(self, type_id: int) -> ConnectionTypesModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/connection-types/{type_id}")
        response.raise_for_status()
    ...
    def get_connection_providers(self) -> List[ConnectionProvidersModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/connection-providers/")
        response.raise_for_status()
    ...
    def get_connection_provider(self, provider_id: int) -> ConnectionProvidersModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/connection-providers/{provider_id}")
        response.raise_for_status()
    ...
    def get_vector_distance_strategies(self) -> List[VectorDistanceStrategiesModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/vector-distance-strategies/")
        response.raise_for_status()
    ...
    def get_vector_distance_strategy(self, strategy_id: int) -> VectorDistanceStrategiesModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/vector-distance-strategies/{strategy_id}")
        response.raise_for_status()
    ...
    def get_connection_providers_vector_distance_strategies(self) -> List[
        ...
        response = requests.get(f"{self.base_url}/fixed/connection-providers-vector-distance-strategies/")
        response.raise_for_status()
    ...
    def get_connection_providers_vector_distance_strategy(self,
        ...
        response = requests.get(f"{self.base_url}/fixed/connection-providers-vector-distance-strategies/{id}")
        response.raise_for_status()
    ...
    def get_retriever_types(self) -> List[RetrieverTypesModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/retriever-types/")
        response.raise_for_status()
    ...
    def get_retriever_type(self, type_id: int) -> RetrieverTypesModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/retriever-types/{type_id}")
        response.raise_for_status()
    ...
    def get_retriever_strategies(self) -> List[RetrieverStrategiesModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/retriever-strategies/")
        response.raise_for_status()
    ...
    def get_retriever_strategy(self, strategy_id: int) -> RetrieverStrategiesModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/retriever-strategies/{strategy_id}")
        response.raise_for_status()
    ...
    def get_vector_channel_strategies(self) -> List[VectorChannelStrategiesModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/vector-channel-strategies/")
        response.raise_for_status()
    ...
    def get_vector_channel_strategy(self, strategy_id: int) -> VectorChannelStrategiesModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/vector-channel-strategies/{strategy_id}")
        response.raise_for_status()
    ...
    def get_run_statuses(self) -> List[RunStatusesModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/run-statuses/")
        response.raise_for_status()
    ...
    def get_run_status(self, status_id: int) -> RunStatusesModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/run-statuses/{status_id}")
        response.raise_for_status()
    ...
    def get_avatars(self) -> List[AvatarsModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/avatars/")
        response.raise_for_status()
    ...
    def get_avatar(self, avatar_id: int) -> AvatarsModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/avatars/{avatar_id}")
        response.raise_for_status()
    ...
    def get_guardrail_types(self) -> List[GuardrailTypesModel]:
        ...
        response = requests.get(f"{self.base_url}/fixed/guardrail-types/")
        response.raise_for_status()
    ...
    def get_guardrail_type(self, type_id: int) -> GuardrailTypesModel:
        ...
        response = requests.get(f"{self.base_url}/fixed/guardrail-types/{type_id}")
        response.raise_for_status()
