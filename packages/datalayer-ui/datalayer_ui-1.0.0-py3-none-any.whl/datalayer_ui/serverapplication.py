...
from datalayer_ui.handlers.resource_usage.api import ApiHandler, KernelUsageHandler
...
#        self.serverapp.jinja_template_vars.update({"jupyter_ui_version" : __version__})
    ...
    def initialize_handlers(self):
        handlers = [
            ...
            (url_path_join(self.name, "/metrics/v1/kernel_usage", r"get_usage/(.+)$"), KernelUsageHandler),
        ]
