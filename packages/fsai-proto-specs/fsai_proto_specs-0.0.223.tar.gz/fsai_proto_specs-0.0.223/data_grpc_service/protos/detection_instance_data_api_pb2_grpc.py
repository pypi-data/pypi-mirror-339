...
from data_grpc_service.protos import detection_instance_data_api_pb2 as data__grpc__service_dot_protos_dot_detection__instance__data__api__pb2


class DetectionInstanceDataApiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetDetectionInstanceDataById = channel.unary_stream(
                ...
                response_deserializer=data__grpc__service_dot_protos_dot_detection__instance__data__api__pb2.GetDetectionInstanceDataByIdResponse.FromString,
                )
...
def add_DetectionInstanceDataApiServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetDetectionInstanceDataById': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=data__grpc__service_dot_protos_dot_detection__instance__data__api__pb2.GetDetectionInstanceDataByIdResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'DetectionInstanceDataApi', rpc_method_handlers)
...
class DetectionInstanceDataApi(object):
    ...
    def GetDetectionInstanceDataById(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/DetectionInstanceDataApi/GetDetectionInstanceDataById',
            data__grpc__service_dot_protos_dot_detection__instance__data__api__pb2.GetDetectionInstanceDataByIdRequest.SerializeToString,
            data__grpc__service_dot_protos_dot_detection__instance__data__api__pb2.GetDetectionInstanceDataByIdResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
