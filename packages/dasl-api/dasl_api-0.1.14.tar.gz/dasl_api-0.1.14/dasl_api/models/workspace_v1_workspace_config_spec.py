...
class WorkspaceV1WorkspaceConfigSpec(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["systemTablesConfig", "defaultSQLWarehouse", "detectionRuleMetadata", "notableExport", "operationalAlertExport", "observables", "daslStoragePath", "daslCustomPresetsPath", "defaultConfig", "managedRetention"]
