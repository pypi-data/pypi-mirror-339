...
class CoreV1DataSourceFieldUtils(BaseModel):
    ...
    """ # noqa: E501
    temporary_fields: Optional[List[Optional[CoreV1DataSourceFieldSpec]]] = Field(default=None, description="A set of temporary columns to be added to the input in order to perform an arbitrary number of data transformations that require sequential execution. These fields will not be  considered as unreferenced columns and so will not be preserved if preserve = true. Note: nested temporary field names are not supported. ", alias="temporaryFields")
