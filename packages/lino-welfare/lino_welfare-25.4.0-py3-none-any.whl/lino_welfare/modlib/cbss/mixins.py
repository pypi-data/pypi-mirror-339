...
class CBSSRequest(UserAuthored, mixins.Duplicable, Certifiable):
    ...
    person = dd.ForeignKey('pcsw.Client', verbose_name=_("Client"))
...
Read-only.""")
    ...
    environment = models.CharField(max_length=4,
                                   editable=False,
                                   verbose_name=_("T/A/B"))
    ticket = models.CharField(max_length=36,
                              editable=False,
    ...
    response_xml = models.TextField(verbose_name=_("Response"),
                                    editable=False,
                                    blank=True,
                                    help_text="""\
...
""")
    ...
    debug_messages = models.TextField(verbose_name=_("Debug messages"),
                                      editable=False,
                                      blank=True)
    info_messages = models.TextField(verbose_name=_("Info messages"),
                                     editable=False,
                                     blank=True)
...
class SSDNRequest(CBSSRequest):
    ...
    def validate_request(self):
        ...
        wrapped_srvreq = self.wrap_ssdn_request(srvreq,
...
class NewStyleRequest(CBSSRequest):
    ...
    def create_client(self):
        ...
        t = HttpAuthenticated(username=sc.cbss_http_username,
    ...
    def execute_request_(self, now, simulate_response):
        ...
        ci.cbeNumber = settings.SITE.get_config_value('cbss_org_unit')
...
class WithPerson(SSIN):
    ...
    birth_date = dd.IncompleteDateField(blank=True,
