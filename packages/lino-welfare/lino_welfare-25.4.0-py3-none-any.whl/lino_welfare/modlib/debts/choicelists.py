...
# from lino_xl.lib.accounting.fields import DebitOrCreditField
...
add(
    '10',  # used by PrintExpensesByBudget
    _("Description, remarks, yearly amount, actor amounts"),
    "description remarks yearly_amount{} dynamic_amounts".format(AMOUNT_WIDTH))

add('11', _("Description, remarks, actor amounts"),
    "description remarks dynamic_amounts")

add(
    '20',  # used by PrintLiabilitiesByBudget
    _("Partner, remarks, monthly rate, actor amounts"),
    "partner:20 remarks:20 monthly_rate:10 dynamic_amounts")

add(
    '30',  # used by PrintAssetsByBudget, PrintIncomesByBudget
    _("Full description, actor amounts"),
    "full_description dynamic_amounts")

add(
    '40',  # used by Inkasso-Unternehmen and Gerichtsvollzieher
