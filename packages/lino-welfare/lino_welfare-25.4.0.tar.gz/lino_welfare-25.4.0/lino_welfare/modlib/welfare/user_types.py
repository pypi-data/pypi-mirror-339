...
# 210
class ReceptionClerk(SiteUser, AuthorshipTaker, OfficeOperator, NotesUser,
                     GuestOperator, CalendarReader, ContactsStaff, AidsStaff,
                     CBSSUser, BeIdUser, SepaUser, ExcerptsUser, CoursesUser,
                     SocialCoordinator, CoachingsStaff):
    pass


class ReceptionClerkFlexible(
        SiteUser,
        AuthorshipTaker,
        SimpleContactsUser,
        OfficeOperator,
...
class IntegrationAgent(SiteUser, IntegUser, SocialUser, CareerUser,
                       ...
                       ExcerptsUser, CoachingsUser, BeIdUser, GuestOperator,
                       ContactsUser, NotesUser):
    pass


class IntegrationAgentManager(IntegrationAgent, IntegrationStaff, OfficeStaff,
                              NotesStaff, CoachingsStaff, AidsStaff,
                              ContactsStaff, SocialStaff, CareerStaff,
                              NewcomersOperator, CoursesTeacher, xCoursesStaff,
                              SepaStaff, PollsStaff):
    pass
...
class IntegrationAgentReception(
    SiteUser, IntegUser, SocialUser, CareerUser, CoursesUser, xCoursesUser,
    OfficeOperator, OfficeUser, CBSSUser, CheckdataUser, PollsUser,
    ExcerptsUser, BeIdUser, GuestOperator, AuthorshipTaker, NotesUser,
    CalendarReader, ContactsStaff, AidsStaff, SepaUser, SocialCoordinator,
    CoachingsStaff):

    pass


class SocialAgent(SiteUser, SocialUser, OfficeUser, ContactsUser, CBSSUser,
                  BeIdUser, CheckdataUser, AidsUser, PollsUser, SepaUser,
                  CoursesUser, SocialCoordinator, ExcerptsUser, CoachingsUser,
                  AuthorshipTaker, GuestOperator, NotesUser):
    pass


class SocialAgentManager(SocialAgent, SocialStaff, OfficeStaff, ContactsStaff,
                         AidsStaff, PollsStaff, SepaStaff, CoachingsStaff):
    pass

class SocialAgentReception(
    SiteUser, SocialCoordinator, SocialUser, OfficeUser, OfficeOperator, CheckdataUser,
    PollsUser, AuthorshipTaker, NotesUser,
    GuestOperator, CalendarReader, ContactsStaff, AidsStaff, CBSSUser, BeIdUser,
    SepaUser, ExcerptsUser, CoursesUser, CoachingsStaff):
    pass


class DebtsConsultant(SiteUser, DebtsUser, SocialUser, OfficeUser,
                      OfficeOperator, ContactsUser, CBSSUser, CoursesUser,
                      PollsUser, BeIdUser, NotesUser, CheckdataUser, AidsUser,
                      GuestOperator, CoachingsUser, SepaUser, NewcomersUser):
    pass


class NewcomersConsultant(SiteUser, NewcomersUser, SocialUser, OfficeUser,
                          OfficeOperator, ContactsUser, CBSSUser, BeIdUser,
                          NotesUser, CoursesUser, CheckdataUser, AidsUser,
                          CoachingsUser, PollsUser, GuestOperator, SepaUser):
    pass


class Accountant(SiteUser, LedgerUser, ContactsUser, OfficeUser, NotesUser,
...
class SiteAdmin(SiteAdmin, AidsStaff, AuthorshipTaker, BeIdUser, CBSSUser,
                CareerStaff, CheckdataUser, CoachingsStaff, ContactsStaff,
                CoursesUser, xCoursesStaff, DebtsStaff, ExcerptsStaff,
                GuestOperator, IntegrationStaff, LedgerStaff, NewcomersUser,
                NotesStaff, OfficeStaff, PollsStaff, SepaStaff, SiteSearcher,
...
class Supervisor(SiteUser, Supervisor, AuthorshipTaker, OfficeOperator,
                 BeIdUser, GuestOperator, CoursesUser, NotesUser,
                 ContactsStaff, AidsStaff, NewcomersOperator, ExcerptsUser,
                 SepaUser):
    pass
...
add('130', _("Integration agent (Reception)"), IntegrationAgentReception)
...
add('430', _("Social agent (Reception)"), SocialAgentReception)
