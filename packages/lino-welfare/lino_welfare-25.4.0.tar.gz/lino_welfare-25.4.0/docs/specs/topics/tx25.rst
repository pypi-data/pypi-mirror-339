.. doctest docs/specs/topics/tx25.rst
.. _tx25:
.. _welfare.specs.tx25:
...
>>> tpl = u"{0} ({1}) : {2} "
>>> for name, v in sorted(HANDLERS.items(), key=lambda item: (item[1], item[0])):
...
...     with translation.override('de'):
...         ses.show(cbss.RetrieveTIGroupsResult, obj)
>>> showit(2)  #doctest: +NORMALIZE_WHITESPACE +ELLIPSIS +REPORT_UDIFF
============================== ===== ========== ==============================================================================================================================================================================
 Gruppe                         TI    Seit       Information
------------------------------ ----- ---------- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 Reisepässe                     199   31.01.11   Status: **Ausstellung** (0), Typ **Reisepass** (0), Nr. **EH960150  **, ausgestellt durch **Eupen** (63023), Erneuerungsnr. **00**, produziert 21.01.11, gültig bis 20.01.16
 Erstelldatum                   253   05.09.15
