...
from models.HSAZLM import Encoder
from tools.dataset import create_dataloaders
from tools.tool import list_folders
...
def parse_args(args=None):
    ...
    parser.add_argument('--save_path', default='/data/coding/results/train_D0')
    parser.add_argument('--feature_extractor_path',
                        default=r'/data/coding/results/train_D0/models/feature_extractor.pt')
