...
def main(args):
    ...
    savemat(args.features, {'train_features': train_features, 'train_labels': train_labels,
...
def parse_args(args=None):
    ...
    parser.add_argument('--encoder_path', default='/data/coding/results/train_D0/models/decae.pt')
    parser.add_argument('--sa_path', default='/data/coding/data/predicate-matrix-binary.txt')
    parser.add_argument('--save_path', default='/data/coding/results/train_D0/HSA.mat')
    parser.add_argument('--feature_extractor_path', default=r'/data/coding/results/train_D0/models/feature_extractor.pt')
    parser.add_argument('--features', type=str, default=r'/data/coding/results/train_D0/D0-D0.mat')
