...
class UsersLocal(
    ...
    def read_user_dict_by_user_id(self, user_id: int) -> dict:
        """
        Returns a dict of user with (number, username, user.main_email_address, first_name, last_name, active_location_id)
        """
    ...
    def delete_by_user_id(self, user_id: int) -> int:
        ...
        """
        deleted_row = self.delete_by_column_and_value(id_column_value=user_id)
        return deleted_row
