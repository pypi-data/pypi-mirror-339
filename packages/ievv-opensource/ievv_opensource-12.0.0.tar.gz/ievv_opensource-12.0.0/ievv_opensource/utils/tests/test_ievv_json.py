...
class TestIevvJSON(test.TestCase):
    def test_datetime(self):
        ...
        self.assertEqual(encoded, '{"somedatetime": {"__type__": "datetime", "value": "2019-12-23 23:50:00+09:00"}}')
    ...
    def test_date(self):
        ...
        encoded = ievv_json.dumps(data, sort_keys=True)
        self.assertEqual(encoded, '{"somedate": {"__type__": "date", "value": "2019-12-24"}}')
        decoded = ievv_json.loads(encoded)
        self.assertDictEqual(decoded, data)
    ...
    def test_time(self):
        ...
        encoded = ievv_json.dumps(data, sort_keys=True)
        self.assertEqual(encoded, '{"sometime": {"__type__": "time", "value": "12:40:38.000123"}}')
        decoded = ievv_json.loads(encoded)
        self.assertDictEqual(decoded, data)
    ...
    def test_decimal(self):
        ...
        encoded = ievv_json.dumps(data, sort_keys=True)
        self.assertEqual(encoded, '{"somedecimal": {"__type__": "decimal", "value": "10.2"}}')
        decoded = ievv_json.loads(encoded)
        self.assertDictEqual(decoded, data)
