...
class Hauptprogramm(tk.Tk):
    ...
    def baueWidgets(self):
        ...
        def FactoryPersonListe():
            ...
            form.addWidget(
                'id',
                ttk.Entry(self.frmPersonListeInhalt.innerFrame, state=tk.DISABLED, width=6),
                'int',
                label='ID')
            form.addWidget(
                'name',
        ...
        def FactoryFamListe():
            ...
            form.addWidget(
                'id',
                ttk.Entry(self.frmFamListeInhalt.innerFrame, state=tk.DISABLED, width=6),
                'int',
                label='ID')
            form.addWidget(
                'name',
                ...
                with CtxNotebook(self.frmMain) as self.nbkMain:
                    ...
                    with CtxNotebook(self.nbkMain) as self.nbkPersonen:
                        ...
                        with CtxPanedWindow(
                            ...
                            self.sfrPersEinzelGruppen.setHeight(40)
