...
class Test_Core_Functions(unittest.TestCase):
    def test_part_digestion(self):
        ...
        self.assertEqual(extract.roles, ['https://identifiers.org/so/SO:0000915'], "Part digestion extracted part missing engineered insert role") #engineered insert role
        self.assertTrue('http://identifiers.org/so/SO:0000987' in extract.types, "Part digestion extracted part missing linear DNA type")
    ...
    def test_backbone_digestion(self):
        ...
        parts_list, assembly_plan = backbone_digestion(md, [rebase_restriction_enzyme('BsaI')], assembly_plan, doc)
        ...
        extract = parts_list[0][0]
        self.assertEqual(extract.roles, ['https://identifiers.org/so/SO:0000755'], "Backbone digestion extracted part missing plasmid vector role") #plasmid vector
