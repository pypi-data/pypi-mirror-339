...
from cratonapi.requests.datarequests import uploadwellhodographrequest, cubesaroundpointrequest
...
class DataConnector:
    ...
    def get_cube_data_range(self,
                            ...
                            end_crossline_idx: int) -> CubeDataSlice:
        """Request code 19"""
        message = cubedatarangerequest.request(cube_id,
                                               horizon_top_name,
                                               horizon_bot_name,
                                               top_off,
                                               bot_off,
    ...
    def get_cubes_around_point(self, x: float, y: float, radius: float) -> Tuple[int, List[int]]:
        """Request code 21"""
