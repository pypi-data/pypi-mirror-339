...
Thank you for your help improving **geeplot**!

**geeplot** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **geeplot** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/<YOUR USERNAME>/geeplot
   cd geeplot
...
This will install the **geeplot** library, together with two additional tools:
