...
class Obj_Actions:
    ...
    def insert_or_update_actions(self, actions, connection, con_type):
        ...
        if missing_keys:
            ...
            description = actions.get('description', '') or None
            service_code = actions.get('service_code', '') or None
    ...
    def process_data(self, conn, sql_models_data, schema_name, con_type):
                        ...
                        if ':' in actions['actual_func']:
                            ...
                            if con_type == 'Oracle':
                                queryy = f"""
                                    ...
                                    WHERE OBJECT_NAME = UPPER('{sql_function_name}') 
