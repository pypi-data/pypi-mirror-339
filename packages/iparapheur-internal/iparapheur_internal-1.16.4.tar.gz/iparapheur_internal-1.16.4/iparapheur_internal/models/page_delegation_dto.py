...
class PageDelegationDto(BaseModel):
    """
    PageDelegationDto
    """ # noqa: E501
    ...
    content: Optional[List[DelegationDto]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageDelegationDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageDelegationDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [DelegationDto.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
