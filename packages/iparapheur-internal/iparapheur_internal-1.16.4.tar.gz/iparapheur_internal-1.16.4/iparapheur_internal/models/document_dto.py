...
class DocumentDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "index", "pageCount", "contentLength", "mediaType", "pagesProperties", "pdfVisualId", "signaturePlacementAnnotations", "signatureTags", "sealTags", "detachedSignatures", "embeddedSignatureInfos", "signatureProof", "deletable", "isMainDocument"]
