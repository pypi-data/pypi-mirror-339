...
from tgtrader.streamlit_pages.pages.tools.ff5_analysis import run as ff5_analysis_run
...
def run():
    ...
    if 'logged_in' not in st.session_state or not st.session_state['logged_in']:
        ...
        market_style_analysis_page = st.Page(ff5_analysis_run, title='FF5风格分析',
                                            icon=':material/psychology:', url_path='market_style_analysis')
        strategy_pages['工具'] = [corr_analysis_page, market_style_analysis_page]
