from litepolis_database_default.Users import UserManager, User
import pytest
...
def test_get_user():
    ...
    retrieved_user = UserManager.read_user(user.id)
...
def test_update_user():
    ...
    updated_user = UserManager.update_user(user.id, update_data)
...
def test_delete_user():
    ...
    deleted = UserManager.delete_user(user.id)
