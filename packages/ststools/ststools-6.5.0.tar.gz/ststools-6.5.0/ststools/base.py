...
def Map():
    ...
    smoothing_slider = FloatSlider(value=3, min=0.5, max=20, step=0.5, description="Smoothing")
    smoothing_method_dropdown = Dropdown(options=["Savgol", "Moving Avg"], value="Savgol", description="Method")
    threshold_slider = FloatSlider(value=100, min=0.5, max=100, step=0.5, description="Threshold Remove Outlier")
    threshold_method_dropdown = Dropdown(options=["iqr", "std"], value="iqr", description="Method")
    ...
    widgets_top_row2 =  HBox([threshold_slider,threshold_method_dropdown
    ])
    widgets_top_row3 = HBox([
    ...
    layout = VBox([widgets_top_row1, widgets_top_row2,widgets_top_row3, heatmap_and_derivative], layout=Layout(width='100%'))
