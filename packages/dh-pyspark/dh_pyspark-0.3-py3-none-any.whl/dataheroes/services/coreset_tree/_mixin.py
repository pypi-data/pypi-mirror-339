...
from dataheroes.utils import telemetry, localtime, colored
...
class ResampleMixin:
    ...
    def _get_resampling_level(self, n_rounds: int, tree_idx: int, verbose: bool = False) -> int:
        ...
        max_in_mem_samples = evaluate_max_batch_size(n_features=n_features)
        ...
        for level in range(tree_leaf_level):
            ...
            if verbose:
                print(
                    ...
                    f"{n_rounds=}, {n_samples_upper_bound=}, {n_features=}, {max_in_mem_samples=}, "
...
class RefinementMixin:
    ...
    def _get_refinement_data(
        ...
        max_samples = evaluate_max_batch_size(n_features=self.data_manager.n_features)
