...
class SetupVersion(_message.Message):
    __slots__ = ("name", "version", "content", "creation_date")
    ...
    def __init__(self, name: _Optional[str] = ..., version: _Optional[str] = ..., content: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., creation_date: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...

class Setup(_message.Message):
    __slots__ = ("id", "name", "organisation_id", "owner", "module_id", "current_setup_version")
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., organisation_id: _Optional[str] = ..., owner: _Optional[str] = ..., module_id: _Optional[str] = ..., current_setup_version: _Optional[_Union[SetupVersion, _Mapping]] = ...) -> None: ...

class CreateSetupRequest(_message.Message):
    __slots__ = ("name", "organisation_id", "owner", "module_id", "current_setup_version")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ORGANISATION_ID_FIELD_NUMBER: _ClassVar[int]
    OWNER_FIELD_NUMBER: _ClassVar[int]
    MODULE_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    module_id: str
    current_setup_version: SetupVersion
    def __init__(self, name: _Optional[str] = ..., organisation_id: _Optional[str] = ..., owner: _Optional[str] = ..., module_id: _Optional[str] = ..., current_setup_version: _Optional[_Union[SetupVersion, _Mapping]] = ...) -> None: ...
...
class UpdateSetupRequest(_message.Message):
    __slots__ = ("setup_id", "name", "owner", "current_setup_version")
    SETUP_ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    OWNER_FIELD_NUMBER: _ClassVar[int]
    CURRENT_SETUP_VERSION_FIELD_NUMBER: _ClassVar[int]
    ...
    owner: str
    current_setup_version: SetupVersion
    def __init__(self, setup_id: _Optional[str] = ..., name: _Optional[str] = ..., owner: _Optional[str] = ..., current_setup_version: _Optional[_Union[SetupVersion, _Mapping]] = ...) -> None: ...
...
class CreateSetupVersionRequest(_message.Message):
    __slots__ = ("name", "version", "content")
    NAME_FIELD_NUMBER: _ClassVar[int]
    VERSION_FIELD_NUMBER: _ClassVar[int]
    CONTENT_FIELD_NUMBER: _ClassVar[int]
    name: str
    version: str
    content: _struct_pb2.Struct
    def __init__(self, name: _Optional[str] = ..., version: _Optional[str] = ..., content: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...
