...
def fdt_get_symbol(fdt, name):
    return _libfdt.fdt_get_symbol(fdt, name)
...
def fdt_setprop_namelen(fdt, nodeoffset, name, namelen, val, len):
    return _libfdt.fdt_setprop_namelen(fdt, nodeoffset, name, namelen, val, len)

def fdt_setprop(fdt, nodeoffset, name, val, len):
    return _libfdt.fdt_setprop(fdt, nodeoffset, name, val, len)

def fdt_setprop_placeholder_namelen(fdt, nodeoffset, name, namelen, len, prop_data):
    return _libfdt.fdt_setprop_placeholder_namelen(fdt, nodeoffset, name, namelen, len, prop_data)
