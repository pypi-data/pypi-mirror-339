...
def main():
    ...
    parser.add_argument("-k", "--kmaPath",
                        help="Path to KMA",
                        default=None)
    parser.add_argument("--kma_threads",
                        help="Number of threads to use with KMA",
                        type=int,
                        default=None)
    ...
    if conf.acquired is True:
        ...
        if (conf.inputfasta):
            ...
            additional_kma_args = f"-t {conf.kma_threads}{kma_nano_args}"
            ...
            kma_run = acquired_finder.kma(
                ...
                kma_apm="p",
                kma_1t1=True,
                kma_add_args=additional_kma_args
            )
