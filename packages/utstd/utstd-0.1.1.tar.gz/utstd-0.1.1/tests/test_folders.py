...
def test_default_initial_amount(lab01_ex02):
    assert lab01_ex02.course_code == "36106"
    assert lab01_ex02._lab == "lab01"
    assert lab01_ex02._exercise == "ex02"
    assert lab01_ex02.folder_path is not None

def test_setting_initial_amount(at1):
    assert at1.course_code == "36106"
    assert at1._assignment == "AT1"
    assert at1.folder_path is not None
