            ...
            python_schema=core_schema.chain_schema([
                core_schema.union_schema([
                    ...
                    core_schema.chain_schema([
                        ...
                        core_schema.no_info_plain_validator_function(lambda v: v.split(':')),
                    ])
                ]),
            ]),
            serialization=core_schema.plain_serializer_function_ser_schema(set)
        )
