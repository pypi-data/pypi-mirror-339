...
def create_log_message(log_config: LogConfig, message: str, log_to_console=True) -> tuple[int, str]:
    ...
    try:
        ...
        post_data = {"deviceName": log_config.device_name, "agentType": log_config.agent_type, "agentVersion": log_config.agent_version, "agentIndex": log_config.agent_index, "processID": log_config.process_id, "message": message, "logDate": str(utc_now)}
