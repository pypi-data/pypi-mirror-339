...
def format_error_message(
    ...
    args_str = ", ".join(f"{k}={v}" for k, v in arguments.items() if k != "content" and len(str(v)) < 50)
...
def display_error(
    ...
    formatted = format_error_message(error_msg, tool_name, arguments, task_id, task_desc)
