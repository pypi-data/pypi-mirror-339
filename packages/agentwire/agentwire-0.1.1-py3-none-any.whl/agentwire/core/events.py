...
class AWPEvent(ConfiguredBaseModel):
    """
...
class TextMessageStartEvent(AWPEvent):
    """
...
class TextMessageContentEvent(AWPEvent):
    """
...
class TextMessageEndEvent(AWPEvent):
    """
...
class ToolCallStartEvent(AWPEvent):
    """
...
class ToolCallArgsEvent(AWPEvent):
    """
...
class ToolCallEndEvent(AWPEvent):
    """
...
class StateSnapshotEvent(AWPEvent):
    """
...
class StateDeltaEvent(AWPEvent):
    """
...
class MessagesSnapshotEvent(AWPEvent):
    """
...
class RunStartedEvent(AWPEvent):
    """
...
class RunFinishedEvent(AWPEvent):
    """
...
class StepStartedEvent(AWPEvent):
    """
...
class StepFinishedEvent(AWPEvent):
    """
