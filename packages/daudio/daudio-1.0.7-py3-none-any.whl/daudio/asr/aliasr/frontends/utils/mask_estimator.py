...
from daudio.asr.aliasr.models.language_model.rnn.encoders import RNN, RNNP
...
class MaskEstimator(torch.nn.Module):
    ...
    def forward(self, xs: ComplexTensor, ilens: torch.LongTensor) -> Tuple[Tuple[torch.Tensor, ...], torch.LongTensor]:
