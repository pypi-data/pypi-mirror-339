...
class CTC(torch.nn.Module):
    ...
    def __init__(self, odim: int, encoder_output_size: int, dropout_rate: float=0.0, ctc_type: str='builtin', reduce: bool=True, ignore_nan_grad: bool=True, extra_linear: bool=True):
        super().__init__()
    ...
    def forward(self, hs_pad, hlens, ys_pad, ys_lens):
        ...
        loss = self.loss_fn(ys_hat, ys_true, hlens, ys_lens).to(device=hs_pad.device, dtype=hs_pad.dtype)
        return loss
