...
class Affaire(EntityType):
    ...
    ref = String(
        fulltextindexed=True, indexed=True, constraints=[SizeConstraint(max=16)]
    )
    sujet = String(fulltextindexed=True, constraints=[SizeConstraint(max=256)])
...
class Folder2(EntityType):
    ...
    name = String(
        ...
        constraints=[UniqueConstraint(), SizeConstraint(max=64)],
    )
    description = RichString(fulltextindexed=True)
