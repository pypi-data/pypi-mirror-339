...
if __name__ == "__main__":
    ...
    """) as demo:
        gr.Markdown("<h1 style='text-align: center;'>RNA Design and Visualisation</h1>")
        gr.Markdown(
            "<p style='text-align: center;'>This demo uses the OmniGenome foundation model to design RNA sequences that fold into a given RNA structure.</p>")
        ...
        with gr.Row():
            true_image = gr.Image(label="Reference RNA Structure Folding", elem_classes="center-image")
            image = gr.Image(label="Predicted RNA Structure Folding", elem_classes="center-image")
        ...
        demo.load(reload_image, inputs=[sequence_text, structure_text],
                  outputs=[true_image, image], every=0.05)
