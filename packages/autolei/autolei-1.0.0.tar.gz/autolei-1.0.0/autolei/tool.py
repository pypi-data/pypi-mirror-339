...
class Tools(tk.Frame):  # Assuming this inherits from tk.Frame
    ...
    def __init__(self, parent: tk.Frame):
        ...
        instruction_msg = "2. Roll back XDS.INP to certain stage."
        label = tk.Label(intro_frame, text=instruction_msg, bg='white')
        label.pack(side="left", fill="both", expand=True)  # Ensure it fills the frame horizontally
        ...
        delete_xds_button = tk.Button(row3_frame, text="Delete XDS", command=self.confirm_delete_xds, bg="#f3e3e3")
        delete_xds_button.grid(row=0, column=3, sticky="w", padx=25, pady=sp)
        ...
        instruction_msg = "3. Change image path in XDS.INP to (SMV .img only)"
        label = tk.Label(intro_frame, text=instruction_msg, bg='white')
        label.pack(side="left", fill="both", expand=True)  # Ensure it fills the frame horizontally

        # Function 3
        row5_frame = tk.Frame(self, bg='white')
        row5_frame.grid(row=5, column=0, sticky="w", padx=10, pady=sp)
        ...
        instruction_msg = "4. Generate PETS input from FEI .mrc file"
        label = tk.Label(intro_frame, text=instruction_msg, bg='white')
        label.pack(side="left", fill="both", expand=True)  # Ensure it fills the frame horizontally

        # Function 4
        row7_frame = tk.Frame(self, bg='white')
        row7_frame.grid(row=7, column=0, sticky="w", padx=10, pady=sp)
