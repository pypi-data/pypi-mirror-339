...
class AutoLei(tk.Tk):
    ...
    def update_title(self):
        ...
        if self.input_path:
            self.title(f"AutoLEI 1.0.0 - {self.input_path} - {self.dataset_counts} datasets")
        else:
            self.title("AutoLEI 1.0.0")
...
def main() -> None:
    ...
    """
    print("Report bug: \nlei.wang@mmk.su.se\nyinlin.chen@mmk.su.se\n")

    print("AutoLEI version 1.0.0, build date 2024-12-25")
