...
class RealTime(Page):
    ...
    def __init__(self, parent: tk.Widget):
        ...
        introduce_label = tk.Label(self,
                                   text="RealTime MicroED data processing, designed for data collected by EPU-D and Instamatic. "
        ...
        self.last_status = tk.Entry(result1_frame, width=40)
        ...
        unit_cell_label = tk.Label(result3_frame, text="Average Unit cell", bg='white')
        unit_cell_label.pack(side="left", padx=(25, 10))
