...
class Lost(models.Model):
    ...
    personal_manager = models.ForeignKey('PersonalManager', models.SET_NULL, null=True, verbose_name='Перс. менеджер')
    personal_manager_date = models.DateField('Когда назначен', null=True)
