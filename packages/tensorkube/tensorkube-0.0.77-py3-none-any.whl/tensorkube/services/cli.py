...
def configure(vpc_public_subnets, vpc_private_subnets, legacy, test, override_policy_checks):
    ...
    if override_policy_checks:
        has_permissions = True
        click.echo(click.style("You are overriding permissions and policy checks. You may run into permission issues", bold=True, fg=CliColors.WARNING.value))
    else:
