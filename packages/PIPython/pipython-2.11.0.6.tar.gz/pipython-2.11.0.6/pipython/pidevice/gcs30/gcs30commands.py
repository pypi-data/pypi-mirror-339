...
__signature__ = 0xe756017f552085f346d44dd21059eb46
...
class GCS30Commands(GCSBaseCommands):
    ...
    def __str__(self):
        return f'GCS30Commands(msgs={str(self._msgs)})'
    ...
    def _init_valid_ucls(self):
        # Consider iterating the dictionary directly instead of calling .keys() pylint: disable=C0201
            ...
            if PIBlockNames.PARAM_OVERVIEW.value in block_cmd_line:
                for line in block_cmd_line[PIBlockNames.PARAM_OVERVIEW.value]:
                    ...
                    if data_type.upper() in (
                        ...
                        raise KeyError(f'unknown parameter type {data_type}')
    ...
    def bufdata_generator(self, read_block_size=None):
        ...
        while self._msgs._databuffer['index'] > 0:
            ...
            blocksize = min(blocksize, self._msgs._databuffer['index'])
