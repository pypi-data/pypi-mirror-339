...
__signature__ = 0x3329b10eb693a20ef7661dbf78bce42a
...
print(gcs.qIDN())
# answer e.g:
# '(c)2015 - 2018 Physik Instrumente (PI) SE & Co. KG, C-885.M1 TCP-IP Master,987654321,1.0.1.0'
...
# answer e.g:
# '0 2 (c)2016 Physik Instrumente (PI) SE & Co. KG, E-873.10C885, 117007101, 02.016'
