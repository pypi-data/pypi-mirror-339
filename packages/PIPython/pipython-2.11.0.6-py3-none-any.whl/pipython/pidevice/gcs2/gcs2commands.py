...
__signature__ = 0x49e509f17d26a9f4a4f6fec1fccee10c
...
class GCS2Commands(GCSBaseCommands):
    ...
    def __str__(self):
        return f'GCS2Commands(msgs={str(self._msgs)})'
...
#        super().funcs.fdel(self)
        ...
        if not self._settings['paramconv']:
            for line in self.qHPA().splitlines():
                ...
                if convtype.upper() == 'INT':
                    ...
                    raise KeyError(f'unknown parameter type {convtype}')
    ...
    def IsControllerReady(self):
        ...
        try:
            ...
            raise ValueError(f'unexpected response {answer} for IsControllerReady()') from TypeError
