...
__signature__ = 0x243f8cf8c043926b0be7e2e5259a726f
...
class PISerial(PIGateway):
    ...
    def __str__(self):
        return f'PISerial(port={self._port}, baudrate={self._baudrate})'
    ...
    def ConnectRS232(self, port, baudrate):
        ...
        @param port : Name of the serial port to use as string, e.g.
                      "COM1" on Windows or
                      "/dev/ttyS0" on Linux, or
                      "/dev/ttyUSB0" on Linux if a virtual com port for USB is used.
        @param baudrate : Baud rate as integer.
        """
