...
def atk_mattersim():
    ...
    if len(sys.argv) > 1:
        ...
        \033[1m FINETUNE \033[0m: "{'project_name' : 'NAME', 'train_data_path': 'FILE', 'device': 'cuda/cpu', 'force_loss_ratio': 'FLOAT', 'load_model_path': 'small/large/PATH', 'y/n', 'batch_size': 'INT', 'epochs': 'INT', 'seed': 'INT', 'lr': 'FLOAT', 'save_checkpoint' : 'y', 'ckpt_interval': '25', 'save_path': 'PATH'}"\n
