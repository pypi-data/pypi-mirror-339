...
def gen_template(sequence, cterm, nterm, disable_template_variance):
    if cterm:
        sequence = sequence + cterm
    if nterm:
        sequence = nterm + sequence
    return generate_template.template_from_sequence(sequence, disable_template_variance)
...
def generate_squiggle(sequence: str = None,
                      ...
                      disable_template_variance: bool = False,
                      cterm: str = None,
                      nterm: str = None,
    ...
    if sequence:
        template = gen_template(sequence, cterm, nterm, disable_template_variance)
    elif protein_id:
