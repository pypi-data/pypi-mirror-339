...
import pytest
from google.genai.types import Content, Part, Tool as GeminiTool, FunctionDeclaration, Schema
...
def test_clean_schema_handles_nested_objects():
    ...
    assert cleaned["properties"]["user"]["properties"]["settings"]["properties"]["theme"]["type"] == "string"
...
def test_clean_schema_handles_arrays():
    ...
    assert cleaned["properties"]["records"]["items"]["properties"]["id"]["type"] == "string"
