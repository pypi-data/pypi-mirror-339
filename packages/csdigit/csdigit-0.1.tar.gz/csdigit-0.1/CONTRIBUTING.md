...
Welcome to `csdigit` contributor's guide.
...
If you experience bugs or general issues with `csdigit`, please have a look
...
You can help improve `csdigit` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`csdigit` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `csdigit`'s files. While this mechanism can
...
```
conda create -n csdigit python=3 six virtualenv pytest pytest-cov
conda activate csdigit
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/csdigit.git
   cd csdigit
   ```
...
5. Install [pre-commit]:
   ...
   `csdigit` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/csdigit
[issue tracker]: https://github.com/<USERNAME>/csdigit/issues
