...
class ApiOutputEosPropertiesTPnResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        """Dump an instance of `ApiOutputEosPropertiesTPnResult` to a dict."""
        result: Dict[str, Any] = {}
        for attr_name, api_key in self.FIELD_MAP.items():
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        """Create an instance of `ApiOutputEosPropertiesTPnResult` from a dict."""
        d = src_dict.copy()
        kwargs = {}

        for field, api_key in cls.FIELD_MAP.items():
