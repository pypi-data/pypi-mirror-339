...
class ContentSafetyChecker(AnswerProcessingBase):
    ...
    def validate_input_and_replace_if_harmful(self, text):
        with tracer.start_as_current_span("ContentSafetyChecker.validate_input_and_replace_if_harmful"):
    ...
    def validate_output_and_replace_if_harmful(self, text):
        with tracer.start_as_current_span("ContentSafetyChecker.validate_output_and_replace_if_harmful"):
    ...
    def _filter_text_and_replace(self, text, response_template):
        with tracer.start_as_current_span("ContentSafetyChecker._filter_text_and_replace"):
