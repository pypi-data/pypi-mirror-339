...
class QuestionAnswerTool(AnsweringToolBase):
    ...
    def __init__(self) -> None:
        ...
        """
        with tracer.start_as_current_span("QuestionAnswerTool.__init__"):
    ...
    def json_remove_whitespace(obj: str) -> str:
        ...
        """
        with tracer.start_as_current_span("QuestionAnswerTool.json_remove_whitespace"):
            try:
    ...
    def clean_chat_history(chat_history: list[dict]) -> list[dict]:
        ...
        """
        with tracer.start_as_current_span("QuestionAnswerTool.clean_chat_history"):
            ...
            logger.info(f"Chat history cleaned. Returning {len(cleaned_history)} messages.")
    ...
    def generate_messages(self, question: str, sources: list[SourceDocument]):
        ...
        """
        with tracer.start_as_current_span("QuestionAnswerTool.generate_messages"):
            sources_text = "\n\n".join(
    ...
    def generate_on_your_data_messages(
        ...
        Returns:
            list[dict]: The generated messages.
        """
        with tracer.start_as_current_span("QuestionAnswerTool.generate_on_your_data_messages"):
    ...
    def format_answer_from_response(
        ...
        Returns:
            Answer: The formatted answer.
        """
        with tracer.start_as_current_span("QuestionAnswerTool.format_answer_from_response"):
