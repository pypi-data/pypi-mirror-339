...
def create_main(folder_name, uname, max_retry):
    ...
    service_name = f"{folder_name}-4.service"
...
Type=simple
User=chetansirsa
WorkingDirectory=/home/chetansirsa/{folder_name}
ExecStart=/bin/bash /home/chetansirsa/{folder_name}/main.sh
Restart=on-failure
RestartSec=1
[Install]
WantedBy=multi-user.target"""
...
if __name__ == "__main__":
    # print(create_service_content("botasaurus-starter", "chetansirsa", 3, "./a.sh"))

    launch_file_path, service_name = create_main("botasaurus-starter", "chetansirsa", 3,)
    setup_systemctl_for_data_scraper(launch_file_path, service_name)