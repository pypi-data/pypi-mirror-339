...
test_dims = (
    ...
    (32*5 * 1024, 512, 512, 0, 0),
    (32*5 * 1024, 512, 512, 0, 1),
    (32*5 * 1024, 512, 512, 1, 0),
    (32*5 * 1024, 512, 512, 1, 1),
    (32*5 * 1024, 512, 2048, 0, 0),
    (32*5 * 1024, 512, 2048, 0, 1),
    (32*5 * 1024, 512, 2048, 1, 0),
    (32*5 * 1024, 512, 2048, 1, 1),
