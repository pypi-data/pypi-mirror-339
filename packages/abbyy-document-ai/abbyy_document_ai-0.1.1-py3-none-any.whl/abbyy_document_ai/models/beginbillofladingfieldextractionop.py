...
class BeginBillOfLadingFieldExtractionProcessBillOfLadingRequestTypedDict(TypedDict):
...
class BeginBillOfLadingFieldExtractionProcessBillOfLadingRequest(BaseModel):
    r"""Request to process a document using the bill-of-lading model"""
