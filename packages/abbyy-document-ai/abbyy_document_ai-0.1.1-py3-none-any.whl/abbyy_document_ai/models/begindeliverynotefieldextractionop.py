...
class BeginDeliveryNoteFieldExtractionProcessDeliveryNoteRequestTypedDict(TypedDict):
...
class BeginDeliveryNoteFieldExtractionProcessDeliveryNoteRequest(BaseModel):
    r"""Request to process a document using the delivery-note model"""
