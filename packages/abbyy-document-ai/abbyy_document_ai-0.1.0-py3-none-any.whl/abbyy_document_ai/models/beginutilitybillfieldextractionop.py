...
class BeginUtilityBillFieldExtractionProcessUtilityBillRequestTypedDict(TypedDict):
...
class BeginUtilityBillFieldExtractionProcessUtilityBillRequest(BaseModel):
    r"""Request to process a document using the utility-bill model"""
