...
class BeginTaxiReceiptFieldExtractionProcessTaxiReceiptRequestTypedDict(TypedDict):
...
class BeginTaxiReceiptFieldExtractionProcessTaxiReceiptRequest(BaseModel):
    r"""Request to process a document using the taxi-receipt model"""
