...
class BeginPackingListFieldExtractionProcessPackingListRequestTypedDict(TypedDict):
...
class BeginPackingListFieldExtractionProcessPackingListRequest(BaseModel):
    r"""Request to process a document using the packing-list model"""
