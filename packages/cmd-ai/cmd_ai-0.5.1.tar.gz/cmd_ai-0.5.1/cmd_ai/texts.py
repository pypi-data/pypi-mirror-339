...
tool_callSympy = {
    ...
    "function": {
        "name": "callSympy",
        "description": "calculate mathematical expressions exactly using python sympy module.",
        "parameters": {
            "type": "object",
            "properties": {
                "expression": {
                    "type": "string",
                    "description": "Mathematical expression in python sympy notation. The content will go as the parameter to sympify() function."
                }
            },
            "required": ["expression"]
        }
