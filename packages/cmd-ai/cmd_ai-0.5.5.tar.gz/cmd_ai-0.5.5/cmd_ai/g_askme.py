...
def g_ask_anyone(
    ...
    if config.MODEL_TO_USE.find("claude") >= 0:
        ...
        models = [ "gpt-4o-2024-11-20", "o3-mini-2025-01-31", "claude-3-7-sonnet-20250219", "gemini-2.5-pro-exp-03-25"]
        ...
        # #
        resdi = "dialog is not recorded", "select", config.MODEL_TO_USE
    else:
        resdi = None
