...
namespace sasktran2::math {
    ...
    class UnitSphere {
      ...
      public:
        ...
        virtual void
        interpolate(const Eigen::Vector3d& direction,
     ...
     * @class LebedevSphere
     *
     * @brief A class that represents a unit sphere with Lebedev quadrature
     * points.
     *
     * The class provides a convenient way to access the cartesian coordinates
     * and weights of the Lebedev quadrature points. The cartesian coordinates
     * are stored in the `m_xyz` member variable and the weights are stored in
     * the `m_weights` member variable.
     */
    class LebedevSphere : public UnitSphere {
      ...
      public:
         ...
         *
         * The number of points must be one of the following: [6, 14, 26, 38,
         * 50, 74, 86, 110, 146, 170, 194, 230, 266, 302, 350, 434, 590, 770,
         * 974, 1202, 1454, 1730, 2030, 2354, 2702, 3074, 3470, 3890].
         *
         * @param npoints The number of quadrature points to be used in
        ...
        /**
         * Performs integration over the unit sphere for a set of values
         * specified on the grid ponts.  The values can be vector valued, i.e.,
         * N values for each grid point.  In this case the result is a vector of
         * length N.
         *
         * @tparam N Length of result
         * @param values Matrix of values to integrate over.  These are
         * specified on the internal m_xyz quadrature points
         * @param result The integrated result of size N
         */
        template <int N>
        void integrate_on_grid(const Eigen::Matrix<double, N, -1>& values,
         ...
         * @return Eigen::Vector3d The quadrature position as a 3-dimensional
         * vector.
         */
