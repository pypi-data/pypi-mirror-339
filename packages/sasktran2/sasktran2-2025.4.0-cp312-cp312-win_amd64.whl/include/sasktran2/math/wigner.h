...
namespace sasktran2::math {
    ...
    class WignerDCalculator {
      private:
        ...
        /** Internal method to determine the start scaling factor of the
         * recurrence
         *
         * @return The start scaling factor of the recurrence relation for the
         * given internal m_m, m_n, and m_lmin
         */
