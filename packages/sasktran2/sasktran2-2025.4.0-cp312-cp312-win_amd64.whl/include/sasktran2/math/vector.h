...
namespace sasktran2::math {
     ...
     */
    inline double angle_degrees_between(const Eigen::Vector3d& v1,
    ...
    /** Calculates the component of a vector that is perpindicular to another
     * vector.
     *
     * @param v1 First vector
     * @param v2 Second vector
    ...
    component_perpindicular_to(const Eigen::Vector3d& v1,
                               const Eigen::Vector3d& v2) {
        double zcomp;
