...
def patched_serial_init(self, *args, **kwargs):
...
print("\nSetting things up for you. Hang tight...")
suppress_print() # Suppress internal output to maintain clarity for beginners and avoid exposing unnecessary implementation details
...
class _Style:
    ...
    def info():
        ...
        formatted_text = (
            ...
            f"\n{_Style.__COLOR_BLUE}{_Style.__BOLD}THE PYNNACLE-GENESIS{_Style.__RESET}\n\n"
            f"This module is tailored for beginners in robotics and programming,\n"
            f'originally for readers of "{_Style.__COLOR_BLUE}{_Style.__ITALIC}Python Odyssey: Into the World of Robotics{_Style.__RESET}" by {_Style.__BOLD}{_Style.__COLOR_BLUE}Team Pinnacle{_Style.__RESET}.\n'
            f"Based on {_Style.__ITALIC}Pymata4{_Style.__RESET}, it provides a Python-based robotics coding experience inspired by popular development board environments.\n"
            ...
            f"{_Style.__COLOR_BLUE}{_Style.__BOLD}Copyright (c) 2025 {_Style.__RESET}{_Style.__COLOR_BLUE}{_Style.__UNDERLINE}Rafael Red Angelo M. Hizon{_Style.__RESET}, {_Style.__COLOR_BLUE}{_Style.__UNDERLINE}Jenel M. Justo{_Style.__RESET}, {_Style.__COLOR_BLUE}{_Style.__UNDERLINE}Serena Mae C.S. Lee\n{_Style.__RESET}"
        )
...
def play(pin, frequency, duration=None):
    if duration is None:
