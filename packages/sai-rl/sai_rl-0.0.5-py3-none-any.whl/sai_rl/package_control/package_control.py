...
class PackageControl:
    def __init__(
        ...
        self._index_url = index_url or config.pypi_url
    ...
    def update(
        ...
        try:
            auth_index_url = f"https://sai:{self._api.api_key}@{self._index_url.split('https://')[-1]}"

            cmd = f"uv pip install {package_name} --index-url={auth_index_url} --upgrade"
