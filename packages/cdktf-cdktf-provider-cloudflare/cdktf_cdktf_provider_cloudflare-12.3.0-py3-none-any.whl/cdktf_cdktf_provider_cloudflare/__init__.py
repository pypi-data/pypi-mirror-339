...
__all__ = [
    ...
    "workers_for_platforms_script_secret",
    "workers_kv",
...
from . import data_cloudflare_workers_for_platforms_script_secret
from . import data_cloudflare_workers_for_platforms_script_secrets
...
from . import workers_for_platforms_script_secret
