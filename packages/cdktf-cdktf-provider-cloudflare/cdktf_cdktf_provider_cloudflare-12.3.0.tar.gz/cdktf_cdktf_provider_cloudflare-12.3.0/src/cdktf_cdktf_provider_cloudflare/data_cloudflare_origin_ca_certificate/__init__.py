...
class DataCloudflareOriginCaCertificate(
    ...
    def __init__(
        ...
        *,
        ...
        :param certificate_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/data-sources/origin_ca_certificate#certificate_id DataCloudflareOriginCaCertificate#certificate_id}
        :param filter: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/data-sources/origin_ca_certificate#filter DataCloudflareOriginCaCertificate#filter}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def put_filter(self, *, zone_id: builtins.str) -> None:
        '''
        :param zone_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/data-sources/origin_ca_certificate#zone_id DataCloudflareOriginCaCertificate#zone_id}
        '''
        value = DataCloudflareOriginCaCertificateFilter(zone_id=zone_id)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"zone_id": "zoneId"},
)
class DataCloudflareOriginCaCertificateFilter:
    def __init__(self, *, zone_id: builtins.str) -> None:
        '''
        :param zone_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/data-sources/origin_ca_certificate#zone_id DataCloudflareOriginCaCertificate#zone_id}
        '''
        if __debug__:
