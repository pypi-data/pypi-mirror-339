...
class CloudConnectorRules(
    ...
    def __init__(
        ...
        *,
        ...
        :param zone_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/resources/cloud_connector_rules#zone_id CloudConnectorRules#zone_id}
        :param rules: List of Cloud Connector rules. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/resources/cloud_connector_rules#rules CloudConnectorRules#rules}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing CloudConnectorRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/resources/cloud_connector_rules#import import section} in the documentation of this resource for the id to use
    ...
    def parameters(self) -> "CloudConnectorRulesParametersOutputReference":
        return typing.cast("CloudConnectorRulesParametersOutputReference", jsii.get(self, "parameters"))
...
@jsii.data_type(
    jsii_type="@cdktf/provider-cloudflare.cloudConnectorRules.CloudConnectorRulesParameters",
    jsii_struct_bases=[],
    name_mapping={},
)
class CloudConnectorRulesParameters:
    ...
    def __repr__(self) -> str:
        return "CloudConnectorRulesParameters(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class CloudConnectorRulesParametersOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-cloudflare.cloudConnectorRules.CloudConnectorRulesParametersOutputReference",
):
    def __init__(
        self,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1c5e895b7dd86c0ff27c2057aca6dfaa40d6ede02c8d225076cf59ffffe1aa02)
    ...
    def internal_value(self) -> typing.Optional[CloudConnectorRulesParameters]:
        return typing.cast(typing.Optional[CloudConnectorRulesParameters], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[CloudConnectorRulesParameters],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4a438466564dbe0abc9f8bf2e56babe33f80bfb9dcb903c9055772bc81920f15)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CloudConnectorRulesRules:
    def __init__(
        ...
        *,
        ...
        '''
        :param cloud_provider: Cloud Provider type Available values: "aws_s3", "r2", "gcp_storage", "azure_storage". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/resources/cloud_connector_rules#cloud_provider CloudConnectorRules#cloud_provider}
        :param description: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/resources/cloud_connector_rules#description CloudConnectorRules#description}.
        :param enabled: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/resources/cloud_connector_rules#enabled CloudConnectorRules#enabled}.
        :param expression: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/resources/cloud_connector_rules#expression CloudConnectorRules#expression}.
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/resources/cloud_connector_rules#id CloudConnectorRules#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param parameters: Parameters of Cloud Connector Rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/resources/cloud_connector_rules#parameters CloudConnectorRules#parameters}
        '''
...
class CloudConnectorRulesRulesOutputReference(
    ...
    def put_parameters(self, *, host: typing.Optional[builtins.str] = None) -> None:
        '''
        :param host: Host to perform Cloud Connection to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/resources/cloud_connector_rules#host CloudConnectorRules#host}
        '''
    ...
    def cloud_provider(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__1eb5d3e4afa84880a187f651b56dc9e59f93b964a180b73ee0e8fd6a773f4ad3)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
__all__ = [
    ...
    "CloudConnectorRulesParametersOutputReference",
...
def _typecheckingstub__1c5e895b7dd86c0ff27c2057aca6dfaa40d6ede02c8d225076cf59ffffe1aa02(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__4a438466564dbe0abc9f8bf2e56babe33f80bfb9dcb903c9055772bc81920f15(
    value: typing.Optional[CloudConnectorRulesParameters],
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__1eb5d3e4afa84880a187f651b56dc9e59f93b964a180b73ee0e8fd6a773f4ad3(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
