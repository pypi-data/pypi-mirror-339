...
class DataCloudflareListItem(
    ...
    def __init__(
        ...
        *,
        ...
        :param account_identifier: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/data-sources/list_item#account_identifier DataCloudflareListItem#account_identifier}
        :param item_id: The unique ID of the item in the List. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/data-sources/list_item#item_id DataCloudflareListItem#item_id}
        :param list_id: The unique ID of the list. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/data-sources/list_item#list_id DataCloudflareListItem#list_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataCloudflareListItem that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.3.0/docs/data-sources/list_item#import import section} in the documentation of this resource for the id to use
    ...
    def account_identifier(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e87ab4fc4d7db0bd91831713d03fb25a97fe9e402e2a2736ac07b044730f9ee1)
...
def _typecheckingstub__e87ab4fc4d7db0bd91831713d03fb25a97fe9e402e2a2736ac07b044730f9ee1(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
