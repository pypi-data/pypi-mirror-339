...
class ServicePortConfig(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "xDefangListener":
            suggest = "x_defang_listener"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ServicePortConfig. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ServicePortConfig.__key_warning(key)
    ...
    def __init__(__self__, *,
                 ...
                 x_defang_listener: Optional[builtins.str] = None):
    ...
    def x_defang_listener(self) -> Optional[builtins.str]:
