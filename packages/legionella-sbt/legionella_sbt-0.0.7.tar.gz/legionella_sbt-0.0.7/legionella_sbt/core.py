...
__all__ = ['PACKAGE_NAME', 'DEV_MODE', 'PACKAGE_DIR', 'PROJECT_DIR', 'config', 'set_env_variables', 'get_config',
           'get_resources_dir', 'show_project_env_vars', 'get_samplesheet']
...
PACKAGE_NAME: str = "legionella_sbt"  # Make sure to adjust this to your package name
DEV_MODE: bool = (
...
def get_resources_dir(PACKAGE_NAME):

    spec = importlib.util.find_spec(PACKAGE_NAME)
    module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(module)
    PACKAGE_DIR = Path(module.__file__).parent.parent
    resources_dir = PACKAGE_DIR.joinpath("legionella_sbt_resources")
