...
# Get the package resource directory for consistent path resolution
def get_resource_path(relative_path: str) -> str:
    """
    Get the absolute path to a resource file that works both in development
    and when installed as a package.
    """
    try:
        # When installed as a package
        base_path = str(importlib.resources.files("vtai"))
        return os.path.join(base_path, relative_path)
    except (ImportError, AttributeError):
        # Fallback for development environment
        return os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "vtai", relative_path)
...
# ICONS_PROVIDER_MAP modification - updating resource paths to use proper package paths
ICONS_PROVIDER_MAP: Dict[str, str] = {
    # App icons
    "VT.ai": get_resource_path("resources/vt.jpg"),
    "Mino": get_resource_path("resources/vt.jpg"),
    # OpenAI icons
    "tts-1": get_resource_path("resources/chatgpt-icon.png"),
    "tts-1-hd": get_resource_path("resources/chatgpt-icon.png"),
    "OpenAI": get_resource_path("resources/chatgpt-icon.png"),
    "dall-e-3": get_resource_path("resources/chatgpt-icon.png"),
    "gpt-4": get_resource_path("resources/chatgpt-icon.png"),
    "gpt-4o": get_resource_path("resources/chatgpt-icon.png"),
    "gpt-4-turbo": get_resource_path("resources/chatgpt-icon.png"),
    "gpt-3.5-turbo": get_resource_path("resources/chatgpt-icon.png"),
    # Other provider icons
    "Ollama": get_resource_path("resources/ollama.png"),
    "Anthropic": get_resource_path("resources/claude-ai-icon.png"),
    "Google": get_resource_path("resources/google-gemini-icon.png"),
    "Groq": get_resource_path("resources/groq.ico"),
    "command": get_resource_path("resources/cohere.ico"),
    "command-r": get_resource_path("resources/cohere.ico"),
    "command-light": get_resource_path("resources/cohere.ico"),
    "command-r-plus": get_resource_path("resources/cohere.ico"),
    "claude-2": get_resource_path("resources/claude-ai-icon.png"),
    "claude-3-sonnet-20240229": get_resource_path("resources/claude-ai-icon.png"),
    "claude-3-haiku-20240307": get_resource_path("resources/claude-ai-icon.png"),
    "claude-3-opus-20240229": get_resource_path("resources/claude-ai-icon.png"),
    "groq/llama3-8b-8192": get_resource_path("resources/groq.ico"),
    "groq/llama3-70b-8192": get_resource_path("resources/groq.ico"),
    "groq/mixtral-8x7b-32768": get_resource_path("resources/groq.ico"),
    "gemini/gemini-1.5-pro-latest": get_resource_path("resources/google-gemini-icon.png"),
    "gemini/gemini-1.5-flash-latest": get_resource_path("resources/google-gemini-icon.png"),
    "openrouter/mistralai/mistral-7b-instruct": get_resource_path("resources/openrouter.ico"),
    "OpenRouter - Mistral 7b instruct Free": get_resource_path("resources/openrouter.ico"),
    "ollama/llama3": get_resource_path("resources/ollama.png"),
    "ollama/mistral": get_resource_path("resources/ollama.png"),
}
