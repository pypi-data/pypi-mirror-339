...
# https://blog.csdn.net/EasonCcc/article/details/108540687
...
class Stem_v4_Res2(nn.Module):
    ...
    def __init__(self):
        ...
        self.step2_conv = BasicConv2d(64, 96, 3, 2, 0, bias=False)
        ...
        self.step3_2 = nn.Sequential(
            BasicConv2d(160, 64, 1, 1, 0, bias=False),
            BasicConv2d(64, 64, (7, 1), (1, 1), (3, 0), bias=False),
            BasicConv2d(64, 64, (1, 7), (1, 1), (0, 3), bias=False),
            BasicConv2d(64, 96, 3, 1, 0, bias=False)
        )
        self.step4_pool = nn.MaxPool2d(3, 2, 0)
        self.step4_conv = BasicConv2d(192, 192, 3, 2, 0, bias=False)
...
class Stem_Res1(nn.Module):
    ...
    def __init__(self):
        ...
        self.stem = nn.Sequential(
            ...
            BasicConv2d(32, 64, 3, 1, 1, bias=False),
            nn.MaxPool2d(3, 2, 0),
            BasicConv2d(64, 80, 1, 1, 0, bias=False),
            BasicConv2d(80, 192, 3, 1, 0, bias=False),
            BasicConv2d(192, 256, 3, 2, 0, bias=False)
        )
...
class Inception_A(nn.Module):
    ...
    def __init__(self, in_channels, b1, b2, b3_n1, b3_n3, b4_n1, b4_n3):
        ...
        self.branch1 = nn.Sequential(
            nn.AvgPool2d(3, 1, 1),
            BasicConv2d(in_channels, b1, 1, 1, 0, bias=False)
        )
        self.branch2 = BasicConv2d(in_channels, b2, 1, 1, 0, bias=False)
        self.branch3 = nn.Sequential(
            BasicConv2d(in_channels, b3_n1, 1, 1, 0, bias=False),
            BasicConv2d(b3_n1, b3_n3, 3, 1, 1, bias=False)
        )
        self.branch4 = nn.Sequential(
            BasicConv2d(in_channels, b4_n1, 1, 1, 0, bias=False),
            BasicConv2d(b4_n1, b4_n3, 3, 1, 1, bias=False),
            BasicConv2d(b4_n3, b4_n3, 3, 1, 1, bias=False)
        )
...
class Inception_A_res(nn.Module):
    ...
    def __init__(self, in_channels, b1, b2_n1, b2_n3, b3_n1, b3_n3_1, b3_n3_2, n1_linear):
        ...
        self.branch1 = BasicConv2d(in_channels, b1, 1, 1, 0, bias=False)
        self.branch2 = nn.Sequential(
            BasicConv2d(in_channels, b2_n1, 1, 1, 0, bias=False),
            BasicConv2d(b2_n1, b2_n3, 3, 1, 1, bias=False),
        )
        self.branch3 = nn.Sequential(
            BasicConv2d(in_channels, b3_n1, 1, 1, 0, bias=False),
            BasicConv2d(b3_n1, b3_n3_1, 3, 1, 1, bias=False),
            BasicConv2d(b3_n3_1, b3_n3_2, 3, 1, 1, bias=False)
        )
...
class Reduction_A(nn.Module):
    ...
    def __init__(self, in_channels, k, l, m, n):
        ...
        self.branch2 = BasicConv2d(in_channels, n, 3, 2, 0, bias=False)
        self.branch3 = nn.Sequential(
            BasicConv2d(in_channels, k, 1, 1, 0, bias=False),
...
class Inception_B(nn.Module):
    ...
    def __init__(self, in_channels, b1, b2, b3_n1, b3_n1x7, b3_n7x1, b4_n1, b4_n1x7_1,
        ...
        self.branch3 = nn.Sequential(
            BasicConv2d(in_channels, b3_n1, 1, 1, 0, bias=False),
            BasicConv2d(b3_n1, b3_n1x7, (1, 7), (1, 1), (0, 3), bias=False),
            BasicConv2d(b3_n1x7, b3_n7x1, (7, 1), (1, 1), (3, 0), bias=False)
        )
        self.branch4 = nn.Sequential(
            BasicConv2d(in_channels, b4_n1, 1, 1, 0, bias=False),
            BasicConv2d(b4_n1, b4_n1x7_1, (1, 7), (1, 1), (0, 3), bias=False),
            BasicConv2d(b4_n1x7_1, b4_n7x1_1, (7, 1), (1, 1), (3, 0), bias=False),
            BasicConv2d(b4_n7x1_1, b4_n1x7_2, (1, 7), (1, 1), (0, 3), bias=False),
            BasicConv2d(b4_n1x7_2, b4_n7x1_2, (7, 1), (1, 1), (3, 0), bias=False)
        )
...
class Inception_B_res(nn.Module):
    ...
    def __init__(self, in_channels, b1, b2_n1, b2_n1x7, b2_n7x1, n1_linear):
        ...
        self.branch2 = nn.Sequential(
            BasicConv2d(in_channels, b2_n1, 1, 1, 0, bias=False),
            BasicConv2d(b2_n1, b2_n1x7, (1, 7), (1, 1), (0, 3), bias=False),
            BasicConv2d(b2_n1x7, b2_n7x1, (7, 1), (1, 1), (3, 0), bias=False)
        )
...
class Reduction_B_v4(nn.Module):
    ...
    def __init__(self, in_channels, b2_n1, b2_n3, b3_n1, b3_n1x7, b3_n7x1, b3_n3):
        ...
        self.branch2 = nn.Sequential(
            BasicConv2d(in_channels, b2_n1, 1, 1, 0, bias=False),
            BasicConv2d(b2_n1, b2_n3, 3, 2, 0, bias=False)
        )
        self.branch3 = nn.Sequential(
            BasicConv2d(in_channels, b3_n1, 1, 1, 0, bias=False),
            BasicConv2d(b3_n1, b3_n1x7, (1, 7), (1, 1), (0, 3), bias=False),
            BasicConv2d(b3_n1x7, b3_n7x1, (7, 1), (1, 1), (3, 0), bias=False),
            BasicConv2d(b3_n7x1, b3_n3, 3, 2, 0, bias=False)
        )
...
class Reduction_B_Res(nn.Module):
    ...
    def __init__(self, in_channels, b2_n1, b2_n3, b3_n1, b3_n3, b4_n1, b4_n3_1, b4_n3_2):
        ...
        self.branch3 = nn.Sequential(
            BasicConv2d(in_channels, b3_n1, 1, 1, 0, bias=False),
            BasicConv2d(b3_n1, b3_n3, 3, 2, 0, bias=False)
        )
        self.branch4 = nn.Sequential(
            BasicConv2d(in_channels, b4_n1, 1, 1, 0, bias=False),
            BasicConv2d(b4_n1, b4_n3_1, 3, 1, 1, bias=False),
            BasicConv2d(b4_n3_1, b4_n3_2, 3, 2, 0, bias=False)
        )
...
class Inception_C(nn.Module):
    ...
    def __init__(self, in_channels, b1, b2, b3_n1, b3_n1x3_3x1, b4_n1,
        ...
        self.branch2 = BasicConv2d(in_channels, b2, 1, 1, 0, bias=False)
        self.branch3_1 = BasicConv2d(in_channels, b3_n1, 1, 1, 0, bias=False)
        self.branch3_1x3 = BasicConv2d(b3_n1, b3_n1x3_3x1, (1, 3), (1, 1), (0, 1), bias=False)
        self.branch3_3x1 = BasicConv2d(b3_n1, b3_n1x3_3x1, (3, 1), (1, 1), (1, 0), bias=False)
        self.branch4_1 = nn.Sequential(
            BasicConv2d(in_channels, b4_n1, 1, 1, 0, bias=False),
            BasicConv2d(b4_n1, b4_n1x3, (1, 3), (1, 1), (0, 1), bias=False),
            BasicConv2d(b4_n1x3, b4_n3x1, (3, 1), (1, 1), (1, 0), bias=False)
        )
        self.branch4_1x3 = BasicConv2d(b4_n3x1, b4_n1x3_3x1, (1, 3), (1, 1), (0, 1), bias=False)
        self.branch4_3x1 = BasicConv2d(b4_n3x1, b4_n1x3_3x1, (3, 1), (1, 1), (1, 0), bias=False)
...
class Inception_C_res(nn.Module):
    ...
    def __init__(self, in_channels, b1, b2_n1, b2_n1x3, b2_n3x1, n1_linear):
        ...
        self.branch2 = nn.Sequential(
            BasicConv2d(in_channels, b2_n1, 1, 1, 0, bias=False),
            BasicConv2d(b2_n1, b2_n1x3, (1, 3), (1, 1), (0, 1), bias=False),
            BasicConv2d(b2_n1x3, b2_n3x1, (3, 1), (1, 1), (1, 0), bias=False)
        )
