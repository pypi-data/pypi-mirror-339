...
PROTOBUF_EXPORT extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_xla_2fservice_2fcpu_2fonednn_5fconfig_2eproto;
namespace xla {
namespace cpu {
...
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_EXPORT ::xla::cpu::OneDnnConvolutionConfig* Arena::CreateMaybeMessage<::xla::cpu::OneDnnConvolutionConfig>(Arena*);
template<> PROTOBUF_EXPORT ::xla::cpu::OneDnnDataLayoutProto* Arena::CreateMaybeMessage<::xla::cpu::OneDnnDataLayoutProto>(Arena*);
template<> PROTOBUF_EXPORT ::xla::cpu::OneDnnFactorLayoutProto* Arena::CreateMaybeMessage<::xla::cpu::OneDnnFactorLayoutProto>(Arena*);
template<> PROTOBUF_EXPORT ::xla::cpu::OneDnnFilterLayoutProto* Arena::CreateMaybeMessage<::xla::cpu::OneDnnFilterLayoutProto>(Arena*);
template<> PROTOBUF_EXPORT ::xla::cpu::OneDnnFusionConfig* Arena::CreateMaybeMessage<::xla::cpu::OneDnnFusionConfig>(Arena*);
template<> PROTOBUF_EXPORT ::xla::cpu::OneDnnMatMulConfig* Arena::CreateMaybeMessage<::xla::cpu::OneDnnMatMulConfig>(Arena*);
template<> PROTOBUF_EXPORT ::xla::cpu::OneDnnNormConfig* Arena::CreateMaybeMessage<::xla::cpu::OneDnnNormConfig>(Arena*);
template<> PROTOBUF_EXPORT ::xla::cpu::OneDnnOptimizationConfig* Arena::CreateMaybeMessage<::xla::cpu::OneDnnOptimizationConfig>(Arena*);
template<> PROTOBUF_EXPORT ::xla::cpu::OneDnnSoftmaxConfig* Arena::CreateMaybeMessage<::xla::cpu::OneDnnSoftmaxConfig>(Arena*);
template<> PROTOBUF_EXPORT ::xla::cpu::OneDnnTensorLayoutProto* Arena::CreateMaybeMessage<::xla::cpu::OneDnnTensorLayoutProto>(Arena*);
template<> PROTOBUF_EXPORT ::xla::cpu::OneDnnWindowProto* Arena::CreateMaybeMessage<::xla::cpu::OneDnnWindowProto>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace xla {
namespace cpu {
...
PROTOBUF_EXPORT const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* OneDnnFusionConfig_FusionKind_descriptor();
template<typename T>
...
PROTOBUF_EXPORT const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* OneDnnNormConfig_ScaleAndShift_descriptor();
template<typename T>
...
class PROTOBUF_EXPORT OneDnnDataLayoutProto final :
...
class PROTOBUF_EXPORT OneDnnFilterLayoutProto final :
...
class PROTOBUF_EXPORT OneDnnFactorLayoutProto final :
...
class PROTOBUF_EXPORT OneDnnOptimizationConfig final :
...
class PROTOBUF_EXPORT OneDnnFusionConfig final :
...
class PROTOBUF_EXPORT OneDnnTensorLayoutProto final :
...
class PROTOBUF_EXPORT OneDnnSoftmaxConfig final :
...
class PROTOBUF_EXPORT OneDnnMatMulConfig final :
...
class PROTOBUF_EXPORT OneDnnWindowProto final :
...
class PROTOBUF_EXPORT OneDnnNormConfig final :
...
class PROTOBUF_EXPORT OneDnnConvolutionConfig final :
