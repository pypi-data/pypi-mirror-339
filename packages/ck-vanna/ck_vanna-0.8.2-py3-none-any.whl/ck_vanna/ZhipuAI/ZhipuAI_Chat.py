...
class ZhipuAI_Chat(VannaBase):
    def __init__(self, config=None):
        ...
        异常:
            Exception: 当config中缺少api_key时抛出
        """
    ...
    def add_ddl_to_prompt(
        ...
        参数:
            initial_prompt (str): 初始提示文本
            ddl_list (List[str]): DDL语句列表
            max_tokens (int, 可选): 最大token数量限制，默认14000
    ...
    def add_documentation_to_prompt(
        ...
        参数:
            initial_prompt (str): 初始提示文本
            documentation_List (List[str]): 文档内容列表
            max_tokens (int, 可选): 最大token数量限制，默认14000
