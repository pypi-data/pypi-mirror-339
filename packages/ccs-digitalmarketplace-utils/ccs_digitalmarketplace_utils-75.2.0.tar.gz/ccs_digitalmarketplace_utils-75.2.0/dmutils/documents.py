...
def validate_documents_from_question(files, section):
    ...
    FILE_TYPE_TO_VALIDATION = {
        ...
        'zip': file_is_zip,
        'image': file_is_image,
        'open_document_or_zip': file_is_open_document_or_zip_format,
    }
...
def file_is_open_document_or_zip_format(file_object):
    return file_is_open_document_format(file_object) or file_is_zip(file_object)
