...
def session_fixture(request):
    ...
    summary_path = r"/Users/debugtalk/MyProjects/Pastor-dev/pastor/examples/postman_echo/logs/request_methods/hardcode.summary.json"
