...
from pastor.exceptions import ValidationFailure, ParamsError
from pastor.models import VariablesMapping, Validators, FunctionsMapping
    ...
    def validate(
        ...
        for v in validators:
            ...
            if check_item and isinstance(check_item, Text):
                if check_item in variables_mapping.setdefault('sql_return_data', {}):
                    check_value = variables_mapping.get('sql_return_data').get(check_item)
                else:
