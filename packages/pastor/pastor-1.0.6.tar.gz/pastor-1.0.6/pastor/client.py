...
from pastor.models import RequestData, ResponseData
from pastor.models import SessionData, ReqRespData
from pastor.utils import lower_dict_keys, omit_long_data
...
class HttpSession(requests.Session):
    ...
    to be able to log in and out of websites). Each request is logged so that pastor can
    display statistics.
