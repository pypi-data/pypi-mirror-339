""" Convert HAR (HTTP Archive) to YAML/JSON testcase for Pastor.

Usage:
    # convert to JSON format testcase
    $ prun har2case demo.har

    # convert to YAML format testcase
    $ prun har2case demo.har -2y

"""

from pastor.ext.har2case.core import HarParser
...
def init_har2case_parser(subparsers):
    ...
    parser = subparsers.add_parser(
        "har2case",
        help="Convert HAR(HTTP Archive) to YAML/JSON testcases for Pastor.",
    )
