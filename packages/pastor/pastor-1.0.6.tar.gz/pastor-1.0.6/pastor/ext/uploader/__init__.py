...
from pastor.models import TStep, FunctionsMapping
from pastor.parser import parse_variables_mapping, parse_data
...
def ensure_upload_ready():
    ...
    or you can install pastor with optional upload dependencies:
    $ pip install "pastor[upload]"
    """
    logger.error(msg)
    sys.exit(1)
...
def multipart_encoder(**kwargs):
    ...
    for key, value in kwargs.items():
        ...
        if os.path.isabs(value):
            ...
            from pastor.loader import load_project_meta
