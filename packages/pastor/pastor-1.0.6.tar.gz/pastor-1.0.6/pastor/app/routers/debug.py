...
from pastor.models import ProjectMeta, TestCase

router = APIRouter()
runner = Pastor()


@router.post("/prun/debug/testcase", tags=["debug"])
...
# @router.post("/prun/debug/api", tags=["debug"])
...
#
#
# @router.post("/prun/debug/testcases", tags=["debug"])
