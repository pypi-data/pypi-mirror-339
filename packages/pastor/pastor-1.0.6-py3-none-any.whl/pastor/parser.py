...
from pastor import loader, utils, exceptions
from pastor.models import VariablesMapping, FunctionsMapping
...
def get_mapping_function(
    ...
    Args:
        ...
        validate_functions_mapping (dict): functions mapping
    ...
    if function_name in functions_mapping:
        ...
        from pastor.ext import uploader

        return getattr(uploader, function_name)

    try:
        # check if pastor builtin functions
