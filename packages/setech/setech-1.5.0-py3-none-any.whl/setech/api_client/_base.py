...
class BaseClient(ABC):
    ...
    def after_request(self, response: httpx.Response) -> None:
        """
        Hook to execute additional tasks just after the reesponse has been received.
    ...
    def _debug(self, msg: str, stacklevel: int, *args: Any, **kwargs: Any) -> None:
        self._log("DEBUG", f"[{self._nonce}] {msg}", stacklevel=stacklevel + 1, *args, **kwargs)

    def _info(self, msg: str, stacklevel: int, *args: Any, **kwargs: Any) -> None:
        self._log("INFO", f"[{self._nonce}] {msg}", stacklevel=stacklevel + 1, *args, **kwargs)

    def _warn(self, msg: str, stacklevel: int, *args: Any, **kwargs: Any) -> None:
        self._log("WARNING", f"[{self._nonce}] {msg}", stacklevel=stacklevel + 1, *args, **kwargs)

    def _error(self, msg: str, stacklevel: int, *args: Any, **kwargs: Any) -> None:
        self._log("ERROR", f"[{self._nonce}] {msg}", stacklevel=stacklevel + 1, *args, **kwargs)

    def _critical(self, msg: str, stacklevel: int, *args: Any, **kwargs: Any) -> None:
        self._log("CRITICAL", f"[{self._nonce}] {msg}", stacklevel=stacklevel + 1, *args, **kwargs)
