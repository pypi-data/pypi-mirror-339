...
class OneZot:
    """
    OneZot client for audio and video communication over LiveKit.
    ...
    def __init__(self, api_key: str, room_name: str):
        """
        Initialize a new OneZot client.
    ...
    async def _async_initialize(self):
        ...
        response = requests.post(
            "https://uu4rvj3echoqgzz7lxmbnukkmy0yblql.lambda-url.us-east-1.on.aws/get-token-onezot",
            json={
