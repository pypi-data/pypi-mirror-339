...
class PersonDTO:
    ...
    Attributes:
        uid (Union[Unset, str]): Is the unique id of the person
        common_name (Union[Unset, str]): Is the common name of the person
        surname (Union[Unset, str]): Is the first name of the person
        gecos (Union[Unset, str]): Is name of the person
        mail (Union[Unset, str]): Is the mail of the person
    """
