...
from elog_cli.elog_management_backend_client.api.entries_controller import get_full,search, update_entry_attachment_preview, update_entry_n_gram_vector, get_update_entry_n_gram_vector_stat
...
class ElogApi():
    ...
    def get_stat_for_ngram_task(self, job_id:str)->EntryProcessingStats:
        """
