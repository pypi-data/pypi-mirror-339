...
if TYPE_CHECKING:
    from ..models.entry_processing_stats import EntryProcessingStats


T = TypeVar("T", bound="ApiResultResponseEntryProcessingStats")


@_attrs_define
class ApiResultResponseEntryProcessingStats:
    ...
    Attributes:
        ...
        payload (Union[Unset, EntryProcessingStats]): Is the result of the processing of entries.
    """

    error_code: int
    error_message: Union[Unset, str] = UNSET
    error_domain: Union[Unset, str] = UNSET
    payload: Union[Unset, "EntryProcessingStats"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        payload: Union[Unset, EntryProcessingStats]
        if isinstance(_payload, Unset):
            payload = UNSET
        else:
            payload = EntryProcessingStats.from_dict(_payload)

        api_result_response_entry_processing_stats = cls(
        ...
        api_result_response_entry_processing_stats.additional_properties = d
        return api_result_response_entry_processing_stats
