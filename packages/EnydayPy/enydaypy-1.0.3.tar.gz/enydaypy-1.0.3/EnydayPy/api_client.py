...
from EnydayPy.api_response import ApiResponse, T as ApiResponseT
import EnydayPy.models
from EnydayPy import rest
from EnydayPy.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(EnydayPy.models, klass)
