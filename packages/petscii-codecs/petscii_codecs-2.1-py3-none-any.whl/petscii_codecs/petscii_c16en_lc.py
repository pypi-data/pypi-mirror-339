"""
Python Character Mapping Codec for 'petscii_c16en_lc' generated by gen-codec.
"""

#    Name:		PETSCII C16 English Lowercase to Unicode Table
#    Unicode version:	3.0
#    Table version:	1.10
...
codecs.register(lambda e: getregentry() if e.replace('-', '_') == 'petscii_c16en_lc' else None)
