"""
Python Character Mapping Codec for 'petscii_40c128en_uc' generated by gen-codec.
"""

#    Name:		PETSCII C128 (40 col) English Uppercase to Unicode Table
#    Unicode version:	3.0
#    Table version:	1.00
...
encoding_table = {
    ...
    0xf104:	b'\x81',  	  # ORANGE COLOR SWITCH (CUS)
    0xf105:	b'\x90',  	  # BLACK COLOR SWITCH (CUS)
    0xf106:	b'\x95',  	  # BROWN COLOR SWITCH (CUS)
    0xf107:	b'\x96',  	  # LIGHT RED COLOR SWITCH (CUS)
    0xf108:	b'\x97',  	  # GRAY 1 COLOR SWITCH (CUS)
...
codecs.register(lambda e: getregentry() if e.replace('-', '_') == 'petscii_40c128en_uc' else None)
