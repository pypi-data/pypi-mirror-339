"""
Python Character Mapping Codec for 'petscii_c16en_uc' generated by gen-codec.
"""

#    Name:		PETSCII C16 English Uppercase to Unicode Table
#    Unicode version:	3.0
#    Table version:	1.00
...
decoding_table = {
    ...
    0x96:	'\uf148',	  # YELLOW GREEN COLOR SWITCH (CUS)
    0x97:	'\uf149',	  # PINK COLOR SWITCH (CUS)
    0x98:	'\uf14a',	  # BLUE GREEN COLOR SWITCH (CUS)
    0x99:	'\uf10b',	  # LIGHT BLUE COLOR SWITCH (CUS)
    0x9a:	'\uf14b',	  # DARK BLUE COLOR SWITCH (CUS)
    0x9b:	'\uf10a',	  # LIGHT GREEN COLOR SWITCH (CUS)
...
encoding_table = {
    ...
    0xf10a:	b'\x9b',  	  # LIGHT GREEN COLOR SWITCH (CUS)
    0xf10b:	b'\x99',  	  # LIGHT BLUE COLOR SWITCH (CUS)
    ...
    0xf146:	b'\x82',  	  # FLASH ON (CUS)
    0xf147:	b'\x84',  	  # FLASH OFF (CUS)
    0xf148:	b'\x96',  	  # YELLOW GREEN COLOR SWITCH (CUS)
    0xf149:	b'\x97',  	  # PINK COLOR SWITCH (CUS)
    0xf14a:	b'\x98',  	  # BLUE GREEN COLOR SWITCH (CUS)
    0xf14b:	b'\x9a',  	  # DARK BLUE COLOR SWITCH (CUS)
...
codecs.register(lambda e: getregentry() if e.replace('-', '_') == 'petscii_c16en_uc' else None)
