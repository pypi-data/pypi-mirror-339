"""
Python Character Mapping Codec for 'petscii_c64en_uc' generated by gen-codec.
"""
...
codecs.register(lambda e: getregentry() if e.replace('-', '_') == 'petscii_c64en_uc' else None)
