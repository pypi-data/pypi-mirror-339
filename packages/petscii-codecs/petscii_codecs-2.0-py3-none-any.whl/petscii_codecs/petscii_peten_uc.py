"""
Python Character Mapping Codec for 'petscii_peten_uc' generated by gen-codec.
"""

#    Name:		PETSCII PET English Uppercase to Unicode Table
#    Unicode version:	3.0
#    Table version:	1.00
...
codecs.register(lambda e: getregentry() if e.replace('-', '_') == 'petscii_peten_uc' else None)
