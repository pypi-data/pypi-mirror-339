"""
Python Character Mapping Codec for 'petscii_80c128en_uc' generated by gen-codec.
"""

#    Name:		PETSCII C128 (80 col) English Uppercase to Unicode Table
#    Unicode version:	3.0
#    Table version:	1.00
...
decoding_table = {
    ...
    0x60:	'\U0001fb79',	  # HORIZONTAL ONE EIGHTH BLOCK-5
...
encoding_table = {
    ...
    0x2502:	b'}',     	  # BOX DRAWINGS LIGHT VERTICAL
...
codecs.register(lambda e: getregentry() if e.replace('-', '_') == 'petscii_80c128en_uc' else None)
