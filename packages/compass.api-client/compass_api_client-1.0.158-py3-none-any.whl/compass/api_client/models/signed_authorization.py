...
class SignedAuthorization(BaseModel):
    ...
    r: R
    s: S
    y_parity: StrictInt = Field(alias="yParity")
    __properties: ClassVar[List[str]] = ["nonce", "address", "chainId", "r", "s", "yParity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "r": R.from_dict(obj["r"]) if obj.get("r") is not None else None,
            "s": S.from_dict(obj["s"]) if obj.get("s") is not None else None,
