...
class TestAerodromeSlipstreamSellExactlyRequest(unittest.TestCase):
    """AerodromeSlipstreamSellExactlyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AerodromeSlipstreamSellExactlyRequest:
        """Test AerodromeSlipstreamSellExactlyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AerodromeSlipstreamSellExactlyRequest`
        """
    ...
    def testAerodromeSlipstreamSellExactlyRequest(self):
        """Test AerodromeSlipstreamSellExactlyRequest"""
