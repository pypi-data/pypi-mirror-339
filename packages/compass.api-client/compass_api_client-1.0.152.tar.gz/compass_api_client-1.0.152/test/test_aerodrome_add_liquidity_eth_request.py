...
class TestAerodromeAddLiquidityEthRequest(unittest.TestCase):
    """AerodromeAddLiquidityEthRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AerodromeAddLiquidityEthRequest:
        """Test AerodromeAddLiquidityEthRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AerodromeAddLiquidityEthRequest`
        """
    ...
    def testAerodromeAddLiquidityEthRequest(self):
        """Test AerodromeAddLiquidityEthRequest"""
