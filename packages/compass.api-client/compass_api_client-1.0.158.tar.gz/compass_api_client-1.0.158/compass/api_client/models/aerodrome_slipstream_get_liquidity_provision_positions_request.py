...
class AerodromeSlipstreamGetLiquidityProvisionPositionsRequest(BaseModel):
    """
    AerodromeSlipstreamGetLiquidityProvisionPositionsRequest
    """ # noqa: E501
    chain: Chain
    user: StrictStr = Field(description="The address of the user to check the balance of")
