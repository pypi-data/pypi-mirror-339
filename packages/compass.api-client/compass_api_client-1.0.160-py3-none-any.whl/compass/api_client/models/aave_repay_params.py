...
class AaveRepayParams(BaseModel):
    ...
    AaveRepayParams
    """ # noqa: E501
    asset: Token = Field(description="The symbol of the underlying asset to repay. Note the [supported tokens per chain](/#/#token-table).")
    amount: Amount1
    ...
    __properties: ClassVar[List[str]] = ["asset", "amount", "interest_rate_mode", "on_behalf_of"]
