...
class MulticallAuthorizationResponse(BaseModel):
    ...
    """ # noqa: E501
    nonce: StrictInt = Field(description="A unique nonce value for this authorization")
    address: StrictStr = Field(description="The Ethereum address authorized for multicall")
    chain_id: StrictInt = Field(description="The chain ID for the blockchain network", alias="chainId")
    __properties: ClassVar[List[str]] = ["nonce", "address", "chainId"]
