...
class MulticallAuthorizationRequest(BaseModel):
    ...
    """ # noqa: E501
    chain: Chain = Field(description="The blockchain network to use")
    sender: StrictStr = Field(description="The Ethereum address to use for authorization")
    address: StrictStr = Field(description="The Ethereum address to authorize for multicall")
    __properties: ClassVar[List[str]] = ["chain", "sender", "address"]
