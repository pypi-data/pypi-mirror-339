...
class TestAaveBorrowParams(unittest.TestCase):
    """AaveBorrowParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AaveBorrowParams:
        """Test AaveBorrowParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AaveBorrowParams`
        """
        model = AaveBorrowParams()
        if include_optional:
            return AaveBorrowParams(
                asset = '1INCH',
                amount = None,
