...
import frogml_proto.qwak.administration.runtime_configuration.v0.network_config_pb2
import frogml_proto.qwak.administration.runtime_configuration.v0.runtime_config_pb2
import sys
import typing
...
class EnvironmentRuntimeConfig(google.protobuf.message.Message):
    ...
    @property
    def runtime_configuration(self) -> frogml_proto.qwak.administration.runtime_configuration.v0.runtime_config_pb2.RuntimeConfiguration: ...
    @property
    def network_configuration(self) -> frogml_proto.qwak.administration.runtime_configuration.v0.network_config_pb2.EnvironmentNetworkConfiguration: ...
    def __init__(
        self,
        *,
        runtime_configuration: frogml_proto.qwak.administration.runtime_configuration.v0.runtime_config_pb2.RuntimeConfiguration | None = ...,
        network_configuration: frogml_proto.qwak.administration.runtime_configuration.v0.network_config_pb2.EnvironmentNetworkConfiguration | None = ...,
    ) -> None: ...
