...
from frogml_proto.qwak.administration.runtime_configuration.v0 import runtime_config_pb2 as qwak_dot_administration_dot_runtime__configuration_dot_v0_dot_runtime__config__pb2
...
_ENVIRONMENTRUNTIMECONFIG = DESCRIPTOR.message_types_by_name['EnvironmentRuntimeConfig']
...
EnvironmentRuntimeConfig = _reflection.GeneratedProtocolMessageType('EnvironmentRuntimeConfig', (_message.Message,), {
  'DESCRIPTOR' : _ENVIRONMENTRUNTIMECONFIG,
  '__module__' : 'qwak.administration.v0.environments.configuration_pb2'
  # @@protoc_insertion_point(class_scope:qwak.administration.environment.EnvironmentRuntimeConfig)
  })
_sym_db.RegisterMessage(EnvironmentRuntimeConfig)
