...
class AccountBrief(google.protobuf.message.Message):
    ...
    @property
    def jfrog_project_details(self) -> frogml_proto.qwak.administration.account.v1.jfrog_tenant_details_pb2.JPDDetails: ...
    def __init__(
        self,
        *,
        account_id: builtins.str = ...,
        ...
        jfrog_project_details: frogml_proto.qwak.administration.account.v1.jfrog_tenant_details_pb2.JPDDetails | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["jfrog_project_details", b"jfrog_project_details", "jfrog_tenant_id", b"jfrog_tenant_id", "optional_jpd_details", b"optional_jpd_details", "optional_tenant_id", b"optional_tenant_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["account_id", b"account_id", "default_env_id", b"default_env_id", "environment_briefs", b"environment_briefs", "environment_ids", b"environment_ids", "jfrog_project_details", b"jfrog_project_details", "jfrog_tenant_id", b"jfrog_tenant_id", "optional_jpd_details", b"optional_jpd_details", "optional_tenant_id", b"optional_tenant_id"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["optional_jpd_details", b"optional_jpd_details"]) -> typing_extensions.Literal["jfrog_project_details"] | None: ...
    @typing.overload
...
class EnvironmentBrief(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["environment_id", b"environment_id", "storage_bucket", b"storage_bucket"]) -> None: ...
