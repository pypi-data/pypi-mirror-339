...
async def yandex(parser_request: ParserRequest, search_id: int):
    ...
    yandex_api = await YandexSearchTextApiV1.create(
        oauth_token="y0_AgAAAAAjqpJNAATuwQAAAADtQVIaTbWuYLitQDa0fzEHdadBQGq2OgA",
        folder_id="b1gka8i9bk03anf6nh07",
        api_key_v1="AQVN3Dqhs-FO3l9Yd2HMeL83_t6WJvpZ5d6jKHOS")
