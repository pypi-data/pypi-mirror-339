...
def main():
    ...
    helper = argparse.ArgumentParser(prog="test_solve", description="The Baldor Testing Application using randomly generated, large sparse matrices.")
    ...
    for i in range(num_tests):
        ...
        output = f"{i + 1}-Baldor Test: {answer}" 
        utils.println(output, logger, args.log)
