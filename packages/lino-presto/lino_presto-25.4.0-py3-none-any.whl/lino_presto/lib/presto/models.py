...
class Client(Person, SSIN, UserAuthored, CreatedModified, ClientBase, Taggable):
    ...
    death_date = IncompleteDateField(blank=True,
...
class ClientDetail(PersonDetail):
    ...
    tags healthcare.SituationsByClient clients.ContactsByClient
    """,
                      label=_("Client"))
    ...
    uploads.UploadsByProject:30 trading.InvoicesByPartner:50
    """,
                         label=_("Invoicing"))
    ...
    # checkdata.MessagesByOwner accounting.MovementsByPartner
