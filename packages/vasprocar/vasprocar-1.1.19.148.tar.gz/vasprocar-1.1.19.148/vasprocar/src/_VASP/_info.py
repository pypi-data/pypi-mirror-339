...
if (ispin == 1):
   ...
   if ((len(VTemp) >= 3) and (VTemp[0] == 'Fermi')):
      ...
      VTemp = outcar.readline()
   if ((len(VTemp) >= 3) and (VTemp[0] == 'val.')):  VTemp = outcar.readline().split()
   if ((len(VTemp) >= 3) and (VTemp[0] == 'cond.')):  VTemp = outcar.readline().split()
   if ((len(VTemp) >= 3) and (VTemp[0] == 'fundamental')):  VTemp = outcar.readline().split()
   if ((len(VTemp) >= 3) and (VTemp[0] == 'Fermi')):
      Efermi = float(VTemp[2])
      VTemp = outcar.readline()
