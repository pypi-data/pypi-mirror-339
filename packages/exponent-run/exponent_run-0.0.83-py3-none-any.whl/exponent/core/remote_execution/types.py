...
MessageAttachment = Annotated[
    Union[FileAttachment, URLAttachment, TableSchemaAttachment, PromptAttachment],
...
class CreateCheckpointResponse(RemoteExecutionResponse):
    ...
    uncommitted_changes_commit_hash: Optional[str] = None
    diff_versus_last_checkpoint: Optional[GitDiff] = None
...
class CreateCheckpointRequest(RemoteExecutionRequest[CreateCheckpointResponse]):
    ...
    last_checkpoint_head_commit: Optional[str] = None
    last_checkpoint_uncommitted_changes_commit: Optional[str] = None
...
class RollbackToCheckpointRequest(RemoteExecutionRequest[RollbackToCheckpointResponse]):
    ...
    head_commit: str
    uncommitted_changes_commit: Optional[str]
