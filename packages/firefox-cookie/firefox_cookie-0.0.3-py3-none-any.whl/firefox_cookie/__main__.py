...
def parse_args(args=None):
    p = argparse.ArgumentParser(
        description='Extract browser cookies using firefox_cookie.',
    ...
    for browser in firefox_cookie.all_browsers:
...
def main(args=None):
    ...
    try:
        if args.browser:
            ...
            cj = firefox_cookie.load()
    except firefox_cookie.BrowserCookieError as e:
        p.error(e.args[0])
