import os
import shutil
from AOT_Acoustic import load_field, hex_to_binary_array
import numpy as np
import re
import time
...
def getSaveAOsignal(listFieldPathHDR, laser, data_path, save_directory):
    ...
    for nScan in range(len(new_listFieldPathHDR)):  
        acoustic_envelope_squared.append(load_field(os.path.join(save_directory,new_listFieldPathHDR[nScan])))
