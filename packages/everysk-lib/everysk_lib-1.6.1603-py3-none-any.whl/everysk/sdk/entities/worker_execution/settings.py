...
WORKER_EXECUTION_TIME_EVENT_TYPE = StrField(default='TIME_EVENT', readonly=True)
WORKER_EXECUTION_CRON_EVENT_TYPE = StrField(default='CRON_EVENT', readonly=True)
...
WORKER_EXECUTION_EVENT_TYPE_LIST = ListField(default=['INTEGRATION_EVENT', 'TIME_EVENT', 'CRON_EVENT', 'WORKER_FINISHED_EVENT', 'MANUAL', 'API'], readonly=True)
...
WORKER_EXECUTION_TYPE_LIST = ListField(default=['TIME_DRIVEN', 'EVENT_DRIVEN', 'CRON_EVENT', 'MANUAL', 'API'], readonly=True)
...
WORKER_TEMPLATE_TYPES = ListField(
    default=['STARTER', 'BASIC', 'FORKER', 'BARRIER', 'CONDITIONAL', 'TRY', 'CATCH', 'ENDER', 'Retrieve'], # Retrieve is a legacy type.
    readonly=True
)
