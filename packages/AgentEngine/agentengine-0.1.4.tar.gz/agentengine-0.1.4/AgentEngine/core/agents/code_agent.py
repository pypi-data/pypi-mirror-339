...
from AgentEngine.framework.agents import CodeAgent, populate_template, handle_agent_output_types, AgentError, AgentType
from AgentEngine.framework.utils import AgentExecutionError, AgentGenerationError, AgentParsingError,parse_code_blobs, truncate_content
from AgentEngine.framework.models import ChatMessage
from AgentEngine.framework.memory import ActionStep, ToolCall, TaskStep, SystemPromptStep
from AgentEngine.framework.local_python_executor import fix_final_answer_code
from AgentEngine.framework.monitoring import LogLevel
    ...
    def __init__(self, observer: MessageObserver, lang="zh", prompt_templates=None, *args, **kwargs):
        ...
        if prompt_templates is not None:
            ...
            if lang=="zh":
                ...
                prompt_path = os.path.normpath(os.path.join(file_path, "../../framework/prompts/code_agent.yaml"))
