...
.. note::
    If you are looking for bulk random structure search, we recommend using packages such as `AIRSS <https://airss-docs.github.io>`_, which are specifically designed for this purpose.
