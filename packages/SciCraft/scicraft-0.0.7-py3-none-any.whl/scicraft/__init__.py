...
def ttest(variable,treatment,dataset=df):
    """
    Input: variable to test, and group variable, dataframe (default=df)
    Print variable name, mean treatment group (1), mean base group (0), difference between groups, t-value and significance
    """
    group1=dataset[dataset[treatment]==1]
    group0=dataset[dataset[treatment]==0]
