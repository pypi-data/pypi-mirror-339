...
class FunctionApp(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.restart_on_error is None
            and "restart_on_error" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "latest_version": Version.from_dict(obj["latest_version"])
                if obj.get("latest_version") is not None
                else None,
                "function_type": obj.get("function_type"),
                "webhooks": [WebhookModel.from_dict(_item) for _item in obj["webhooks"]]
