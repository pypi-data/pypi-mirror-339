...
class Job(BaseModel):
    ...
    function_id: StrictStr = Field(
        description="The id of the function that the job belongs to. This can be the first 7 characters of the full id."
    )
    ...
    status: StrictStr = Field(
        description="The status of the job. Possible values: 'queued', 'processing', 'error', 'finished', 'cancelled'"
    )
    created_at: Optional[datetime]
    started_at: Optional[datetime]
    completed_at: Optional[datetime]
    inputs: Optional[Dict[str, Any]] = Field(
        default=None, description="Show child attributes"
    )
    outputs: Optional[List[OutputsInner]] = Field(
        default=None, description="Show child attributes"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "function": CompactFunctionApp.from_dict(obj["function"])
                ...
                "outputs": [OutputsInner.from_dict(_item) for _item in obj["outputs"]]
                ...
                "restarts": [Restart.from_dict(_item) for _item in obj["restarts"]]
                if obj.get("restarts") is not None
                else None,
            }
        )
        return _obj
