...
class ConfigModel(BaseModel):
    ...
    restart_on_error: Optional[StrictBool] = Field(
        default=True, description="Whether to restart the function on job error"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                if obj.get("private") is not None
                else False,
                "type": obj.get("type"),
                ...
                if obj.get("restart_on_error") is not None
                else True,
            }
        )
