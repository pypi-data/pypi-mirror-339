...
class serverManager(metaclass=SingletonMeta):
    def __init__(self, src_dir=None,main_dir=None,domain=None,imgs_dir=None,pages_dir=None,json_dir=None,contents_dir=None,public_dir=None,fb_id=None,directory=None,directory_links=None,page_layout_dir=None,layout_filename=None):
