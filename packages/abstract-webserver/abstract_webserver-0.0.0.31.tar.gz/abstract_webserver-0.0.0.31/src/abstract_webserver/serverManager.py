...
def create_directory_links(public_dir=None,pages_dir=None,json_dir=None,domain=None,main_dir=None,src_dir=None,contents_dir=None,directory_links=None):
    ...
    domain = get_domain_dirs(get_domain,dir_str=domain,directory=src_dir)
    directory_links= directory_links or {}
...
class serverManager(metaclass=SingletonMeta):
    def __init__(self, src_dir=None,main_dir=None,domain=None,imgs_dir=None,pages_dir=None,json_dir=None,contents_dir=None,public_dir=None,fb_id=None,directory=None,page_layout_dir=None,layout_filename=None):
