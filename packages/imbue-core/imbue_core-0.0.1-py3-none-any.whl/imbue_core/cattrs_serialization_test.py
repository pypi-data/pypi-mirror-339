...
def test_pydantic_serdes() -> None:
    ...
    expected_serialized_x = """{"__type": "imbue_core.cattrs_serialization_test.PydanticSettingsClass", "test_path": {"value": "/tmp/asdf", "__type": "pathlib.PosixPath"}, "command": "hello world!", "name": "named", "is_primary": false, "is_terminal_expanded": null}"""
...
def test_nested_pydantic_serdes() -> None:
    ...
    expected_serialized_x = """{"__type": "imbue_core.cattrs_serialization_test.PydanticNestedSettings", "more_tests": 42, "nested_field": {"__type": "imbue_core.cattrs_serialization_test.PydanticSettingsClass", "test_path": {"value": "/tmp/asdf", "__type": "pathlib.PosixPath"}, "command": "hello world!", "name": "named", "is_primary": false, "is_terminal_expanded": null}}"""
    serialized_x = serialize_to_json(
        x,
        is_reversible=True,
    )
...
class AttrsPydanticNestedSettings(BaseSettings):
    model_config = SettingsConfigDict(frozen=True)

    more_tests: int = 42
    nested_field: PydanticNestedSettings
    attrs_nested_field: ClassWithUnserializableFields


def test_attrs_nested_pydantic_serdes() -> None:
    x = AttrsPydanticNestedSettings(
        nested_field=PydanticNestedSettings(
            more_tests=43,
            nested_field=PydanticSettingsClass(
                command="hello world!", name="named", is_primary=False, is_terminal_expanded=None
        ...
        attrs_nested_field=ClassWithUnserializableFields(obj1=SomeAttrsClass(x=1), obj2=SomeAttrsClass(x=2)),
    )

    expected_serialized_x = """{"__type": "imbue_core.cattrs_serialization_test.AttrsPydanticNestedSettings", "more_tests": 42, "nested_field": {"__type": "imbue_core.cattrs_serialization_test.PydanticNestedSettings", "more_tests": 43, "nested_field": {"__type": "imbue_core.cattrs_serialization_test.PydanticSettingsClass", "test_path": {"value": "/tmp/asdf", "__type": "pathlib.PosixPath"}, "command": "hello world!", "name": "named", "is_primary": false, "is_terminal_expanded": null}}, "attrs_nested_field": {"__type": "imbue_core.cattrs_serialization_test.ClassWithUnserializableFields", "obj1": {"__type": "imbue_core.cattrs_serialization_test.SomeAttrsClass", "x": 1, "y": "abc", "z": []}, "obj2": {"__type": "imbue_core.cattrs_serialization_test.SomeAttrsClass", "x": 2, "y": "abc", "z": []}}}"""
    serialized_x = serialize_to_json(
        x,
        is_reversible=True,
    )
...
def test_attrs_nested_pydantic_serdes_with_default_on_attrs() -> None:
    x = AttrsPydanticNestedSettings(
        nested_field=PydanticNestedSettings(
            more_tests=43,
            nested_field=PydanticSettingsClass(
    ...
    expected_serialized_x = """{"__type": "imbue_core.cattrs_serialization_test.AttrsPydanticNestedSettings", "more_tests": 42, "nested_field": {"__type": "imbue_core.cattrs_serialization_test.PydanticNestedSettings", "more_tests": 43, "nested_field": {"__type": "imbue_core.cattrs_serialization_test.PydanticSettingsClass", "test_path": {"value": "/tmp/asdf", "__type": "pathlib.PosixPath"}, "command": "hello world!", "name": "named", "is_primary": false, "is_terminal_expanded": null}}, "attrs_nested_field": {"__type": "imbue_core.cattrs_serialization_test.ClassWithUnserializableFields", "obj1": {"__type": "imbue_core.cattrs_serialization_test.SomeAttrsClass", "x": 1, "y": "abc", "z": []}, "obj2": null}}"""
    serialized_x = serialize_to_json(x, is_reversible=True, use_defaults_for_unserializable_fields=True)
    assert serialized_x == expected_serialized_x

    deserialized_x = deserialize_from_json(serialized_x, use_defaults_for_unserializable_fields=True)
    assert deserialized_x.nested_field == x.nested_field
    assert deserialized_x.attrs_nested_field.obj1 == x.attrs_nested_field.obj1
    assert deserialized_x.attrs_nested_field.obj2 is None
