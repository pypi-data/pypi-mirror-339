...
def install_for_cursor():
    ...
    if platform.system() == "Windows":
        config_path = Path(os.getenv("USERPROFILE")) / ".cursor" / "mcp.json"
    else:
    ...
    print(f"✅ Cursor MCP configuration updated at: {config_path}")
    print("🎉 You can now restart Cursor IDE to use maths-mcp.")
def main():
