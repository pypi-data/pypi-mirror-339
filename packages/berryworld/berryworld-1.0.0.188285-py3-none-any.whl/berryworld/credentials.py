...
class SQLCredentials:
    def __init__(self, db_name, server_type=None, azure=False):
        if db_name is None:
    ...
    def simple_creds(self):
        ...
        try:
            if self.azure is True:
                server_name = os.environ["SQL_" + self.db_name.upper() + '_' + self.server_type.upper()]
                db_name = os.environ["SQL_" + self.db_name.upper() + '_DB_NAME']
                user_name = os.environ["SQL_" + self.db_name.upper() + '_USER_NAME']
                password = os.environ["SQL_" + self.db_name.upper() + '_PASSWORD']
            else:
