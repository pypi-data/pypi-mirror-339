...
def run_cmd_list(cmd_list: List[str], logger: Optional[Callable] = None, n: int = 1, choice="thread", confirm=True, **kwargs):
    if not cmd_list:
    ...
    if confirm:
        ...
        print(f"Execution mode: {'Batch (threads: ' + str(n) + ')' if n > 1 else 'Stream'}")
