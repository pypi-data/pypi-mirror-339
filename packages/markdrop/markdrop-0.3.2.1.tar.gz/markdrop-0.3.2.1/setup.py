...
setup(
    ...
    author="Shorya Sethia, Suraj Prasad",
    ...
    keywords="pdf markdown converter ai llm table-extraction image-analysis document-processing pdf-to-markdown pdf-to-text pdf-to-image pdf-to-table pdf-to-markdown-converter pdf-to-markdown-tool pdf-to-markdown-ai image-extraction table-detection table-extraction ai-powered-pdf-processing advanced-pdf-processing document-structure-preservation high-quality-image-extraction advanced-ml-models content-description generation local-files url-support",
)
