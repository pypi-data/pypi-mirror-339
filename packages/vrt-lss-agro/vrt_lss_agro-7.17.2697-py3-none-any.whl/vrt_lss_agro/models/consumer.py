    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.consumption_forecast:
            for _item_consumption_forecast in self.consumption_forecast:
                if _item_consumption_forecast:
                    _items.append(_item_consumption_forecast.to_dict())
        ...
        if self.stock_forecast:
            for _item_stock_forecast in self.stock_forecast:
                if _item_stock_forecast:
                    _items.append(_item_stock_forecast.to_dict())
