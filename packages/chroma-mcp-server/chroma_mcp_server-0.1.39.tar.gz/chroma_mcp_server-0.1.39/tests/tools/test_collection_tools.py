...
from src.chroma_mcp.tools.collection_tools import (
    ...
    # Import Tool classes for type hinting if needed later, though not strictly necessary for testing _impl
    CreateCollectionTool, ListCollectionsTool, GetCollectionTool, SetCollectionDescriptionTool,
    SetCollectionSettingsTool, UpdateCollectionMetadataTool, RenameCollectionTool, 
    DeleteCollectionTool, PeekCollectionTool 
)
