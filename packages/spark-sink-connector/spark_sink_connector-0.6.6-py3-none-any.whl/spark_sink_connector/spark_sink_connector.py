...
from .enums import *
from .schema_helper import get_schemas_from_registry, process_data_with_schema_evolution, add_avro_columns_transform
...
class SparkSinkConnector:
    ...
    def apply_schema_from_registry(self, kind: SchemaKind) -> 'SparkSinkConnector':
        ...
        if kind == SchemaKind.AVRO:
            ...
            self.dataframe = add_avro_columns_transform(self.dataframe)
