...
async def post_save(bot, data_user, data_web, MEDIA_D, BASE_P, KEYS_JSON, PROJECT_USERNAME, PROJECT_TYPE):
    ...
    try:
        ...
        result['post'] = {
            ...
            'POST_WEB': POST_WEB, 'POST_PAY': POST_PAY, 'POST_INVOICE': POST_INVOICE, 'POST_BLOG': POST_BLOG,
        ...
        sql = f"""
            INSERT INTO {schema_prefix}_{ENT_TID}.POST (
                ...
                POST_WEB, POST_PAY, POST_INVOICE, POST_BLOG, POST_ISPRIVATE, 
        ...
        await db_change_pg(sql, (
            ...
            POST_TYPE, POST_TEXT, POST_MEDIA, POST_BUTTONS, POST_CHKBOX,
            POST_WEB, POST_PAY or None, POST_INVOICE or None, POST_BLOG, POST_ISPRIVATE or None,
...
async def post_pub(bot, lz, chat_id, ENT_TID, post, MEDIA_D, BASE_S, BASE_D, PROJECT_USERNAME, is_private=True, cur_=1):
    ...
    try:
        ...
        # region reply_markup
        reply_markup = InlineKeyboardBuilder()
        print(f"region reply_markup {POST_ISPAY=}, {POST_TYPE=}")
        if POST_ISPAY and POST_PAY and POST_TYPE not in ['photo', 'video']:
            # url_ = f'https://t.me/{PROJECT_USERNAME}/web?startapp=mpay-{msg_chkbox['chkWeb']}-{BOT_TID}'
            print(f"{POST_PAY=}")
