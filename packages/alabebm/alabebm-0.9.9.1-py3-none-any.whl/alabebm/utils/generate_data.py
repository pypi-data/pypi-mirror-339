...
def generate_data(
    ...
    if "kjOrdinal" in experiment_name:
        ...
        # # Debug code to check the distribution
        # if experiment_name == 'sn_kjContinuousBeta':
        #     # Also print raw stats
        #     print(f"Mean: {np.mean(disease_stages)}")
        #     print(f"Median: {np.median(disease_stages)}")
        #     print(f"Min: {np.min(disease_stages)}")
        #     print(f"Max: {np.max(disease_stages)}")
