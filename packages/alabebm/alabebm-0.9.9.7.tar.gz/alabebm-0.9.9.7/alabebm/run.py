...
def run_ebm(
    ...
    desired_bm_order = sorted(true_order_dict, key=true_order_dict.get)
    ...
    results = {
        ...
        "thinning": thinning,
         "kendalls_tau": tau, 
        "p_value": p_value,
        'true_order': {bm: true_order_dict[bm] for bm in desired_bm_order},
        'ml_order': {bm: most_likely_order_dic[bm] for bm in desired_bm_order},
