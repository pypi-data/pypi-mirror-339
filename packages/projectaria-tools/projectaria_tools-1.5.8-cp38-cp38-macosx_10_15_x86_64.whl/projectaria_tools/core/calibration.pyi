...
import typing
__all__ = ['ARIA_ET_CALIBRATION', 'ARIA_MIC_CALIBRATION', 'BAROMETER_CALIBRATION', 'BarometerCalibration', 'CAMERA_CALIBRATION', 'CameraCalibration', 'CameraModelType', 'CameraProjection', 'DeviceCadExtrinsics', 'DeviceCalibration', 'FISHEYE62', 'FISHEYE624', 'IMU_CALIBRATION', 'ImuCalibration', 'KANNALA_BRANDT_K3', 'LINEAR', 'LinearRectificationModel3d', 'MAGNETOMETER_CALIBRATION', 'MICROPHONE_CALIBRATION', 'MagnetometerCalibration', 'MicrophoneCalibration', 'NOT_VALID', 'SPHERICAL', 'SensorCalibration', 'SensorCalibrationType', 'color_correct', 'device_calibration_from_json', 'device_calibration_from_json_string', 'devignetting', 'distort_by_calibration', 'distort_depth_by_calibration', 'distort_label_by_calibration', 'get_linear_camera_calibration', 'get_spherical_camera_calibration', 'rotate_camera_calib_cw90deg']
...
class SensorCalibrationType:
    ...
    def value(arg0: SensorCalibrationType) -> int:
        ...
@typing.overload
def color_correct(src_image: typing.Annotated[numpy.typing.ArrayLike, numpy.uint8]) -> numpy.typing.NDArray[numpy.float32] | numpy.typing.NDArray[numpy.uint8] | numpy.typing.NDArray[numpy.uint16] | numpy.typing.NDArray[numpy.uint64] | numpy.typing.NDArray[...]:
    """
    Correct color distorted image in old Aria recordings
    """
@typing.overload
def color_correct(src_image: typing.Annotated[numpy.typing.ArrayLike, numpy.uint16]) -> None:
    """
    Correct color distorted image in old Aria recordings
    """
@typing.overload
def color_correct(src_image: typing.Annotated[numpy.typing.ArrayLike, numpy.uint64]) -> None:
    """
    Correct color distorted image in old Aria recordings
    """
@typing.overload
def color_correct(src_image: typing.Annotated[numpy.typing.ArrayLike, numpy.float32]) -> None:
    """
    Correct color distorted image in old Aria recordings
    """
