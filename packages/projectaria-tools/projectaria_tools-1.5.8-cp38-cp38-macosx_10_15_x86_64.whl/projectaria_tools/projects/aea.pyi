...
class SentenceData:
    ...
    def end_timestamp_ns(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def start_timestamp_ns(self) -> int:
        ...
    @start_timestamp_ns.setter
    def start_timestamp_ns(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def words(self) -> dict[int, WordData]:
        ...
    @words.setter
    def words(self, arg0: dict[typing.SupportsInt, WordData]) -> None:
        ...
class SpeechDataProvider:
    ...
    def empty(self) -> bool:
        ...
    def get_sentence_data_by_timestamp_ns(self, device_timestamp_ns: typing.SupportsInt, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> SentenceData | None:
        """
        ...
        """
    def get_word_data_by_timestamp_ns(self, device_timestamp_ns: typing.SupportsInt, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> WordData | None:
        """
