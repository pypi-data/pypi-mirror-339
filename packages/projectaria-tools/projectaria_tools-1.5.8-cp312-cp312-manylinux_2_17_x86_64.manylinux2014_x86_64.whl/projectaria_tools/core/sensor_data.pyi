...
class AudioData:
    ...
    def data(self) -> list[int]:
        ...
    @data.setter
    def data(self, arg0: list[typing.SupportsInt]) -> None:
        ...
class AudioDataRecord:
    ...
    def capture_timestamps_ns(self, arg0: list[typing.SupportsInt]) -> None:
        ...
...
class MotionData:
    ...
    def __init__(self) -> None:
        ...
    @property
    def accel_msec2(self) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        ...
    @accel_msec2.setter
    def accel_msec2(self, arg0: typing.Annotated[list[typing.SupportsFloat], pybind11_stubgen.typing_ext.FixedSize(3)]) -> None:
        ...
    @property
    def arrival_timestamp_ns(self) -> int:
        ...
    ...
    def capture_timestamp_ns(self, arg0: typing.SupportsInt) -> None:
        ...
    @property
    def gyro_radsec(self) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        ...
    @gyro_radsec.setter
    def gyro_radsec(self, arg0: typing.Annotated[list[typing.SupportsFloat], pybind11_stubgen.typing_ext.FixedSize(3)]) -> None:
        ...
    @property
    def mag_tesla(self) -> typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)]:
        ...
    @mag_tesla.setter
    def mag_tesla(self, arg0: typing.Annotated[list[typing.SupportsFloat], pybind11_stubgen.typing_ext.FixedSize(3)]) -> None:
        ...
    @property
    def temperature(self) -> float:
        ...
...
class SensorData:
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    def __init__(self, arg0: projectaria_tools.core.stream_id.StreamId, arg1: None | tuple[ImageData, ImageDataRecord] | MotionData | GpsData | WifiBeaconData | tuple[AudioData, AudioDataRecord] | BarometerData | BluetoothBeaconData, arg2: SensorDataType, arg3: typing.SupportsInt, arg4: dict[TimeSyncMode, typing.SupportsInt]) -> None:
        ...
...
class WifiBeaconData:
    ...
    def rssi_per_antenna(self, arg0: list[typing.SupportsFloat]) -> None:
        ...
    @property
    def system_timestamp_ns(self) -> int:
        ...
