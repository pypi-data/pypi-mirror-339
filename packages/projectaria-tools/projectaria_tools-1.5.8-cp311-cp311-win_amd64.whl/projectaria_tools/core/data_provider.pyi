...
class DeliverQueuedOptions(SubstreamSelector):
    ...
    def _pybind11_conduit_v1_(*args, **kwargs):
        ...
    def __init__(self, arg0: typing.SupportsInt, arg1: typing.SupportsInt, arg2: dict[projectaria_tools.core.stream_id.StreamId, typing.SupportsInt]) -> None:
        ...
    ...
    def get_truncate_last_device_time_ns(self) -> int:
        ...
        """
    def set_subsample_rate(self, stream_id: projectaria_tools.core.stream_id.StreamId, rate: typing.SupportsInt) -> None:
        """
        Sets how many times the frame rate is downsampled in a stream i.e, after a data is played, rate - 1 data are skipped.
        """
    def set_truncate_first_device_time_ns(self, time_ns: typing.SupportsInt) -> None:
        """
        Sets how much time to skip from the beginning of the recording.
        """
    def set_truncate_last_device_time_ns(self, time_ns: typing.SupportsInt) -> None:
        """
...
class VrsDataProvider:
    ...
    def check_stream_is_type(self, stream_id: projectaria_tools.core.stream_id.StreamId, type: projectaria_tools.core.sensor_data.SensorDataType) -> bool:
        ...
        """
    def convert_from_device_time_to_synctime_ns(self, device_time_ns: typing.SupportsInt, mode: projectaria_tools.core.sensor_data.TimeSyncMode) -> int:
        """
        Convert DeviceTime timestamp into synchronized timestamp in nanoseconds.
        """
    def convert_from_device_time_to_timecode_ns(self, device_time_ns: typing.SupportsInt) -> int:
        """
        Convert DEVICE_TIME timestamp into TIME_CODE in nanoseconds.
        """
    def convert_from_synctime_to_device_time_ns(self, sync_time_ns: typing.SupportsInt, mode: projectaria_tools.core.sensor_data.TimeSyncMode) -> int:
        """
        Convert sync timestamp into synchronized timestamp in nanoseconds.
        """
    def convert_from_timecode_to_device_time_ns(self, timecode_time_ns: typing.SupportsInt) -> int:
        """
    ...
    def get_audio_configuration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.sensor_data.AudioConfig:
        ...
    def get_audio_data_by_index(self, stream_id: projectaria_tools.core.stream_id.StreamId, index: typing.SupportsInt) -> tuple[projectaria_tools.core.sensor_data.AudioData, projectaria_tools.core.sensor_data.AudioDataRecord]:
        ...
    def get_audio_data_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> tuple[projectaria_tools.core.sensor_data.AudioData, projectaria_tools.core.sensor_data.AudioDataRecord]:
        ...
    def get_barometer_configuration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.sensor_data.BarometerConfigRecord:
        ...
    def get_barometer_data_by_index(self, stream_id: projectaria_tools.core.stream_id.StreamId, index: typing.SupportsInt) -> projectaria_tools.core.sensor_data.BarometerData:
        ...
    def get_barometer_data_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> projectaria_tools.core.sensor_data.BarometerData:
        ...
    def get_bluetooth_configuration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.sensor_data.BluetoothBeaconConfigRecord:
        ...
    def get_bluetooth_data_by_index(self, stream_id: projectaria_tools.core.stream_id.StreamId, index: typing.SupportsInt) -> projectaria_tools.core.sensor_data.BluetoothBeaconData:
        ...
    def get_bluetooth_data_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> projectaria_tools.core.sensor_data.BluetoothBeaconData:
        ...
    ...
    def get_gps_configuration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.sensor_data.GpsConfigRecord:
        ...
    def get_gps_data_by_index(self, stream_id: projectaria_tools.core.stream_id.StreamId, index: typing.SupportsInt) -> projectaria_tools.core.sensor_data.GpsData:
        ...
    def get_gps_data_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> projectaria_tools.core.sensor_data.GpsData:
        ...
    def get_image_configuration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.sensor_data.ImageConfigRecord:
        ...
    def get_image_data_by_index(self, stream_id: projectaria_tools.core.stream_id.StreamId, index: typing.SupportsInt) -> tuple[projectaria_tools.core.sensor_data.ImageData, projectaria_tools.core.sensor_data.ImageDataRecord]:
        ...
    def get_image_data_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> tuple[projectaria_tools.core.sensor_data.ImageData, projectaria_tools.core.sensor_data.ImageDataRecord]:
        ...
    def get_imu_configuration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.sensor_data.MotionConfigRecord:
        ...
    def get_imu_data_by_index(self, stream_id: projectaria_tools.core.stream_id.StreamId, index: typing.SupportsInt) -> projectaria_tools.core.sensor_data.MotionData:
        ...
    def get_imu_data_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> projectaria_tools.core.sensor_data.MotionData:
        ...
    def get_index_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> int:
        """
    ...
    def get_magnetometer_configuration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.sensor_data.MotionConfigRecord:
        ...
    def get_magnetometer_data_by_index(self, stream_id: projectaria_tools.core.stream_id.StreamId, index: typing.SupportsInt) -> projectaria_tools.core.sensor_data.MotionData:
        ...
    def get_magnetometer_data_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> projectaria_tools.core.sensor_data.MotionData:
        ...
    ...
    def get_sensor_calibration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.calibration.SensorCalibration | None:
        ...
        """
    def get_sensor_data_by_index(self, stream_id: projectaria_tools.core.stream_id.StreamId, index: typing.SupportsInt) -> projectaria_tools.core.sensor_data.SensorData:
        """
        ...
        """
    def get_sensor_data_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> projectaria_tools.core.sensor_data.SensorData:
        """
    ...
    def get_wps_configuration(self, stream_id: projectaria_tools.core.stream_id.StreamId) -> projectaria_tools.core.sensor_data.WifiBeaconConfigRecord:
        ...
    def get_wps_data_by_index(self, stream_id: projectaria_tools.core.stream_id.StreamId, index: typing.SupportsInt) -> projectaria_tools.core.sensor_data.WifiBeaconData:
        ...
    def get_wps_data_by_time_ns(self, stream_id: projectaria_tools.core.stream_id.StreamId, time_ns: typing.SupportsInt, time_domain: projectaria_tools.core.sensor_data.TimeDomain, time_query_options: projectaria_tools.core.sensor_data.TimeQueryOptions = ...) -> projectaria_tools.core.sensor_data.WifiBeaconData:
        ...
