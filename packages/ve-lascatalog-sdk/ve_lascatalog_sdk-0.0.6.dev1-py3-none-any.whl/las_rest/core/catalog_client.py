...
class CatalogClient:
    ...
    def get_catalog(self, catalog_name) -> Catalog:
        ...
        if response.get('ResponseMetadata').get('Error') is not None:
            logger.error("get catalogs error %s", response['ResponseMetadata'].get('Message'))
            return None
    ...
    def create_catalog(self, catalog_name, location, description) -> bool:
        ...
        if response is None or response.get('ResponseMetadata') is None:
            return False
        if response.get('ResponseMetadata').get('Error') is not None:
            logger.error("create catalog error %s", response['ResponseMetadata']['Error'].get('Message'))
            return False
        return True
    ...
    def drop_catalog(self, catalog_name) -> bool:
        ...
        if response is None or response.get('ResponseMetadata') is None:
            return False
        if response.get('ResponseMetadata').get('Error') is not None:
            logger.error("drop catalog error %s", response['ResponseMetadata']['Error'].get('Message'))
            return False
        return True
    ...
    def get_database(self, db_name: str, catalog_name: str = None) -> Database:
        ...
        if response is None or response.get('ResponseMetadata') is None:
            return None
        if response.get('ResponseMetadata').get('Error') is not None:
            logger.error("get catalog error %s", response['ResponseMetadata']['Error'].get('Message'))
            return None
    ...
    def create_database(self, database: Database) -> bool:
        ...
        if response is None or response.get('ResponseMetadata') is None:
            return False
        if response.get('ResponseMetadata').get('Error') is not None:
            logger.error("create database error %s", response['ResponseMetadata']['Error'].get('Message'))
            return False
        return True
    ...
    def drop_database(self, database_name: str, catalog_name: str) -> bool:
        ...
        if response is None or response.get('Result') is None:
            return False
        if response.get('Result').get("ErrorMessage") is not None:
    ...
    def alter_database(self, database: Database) -> bool:
        ...
        if response is None or response.get('ResponseMetadata') is None:
            return False
        if response.get('ResponseMetadata').get('Error') is not None:
            logger.error("alter database error %s", response['ResponseMetadata']['Error'].get('Message'))
            return False
        return True
    ...
    def get_table(self, table_name: str, database: str, catalog_name: str = None, ) -> Table:
        ...
        if response is None or response.get('ResponseMetadata') is None:
            return None
        if response.get('ResponseMetadata').get('Error') is not None:
            logger.error("get table error %s", response['ResponseMetadata']['Error'].get('Message'))
            return None
    ...
    def create_table(self, table: Table) -> bool:
        ...
        if response is None or response.get('ResponseMetadata') is None:
            return False
        if response.get('ResponseMetadata').get('Error') is not None:
            logger.error("create table error %s", response['ResponseMetadata']['Error'].get('Message'))
            return False
        return True
    ...
    def alter_table(self, table: Table) -> bool:
        ...
        if response is None or response.get('ResponseMetadata') is None:
            return False
        if response.get('ResponseMetadata').get('Error') is not None:
            logger.error("alter table error %s", response['ResponseMetadata']['Error'].get('Message'))
            return False
        return True
    ...
    def drop_table(self, catalog: str, database: str, table_name: str) -> bool:
        ...
        if response is None or response.get('ResponseMetadata') is None:
            return False
        if response.get('ResponseMetadata').get('Error') is not None:
            logger.error("drop table error %s", response['ResponseMetadata']['Error'].get('Message'))
            return False
        return True
    ...
    def update_optimizer_task(self, catalog: str, database: str, table_name: str, type: str, taskId: int, task_detail: dict) -> bool:
        ...
        if response is None or response.get('ResponseMetadata') is None:
            return False
        if response.get('ResponseMetadata').get('Error') is not None:
            logger.error("alter optimizertask error %s", response['ResponseMetadata']['Error'].get('Message'))
            return False
        return True