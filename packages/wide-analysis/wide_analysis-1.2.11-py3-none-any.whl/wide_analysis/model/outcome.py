...
best_models_tasks = {
    'wikipedia': 'research-dump/roberta-large_outcome_Wikipedia_Full_v3', #'research-dump/roberta-large_deletion_multiclass_complete_final_v2',
...
best_models_langs = {
    'en': 'research-dump/roberta-large_outcome_Wikipedia_Full_v3',#'research-dump/roberta-large_deletion_multiclass_complete_final_v2',
...
label_mapping_wikipedia_en = {
    ...
    'merge': [4, 'LABEL_4'],
    'speedy keep': [5, 'LABEL_5'],      
    'speedy delete': [6, 'LABEL_6'],
    'withdrawn': [7, 'LABEL_7']
}
...
def get_outcome(input_text_or_url, mode='url', openai_access_token=None, explanation=False, lang='en', platform='wikipedia', explainer_model='gpt-4o-mini', date='', years=None, model = ''):
    if lang == 'en':
        ...
        model_name = model if model!= '' else best_models_tasks[platform]
