...
# Import the models module with an alias and the new enum
from .models import models as M
from .models.models import ExistingChromeInstanceStrategy # Added import
...
class AutomationApi:
    ...
    # Note: open_application is duplicated in SystemApi, keeping it here for potential C# parity/structure
    def open_application(self, app_name_or_path: str) -> Optional[M.SimpleResponse]: # Update return type hint
        """
        Launches an application by path or name.
    ...
    # Note: get_window_details is duplicated in SystemApi, keeping it here for potential C# parity/structure
    def get_window_details(self, window_id: str) -> Optional[M.WindowDetailInfosDTO]: # Update return type hint
        """
        Gets detailed UI automation information for a window.
    ...
    def click_element(self, description: str) -> Optional[M.ActionResponse]: # Update return type hint
        """
        ...
        """
        # Use _post_internal with expected_type
        return self._client._post_internal("/tools-api/automation/click-element", expected_type=M.ActionResponse, data={"description": description})

    def type_in_element(self, description: str, text: str) -> Optional[M.ActionResponse]: # Update return type hint
        """
        ...
        """
        # Use _post_internal with expected_type
        return self._client._post_internal("/tools-api/automation/type-in-element", expected_type=M.ActionResponse, data={"description": description, "text": text})

    def get_element_text(self, description: str) -> Optional[M.ActionResponse]: # Update return type hint
        """
        ...
        Returns:
            Action response with element text or None on error
        """
        # Use _post_internal with expected_type
        return self._client._post_internal("/tools-api/automation/get-element-text", expected_type=M.ActionResponse, data={"description": description})
