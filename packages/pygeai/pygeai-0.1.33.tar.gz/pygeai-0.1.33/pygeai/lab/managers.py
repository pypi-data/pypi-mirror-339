...
class AILabManager:
    ...
    def create_process(
        ...
        response_data = self.__process_client.create_process(
            ...
            agentic_activities=[activity.to_dict() for activity in process.agentic_activities],
            artifact_signals=[signal.to_dict() for signal in process.artifact_signals],
            user_signals=[signal.to_dict() for signal in process.user_signals],
            start_event=process.start_event.to_dict(),
            end_event=process.end_event.to_dict(),
            sequence_flows=[flow.to_dict() for flow in process.sequence_flows],
            automatic_publish=automatic_publish
        )
    ...
    def create_task(
        ...
        :param project_id: str - Unique identifier of the project.
        :param task: Task - The task configuration to create.
    ...
    def update_task(
        ...
        :param project_id: str - Unique identifier of the project.
        :param task: Task - The task configuration to update.
    ...
    def start_instance(
        ...
        :return: Union[ProcessInstance, ErrorListResponse] - The started instance if successful, or an error response.
        """
