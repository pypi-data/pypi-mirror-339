...
class AgenticProcessClient(BaseClient):
    ...
    def create_task(
        ...
        :param description: str, optional - Description of the task.
        :param title_template: str, optional - Title template for the task.
    ...
    def update_task(
        ...
        :param description: str, optional - Updated description of the task.
        :param title_template: str, optional - Updated title template for the task.
        ...
        identifier = task_id if task_id else name
