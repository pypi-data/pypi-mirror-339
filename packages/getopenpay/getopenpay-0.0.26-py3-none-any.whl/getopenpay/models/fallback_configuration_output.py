...
class FallbackConfigurationOutput(BaseModel):
  ...
  price_groups: Optional[List[SelectedPriceQuantity]] = Field(
    default=None,
    description=
    ...
    _obj = cls.model_validate(
      {
        'fallback_processor_preferences':
          CheckoutProcessorsPreferences.from_dict(obj['fallback_processor_preferences'])
          if obj.get('fallback_processor_preferences') is not None else None,
        'price_groups':
          [SelectedPriceQuantity.from_dict(_item) for _item in obj['price_groups']]
