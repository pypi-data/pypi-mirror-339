...
class InvoicePublic(BaseModel):
  ...
  lines: Optional[List[InvoiceItemPublic]] = Field(
    default=None, description='List of individual line items that make up the invoice.'
  )
  ...
  __properties: ClassVar[List[str]] = [
    ...
    'branding', 'card_type', 'created_at', 'currency', 'customer_vat_id', 'due_amount_atom',
    'due_date', 'id', 'invoice_pdf_url', 'is_initial_invoice_for_trial_sub', 'last_four', 'lines',
    'merchant_vat_id', 'paid_amount_atom', 'paid_at', 'provider_type_fee_amount_atom',
    'receipt_pdf_url', 'remaining_amount_atom', 'status', 'tax_amount_atom', 'total_amount_atom',
    'total_discount_amount_atoms', 'total_excluding_taxes_amount_atom', 'trial_end_for_sub',
    'trial_start_for_sub'
  ]
    ...
    _obj = cls.model_validate(
      {
        ...
        'lines':
          [InvoiceItemPublic.from_dict(_item) for _item in obj['lines']]
