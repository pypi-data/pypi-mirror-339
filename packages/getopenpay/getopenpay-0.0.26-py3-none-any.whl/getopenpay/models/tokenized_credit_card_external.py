...
class TokenizedCreditCardExternal(BaseModel):
  ...
  mappings: Optional[List[PaymentMethodMappingExternal]] = Field(
    default=None,
    description=
  ...
  def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
    ...
    _obj = cls.model_validate(
      {
        'billing_address':
          CompleteAddress.from_dict(obj['billing_address'])
        ...
        'mappings':
          [PaymentMethodMappingExternal.from_dict(_item) for _item in obj['mappings']]
