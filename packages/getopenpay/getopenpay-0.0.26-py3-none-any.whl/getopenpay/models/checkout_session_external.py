...
class CheckoutSessionExternal(BaseModel):
  ...
  line_items: List[CheckoutSessionLineItemExternal] = Field(
    ...
    _obj = cls.model_validate(
      {
        ...
        'line_items':
          [CheckoutSessionLineItemExternal.from_dict(_item) for _item in obj['line_items']]
        ...
        'setup_intent':
          SetupIntentExternal.from_dict(obj['setup_intent'])
