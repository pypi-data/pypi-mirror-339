...
class NonPciIntegration(BaseModel):
  ...
  configuration: Optional[List[NonPciIntegrationConfigurationInner]] = Field(
    default=None, description='The configuration fields'
  )
    ...
    _obj = cls.model_validate(
      {
        ...
        'configuration':
          [NonPciIntegrationConfigurationInner.from_dict(_item) for _item in obj['configuration']]
