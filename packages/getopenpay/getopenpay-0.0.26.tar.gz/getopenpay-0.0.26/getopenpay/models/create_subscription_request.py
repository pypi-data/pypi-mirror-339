...
class CreateSubscriptionRequest(BaseModel):
  ...
  selected_product_price_quantity: List[SelectedPriceQuantity] = Field(
    description="This object contains details of selected product' price and quantity."
  )
  ...
  __properties: ClassVar[List[str]] = [
    ...
    'skip_invoice_payment', 'starts_at', 'total_amount_atom', 'trial_end', 'trial_from_price',
    'trial_period_days'
  ]
    ...
    _obj = cls.model_validate(
      {
        ...
        'checkout_preferences':
          CheckoutPreferences.from_dict(obj['checkout_preferences'])
        ...
        'selected_product_price_quantity':
          [
            ...
            for _item in obj['selected_product_price_quantity']
