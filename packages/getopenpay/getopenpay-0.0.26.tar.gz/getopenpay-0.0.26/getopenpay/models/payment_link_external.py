...
class PaymentLinkExternal(BaseModel):
  ...
  line_items: List[PaymentLinkLineItemExternal] = Field(
    description='The line items purchased by the customers.'
  )
    ...
    _obj = cls.model_validate(
      {
        ...
        'checkout_preferences':
          CheckoutPreferencesOutput.from_dict(obj['checkout_preferences'])
        ...
        'line_items':
          [PaymentLinkLineItemExternal.from_dict(_item) for _item in obj['line_items']]
