...
class CreateCouponRequest(BaseModel):
  ...
  product_family_ids: Optional[List[StrictStr]] = Field(
    default=None, description='An array of Product Family IDs that this Coupon can apply to.'
  )
  product_ids: Optional[List[StrictStr]] = Field(
    default=None, description='An array of Product IDs that this Coupon can apply to.'
  )
