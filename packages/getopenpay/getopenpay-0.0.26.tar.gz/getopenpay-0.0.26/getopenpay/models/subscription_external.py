...
class SubscriptionExternal(BaseModel):
  ...
  subscription_items: List[SubscriptionItemExternal] = Field(
    ...
    _obj = cls.model_validate(
      {
        ...
        'cancellation_details':
          SubscriptionCancellationDetails.from_dict(obj['cancellation_details'])
        ...
        'subscription_items':
          [SubscriptionItemExternal.from_dict(_item) for _item in obj['subscription_items']]
