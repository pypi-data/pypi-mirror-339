...
class CheckoutProcessorsPreferences(BaseModel):
  """
    ...
    """ # noqa: E501
  filter_providers: Optional[List[PaymentProviderType]] = Field(
    default=None, description='If not empty, the enabled providers will be filtered by this list.'
  )
  ids_whitelist: Optional[List[StrictStr]] = Field(
    default=None, description='If not empty, only the processors with these ids will be accepted.'
  )
  names_whitelist: Optional[List[StrictStr]] = Field(
    default=None,
    description=
