...
class PromotionCodeExternal(BaseModel):
  ...
  customer_ids: Optional[List[StrictStr]] = Field(
    default=None,
    description=
  ...
  def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
    ...
    _obj = cls.model_validate(
      {
        'code': obj.get('code'),
        'coupon': CouponExternal.from_dict(obj['coupon'])
                  if obj.get('coupon') is not None else None,
        ...
        'restrictions':
          PromoRestrictions.from_dict(obj['restrictions'])
