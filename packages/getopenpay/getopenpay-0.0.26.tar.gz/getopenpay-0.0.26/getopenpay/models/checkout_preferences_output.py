...
class CheckoutPreferencesOutput(BaseModel):
  ...
  # noqa: E501
  fallback_cascade_preferences: Optional[List[FallbackConfigurationOutput]] = Field(
    default=None,
    description=
  ...
  fallback_cascade_selected_product_price_quantity: Optional[
    List[List[SelectedPriceQuantity]]
  ] = Field(
    default=None,
    description=
      ...
      for _item_fallback_cascade_selected_product_price_quantity in self.fallback_cascade_selected_product_price_quantity:
        if _item_fallback_cascade_selected_product_price_quantity:
          _items.append(
            [
              _inner_item.to_dict()
              for _inner_item in _item_fallback_cascade_selected_product_price_quantity
    ...
    _obj = cls.model_validate(
      {
        'fallback_cascade_preferences':
          [
            ...
            for _item in obj['fallback_cascade_preferences']
        ...
        'processor_preferences':
          CheckoutProcessorsPreferences.from_dict(obj['processor_preferences'])
