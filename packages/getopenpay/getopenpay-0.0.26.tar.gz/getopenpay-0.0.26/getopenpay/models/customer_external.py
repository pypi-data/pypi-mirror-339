...
class CustomerExternal(BaseModel):
  ...
  balance_atoms: Optional[List[CustomerBalanceExternal]] = Field(
    default=None,
    description=
  ...
  mrr: Optional[List[CustomerTotalAmount]] = Field(
    default=None,
    description='The monthly recurring revenue of the customer broken down by currency.'
  )
  notes: Optional[StrictStr]
  object: Optional[ObjectName] = None
  phone_number: Optional[StrictStr] = None
  shipping_addresses: Optional[List[CompleteAddress]] = Field(
    default=None, description="List of customer's shipping addresses."
  )
  should_send_payment_receipt: StrictBool = Field(
    description='Whether email should be sent or not on payment.'
  )
  status: Optional[CustomerStatus] = None
  subscribed_to_products: Optional[List[ProductExternal]] = Field(
    default=None, description='List of products that the customer is subscribed to.'
  )
  subscriptions: Optional[List[SubscriptionExternal]] = Field(
    default=None, description="List of customer's subscriptions."
  )
  total_refunds: Optional[List[CustomerTotalAmount]] = Field(
    default=None, description='The total amount refunded to the customer.'
  )
  total_spent: Optional[List[CustomerTotalAmount]] = Field(
    default=None, description='The total amount spent by the customer.'
  )
    ...
    _obj = cls.model_validate(
      {
        ...
        'address':
          CompleteAddress.from_dict(obj['address']) if obj.get('address') is not None else None,
        'balance_atoms':
          [CustomerBalanceExternal.from_dict(_item) for _item in obj['balance_atoms']]
        ...
        'discount':
          DiscountExternal.from_dict(obj['discount']) if obj.get('discount') is not None else None,
        'email': obj.get('email'),
        'first_name': obj.get('first_name'),
        'id': obj.get('id'),
        'invoice_settings':
          CustomerInvoiceSettings.from_dict(obj['invoice_settings'])
        ...
        'last_successful_payment_intent':
          PaymentIntentExternal.from_dict(obj['last_successful_payment_intent'])
          if obj.get('last_successful_payment_intent') is not None else None,
        'metadata': obj.get('metadata'),
        'mrr':
          [CustomerTotalAmount.from_dict(_item) for _item in obj['mrr']]
          if obj.get('mrr') is not None else None,
        'notes': obj.get('notes'),
        'object': obj.get('object'),
        'phone_number': obj.get('phone_number'),
        'shipping_addresses':
          [CompleteAddress.from_dict(_item) for _item in obj['shipping_addresses']]
        ...
        'subscribed_to_products':
          [ProductExternal.from_dict(_item) for _item in obj['subscribed_to_products']]
          if obj.get('subscribed_to_products') is not None else None,
        'subscriptions':
          [SubscriptionExternal.from_dict(_item) for _item in obj['subscriptions']]
          if obj.get('subscriptions') is not None else None,
        'total_refunds':
          [CustomerTotalAmount.from_dict(_item) for _item in obj['total_refunds']]
          if obj.get('total_refunds') is not None else None,
        'total_spent':
          [CustomerTotalAmount.from_dict(_item) for _item in obj['total_spent']]
