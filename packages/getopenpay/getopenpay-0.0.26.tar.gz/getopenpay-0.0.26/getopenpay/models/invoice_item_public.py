...
class InvoiceItemPublic(BaseModel):
  ...
  discount_amount_atoms: List[InvoiceItemDiscountAmountsPublic] = Field(
    description='The amount_atom of all discount.'
  )
  discounts: List[StrictStr] = Field(
    description='The discounts only directly applied to the InvoiceItem.'
  )
  ...
  price_tiers: Optional[List[PriceTierPublic]] = Field(
    default=None, description='The price tiers of the product, if applicable.'
  )
    ...
    _obj = cls.model_validate(
      {
        ...
        'discount_amount_atoms':
          [
            ...
            for _item in obj['discount_amount_atoms']
        ...
        'price_tiers':
          [PriceTierPublic.from_dict(_item) for _item in obj['price_tiers']]
