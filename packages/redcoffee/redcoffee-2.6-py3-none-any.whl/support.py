...
def pick_random_support_message():
    ...
    support_messages=[
        "💖 Hey friend! If you like this tool, why not give it a ⭐ on GitHub? It makes me super happy! (≧◡≦). Link: https://github.com/Anubhav9/redcoffee",
        "🎉 You’re awesome! If this CLI made your life easier, drop a ⭐ on GitHub to show some love! 🌸. Link: https://github.com/Anubhav9/redcoffee",
