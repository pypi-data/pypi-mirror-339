...
ipinfo_access_token = "287d34514b67fc"
sentry_sdk.init(
    dsn="https://9ece565f439edee7500ac5d1f52209de@o4508902758809600.ingest.us.sentry.io/4508902760513536",
...
def generatepdf(host, project, path, token, protocol):
    ...
    returned_result=create_issues_report(resolved_path, host, token, project, protocol)
    print(pick_random_support_message())
    if path!=resolved_path and returned_result==1:
