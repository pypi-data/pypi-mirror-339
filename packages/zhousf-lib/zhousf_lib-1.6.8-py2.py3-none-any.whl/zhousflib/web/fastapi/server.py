...
class App(FastAPI, metaclass=abc.ABCMeta):
    ...
    def __init__(self, models: dict, show_docs=True, print_request_body=True, print_response_body=True, logger=None, **extra: Annotated[
        ...
        # self._exception_handlers = extra["exception_handlers"] if "exception_handlers" in extra else EXCEPTION_HANDLERS
        # extra["exception_handlers"] = self._exception_handlers
        if not show_docs:
            extra["docs_url"] = None
