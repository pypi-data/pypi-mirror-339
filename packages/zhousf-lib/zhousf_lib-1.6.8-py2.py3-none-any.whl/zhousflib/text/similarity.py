...
if __name__ == "__main__":
    ...
    documents = ["本项目位于河北省邯郸市河北峰煤焦化公司厂区内本阶段暂利用气象专业软件获取项目所在地太阳辐射数据根据查取专业软件项目场址代表年总辐射量为根据太阳能资源评估方法中太阳能资源的分级评估方法该区域的太阳能资源丰富程度属类区即资源丰富年辐射稳定程度为类稳定年平均直射比散射辐射较多能保证项目有较高的发电量和较好的开发前景"
                 ,"根据查取专业软件项目场址代表年总辐射量为根据太阳能资源评估方法中太阳能资源的分级评估方法该区域的太阳能资源丰富程度属类区即资源丰富年辐射稳定程度为类稳定年平均直射比散射辐射较多能保证项目有较高的发电量和较好的开发前景"]
