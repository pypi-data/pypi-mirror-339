        ...
        for path in active_paths:
            ...
            for server_name in active_servers[path]:
                ...
                for i, (tool, _) in enumerate(self.result['paths'][path]['servers'][server_name]['tools']):
                    #self.result['paths'][path]['servers'][server_name]['tools'][i] = (tool, 'verified' if tools_verified[i][0] else 'failed')
                    self.result['paths'][path]['servers'][server_name]['tools'][i] = (tool, tools_verified[i][1])
