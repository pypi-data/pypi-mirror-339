...
class MobioAdminSDK(object):
    ...
    @staticmethod
    @sdk_pre_check
    def encrypt_values(merchant_id, module, field, values, group=None):
        from .encrypt_utils import EncryptFieldUtils
        return EncryptFieldUtils.encrypt_field_by_config(merchant_id, module, field, values, group=group)

    @staticmethod
    @sdk_pre_check
    def decrypt_values(merchant_id, module, field, values, group=None):
        from .encrypt_utils import EncryptFieldUtils
        return EncryptFieldUtils.decrypt_field_by_config(merchant_id, module, field, values, group=group)

    @staticmethod
    @sdk_pre_check
    def encrypt_values_by_group(merchant_id, values, group):
        from .encrypt_utils import EncryptFieldUtils
        return EncryptFieldUtils.encrypt_field_by_config_group(merchant_id, values, group=group)

    @staticmethod
    @sdk_pre_check
    def decrypt_values_by_group(merchant_id, values, group):
        from .encrypt_utils import EncryptFieldUtils
        return EncryptFieldUtils.decrypt_field_by_config_group(merchant_id, values, group=group)
    ...
    @staticmethod
    @sdk_pre_check
    def get_group_fields_config_encrypt(merchant_id):
        from .encrypt_utils import EncryptFieldUtils
        return EncryptFieldUtils.get_field_masking_by_type(merchant_id, group_type="group", module=None)

    @staticmethod
    @sdk_pre_check
    def get_single_fields_config_encrypt(merchant_id, module):
        from .encrypt_utils import EncryptFieldUtils
        return EncryptFieldUtils.get_field_masking_by_type(merchant_id, group_type="single", module=module)
