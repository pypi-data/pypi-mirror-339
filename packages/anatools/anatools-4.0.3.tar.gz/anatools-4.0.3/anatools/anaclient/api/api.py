...
class api:
    ...
    from .editor        import createRemoteDevelopment, deleteRemoteDevelopment, listRemoteDevelopment, startRemoteDevelopment, stopRemoteDevelopment, createSSHKey, deleteSSHKey, getSSHKeys
