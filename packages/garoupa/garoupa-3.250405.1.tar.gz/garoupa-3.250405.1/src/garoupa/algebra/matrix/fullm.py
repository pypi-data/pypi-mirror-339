...
#          [0 0 0 1]]
#         """
#         identity = FullM(0, n, mod)
#         self.cells = identity.cells
#         sorted = lambda: (FullM(i, self.n) for i in range(identity.order))
#         super().__init__(identity, sorted, seed)
#         self.n, self.mod = n, mod
#
#     def __iter__(self):
#         while True:
#             yield FullM(self.samplei(), self.n, self.mod)
#
#     def __repr__(self):
#         return f"FullM{self.n}%{self.mod}"
#
#     # @property
