...
class PermissionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "creationTime", "lastModifiedTime"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['BACK_END', 'FRONT_END']):
            raise ValueError("must be one of enum values ('BACK_END', 'FRONT_END')")
        return value
