...
class ResendMfaResponse(BaseModel):
    """
    ResendMfaResponse
    """ # noqa: E501
    mfa_expiration: Optional[datetime] = Field(default=None, alias="mfaExpiration")
    __properties: ClassVar[List[str]] = ["mfaExpiration"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResendMfaResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResendMfaResponse from a dict"""
        if obj is None:
            return None
