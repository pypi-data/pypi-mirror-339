...
class Order(BaseModel):
    ...
    Order
    """ # noqa: E501
    prop: StrictStr = Field(description="The property name for the sort")
    order: Optional[StrictStr] = Field(default=None, description="The direction of sort. Default DESC")
    __properties: ClassVar[List[str]] = ["prop", "order"]
