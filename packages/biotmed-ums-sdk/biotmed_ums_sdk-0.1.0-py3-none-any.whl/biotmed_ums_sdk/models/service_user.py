...
class ServiceUser(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["permissions", "serviceUserId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServiceUser from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServiceUser from a dict"""
        if obj is None:
            return None
