...
class CreateRoleAdminRequest(BaseModel):
    """
    ...
    permission_ids: Optional[List[StrictStr]] = Field(default=None, alias="permissionIds")
    __properties: ClassVar[List[str]] = ["name", "description", "permissionIds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateRoleAdminRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateRoleAdminRequest from a dict"""
        if obj is None:
            return None
