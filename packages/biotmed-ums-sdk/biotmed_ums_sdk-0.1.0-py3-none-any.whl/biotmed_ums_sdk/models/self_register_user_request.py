...
class SelfRegisterUserRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["username", "password", "credentialType", "idPs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SelfRegisterUserRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SelfRegisterUserRequest from a dict"""
        if obj is None:
            return None
