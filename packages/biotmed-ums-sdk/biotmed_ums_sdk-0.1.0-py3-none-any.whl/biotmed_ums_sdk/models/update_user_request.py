...
class UpdateUserRequest(BaseModel):
    ...
    UpdateUserRequest
    """ # noqa: E501
    username: Optional[StrictStr] = Field(default=None, description="user's username. If the credential type is OTP, should be a valid phone (An E.164 formatted phone number e.g +12345678901)")
    ...
    __properties: ClassVar[List[str]] = ["username", "locked", "active", "groupIds", "idPs", "mfa"]
