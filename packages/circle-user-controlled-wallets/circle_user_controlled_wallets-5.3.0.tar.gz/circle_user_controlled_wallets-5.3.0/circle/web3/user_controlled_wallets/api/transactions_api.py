...
class TransactionsApi(object):
    ...
    @auto_fill
    @validate_arguments
    def create_user_transaction_wallet_upgrade_challenge(self, x_user_token : Annotated[StrictStr, Field(..., description="Unique system generated JWT session token for specific user.")], create_wallet_upgrade_transaction_for_end_user_request : Annotated[CreateWalletUpgradeTransactionForEndUserRequest, Field(..., description="Creates a transaction for an end-user request.")], **kwargs) -> CreateWalletUpgradeTransactionForEndUserResponse:  # noqa: E501
        """Create a challenge for a wallet upgrade  # noqa: E501

        Generates a challenge for creating a transaction which upgrades a wallet.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_user_transaction_wallet_upgrade_challenge(x_user_token, create_wallet_upgrade_transaction_for_end_user_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_user_transaction_wallet_upgrade_challenge_with_http_info(x_user_token, create_wallet_upgrade_transaction_for_end_user_request, **kwargs)  # noqa: E501

    @auto_fill
    @validate_arguments
    def create_user_transaction_wallet_upgrade_challenge_with_http_info(self, x_user_token : Annotated[StrictStr, Field(..., description="Unique system generated JWT session token for specific user.")], create_wallet_upgrade_transaction_for_end_user_request : Annotated[CreateWalletUpgradeTransactionForEndUserRequest, Field(..., description="Creates a transaction for an end-user request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create a challenge for a wallet upgrade  # noqa: E501
        ...
        >>> thread = api.create_user_transaction_wallet_upgrade_challenge_with_http_info(x_user_token, create_wallet_upgrade_transaction_for_end_user_request, async_req=True)
        >>> result = thread.get()
