# -*- coding: utf-8 -*-
#
# binarymap documentation build configuration file.
#
...
versionfile = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "../binarymap/__init__.py")
)
...
html_theme_options = {
    "logo": "BloomLogo.jpg",
    "logo_name": "true",
    "description": "Binary representation of protein/nucleotide sequences",
    "github_button": "true",
    "github_user": "jbloomlab",
    "github_repo": "binarymap",
    "github_banner": "true",
    "travis_button": "false",
    "sidebar_width": "250px",
}
...
htmlhelp_basename = "binarymapdoc"
...
man_pages = [(master_doc, "binarymap", "binarymap Documentation", [author], 1)]
