...
class GetNode:
    ...
    def __enter__(self):
        ...
        self.x_node_center = int(found_node.position[0] + found_node.size[0] / 2 + self.offset_x)
        self.y_node_center = int(found_node.position[1] + found_node.size[1] / 2 + self.offset_y)
