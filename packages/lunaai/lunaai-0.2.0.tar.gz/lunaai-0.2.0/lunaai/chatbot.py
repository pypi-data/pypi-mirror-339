...
class LunaAI:
    ...
    def __init__(self, 
                 api: str = "19LwStOlNn7hk58H7HwLUbQZwVWFCnZld+LUNA-17K+1Zxnk-uXHAYhNcQBVGs4Q9AWnzEDt1umD", 
                 accuracy: float = 0.6, 
        ...
        Parameters:
        - api: str -> For more details, contact to (+91 8972260999), defauls to LUNA-17K
    ...
    def _load_data(self):
        ...
        try:
            ...
            self._display_slowly("Invalid API key! Contact to (+91 8972260999)")
            return
...
def chat(api_key: str = "19LwStOlNn7hk58H7HwLUbQZwVWFCnZld+LUNA-17K+1Zxnk-uXHAYhNcQBVGs4Q9AWnzEDt1umD"):
