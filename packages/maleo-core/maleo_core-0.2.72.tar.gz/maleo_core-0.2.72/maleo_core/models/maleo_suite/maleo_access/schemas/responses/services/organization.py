...
from pydantic import field_serializer, FieldSerializationInfo
...
class MaleoAccessOrganizationServiceResponsesSchemas:
    ...
    class GetMultipleChildrenResponse(BaseServiceResponsesSchemas.MultipleChildrenData):
    ...
    class GetSingleChildResponse(BaseGeneralResponsesSchemas.SingleChildData):
