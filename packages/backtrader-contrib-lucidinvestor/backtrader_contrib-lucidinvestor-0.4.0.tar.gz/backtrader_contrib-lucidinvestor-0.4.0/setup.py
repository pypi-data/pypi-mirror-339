...
def read_requirements():
    """Load requirements from requirements.txt, keeping only explicitly versioned packages and appending 'backtrader-lucidinvestor'."""
    with open("requirements.txt", "r") as f:
        requirements = [line.strip() for line in f.readlines() if "==" in line and not line.startswith("#")]

    # Ensure 'backtrader-lucidinvestor' is included
    requirements.append("backtrader-lucidinvestor")
