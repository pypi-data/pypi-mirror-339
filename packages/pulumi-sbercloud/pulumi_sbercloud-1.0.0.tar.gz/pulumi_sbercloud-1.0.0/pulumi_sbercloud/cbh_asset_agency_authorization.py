...
class CbhAssetAgencyAuthorizationArgs:
    def __init__(__self__, *,
                 csms: pulumi.Input[builtins.bool],
                 kms: pulumi.Input[builtins.bool],
    ...
    @property
    @pulumi.getter
    def csms(self) -> pulumi.Input[builtins.bool]:
        return pulumi.get(self, "csms")

    @csms.setter
    def csms(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "csms", value)

    @property
    @pulumi.getter
    def kms(self) -> pulumi.Input[builtins.bool]:
        return pulumi.get(self, "kms")

    @kms.setter
    def kms(self, value: pulumi.Input[builtins.bool]):
...
class _CbhAssetAgencyAuthorizationState:
    def __init__(__self__, *,
                 csms: Optional[pulumi.Input[builtins.bool]] = None,
                 kms: Optional[pulumi.Input[builtins.bool]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter
    def csms(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "csms")

    @csms.setter
    def csms(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "csms", value)

    @property
    @pulumi.getter
    def kms(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "kms")

    @kms.setter
    def kms(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "kms", value)
...
class CbhAssetAgencyAuthorization(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            csms: Optional[pulumi.Input[builtins.bool]] = None,
            kms: Optional[pulumi.Input[builtins.bool]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'CbhAssetAgencyAuthorization':
        """
    ...
    @property
    @pulumi.getter
    def csms(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "csms")

    @property
    @pulumi.getter
    def kms(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "kms")
