...
__all__ = ['IdentityGroupMembershipArgs', 'IdentityGroupMembership']

@pulumi.input_type
class IdentityGroupMembershipArgs:
...
@pulumi.input_type
class _IdentityGroupMembershipState:
    def __init__(__self__, *,
...
class IdentityGroupMembership(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a IdentityGroupMembership resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: IdentityGroupMembershipArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a IdentityGroupMembership resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param IdentityGroupMembershipArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IdentityGroupMembershipArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = IdentityGroupMembershipArgs.__new__(IdentityGroupMembershipArgs)
        ...
        super(IdentityGroupMembership, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            group: Optional[pulumi.Input[builtins.str]] = None,
            users: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'IdentityGroupMembership':
        """
        ...
        __props__ = _IdentityGroupMembershipState.__new__(_IdentityGroupMembershipState)

        __props__.__dict__["group"] = group
        __props__.__dict__["users"] = users
        return IdentityGroupMembership(resource_name, opts=opts, __props__=__props__)
