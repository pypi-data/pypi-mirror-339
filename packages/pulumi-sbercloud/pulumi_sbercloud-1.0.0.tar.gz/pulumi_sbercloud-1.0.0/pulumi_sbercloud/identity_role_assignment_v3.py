...
__all__ = ['IdentityRoleAssignmentV3Args', 'IdentityRoleAssignmentV3']

@pulumi.input_type
class IdentityRoleAssignmentV3Args:
...
@pulumi.input_type
class _IdentityRoleAssignmentV3State:
    def __init__(__self__, *,
                 domain_id: Optional[pulumi.Input[builtins.str]] = None,
                 enterprise_project_id: Optional[pulumi.Input[builtins.str]] = None,
...
class IdentityRoleAssignmentV3(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a IdentityRoleAssignmentV3 resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a IdentityRoleAssignmentV3 resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param IdentityRoleAssignmentV3Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IdentityRoleAssignmentV3Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = IdentityRoleAssignmentV3Args.__new__(IdentityRoleAssignmentV3Args)
    ...
    def get(resource_name: str,
            ...
            group_id: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            role_id: Optional[pulumi.Input[builtins.str]] = None) -> 'IdentityRoleAssignmentV3':
        """
        ...
        __props__ = _IdentityRoleAssignmentV3State.__new__(_IdentityRoleAssignmentV3State)
        ...
        __props__.__dict__["project_id"] = project_id
        __props__.__dict__["role_id"] = role_id
        return IdentityRoleAssignmentV3(resource_name, opts=opts, __props__=__props__)
