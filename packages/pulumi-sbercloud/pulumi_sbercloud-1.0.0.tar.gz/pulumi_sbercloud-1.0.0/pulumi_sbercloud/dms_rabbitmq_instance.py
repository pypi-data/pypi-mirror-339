...
__all__ = ['DmsRabbitmqInstanceArgs', 'DmsRabbitmqInstance']

@pulumi.input_type
class DmsRabbitmqInstanceArgs:
    def __init__(__self__, *,
                 ...
                 enable_acl: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def enable_acl(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "enable_acl")

    @enable_acl.setter
    def enable_acl(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.input_type
class _DmsRabbitmqInstanceState:
    def __init__(__self__, *,
                 access_user: Optional[pulumi.Input[builtins.str]] = None,
                 auto_renew: Optional[pulumi.Input[builtins.str]] = None,
                 availability_zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
...
class DmsRabbitmqInstance(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a DmsRabbitmqInstance resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DmsRabbitmqInstanceArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a DmsRabbitmqInstance resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param DmsRabbitmqInstanceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DmsRabbitmqInstanceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DmsRabbitmqInstanceArgs.__new__(DmsRabbitmqInstanceArgs)
        ...
        super(DmsRabbitmqInstance, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            user_id: Optional[pulumi.Input[builtins.str]] = None,
            user_name: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DmsRabbitmqInstance':
        """
        ...
        __props__ = _DmsRabbitmqInstanceState.__new__(_DmsRabbitmqInstanceState)
        ...
        __props__.__dict__["vpc_id"] = vpc_id
        return DmsRabbitmqInstance(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="enableAcl")
    def enable_acl(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "enable_acl")
    ...
    @property
    @pulumi.getter(name="sslEnable")
    def ssl_enable(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "ssl_enable")
