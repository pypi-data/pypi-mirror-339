...
__all__ = ['ApigGroupArgs', 'ApigGroup']
...
class ApigGroupArgs:
    def __init__(__self__, *,
                 ...
                 environments: Optional[pulumi.Input[Sequence[pulumi.Input['ApigGroupEnvironmentArgs']]]] = None,
                 force_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 url_domains: Optional[pulumi.Input[Sequence[pulumi.Input['ApigGroupUrlDomainArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ApigGroupEnvironmentArgs']]] environments: The array of one or more environments of the associated group.
    ...
    @property
    @pulumi.getter
    def environments(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ApigGroupEnvironmentArgs']]]]:
        """
    ...
    @environments.setter
    def environments(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ApigGroupEnvironmentArgs']]]]):
    ...
    @url_domains.setter
    def url_domains(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ApigGroupUrlDomainArgs']]]]):
        pulumi.set(self, "url_domains", value)


@pulumi.input_type
class _ApigGroupState:
    def __init__(__self__, *,
...
class ApigGroup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 domain_access_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 environments: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ApigGroupEnvironmentArgs', 'ApigGroupEnvironmentArgsDict']]]]] = None,
                 force_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 url_domains: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ApigGroupUrlDomainArgs', 'ApigGroupUrlDomainArgsDict']]]]] = None,
                 __props__=None):
        """
        Create a ApigGroup resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[builtins.str] description: The group description.
        :param pulumi.Input[builtins.bool] domain_access_enabled: Specifies whether to use the debugging domain name to access the APIs within the group.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ApigGroupEnvironmentArgs', 'ApigGroupEnvironmentArgsDict']]]] environments: The array of one or more environments of the associated group.
        :param pulumi.Input[builtins.bool] force_destroy: Whether to delete all sub-resources (for API) from this group.
        :param pulumi.Input[builtins.str] instance_id: The ID of the dedicated instance to which the group belongs.
        :param pulumi.Input[builtins.str] name: The group name.
        :param pulumi.Input[builtins.str] region: The region where the dedicated instance is located.
    ...
    def __init__(__self__,
        ...
        Create a ApigGroup resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param ApigGroupArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ApigGroupArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ApigGroupArgs.__new__(ApigGroupArgs)
        ...
        super(ApigGroup, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            update_time: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            url_domains: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ApigGroupUrlDomainArgs', 'ApigGroupUrlDomainArgsDict']]]]] = None) -> 'ApigGroup':
        """
        ...
        __props__ = _ApigGroupState.__new__(_ApigGroupState)
        ...
        __props__.__dict__["url_domains"] = url_domains
        return ApigGroup(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def environments(self) -> pulumi.Output[Sequence['outputs.ApigGroupEnvironment']]:
        """
        The array of one or more environments of the associated group.
        """
        return pulumi.get(self, "environments")
