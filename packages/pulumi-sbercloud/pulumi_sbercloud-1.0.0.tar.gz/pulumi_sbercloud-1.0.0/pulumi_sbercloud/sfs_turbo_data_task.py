...
class SfsTurboDataTaskArgs:
    def __init__(__self__, *,
                 dest_target: pulumi.Input[builtins.str],
                 share_id: pulumi.Input[builtins.str],
                 src_target: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.str],
                 dest_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 src_prefix: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def dest_target(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "dest_target")

    @dest_target.setter
    def dest_target(self, value: pulumi.Input[builtins.str]):
    ...
    def src_target(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "src_target")

    @src_target.setter
    def src_target(self, value: pulumi.Input[builtins.str]):
    ...
    def dest_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "dest_prefix")

    @dest_prefix.setter
    def dest_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def src_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "src_prefix")

    @src_prefix.setter
    def src_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SfsTurboDataTaskState:
    ...
    @property
    @pulumi.getter(name="destTarget")
    def dest_target(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "dest_target")

    @dest_target.setter
    def dest_target(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dest_target", value)
    ...
    @property
    @pulumi.getter(name="srcTarget")
    def src_target(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "src_target")

    @src_target.setter
    def src_target(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "src_target", value)
...
class SfsTurboDataTask(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            start_time: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'SfsTurboDataTask':
        """
    ...
    @property
    @pulumi.getter(name="destPrefix")
    def dest_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "dest_prefix")

    @property
    @pulumi.getter(name="destTarget")
    def dest_target(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "dest_target")
    ...
    @property
    @pulumi.getter(name="srcPrefix")
    def src_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "src_prefix")

    @property
    @pulumi.getter(name="srcTarget")
    def src_target(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "src_target")
