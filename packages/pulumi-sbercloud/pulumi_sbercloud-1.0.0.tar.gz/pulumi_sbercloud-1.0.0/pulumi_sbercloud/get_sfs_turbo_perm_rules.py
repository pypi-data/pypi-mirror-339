...
def get_sfs_turbo_perm_rules(region: Optional[builtins.str] = None,
...
def get_sfs_turbo_perm_rules_output(region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
