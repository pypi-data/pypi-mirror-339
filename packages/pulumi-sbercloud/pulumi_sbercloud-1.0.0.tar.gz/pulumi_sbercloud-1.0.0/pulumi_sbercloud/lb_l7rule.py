...
class LbL7rule(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a LbL7rule resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a LbL7rule resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param LbL7ruleArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LbL7ruleArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LbL7ruleArgs.__new__(LbL7ruleArgs)
        ...
        super(LbL7rule, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'LbL7rule':
        """
        ...
        __props__ = _LbL7ruleState.__new__(_LbL7ruleState)
        ...
        __props__.__dict__["type"] = type
        __props__.__dict__["value"] = value
        return LbL7rule(resource_name, opts=opts, __props__=__props__)
