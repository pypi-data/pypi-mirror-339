...
__all__ = [
    'GetSfsFileSystemResult',
    'AwaitableGetSfsFileSystemResult',
    'get_sfs_file_system',
    'get_sfs_file_system_output',
]

@pulumi.output_type
class GetSfsFileSystemResult:
    """
...
class AwaitableGetSfsFileSystemResult(GetSfsFileSystemResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSfsFileSystemResult(
...
def get_sfs_file_system(id: Optional[builtins.str] = None,
                        name: Optional[builtins.str] = None,
                        region: Optional[builtins.str] = None,
                        status: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSfsFileSystemResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sbercloud:index/getSfsFileSystem:getSfsFileSystem', __args__, opts=opts, typ=GetSfsFileSystemResult).value

    return AwaitableGetSfsFileSystemResult(
...
def get_sfs_file_system_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSfsFileSystemResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('sbercloud:index/getSfsFileSystem:getSfsFileSystem', __args__, opts=opts, typ=GetSfsFileSystemResult)
    return __ret__.apply(lambda __response__: GetSfsFileSystemResult(
