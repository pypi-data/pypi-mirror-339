...
class SfsTurboArgs:
    def __init__(__self__, *,
                 ...
                 crypt_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 dedicated_flavor: Optional[pulumi.Input[builtins.str]] = None,
                 dedicated_storage_id: Optional[pulumi.Input[builtins.str]] = None,
                 enhanced: Optional[pulumi.Input[builtins.bool]] = None,
                 enterprise_project_id: Optional[pulumi.Input[builtins.str]] = None,
                 hpc_bandwidth: Optional[pulumi.Input[builtins.str]] = None,
                 hpc_cache_bandwidth: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def crypt_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "crypt_key_id")

    @crypt_key_id.setter
    def crypt_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "crypt_key_id", value)

    @property
    @pulumi.getter(name="dedicatedFlavor")
    def dedicated_flavor(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "dedicated_flavor")

    @dedicated_flavor.setter
    def dedicated_flavor(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def enhanced(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "enhanced")

    @enhanced.setter
    def enhanced(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def hpc_bandwidth(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "hpc_bandwidth")

    @hpc_bandwidth.setter
    def hpc_bandwidth(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "hpc_bandwidth", value)

    @property
    @pulumi.getter(name="hpcCacheBandwidth")
    def hpc_cache_bandwidth(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "hpc_cache_bandwidth")

    @hpc_cache_bandwidth.setter
    def hpc_cache_bandwidth(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SfsTurbo(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a SfsTurbo resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a SfsTurbo resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param SfsTurboArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SfsTurboArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SfsTurboArgs.__new__(SfsTurboArgs)
        ...
        super(SfsTurbo, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SfsTurbo':
        """
        ...
        __props__ = _SfsTurboState.__new__(_SfsTurboState)
        ...
        __props__.__dict__["vpc_id"] = vpc_id
        return SfsTurbo(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="cryptKeyId")
    def crypt_key_id(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "crypt_key_id")

    @property
    @pulumi.getter(name="dedicatedFlavor")
    def dedicated_flavor(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "dedicated_flavor")
    ...
    @property
    @pulumi.getter
    def enhanced(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "enhanced")
    ...
    @property
    @pulumi.getter(name="hpcBandwidth")
    def hpc_bandwidth(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "hpc_bandwidth")

    @property
    @pulumi.getter(name="hpcCacheBandwidth")
    def hpc_cache_bandwidth(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "hpc_cache_bandwidth")
    ...
    @property
    @pulumi.getter(name="shareType")
    def share_type(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "share_type")
