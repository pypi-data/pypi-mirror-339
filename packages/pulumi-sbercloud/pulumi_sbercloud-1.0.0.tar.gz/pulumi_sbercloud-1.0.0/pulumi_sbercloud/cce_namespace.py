...
__all__ = ['CceNamespaceArgs', 'CceNamespace']

@pulumi.input_type
class CceNamespaceArgs:
...
class CceNamespace(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a CceNamespace resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a CceNamespace resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param CceNamespaceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CceNamespaceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CceNamespaceArgs.__new__(CceNamespaceArgs)
        ...
        super(CceNamespace, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            prefix: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'CceNamespace':
        """
        ...
        __props__ = _CceNamespaceState.__new__(_CceNamespaceState)
        ...
        return CceNamespace(resource_name, opts=opts, __props__=__props__)
