...
__all__ = ['LbMonitorArgs', 'LbMonitor']
...
class LbMonitor(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a LbMonitor resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a LbMonitor resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param LbMonitorArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LbMonitorArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LbMonitorArgs.__new__(LbMonitorArgs)
        ...
        super(LbMonitor, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            timeout: Optional[pulumi.Input[builtins.int]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            url_path: Optional[pulumi.Input[builtins.str]] = None) -> 'LbMonitor':
        """
        ...
        __props__ = _LbMonitorState.__new__(_LbMonitorState)
        ...
        __props__.__dict__["type"] = type
        __props__.__dict__["url_path"] = url_path
        return LbMonitor(resource_name, opts=opts, __props__=__props__)
