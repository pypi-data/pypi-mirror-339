...
class GetDcsAccountsResult:
    ...
    def account_role(self) -> Optional[builtins.str]:
...
def get_dcs_accounts(account_name: Optional[builtins.str] = None,
                     account_role: Optional[builtins.str] = None,
...
def get_dcs_accounts_output(account_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            account_role: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            account_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
