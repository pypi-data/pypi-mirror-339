...
def get_apig_api_associated_plugins(api_id: Optional[builtins.str] = None,
...
def get_apig_api_associated_plugins_output(api_id: Optional[pulumi.Input[builtins.str]] = None,
