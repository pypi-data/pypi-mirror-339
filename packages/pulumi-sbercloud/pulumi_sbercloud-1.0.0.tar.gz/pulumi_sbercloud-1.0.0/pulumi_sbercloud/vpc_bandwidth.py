...
__all__ = ['VpcBandwidthArgs', 'VpcBandwidth']

@pulumi.input_type
class VpcBandwidthArgs:
...
class _VpcBandwidthState:
    def __init__(__self__, *,
                 ...
                 period_unit: Optional[pulumi.Input[builtins.str]] = None,
                 public_border_group: Optional[pulumi.Input[builtins.str]] = None,
                 publicips: Optional[pulumi.Input[Sequence[pulumi.Input['VpcBandwidthPublicipArgs']]]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def publicips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['VpcBandwidthPublicipArgs']]]]:
        return pulumi.get(self, "publicips")

    @publicips.setter
    def publicips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['VpcBandwidthPublicipArgs']]]]):
...
class VpcBandwidth(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a VpcBandwidth resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: VpcBandwidthArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a VpcBandwidth resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param VpcBandwidthArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(VpcBandwidthArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = VpcBandwidthArgs.__new__(VpcBandwidthArgs)
        ...
        super(VpcBandwidth, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            period_unit: Optional[pulumi.Input[builtins.str]] = None,
            public_border_group: Optional[pulumi.Input[builtins.str]] = None,
            publicips: Optional[pulumi.Input[Sequence[pulumi.Input[Union['VpcBandwidthPublicipArgs', 'VpcBandwidthPublicipArgsDict']]]]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            share_type: Optional[pulumi.Input[builtins.str]] = None,
            size: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'VpcBandwidth':
        """
        ...
        __props__ = _VpcBandwidthState.__new__(_VpcBandwidthState)
        ...
        return VpcBandwidth(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="bandwidthType")
    def bandwidth_type(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "bandwidth_type")
    ...
    @property
    @pulumi.getter
    def publicips(self) -> pulumi.Output[Sequence['outputs.VpcBandwidthPublicip']]:
        return pulumi.get(self, "publicips")
