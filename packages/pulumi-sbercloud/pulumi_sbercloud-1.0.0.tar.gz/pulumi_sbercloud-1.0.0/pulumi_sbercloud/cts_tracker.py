...
__all__ = ['CtsTrackerArgs', 'CtsTracker']

@pulumi.input_type
class CtsTrackerArgs:
    def __init__(__self__, *,
                 bucket_name: Optional[pulumi.Input[builtins.str]] = None,
                 compress_type: Optional[pulumi.Input[builtins.str]] = None,
                 delete_tracker: Optional[pulumi.Input[builtins.bool]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 exclude_services: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    def delete_tracker(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "delete_tracker")

    @delete_tracker.setter
    def delete_tracker(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def exclude_services(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "exclude_services")

    @exclude_services.setter
    def exclude_services(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class CtsTracker(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a CtsTracker resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[CtsTrackerArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a CtsTracker resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param CtsTrackerArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CtsTrackerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CtsTrackerArgs.__new__(CtsTrackerArgs)
        ...
        super(CtsTracker, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            transfer_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            validate_file: Optional[pulumi.Input[builtins.bool]] = None) -> 'CtsTracker':
        """
        ...
        __props__ = _CtsTrackerState.__new__(_CtsTrackerState)
        ...
        __props__.__dict__["validate_file"] = validate_file
        return CtsTracker(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="deleteTracker")
    def delete_tracker(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "delete_tracker")
    ...
    @property
    @pulumi.getter(name="excludeServices")
    def exclude_services(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "exclude_services")
    ...
    @property
    @pulumi.getter(name="organizationEnabled")
    def organization_enabled(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "organization_enabled")
