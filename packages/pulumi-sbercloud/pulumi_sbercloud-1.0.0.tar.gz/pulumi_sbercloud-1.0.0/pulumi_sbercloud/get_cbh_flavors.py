...
class GetCbhFlavorsResult:
    ...
    def max_connection(self) -> Optional[builtins.int]:
    ...
    def spec_code(self) -> Optional[builtins.str]:
...
def get_cbh_flavors(action: Optional[builtins.str] = None,
                    asset: Optional[builtins.int] = None,
                    flavor_id: Optional[builtins.str] = None,
                    max_connection: Optional[builtins.int] = None,
                    memory: Optional[builtins.int] = None,
                    region: Optional[builtins.str] = None,
                    spec_code: Optional[builtins.str] = None,
...
def get_cbh_flavors_output(action: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           asset: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                           flavor_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           max_connection: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                           memory: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                           region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           spec_code: Optional[pulumi.Input[Optional[builtins.str]]] = None,
