...
class NetworkingEipAssociateArgs:
    def __init__(__self__, *,
                 public_ip: pulumi.Input[builtins.str],
    ...
    def public_ip(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "public_ip")

    @public_ip.setter
    def public_ip(self, value: pulumi.Input[builtins.str]):
...
class NetworkingEipAssociate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            public_ipv6: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkingEipAssociate':
        """
    ...
    @property
    @pulumi.getter(name="publicIpv6")
    def public_ipv6(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "public_ipv6")
