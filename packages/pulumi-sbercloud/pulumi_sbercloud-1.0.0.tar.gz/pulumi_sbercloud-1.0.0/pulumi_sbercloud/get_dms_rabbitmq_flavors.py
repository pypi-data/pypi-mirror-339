...
def get_dms_rabbitmq_flavors(arch_type: Optional[builtins.str] = None,
...
def get_dms_rabbitmq_flavors_output(arch_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
