...
__all__ = [
    'GetCceNodeResult',
    'AwaitableGetCceNodeResult',
    'get_cce_node',
    'get_cce_node_output',
]

@pulumi.output_type
class GetCceNodeResult:
    """
    ...
    def data_volumes(self) -> Sequence['outputs.GetCceNodeDataVolumeResult']:
    ...
    def hostname_configs(self) -> Sequence['outputs.GetCceNodeHostnameConfigResult']:
    ...
    def root_volumes(self) -> Sequence['outputs.GetCceNodeRootVolumeResult']:
...
class AwaitableGetCceNodeResult(GetCceNodeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCceNodeResult(
...
def get_cce_node(cluster_id: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 node_id: Optional[builtins.str] = None,
                 region: Optional[builtins.str] = None,
                 status: Optional[builtins.str] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCceNodeResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sbercloud:index/getCceNode:getCceNode', __args__, opts=opts, typ=GetCceNodeResult).value

    return AwaitableGetCceNodeResult(
...
def get_cce_node_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                        ...
                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCceNodeResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('sbercloud:index/getCceNode:getCceNode', __args__, opts=opts, typ=GetCceNodeResult)
    return __ret__.apply(lambda __response__: GetCceNodeResult(
