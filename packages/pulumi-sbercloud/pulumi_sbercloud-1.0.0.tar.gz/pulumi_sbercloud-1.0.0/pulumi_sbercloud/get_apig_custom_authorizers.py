...
def get_apig_custom_authorizers(authorizer_id: Optional[builtins.str] = None,
...
def get_apig_custom_authorizers_output(authorizer_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
