...
__all__ = [
    'GetComputeInstancesResult',
    'AwaitableGetComputeInstancesResult',
    'get_compute_instances',
    'get_compute_instances_output',
]

@pulumi.output_type
class GetComputeInstancesResult:
    """
    ...
    @property
    @pulumi.getter
    def instances(self) -> Sequence['outputs.GetComputeInstancesInstanceResult']:
...
class AwaitableGetComputeInstancesResult(GetComputeInstancesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetComputeInstancesResult(
...
def get_compute_instances(availability_zone: Optional[builtins.str] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetComputeInstancesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sbercloud:index/getComputeInstances:getComputeInstances', __args__, opts=opts, typ=GetComputeInstancesResult).value

    return AwaitableGetComputeInstancesResult(
...
def get_compute_instances_output(availability_zone: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 ...
                                 flavor_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 image_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 instance_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 key_pair: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 tags: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetComputeInstancesResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('sbercloud:index/getComputeInstances:getComputeInstances', __args__, opts=opts, typ=GetComputeInstancesResult)
    return __ret__.apply(lambda __response__: GetComputeInstancesResult(
