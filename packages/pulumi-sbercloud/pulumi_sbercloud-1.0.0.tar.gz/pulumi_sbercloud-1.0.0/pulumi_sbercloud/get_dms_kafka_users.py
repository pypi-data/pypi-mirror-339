...
def get_dms_kafka_users(description: Optional[builtins.str] = None,
...
def get_dms_kafka_users_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
