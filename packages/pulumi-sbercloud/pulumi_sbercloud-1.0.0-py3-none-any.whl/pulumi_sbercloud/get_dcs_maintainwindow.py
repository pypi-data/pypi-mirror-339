...
__all__ = [
    'GetDcsMaintainwindowResult',
    'AwaitableGetDcsMaintainwindowResult',
    'get_dcs_maintainwindow',
    'get_dcs_maintainwindow_output',
]

@pulumi.output_type
class GetDcsMaintainwindowResult:
    """
...
class AwaitableGetDcsMaintainwindowResult(GetDcsMaintainwindowResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDcsMaintainwindowResult(
            begin=self.begin,
...
def get_dcs_maintainwindow(begin: Optional[builtins.str] = None,
                           default: Optional[builtins.bool] = None,
                           end: Optional[builtins.str] = None,
                           region: Optional[builtins.str] = None,
                           seq: Optional[builtins.int] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDcsMaintainwindowResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sbercloud:index/getDcsMaintainwindow:getDcsMaintainwindow', __args__, opts=opts, typ=GetDcsMaintainwindowResult).value

    return AwaitableGetDcsMaintainwindowResult(
...
def get_dcs_maintainwindow_output(begin: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  ...
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDcsMaintainwindowResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('sbercloud:index/getDcsMaintainwindow:getDcsMaintainwindow', __args__, opts=opts, typ=GetDcsMaintainwindowResult)
    return __ret__.apply(lambda __response__: GetDcsMaintainwindowResult(
