...
def get_vpn_connection_health_checks(connection_id: Optional[builtins.str] = None,
...
def get_vpn_connection_health_checks_output(connection_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                            destination_ip: Optional[pulumi.Input[Optional[builtins.str]]] = None,
