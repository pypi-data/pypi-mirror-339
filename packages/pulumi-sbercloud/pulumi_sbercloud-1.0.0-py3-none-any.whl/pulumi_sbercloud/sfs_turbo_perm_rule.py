...
class SfsTurboPermRuleArgs:
    def __init__(__self__, *,
                 ip_cidr: pulumi.Input[builtins.str],
                 rw_type: pulumi.Input[builtins.str],
    ...
    def ip_cidr(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "ip_cidr")

    @ip_cidr.setter
    def ip_cidr(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ip_cidr", value)

    @property
    @pulumi.getter(name="rwType")
    def rw_type(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "rw_type")

    @rw_type.setter
    def rw_type(self, value: pulumi.Input[builtins.str]):
...
class _SfsTurboPermRuleState:
    def __init__(__self__, *,
                 ip_cidr: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 rw_type: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="ipCidr")
    def ip_cidr(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "ip_cidr")

    @ip_cidr.setter
    def ip_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ip_cidr", value)
    ...
    @property
    @pulumi.getter(name="rwType")
    def rw_type(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "rw_type")

    @rw_type.setter
    def rw_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rw_type", value)
...
class SfsTurboPermRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rw_type: Optional[pulumi.Input[builtins.str]] = None,
            share_id: Optional[pulumi.Input[builtins.str]] = None,
            user_type: Optional[pulumi.Input[builtins.str]] = None) -> 'SfsTurboPermRule':
        """
    ...
    @property
    @pulumi.getter(name="ipCidr")
    def ip_cidr(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "ip_cidr")
    ...
    @property
    @pulumi.getter(name="rwType")
    def rw_type(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "rw_type")
