...
__all__ = [
    'GetNetworkingPortResult',
    'AwaitableGetNetworkingPortResult',
    'get_networking_port',
    'get_networking_port_output',
]

@pulumi.output_type
class GetNetworkingPortResult:
    """
    ...
    def all_allowed_ips(self) -> Sequence[builtins.str]:
...
class AwaitableGetNetworkingPortResult(GetNetworkingPortResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNetworkingPortResult(
...
def get_networking_port(admin_state_up: Optional[builtins.bool] = None,
                        ...
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNetworkingPortResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sbercloud:index/getNetworkingPort:getNetworkingPort', __args__, opts=opts, typ=GetNetworkingPortResult).value

    return AwaitableGetNetworkingPortResult(
...
def get_networking_port_output(admin_state_up: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                               ...
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetNetworkingPortResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('sbercloud:index/getNetworkingPort:getNetworkingPort', __args__, opts=opts, typ=GetNetworkingPortResult)
    return __ret__.apply(lambda __response__: GetNetworkingPortResult(
