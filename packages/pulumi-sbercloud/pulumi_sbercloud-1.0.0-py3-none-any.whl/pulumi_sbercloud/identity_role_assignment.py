...
__all__ = ['IdentityRoleAssignmentArgs', 'IdentityRoleAssignment']

@pulumi.input_type
class IdentityRoleAssignmentArgs:
...
@pulumi.input_type
class _IdentityRoleAssignmentState:
    def __init__(__self__, *,
                 domain_id: Optional[pulumi.Input[builtins.str]] = None,
                 enterprise_project_id: Optional[pulumi.Input[builtins.str]] = None,
...
class IdentityRoleAssignment(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a IdentityRoleAssignment resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: IdentityRoleAssignmentArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a IdentityRoleAssignment resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param IdentityRoleAssignmentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IdentityRoleAssignmentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = IdentityRoleAssignmentArgs.__new__(IdentityRoleAssignmentArgs)
        ...
        super(IdentityRoleAssignment, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            group_id: Optional[pulumi.Input[builtins.str]] = None,
            project_id: Optional[pulumi.Input[builtins.str]] = None,
            role_id: Optional[pulumi.Input[builtins.str]] = None) -> 'IdentityRoleAssignment':
        """
        ...
        __props__ = _IdentityRoleAssignmentState.__new__(_IdentityRoleAssignmentState)
        ...
        __props__.__dict__["project_id"] = project_id
        __props__.__dict__["role_id"] = role_id
        return IdentityRoleAssignment(resource_name, opts=opts, __props__=__props__)
