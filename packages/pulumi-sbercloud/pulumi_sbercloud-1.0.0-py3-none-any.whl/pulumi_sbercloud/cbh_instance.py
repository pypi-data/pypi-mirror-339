...
class CbhInstanceArgs:
    def __init__(__self__, *,
                 ...
                 subnet_address: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a CbhInstance resource.
        :param pulumi.Input[builtins.str] availability_zone: Specifies the availability zone name.
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the CBH instance.
        ...
        :param pulumi.Input[builtins.int] period: Specifies the charging period of the CBH instance.
        :param pulumi.Input[builtins.str] period_unit: Specifies the charging period unit of the instance.
        ...
        :param pulumi.Input[builtins.int] attach_disk_size: Specifies the size of the additional data disk for the CBH instance.
        :param pulumi.Input[builtins.str] auto_renew: Specifies whether auto renew is enabled.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project ID to which the CBH instance belongs.
        :param pulumi.Input[builtins.bool] ipv6_enable: Specifies whether the IPv6 network is enabled.
        :param pulumi.Input[builtins.str] name: Specifies the name of the CBH instance.
        :param pulumi.Input[builtins.str] power_action: Specifies the power action after the CBH instance is created.
        :param pulumi.Input[builtins.str] public_ip: schema: Computed; The elastic IP address.
        :param pulumi.Input[builtins.str] public_ip_id: Specifies the ID of the elastic IP.
        :param pulumi.Input[builtins.str] subnet_address: Specifies the IP address of the subnet.
        """
    ...
    def subnet_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def subnet_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CbhInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_zone: Specifies the availability zone name.
        :param pulumi.Input[builtins.str] charging_mode: Specifies the charging mode of the CBH instance.
        :param pulumi.Input[builtins.float] data_disk_size: Indicates the data disk size of the instance.
        :param pulumi.Input[builtins.str] enterprise_project_id: Specifies the enterprise project ID to which the CBH instance belongs.
        :param pulumi.Input[builtins.str] flavor_id: Specifies the product ID of the CBH server.
        :param pulumi.Input[builtins.bool] ipv6_enable: Specifies whether the IPv6 network is enabled.
        :param pulumi.Input[builtins.str] name: Specifies the name of the CBH instance.
        ...
        :param pulumi.Input[builtins.str] period_unit: Specifies the charging period unit of the instance.
        :param pulumi.Input[builtins.str] power_action: Specifies the power action after the CBH instance is created.
        :param pulumi.Input[builtins.str] private_ip: Indicates the private IP of the instance.
        :param pulumi.Input[builtins.str] public_ip: schema: Computed; The elastic IP address.
        :param pulumi.Input[builtins.str] public_ip_id: Specifies the ID of the elastic IP.
        :param pulumi.Input[builtins.str] security_group_id: Specifies the IDs of the security group.
        :param pulumi.Input[builtins.str] status: Indicates the status of the instance.
        :param pulumi.Input[builtins.str] subnet_address: Specifies the IP address of the subnet.
        :param pulumi.Input[builtins.str] subnet_id: Specifies the ID of a subnet.
        :param pulumi.Input[builtins.str] version: Indicates the current version of the instance image.
        :param pulumi.Input[builtins.str] vpc_id: Specifies the ID of a VPC.
        """
        if attach_disk_size is not None:
            pulumi.set(__self__, "attach_disk_size", attach_disk_size)
...
class CbhInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'CbhInstance':
        """
    ...
    @property
    @pulumi.getter(name="subnetAddress")
    def subnet_address(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the IP address of the subnet.
        """
        return pulumi.get(self, "subnet_address")
