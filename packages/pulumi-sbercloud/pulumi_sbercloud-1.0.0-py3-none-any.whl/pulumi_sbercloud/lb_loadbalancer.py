...
__all__ = ['LbLoadbalancerArgs', 'LbLoadbalancer']

@pulumi.input_type
class LbLoadbalancerArgs:
    def __init__(__self__, *,
                 vip_subnet_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] vip_subnet_id: the IPv4 subnet ID of the subnet where the load balancer works
        :param pulumi.Input[builtins.bool] admin_state_up: schema: Deprecated
        :param pulumi.Input[builtins.str] flavor: schema: Deprecated
        :param pulumi.Input[builtins.str] loadbalancer_provider: schema: Deprecated
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: schema: Deprecated
        """
    ...
    def vip_subnet_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vip_subnet_id(self, value: pulumi.Input[builtins.str]):
...
class LbLoadbalancer(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a LbLoadbalancer resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a LbLoadbalancer resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param LbLoadbalancerArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LbLoadbalancerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LbLoadbalancerArgs.__new__(LbLoadbalancerArgs)
        ...
        super(LbLoadbalancer, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            vip_address: Optional[pulumi.Input[builtins.str]] = None,
            vip_port_id: Optional[pulumi.Input[builtins.str]] = None,
            vip_subnet_id: Optional[pulumi.Input[builtins.str]] = None) -> 'LbLoadbalancer':
        """
        ...
        __props__ = _LbLoadbalancerState.__new__(_LbLoadbalancerState)
        ...
        __props__.__dict__["vip_subnet_id"] = vip_subnet_id
        return LbLoadbalancer(resource_name, opts=opts, __props__=__props__)
