...
__all__ = ['DdsInstanceArgs', 'DdsInstance']

@pulumi.input_type
class DdsInstanceArgs:
    def __init__(__self__, *,
                 availability_zone: pulumi.Input[builtins.str],
                 datastore: pulumi.Input['DdsInstanceDatastoreArgs'],
                 flavors: pulumi.Input[Sequence[pulumi.Input['DdsInstanceFlavorArgs']]],
                 ...
                 backup_strategy: Optional[pulumi.Input['DdsInstanceBackupStrategyArgs']] = None,
                 balancer_active_begin: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def datastore(self) -> pulumi.Input['DdsInstanceDatastoreArgs']:
        return pulumi.get(self, "datastore")

    @datastore.setter
    def datastore(self, value: pulumi.Input['DdsInstanceDatastoreArgs']):
        pulumi.set(self, "datastore", value)

    @property
    @pulumi.getter
    def flavors(self) -> pulumi.Input[Sequence[pulumi.Input['DdsInstanceFlavorArgs']]]:
        return pulumi.get(self, "flavors")

    @flavors.setter
    def flavors(self, value: pulumi.Input[Sequence[pulumi.Input['DdsInstanceFlavorArgs']]]):
    ...
    def backup_strategy(self) -> Optional[pulumi.Input['DdsInstanceBackupStrategyArgs']]:
        return pulumi.get(self, "backup_strategy")

    @backup_strategy.setter
    def backup_strategy(self, value: Optional[pulumi.Input['DdsInstanceBackupStrategyArgs']]):
        pulumi.set(self, "backup_strategy", value)

    @property
    @pulumi.getter(name="balancerActiveBegin")
    def balancer_active_begin(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "balancer_active_begin")

    @balancer_active_begin.setter
    def balancer_active_begin(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "balancer_active_begin", value)

    @property
    @pulumi.getter(name="balancerActiveEnd")
    def balancer_active_end(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "balancer_active_end")

    @balancer_active_end.setter
    def balancer_active_end(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "balancer_active_end", value)

    @property
    @pulumi.getter(name="balancerStatus")
    def balancer_status(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "balancer_status")

    @balancer_status.setter
    def balancer_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DdsInstanceConfigurationArgs']]]]):
...
class _DdsInstanceState:
    def __init__(__self__, *,
                 ...
                 db_username: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 disk_encryption_id: Optional[pulumi.Input[builtins.str]] = None,
                 enterprise_project_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DdsInstanceNodeArgs']]] nodes: This field is deprecated.
        """
        if auto_pay is not None:
            warnings.warn("""Deprecated""", DeprecationWarning)
            pulumi.log.warn("""auto_pay is deprecated: Deprecated""")
    ...
    @property
    @pulumi.getter
    def datastore(self) -> Optional[pulumi.Input['DdsInstanceDatastoreArgs']]:
        return pulumi.get(self, "datastore")

    @datastore.setter
    def datastore(self, value: Optional[pulumi.Input['DdsInstanceDatastoreArgs']]):
        pulumi.set(self, "datastore", value)

    @property
    @pulumi.getter(name="dbUsername")
    def db_username(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "db_username")

    @db_username.setter
    def db_username(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def flavors(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DdsInstanceFlavorArgs']]]]:
        return pulumi.get(self, "flavors")

    @flavors.setter
    def flavors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DdsInstanceFlavorArgs']]]]):
        pulumi.set(self, "flavors", value)

    @property
    @pulumi.getter
    def groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DdsInstanceGroupArgs']]]]:
        return pulumi.get(self, "groups")

    @groups.setter
    def groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DdsInstanceGroupArgs']]]]):
    ...
    @property
    @pulumi.getter
    def nodes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DdsInstanceNodeArgs']]]]:
        """
    ...
    @nodes.setter
    def nodes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DdsInstanceNodeArgs']]]]):
...
class DdsInstance(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 auto_renew: Optional[pulumi.Input[builtins.str]] = None,
                 availability_zone: Optional[pulumi.Input[builtins.str]] = None,
                 backup_strategy: Optional[pulumi.Input[Union['DdsInstanceBackupStrategyArgs', 'DdsInstanceBackupStrategyArgsDict']]] = None,
                 balancer_active_begin: Optional[pulumi.Input[builtins.str]] = None,
                 balancer_active_end: Optional[pulumi.Input[builtins.str]] = None,
                 balancer_status: Optional[pulumi.Input[builtins.str]] = None,
                 charging_mode: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 __props__=None):
        """
        Create a DdsInstance resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: DdsInstanceArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a DdsInstance resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param DdsInstanceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DdsInstanceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DdsInstanceArgs.__new__(DdsInstanceArgs)
        ...
        super(DdsInstance, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            time_zone: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DdsInstance':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DdsInstanceNodeArgs', 'DdsInstanceNodeArgsDict']]]] nodes: This field is deprecated.
        """
        opts = pulumi.ResourceOptions.merge(opts, pulumi.ResourceOptions(id=id))

        __props__ = _DdsInstanceState.__new__(_DdsInstanceState)
        ...
        __props__.__dict__["vpc_id"] = vpc_id
        return DdsInstance(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="backupStrategy")
    def backup_strategy(self) -> pulumi.Output['outputs.DdsInstanceBackupStrategy']:
        return pulumi.get(self, "backup_strategy")

    @property
    @pulumi.getter(name="balancerActiveBegin")
    def balancer_active_begin(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "balancer_active_begin")

    @property
    @pulumi.getter(name="balancerActiveEnd")
    def balancer_active_end(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "balancer_active_end")

    @property
    @pulumi.getter(name="balancerStatus")
    def balancer_status(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "balancer_status")
    ...
    @property
    @pulumi.getter
    def datastore(self) -> pulumi.Output['outputs.DdsInstanceDatastore']:
        return pulumi.get(self, "datastore")

    @property
    @pulumi.getter(name="dbUsername")
    def db_username(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "db_username")
    ...
    @property
    @pulumi.getter(name="diskEncryptionId")
    def disk_encryption_id(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "disk_encryption_id")
    ...
    @property
    @pulumi.getter
    def flavors(self) -> pulumi.Output[Sequence['outputs.DdsInstanceFlavor']]:
        return pulumi.get(self, "flavors")

    @property
    @pulumi.getter
    def groups(self) -> pulumi.Output[Sequence['outputs.DdsInstanceGroup']]:
        return pulumi.get(self, "groups")
    ...
    @property
    @pulumi.getter
    def nodes(self) -> pulumi.Output[Sequence['outputs.DdsInstanceNode']]:
        """
        This field is deprecated.
        """
        return pulumi.get(self, "nodes")
