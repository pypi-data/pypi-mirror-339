...
__all__ = [
    'GetComputeFlavorsResult',
    'AwaitableGetComputeFlavorsResult',
    'get_compute_flavors',
    'get_compute_flavors_output',
]

@pulumi.output_type
class GetComputeFlavorsResult:
    """
    ...
    @property
    @pulumi.getter
    def flavors(self) -> Sequence['outputs.GetComputeFlavorsFlavorResult']:
    ...
    def performance_type(self) -> Optional[builtins.str]:
...
class AwaitableGetComputeFlavorsResult(GetComputeFlavorsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetComputeFlavorsResult(
...
def get_compute_flavors(availability_zone: Optional[builtins.str] = None,
                        cpu_core_count: Optional[builtins.int] = None,
                        generation: Optional[builtins.str] = None,
                        memory_size: Optional[builtins.int] = None,
                        performance_type: Optional[builtins.str] = None,
                        region: Optional[builtins.str] = None,
                        storage_type: Optional[builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetComputeFlavorsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sbercloud:index/getComputeFlavors:getComputeFlavors', __args__, opts=opts, typ=GetComputeFlavorsResult).value

    return AwaitableGetComputeFlavorsResult(
...
def get_compute_flavors_output(availability_zone: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               cpu_core_count: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                               generation: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               memory_size: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                               performance_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               storage_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetComputeFlavorsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('sbercloud:index/getComputeFlavors:getComputeFlavors', __args__, opts=opts, typ=GetComputeFlavorsResult)
    return __ret__.apply(lambda __response__: GetComputeFlavorsResult(
