...
__all__ = [
    ...
    'AwaitableGetImagesImageResult',
    'get_images_image',
    'get_images_image_output',
]
...
class AwaitableGetImagesImageResult(GetImagesImageResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetImagesImageResult(
...
def get_images_image(architecture: Optional[builtins.str] = None,
                     ...
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetImagesImageResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sbercloud:index/getImagesImage:getImagesImage', __args__, opts=opts, typ=GetImagesImageResult).value

    return AwaitableGetImagesImageResult(
...
def get_images_image_output(architecture: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            ...
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetImagesImageResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('sbercloud:index/getImagesImage:getImagesImage', __args__, opts=opts, typ=GetImagesImageResult)
    return __ret__.apply(lambda __response__: GetImagesImageResult(
