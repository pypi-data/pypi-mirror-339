...
__all__ = [
    'GetVpcEipResult',
    'AwaitableGetVpcEipResult',
    'get_vpc_eip',
    'get_vpc_eip_output',
]

@pulumi.output_type
class GetVpcEipResult:
    """
...
class AwaitableGetVpcEipResult(GetVpcEipResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVpcEipResult(
...
def get_vpc_eip(enterprise_project_id: Optional[builtins.str] = None,
                port_id: Optional[builtins.str] = None,
                public_ip: Optional[builtins.str] = None,
                region: Optional[builtins.str] = None,
                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVpcEipResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sbercloud:index/getVpcEip:getVpcEip', __args__, opts=opts, typ=GetVpcEipResult).value

    return AwaitableGetVpcEipResult(
...
def get_vpc_eip_output(enterprise_project_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       ...
                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVpcEipResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('sbercloud:index/getVpcEip:getVpcEip', __args__, opts=opts, typ=GetVpcEipResult)
    return __ret__.apply(lambda __response__: GetVpcEipResult(
