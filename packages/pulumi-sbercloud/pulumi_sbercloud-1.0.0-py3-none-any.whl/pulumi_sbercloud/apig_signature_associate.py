...
__all__ = ['ApigSignatureAssociateArgs', 'ApigSignatureAssociate']

@pulumi.input_type
class ApigSignatureAssociateArgs:
    def __init__(__self__, *,
                 instance_id: pulumi.Input[builtins.str],
                 publish_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 signature_id: pulumi.Input[builtins.str],
                 region: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ApigSignatureAssociate resource.
        :param pulumi.Input[builtins.str] instance_id: The ID of the dedicated instance to which the APIs and the signature belong.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] publish_ids: The publish IDs corresponding to the APIs bound by the signature.
        :param pulumi.Input[builtins.str] signature_id: The signature ID for APIs binding.
        :param pulumi.Input[builtins.str] region: The region where the signature and the APIs are located.
        """
    ...
    def signature_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @signature_id.setter
    def signature_id(self, value: pulumi.Input[builtins.str]):
...
@pulumi.input_type
class _ApigSignatureAssociateState:
    def __init__(__self__, *,
                 instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 publish_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 signature_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="signatureId")
    def signature_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The signature ID for APIs binding.
        """
        return pulumi.get(self, "signature_id")
    ...
    @signature_id.setter
    def signature_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "signature_id", value)
...
class ApigSignatureAssociate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ApigSignatureAssociate resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a ApigSignatureAssociate resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param ApigSignatureAssociateArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ApigSignatureAssociateArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ApigSignatureAssociateArgs.__new__(ApigSignatureAssociateArgs)
    ...
    def get(resource_name: str,
            ...
            publish_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            signature_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ApigSignatureAssociate':
        """
        ...
        __props__ = _ApigSignatureAssociateState.__new__(_ApigSignatureAssociateState)

        __props__.__dict__["instance_id"] = instance_id
        __props__.__dict__["publish_ids"] = publish_ids
        __props__.__dict__["region"] = region
        __props__.__dict__["signature_id"] = signature_id
        return ApigSignatureAssociate(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="signatureId")
    def signature_id(self) -> pulumi.Output[builtins.str]:
        """
        The signature ID for APIs binding.
        """
        return pulumi.get(self, "signature_id")
