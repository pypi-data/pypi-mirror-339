...
__all__ = [
    'GetCceClusterResult',
    'AwaitableGetCceClusterResult',
    'get_cce_cluster',
    'get_cce_cluster_output',
]

@pulumi.output_type
class GetCceClusterResult:
    """
    ...
    def certificate_clusters(self) -> Sequence['outputs.GetCceClusterCertificateClusterResult']:
        return pulumi.get(self, "certificate_clusters")

    @property
    @pulumi.getter(name="certificateUsers")
    def certificate_users(self) -> Sequence['outputs.GetCceClusterCertificateUserResult']:
    ...
    @property
    @pulumi.getter
    def endpoints(self) -> Sequence['outputs.GetCceClusterEndpointResult']:
    ...
    @property
    @pulumi.getter
    def masters(self) -> Sequence['outputs.GetCceClusterMasterResult']:
...
class AwaitableGetCceClusterResult(GetCceClusterResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCceClusterResult(
...
def get_cce_cluster(cluster_type: Optional[builtins.str] = None,
                    id: Optional[builtins.str] = None,
                    name: Optional[builtins.str] = None,
                    region: Optional[builtins.str] = None,
                    status: Optional[builtins.str] = None,
                    vpc_id: Optional[builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCceClusterResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sbercloud:index/getCceCluster:getCceCluster', __args__, opts=opts, typ=GetCceClusterResult).value

    return AwaitableGetCceClusterResult(
...
def get_cce_cluster_output(cluster_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           ...
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCceClusterResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('sbercloud:index/getCceCluster:getCceCluster', __args__, opts=opts, typ=GetCceClusterResult)
    return __ret__.apply(lambda __response__: GetCceClusterResult(
