...
class ApigAclPolicyAssociateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: The ID of the dedicated instance to which the APIs and the ACL policy belong.
        :param pulumi.Input[builtins.str] policy_id: The ACL Policy ID for APIs binding.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] publish_ids: The publish IDs corresponding to the APIs bound by the ACL policy.
        :param pulumi.Input[builtins.str] region: The region where the ACL policy and the APIs are located.
        """
...
class ApigAclPolicyAssociate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policy_id: Optional[pulumi.Input[builtins.str]] = None,
            publish_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'ApigAclPolicyAssociate':
        """
