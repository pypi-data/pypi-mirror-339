...
def get_vpc_subnet(availability_zone: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('sbercloud:index/getVpcSubnet:getVpcSubnet', __args__, opts=opts, typ=GetVpcSubnetResult).value
...
def get_vpc_subnet_output(availability_zone: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('sbercloud:index/getVpcSubnet:getVpcSubnet', __args__, opts=opts, typ=GetVpcSubnetResult)
