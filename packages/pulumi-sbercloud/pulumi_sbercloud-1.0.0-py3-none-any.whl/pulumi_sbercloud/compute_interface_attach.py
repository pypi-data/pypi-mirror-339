...
__all__ = ['ComputeInterfaceAttachArgs', 'ComputeInterfaceAttach']

@pulumi.input_type
class ComputeInterfaceAttachArgs:
...
@pulumi.input_type
class _ComputeInterfaceAttachState:
    def __init__(__self__, *,
                 fixed_ip: Optional[pulumi.Input[builtins.str]] = None,
                 fixed_ipv6: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def fixed_ipv6(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "fixed_ipv6")

    @fixed_ipv6.setter
    def fixed_ipv6(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ComputeInterfaceAttach(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a ComputeInterfaceAttach resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a ComputeInterfaceAttach resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param ComputeInterfaceAttachArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ComputeInterfaceAttachArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ComputeInterfaceAttachArgs.__new__(ComputeInterfaceAttachArgs)
        ...
        super(ComputeInterfaceAttach, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            source_dest_check: Optional[pulumi.Input[builtins.bool]] = None) -> 'ComputeInterfaceAttach':
        """
        ...
        __props__ = _ComputeInterfaceAttachState.__new__(_ComputeInterfaceAttachState)
        ...
        __props__.__dict__["security_group_ids"] = security_group_ids
        __props__.__dict__["source_dest_check"] = source_dest_check
        return ComputeInterfaceAttach(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="fixedIpv6")
    def fixed_ipv6(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "fixed_ipv6")
