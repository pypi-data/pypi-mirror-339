...
def get_identity_role_v3(display_name: Optional[builtins.str] = None,
...
def get_identity_role_v3_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
