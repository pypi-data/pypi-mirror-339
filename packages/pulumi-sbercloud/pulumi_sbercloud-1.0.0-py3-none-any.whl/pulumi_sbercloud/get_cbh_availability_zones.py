...
def get_cbh_availability_zones(display_name: Optional[builtins.str] = None,
...
def get_cbh_availability_zones_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
