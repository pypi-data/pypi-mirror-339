...
__all__ = [
    'GetRdsPgSqlLimitsResult',
    'AwaitableGetRdsPgSqlLimitsResult',
    'get_rds_pg_sql_limits',
    'get_rds_pg_sql_limits_output',
]

@pulumi.output_type
class GetRdsPgSqlLimitsResult:
    """
    ...
    def is_effective(self) -> Optional[builtins.str]:
        return pulumi.get(self, "is_effective")

    @property
    @pulumi.getter(name="maxConcurrency")
    def max_concurrency(self) -> Optional[builtins.str]:
        return pulumi.get(self, "max_concurrency")

    @property
    @pulumi.getter(name="maxWaiting")
    def max_waiting(self) -> Optional[builtins.str]:
    ...
    def sql_limit_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "sql_limit_id")

    @property
    @pulumi.getter(name="sqlLimits")
    def sql_limits(self) -> Sequence['outputs.GetRdsPgSqlLimitsSqlLimitResult']:
        return pulumi.get(self, "sql_limits")


class AwaitableGetRdsPgSqlLimitsResult(GetRdsPgSqlLimitsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRdsPgSqlLimitsResult(
...
def get_rds_pg_sql_limits(db_name: Optional[builtins.str] = None,
                          instance_id: Optional[builtins.str] = None,
                          is_effective: Optional[builtins.str] = None,
                          max_concurrency: Optional[builtins.str] = None,
                          max_waiting: Optional[builtins.str] = None,
                          query_id: Optional[builtins.str] = None,
                          query_string: Optional[builtins.str] = None,
                          region: Optional[builtins.str] = None,
                          search_path: Optional[builtins.str] = None,
                          sql_limit_id: Optional[builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRdsPgSqlLimitsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sbercloud:index/getRdsPgSqlLimits:getRdsPgSqlLimits', __args__, opts=opts, typ=GetRdsPgSqlLimitsResult).value

    return AwaitableGetRdsPgSqlLimitsResult(
...
def get_rds_pg_sql_limits_output(db_name: Optional[pulumi.Input[builtins.str]] = None,
                                 instance_id: Optional[pulumi.Input[builtins.str]] = None,
                                 is_effective: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 max_concurrency: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 max_waiting: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 query_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 ...
                                 sql_limit_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRdsPgSqlLimitsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('sbercloud:index/getRdsPgSqlLimits:getRdsPgSqlLimits', __args__, opts=opts, typ=GetRdsPgSqlLimitsResult)
    return __ret__.apply(lambda __response__: GetRdsPgSqlLimitsResult(
