...
class _SwrRepositoryState:
    def __init__(__self__, *,
                 category: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 internal_path: Optional[pulumi.Input[builtins.str]] = None,
                 is_public: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 num_images: Optional[pulumi.Input[builtins.int]] = None,
    ...
    def internal_path(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "internal_path")

    @internal_path.setter
    def internal_path(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def num_images(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "num_images")

    @num_images.setter
    def num_images(self, value: Optional[pulumi.Input[builtins.int]]):
...
class SwrRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[builtins.str]] = None,
            repository_id: Optional[pulumi.Input[builtins.int]] = None,
            size: Optional[pulumi.Input[builtins.int]] = None) -> 'SwrRepository':
        """
    ...
    @property
    @pulumi.getter(name="internalPath")
    def internal_path(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "internal_path")
    ...
    @property
    @pulumi.getter(name="numImages")
    def num_images(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "num_images")
