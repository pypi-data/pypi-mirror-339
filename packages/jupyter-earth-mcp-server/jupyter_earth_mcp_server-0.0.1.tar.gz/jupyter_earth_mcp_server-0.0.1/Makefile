...
pull-docker:
	docker image pull datalayer/jupyter-earth-mcp-server:latest

push-docker:
	docker push datalayer/jupyter-earth-mcp-server:${VERSION}
	docker push datalayer/jupyter-earth-mcp-server:latest
...
publish-pypi: # publish the pypi package
	...
	@exec echo
	@exec echo https://pypi.org/project/jupyter-earth-mcp-server/#history
