...
class ModuleLoader:
    ...
    def load_module(self, abstract_module_name, module_param_dict, module_verilog_code=""):
        moduleExists = True
    ...
    def generate_module(self, abstract_module_name, module_param_dict, module_verilog_code):
        ...
        moduleExists, module_file_name,inst_idx_str = self.load_module(abstract_module_name, module_param_dict, module_verilog_code)
        if not moduleExists:
