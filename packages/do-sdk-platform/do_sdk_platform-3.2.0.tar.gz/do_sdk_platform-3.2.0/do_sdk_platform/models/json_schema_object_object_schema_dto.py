...
class JsonSchemaObjectObjectSchemaDTO(BaseModel):
    """
    JsonSchemaObjectObjectSchemaDTO
    """ # noqa: E501
    type: Optional[JsonSchemaObjectObjectSchemaDTOType] = None
    ...
    required: Optional[JsonSchemaObjectObjectSchemaDTORequired] = None
    ...
    exclusive_minimum: Optional[JsonSchemaObjectObjectSchemaDTOExclusiveMinimum] = Field(default=None, alias="exclusiveMinimum")
    exclusive_maximum: Optional[JsonSchemaObjectObjectSchemaDTOExclusiveMinimum] = Field(default=None, alias="exclusiveMaximum")
    ...
    const: Optional[JsonSchemaObjectObjectSchemaDTOConst] = None
    enum: Optional[List[Any]] = None
    error_message: Optional[Dict[str, Optional[JsonSchemaObjectObjectSchemaDTOErrorMessageValue]]] = Field(default=None, alias="errorMessage")
    default: Optional[JsonSchemaObjectObjectSchemaDTODefault] = None
    __properties: ClassVar[List[str]] = ["type", "properties", "additionalProperties", "unevaluatedProperties", "patternProperties", "minProperties", "maxProperties", "required", "propertyNames", "items", "additionalItems", "minItems", "maxItems", "uniqueItems", "minLength", "maxLength", "pattern", "format", "minimum", "x-deeporigin-path", "maximum", "exclusiveMinimum", "exclusiveMaximum", "multipleOf", "anyOf", "allOf", "oneOf", "if", "then", "else", "const", "enum", "errorMessage", "default"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JsonSchemaObjectObjectSchemaDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JsonSchemaObjectObjectSchemaDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": JsonSchemaObjectObjectSchemaDTOType.from_dict(obj["type"]) if obj.get("type") is not None else None,
            ...
            "required": JsonSchemaObjectObjectSchemaDTORequired.from_dict(obj["required"]) if obj.get("required") is not None else None,
            ...
            "exclusiveMinimum": JsonSchemaObjectObjectSchemaDTOExclusiveMinimum.from_dict(obj["exclusiveMinimum"]) if obj.get("exclusiveMinimum") is not None else None,
            "exclusiveMaximum": JsonSchemaObjectObjectSchemaDTOExclusiveMinimum.from_dict(obj["exclusiveMaximum"]) if obj.get("exclusiveMaximum") is not None else None,
            ...
            "then": obj.get("then"),
            "else": obj.get("else"),
            "const": JsonSchemaObjectObjectSchemaDTOConst.from_dict(obj["const"]) if obj.get("const") is not None else None,
            "enum": obj.get("enum"),
            "errorMessage": dict(
                (_k, JsonSchemaObjectObjectSchemaDTOErrorMessageValue.from_dict(_v))
                for _k, _v in obj["errorMessage"].items()
            )
            if obj.get("errorMessage") is not None
            else None,
            "default": JsonSchemaObjectObjectSchemaDTODefault.from_dict(obj["default"]) if obj.get("default") is not None else None
        })
        return _obj
