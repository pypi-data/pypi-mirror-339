...
class SubscriptionGroupDto(BaseModel):
    ...
    plans: List[SubscriptionsPlansDto]
    __properties: ClassVar[List[str]] = ["groupId", "groupName", "description", "plans"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionGroupDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionGroupDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "plans": [SubscriptionsPlansDto.from_dict(_item) for _item in obj["plans"]] if obj.get("plans") is not None else None
        })
        return _obj
