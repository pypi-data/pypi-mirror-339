...
class HttpLinksDto(BaseModel):
    ...
    first: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["self", "next", "prev", "first"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HttpLinksDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HttpLinksDto from a dict"""
        if obj is None:
            return None
