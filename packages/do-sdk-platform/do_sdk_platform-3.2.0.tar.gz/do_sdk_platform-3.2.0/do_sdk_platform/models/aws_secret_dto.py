...
class AwsSecretDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "type", "keyGroup", "profileName", "accessKey", "secretKey", "defaultRegion"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AwsSecretDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AwsSecretDto from a dict"""
        if obj is None:
            return None
