...
class InvoiceDto(BaseModel):
    ...
    pay_link: Optional[StrictStr] = Field(default=None, alias="payLink")
    status: Optional[StrictStr] = None
    total: Optional[Union[StrictFloat, StrictInt]] = None
    invoice_num: Optional[StrictStr] = Field(default=None, alias="invoiceNum")
    __properties: ClassVar[List[str]] = ["date", "dueDate", "payLink", "status", "total", "invoiceNum"]
