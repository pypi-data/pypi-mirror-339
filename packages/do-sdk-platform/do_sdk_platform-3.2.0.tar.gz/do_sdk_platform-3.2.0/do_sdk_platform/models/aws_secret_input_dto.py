...
class AWSSecretInputDto(BaseModel):
    """
    AWSSecretInputDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["profileName", "secretKey", "accessKey", "defaultRegion"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AWSSecretInputDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AWSSecretInputDto from a dict"""
        if obj is None:
            return None
