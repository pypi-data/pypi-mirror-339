...
class GitSecretDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "type", "keyGroup", "repository", "username", "password"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GitSecretDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GitSecretDto from a dict"""
        if obj is None:
            return None
