...
class PipelineDto(BaseModel):
    ...
    summary: Optional[StrictStr] = Field(description="Description of the pipeline")
    ...
    __properties: ClassVar[List[str]] = ["name", "version", "summary", "pipelineLanguage", "pipelineLanguageVersion", "pipelineUrl", "schema", "sampleSchema", "createdAt", "updatedAt"]
