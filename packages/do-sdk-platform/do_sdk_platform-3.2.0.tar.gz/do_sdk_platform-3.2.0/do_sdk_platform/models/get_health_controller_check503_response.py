...
class GetHealthControllerCheck503Response(BaseModel):
    """
    GetHealthControllerCheck503Response
    """ # noqa: E501
    status: Optional[StrictStr] = None
    info: Optional[Dict[str, GetHealthControllerCheck200ResponseInfoValue]] = None
    error: Optional[Dict[str, GetHealthControllerCheck200ResponseInfoValue]] = None
    details: Optional[Dict[str, GetHealthControllerCheck200ResponseInfoValue]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetHealthControllerCheck503Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetHealthControllerCheck503Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "info": dict(
                (_k, GetHealthControllerCheck200ResponseInfoValue.from_dict(_v))
