...
class ConfigurationValueDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "type", "keyGroup", "filename", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigurationValueDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigurationValueDto from a dict"""
        if obj is None:
            return None
