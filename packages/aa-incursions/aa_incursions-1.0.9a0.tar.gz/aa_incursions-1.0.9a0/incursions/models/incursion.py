...
class Incursion(models.Model):
    ...
    migration_constellation = models.ForeignKey(MapConstellation, blank=True, null=True, on_delete=models.CASCADE, related_name="+")
    ...
    migration_infested_solar_systems = models.ManyToManyField(MapSystem, blank=True, related_name="+")
    ...
    migration_staging_solar_system = models.ForeignKey(MapSystem, blank=True, null=True, on_delete=models.CASCADE, related_name="+")
    ...
    def is_island(self) -> bool:
        try:
            for system in route_path_nodes(self.staging_solar_system.id, 30000142):
