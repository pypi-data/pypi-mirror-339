...
class Role(models.Model):
    name = models.CharField(max_length=64, unique=True, verbose_name=_("Role Name"))
    description = models.TextField(null=True, blank=True, verbose_name=_("Role Description"))
    power = models.IntegerField(default=0, help_text=_("Bigger is better, user can assign a power level lower than this"), verbose_name=_("Role Power"))
    ...
    def member_count(self) -> int:
        return CharacterRoles.objects.filter(role_id=self.pk).count()
...
class CharacterRoles(models.Model):
    character = models.OneToOneField(EveCharacter, on_delete=models.CASCADE, primary_key=True, verbose_name=_("Character"))
    role = models.ForeignKey(Role, verbose_name=_("Incursion Role"), on_delete=models.CASCADE, related_name='incursion_role')
...
class SkillHistory(models.Model):
    ...
    old_level = models.IntegerField(validators=[MinValueValidator(0), MaxValueValidator(5)], verbose_name=_("Old Level"))
    new_level = models.IntegerField(validators=[MinValueValidator(0), MaxValueValidator(5)], verbose_name=_("New Level"))
    logged_at = models.DateTimeField(auto_now_add=True, verbose_name=_("Logged At"))
...
class WaitlistEntryFit(models.Model):
    character = models.ForeignKey(EveCharacter, on_delete=models.CASCADE, related_name='+', verbose_name=_("Character"))
    waitlist_entry = models.ForeignKey(WaitlistEntry, on_delete=models.CASCADE, related_name='+', verbose_name=_("Waitlist Entry"))
    fit = models.ForeignKey("Fitting", on_delete=models.CASCADE, related_name='+', verbose_name=_("Fitting"))
    implant_set = models.ForeignKey("ImplantSet", on_delete=models.CASCADE, related_name='+', verbose_name=_("Implant Set"))
    approved = models.BooleanField(default=False, verbose_name=_("Approved"))
    tags = models.CharField(max_length=255, help_text=_("Comma Separated List"), verbose_name=_("Tags"))
    category = models.ForeignKey(WaitlistCategory, verbose_name=_("Waitlist Category"), on_delete=models.CASCADE, related_name='+')
