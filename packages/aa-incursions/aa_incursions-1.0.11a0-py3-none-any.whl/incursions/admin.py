...
from incursions.models.waitlist import (
    ...
    ApprovedSkills, Badge, Ban, CharacterBadges, CharacterNote, CharacterRoles,
    Fitting, FittingHistory, Fleet, FleetActivity, FleetSquad, ImplantSet,
    Role, SkillCheck, SkillHistory, Waitlist, WaitlistCategory,
...
@admin.register(CharacterRoles)
class CharacterRolesAdmin(admin.ModelAdmin):
    list_display = ("character", "role", "granted_at", "granted_by")
    list_filter = ("role",)
...
@admin.register(FittingHistory)
class FittingHistoryAdmin(admin.ModelAdmin):
    list_display = ("pk", "character", "fit", "implant_set", "logged_at")
    list_filter = ("fit", "implant_set")
    search_fields = ("character__name",)
    list_select_related = ("character", "fit", "implant_set")
...
class FleetActivityAdmin(admin.ModelAdmin):
    ...
    list_filter = ("has_left", "is_boss")
    search_fields = ("character__name", "ship__name")
    list_select_related = ("character", "ship")
...
class SkillHistoryAdmin(admin.ModelAdmin):
    list_display = ("pk", "character", "skill", "old_level", "new_level", "logged_at")
    search_fields = ("character__name", "skill__name")
    list_select_related = ("character", "skill")
