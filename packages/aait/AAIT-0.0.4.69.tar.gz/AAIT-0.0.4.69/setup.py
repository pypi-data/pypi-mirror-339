...
VERSION = "0.0.4.69"  # la version doit être supérieure à la précédente sinon la publication sera refusée
...
# Dépendances
INSTALL_REQUIRES = ["torch; platform_system != 'Darwin'",  # Pour tous sauf macOS
                    "torch==2.2.2; platform_system == 'Darwin'",  # Pour macOS uniquement
                    "sentence-transformers==3.3.1", "gpt4all[all]==2.8.2", "sacremoses==0.1.1",
