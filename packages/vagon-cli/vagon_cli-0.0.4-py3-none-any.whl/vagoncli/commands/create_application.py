...
@click.option(
    ...
    "-o",
    "os_type",
    help="Operating System Type. Options: windows / linux",
    show_default=True,
    required=False,
    default="windows",
)
def create_application(
    app_name, app_archive, executable, machine_type_id, key_mapping_selection, os_type
):
    ...
    create_application_response = create_vendor_application(
        file_name, file_size, executable, os_type
    )
...
def create_vendor_application(file_name, file_size, executable, os_type):
