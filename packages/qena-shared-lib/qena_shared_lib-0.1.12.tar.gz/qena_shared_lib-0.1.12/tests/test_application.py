...
def test_api_controller() -> None:
    ...
    class TestController(ControllerBase):
        ...
        @put()
        def put_route_handler(self, body: dict) -> str:
            return f"put_route_handler_reponse_{body['message']}"

        @post()
        def post_route_handler(self, body: dict) -> str:
...
def test_api_controller_with_no_controller_base() -> None:
    ...
    class TestController:
        ...
        @post()
        def post_test_response(self, body: dict) -> str:
...
def test_api_controller_with_no_wrong_method_annotation() -> None:
    def wrong_get() -> Callable[[Callable], Callable]:
...
@mark.asyncio
async def test_none_logstash_logging() -> None:
    router = APIRouter(prefix="/users")
