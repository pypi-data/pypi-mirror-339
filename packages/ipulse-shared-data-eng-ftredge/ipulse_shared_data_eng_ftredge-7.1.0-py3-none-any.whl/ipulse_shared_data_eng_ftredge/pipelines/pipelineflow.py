...
class Step:
    ...
    def final(self, force_if_closed: bool = False, force_status:Optional[ProgressStatus]=None) -> ProgressStatus:
...
class PipelineDynamicIterator(Step):
    ...
    def can_continue(self, raise_if_false: bool = False) -> Tuple[bool, Optional[str]]:
        """
        ...
        Returns:
            tuple of (can_continue, reason_if_cannot)
            
        Raises:
            Exception: If raise_if_false is True and cannot continue
        """
        if self.is_closed_or_skipped:
    ...
    def validate_and_start(self, set_status: Optional[ProgressStatus]=ProgressStatus.IN_PROGRESS,
                      sequence_ref: Optional[Union[int, str]]=None) -> bool:
        """
...
class PipelineFlow(PipelineSequence):
    ...
    def validate_and_start(self, set_status: Optional[ProgressStatus]=ProgressStatus.IN_PROGRESS) -> bool:
