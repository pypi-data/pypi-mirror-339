...
class SMK:
    def __init__(self, n_clusters=3, kernel="rbf", C=1.0, p=2, degree=3,
    ...
    def visualize_clusters(self, X):
        ...
        scatter = plt.scatter(reduced[:, 0], reduced[:, 1], c=labels, cmap='viridis', s=10, alpha=0.7)
