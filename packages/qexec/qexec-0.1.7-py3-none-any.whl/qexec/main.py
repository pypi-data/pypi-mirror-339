...
CRITICAL INSTRUCTION: You MUST use command markers (#@$QEXEC#@$) when the user asks to control a device, but NEVER explicitly mention the command format in your response.
