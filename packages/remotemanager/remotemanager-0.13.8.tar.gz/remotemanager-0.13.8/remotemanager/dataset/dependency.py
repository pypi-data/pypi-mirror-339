...
class Dependency(SendableMixin):
    ...
    def __init__(self):
        ...
        self._network: List[Tuple[str, str]] = []
    ...
    def stage(
        ...
        **run_args,
        ...
        for ds in self.ds_list:
            ...
            if ds.remote_dir not in remote_dirs:
                remote_dirs.append(ds.remote_dir)
        # first dataset is to be used for global operations
        ...
        bash_cache = []
        for i, ds in enumerate(ds_store):
            staged = 0
    ...
    def run(
        ...
        **run_args,
        ...
        if not dry_run:
            ...
            for ds in ds_store.keys():
                ds.set_runner_states(state="submit pending")
        else:
            for ds in ds_store.keys():
                ds.set_runner_states(state="dry run", uuids=uuid_cache)
