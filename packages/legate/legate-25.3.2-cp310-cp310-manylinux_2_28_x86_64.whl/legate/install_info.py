...
libpath: str = get_libpath("liblegate", "liblegate.so.25.03.02")

networks: list[str] = "ucx".split()
...
legion_version: str = "25.3.0"

legion_git_branch: str = "04b7d5068c5e75f29684703e8a1b8568b3e59b9a"
