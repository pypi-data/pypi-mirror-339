...
@click.option("--type", help="Can be used to specify web application type for optimized hosting.")
...
def deploy(app_path, domain, apptype, ssl, noredirect):
    """Deploy a Flask app."""
    ...
    run_deploy(app_path, domain, apptype, ssl, noredirect)
