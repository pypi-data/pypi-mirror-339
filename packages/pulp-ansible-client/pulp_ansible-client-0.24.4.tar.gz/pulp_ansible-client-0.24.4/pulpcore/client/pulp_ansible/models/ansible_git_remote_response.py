...
class AnsibleGitRemoteResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ca_cert", "connect_timeout", "pulp_created", "headers", "pulp_href", "proxy_url", "rate_limit", "max_retries", "tls_validation", "prn", "sock_connect_timeout", "sock_read_timeout", "name", "client_cert", "total_timeout", "pulp_last_updated", "pulp_labels", "hidden_fields", "url", "download_concurrency", "metadata_only", "git_ref"]
