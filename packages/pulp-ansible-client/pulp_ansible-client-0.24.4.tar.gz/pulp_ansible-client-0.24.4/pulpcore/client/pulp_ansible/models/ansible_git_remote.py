...
class AnsibleGitRemote(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ca_cert", "connect_timeout", "username", "headers", "client_key", "proxy_password", "proxy_url", "rate_limit", "max_retries", "tls_validation", "sock_connect_timeout", "proxy_username", "sock_read_timeout", "name", "client_cert", "total_timeout", "pulp_labels", "url", "password", "download_concurrency", "metadata_only", "git_ref"]
