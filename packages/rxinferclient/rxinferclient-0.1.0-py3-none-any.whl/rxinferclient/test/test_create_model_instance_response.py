...
class TestCreateModelInstanceResponse(unittest.TestCase):
    """CreateModelInstanceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateModelInstanceResponse:
        """Test CreateModelInstanceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateModelInstanceResponse`
        """
    ...
    def testCreateModelInstanceResponse(self):
        """Test CreateModelInstanceResponse"""
