...
class ErrorResponse(BaseModel):
    ...
    ErrorResponse
    """ # noqa: E501
    error: StrictStr = Field(description="Error message explaining the failure")
    message: Optional[StrictStr] = Field(default=None, description="Additional message providing details about the failure")
