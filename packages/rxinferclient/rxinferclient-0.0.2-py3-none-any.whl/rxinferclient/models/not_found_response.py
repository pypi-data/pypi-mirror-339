...
class NotFoundResponse(BaseModel):
    ...
    NotFoundResponse
    """ # noqa: E501
    error: StrictStr = Field(description="Error type, always \"Not Found\" for this error")
    message: StrictStr = Field(description="Detailed message explaining why the resource was not found")
