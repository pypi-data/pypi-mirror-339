...
class AttachEventsToEpisodeRequest(BaseModel):
    """
    AttachEventsToEpisodeRequest
    """ # noqa: E501
    events: List[AttachEventsToEpisodeRequestEventsInner] = Field(description="List of events to attach to the episode")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [AttachEventsToEpisodeRequestEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
