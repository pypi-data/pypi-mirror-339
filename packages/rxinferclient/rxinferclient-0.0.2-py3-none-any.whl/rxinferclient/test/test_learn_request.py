...
class TestLearnRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LearnRequest:
        """Test LearnRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LearnRequest`
        """
        model = LearnRequest()
        if include_optional:
            return LearnRequest(
