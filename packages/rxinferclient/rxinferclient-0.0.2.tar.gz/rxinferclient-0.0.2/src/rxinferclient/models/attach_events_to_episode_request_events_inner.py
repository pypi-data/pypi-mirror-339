...
class AttachEventsToEpisodeRequestEventsInner(BaseModel):
    """
    AttachEventsToEpisodeRequestEventsInner
    """ # noqa: E501
    timestamp: Optional[datetime] = Field(default=None, description="Timestamp of the event")
    data: Optional[Dict[str, Any]] = Field(default=None, description="Arbitrary data to attach to the event, model-specific")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Arbitrary metadata to attach to the event, model-specific")
    __properties: ClassVar[List[str]] = ["timestamp", "data", "metadata"]
