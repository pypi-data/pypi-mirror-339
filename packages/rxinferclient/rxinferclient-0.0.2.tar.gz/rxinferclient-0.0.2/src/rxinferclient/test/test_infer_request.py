...
class TestInferRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InferRequest:
        """Test InferRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InferRequest`
        """
        model = InferRequest()
        if include_optional:
            return InferRequest(
