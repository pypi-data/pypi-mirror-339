...
class ModelInstance(BaseModel):
    ...
    ModelInstance
    """ # noqa: E501
    instance_id: StrictStr = Field(description="Unique identifier for the created model instance")
    ...
    __properties: ClassVar[List[str]] = ["instance_id", "model_name", "created_at", "description", "arguments", "current_episode"]
