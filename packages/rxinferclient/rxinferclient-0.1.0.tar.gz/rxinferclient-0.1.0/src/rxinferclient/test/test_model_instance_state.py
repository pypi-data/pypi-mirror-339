...
class TestModelInstanceState(unittest.TestCase):
    """ModelInstanceState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelInstanceState:
        """Test ModelInstanceState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelInstanceState`
        """
        model = ModelInstanceState()
        if include_optional:
    ...
    def testModelInstanceState(self):
        """Test ModelInstanceState"""
