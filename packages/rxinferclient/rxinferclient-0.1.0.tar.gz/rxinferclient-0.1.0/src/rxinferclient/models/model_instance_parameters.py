...
class ModelInstanceParameters(BaseModel):
    """
    ModelInstanceParameters
    """ # noqa: E501
    parameters: Dict[str, Any] = Field(description="An object containing the current parameters of the model instance. The keys are the parameter names as defined in the model configuration, and the values are the parameter values. ")
