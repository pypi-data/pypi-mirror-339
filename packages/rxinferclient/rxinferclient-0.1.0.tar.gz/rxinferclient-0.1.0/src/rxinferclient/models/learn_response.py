...
class LearnResponse(BaseModel):
    ...
    LearnResponse
    """ # noqa: E501
    learned_parameters: Dict[str, Any] = Field(description="A dictionary of learned parameters and their values")
    __properties: ClassVar[List[str]] = ["learned_parameters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "learned_parameters": obj.get("learned_parameters")
        })
        return _obj
