...
class spark_functions():
    ...
    def flatten_sdf(self,df, columns_to_flatten=None, keywords=None):
        ...
        while current_flatten_targets:
            ...
            # Reset the targets for next iteration
            current_flatten_targets = []
            ...
            for struct_col in struct_cols:
                ...
                for field in result_df.schema[struct_col].dataType.fields:
                    ...
                    # Check if the new column needs further flattening
                    new_col_type = result_df.schema[struct_col].dataType[field.name].dataType
                    if isinstance(new_col_type, StructType) or isinstance(new_col_type, ArrayType):
                        current_flatten_targets.append(nested_col_name)
            ...
            for array_col in array_cols:
                ...
                if isinstance(element_type, StructType):
                    ...
                    for field in element_type.fields:
                        ...
                        # Check if the new column needs further flattening
                        new_col_type = element_type[field.name].dataType
                        if isinstance(new_col_type, StructType) or isinstance(new_col_type, ArrayType):
                            current_flatten_targets.append(nested_col_name)
