...
T = TypeVar("T", bound="UpdateSharingGroupLegacyBody")


@_attrs_define
class UpdateSharingGroupLegacyBody:
    """
    Attributes:
        name (str):
        id (Union[Unset, int]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_sharing_group_legacy_body = cls(
            name=name,
            id=id,
            uuid=uuid,
        ...
        update_sharing_group_legacy_body.additional_properties = d
        return update_sharing_group_legacy_body
