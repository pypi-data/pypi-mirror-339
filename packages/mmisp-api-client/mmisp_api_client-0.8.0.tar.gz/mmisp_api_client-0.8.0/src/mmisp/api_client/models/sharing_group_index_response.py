...
if TYPE_CHECKING:
    from ..models.sharing_group_org_index_item import SharingGroupOrgIndexItem
...
T = TypeVar("T", bound="SharingGroupIndexResponse")


@_attrs_define
class SharingGroupIndexResponse:
    """
    Attributes:
        sharing_group (ShortSharingGroup):
        organisation (ShortOrganisation):
        sharing_group_org (list['SharingGroupOrgIndexItem']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for sharing_group_org_item_data in _sharing_group_org:
            sharing_group_org_item = SharingGroupOrgIndexItem.from_dict(sharing_group_org_item_data)
        ...
        sharing_group_index_response = cls(
        ...
        sharing_group_index_response.additional_properties = d
        return sharing_group_index_response
