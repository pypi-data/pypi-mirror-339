...
T = TypeVar("T", bound="GetOrganisationResponse")
...
class GetOrganisationResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_organisation_response.additional_properties = d
        return get_organisation_response
