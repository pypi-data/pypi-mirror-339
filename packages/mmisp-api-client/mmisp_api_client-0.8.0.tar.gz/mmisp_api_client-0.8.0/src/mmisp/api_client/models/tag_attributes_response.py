...
T = TypeVar("T", bound="TagAttributesResponse")


@_attrs_define
class TagAttributesResponse:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tag_attributes_response.additional_properties = d
        return tag_attributes_response
