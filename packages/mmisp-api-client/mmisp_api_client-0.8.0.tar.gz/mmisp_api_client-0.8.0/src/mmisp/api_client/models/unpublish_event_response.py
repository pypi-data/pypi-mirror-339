...
T = TypeVar("T", bound="UnpublishEventResponse")


@_attrs_define
class UnpublishEventResponse:
    """
    Attributes:
        name (str):
        message (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unpublish_event_response.additional_properties = d
        return unpublish_event_response
