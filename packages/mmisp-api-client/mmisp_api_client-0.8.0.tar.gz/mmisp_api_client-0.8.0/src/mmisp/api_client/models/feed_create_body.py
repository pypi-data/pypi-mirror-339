...
T = TypeVar("T", bound="FeedCreateBody")


@_attrs_define
class FeedCreateBody:
    """
    Attributes:
        name (str):
        provider (str):
        ...
        sharing_group_id (Union[Unset, str]):
    ...
    sharing_group_id: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        feed_create_body.additional_properties = d
        return feed_create_body
