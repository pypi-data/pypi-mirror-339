...
T = TypeVar("T", bound="UpdateSharingGroupBody")


@_attrs_define
class UpdateSharingGroupBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_sharing_group_body.additional_properties = d
        return update_sharing_group_body
