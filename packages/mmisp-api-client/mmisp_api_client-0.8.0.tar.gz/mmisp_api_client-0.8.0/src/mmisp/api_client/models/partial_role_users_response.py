...
T = TypeVar("T", bound="PartialRoleUsersResponse")


@_attrs_define
class PartialRoleUsersResponse:
    """
    Attributes:
        ...
        default_role (Union[Unset, bool]):
        memory_limit (Union[Unset, str]):
        max_execution_time (Union[Unset, str]):
        restricted_to_site_admin (Union[Unset, bool]):
        enforce_rate_limit (Union[Unset, bool]):
        rate_limit_count (Union[Unset, str]):
    """
    ...
    restricted_to_site_admin: Union[Unset, bool] = UNSET
    enforce_rate_limit: Union[Unset, bool] = UNSET
    rate_limit_count: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if restricted_to_site_admin is not UNSET:
            field_dict["restricted_to_site_admin"] = restricted_to_site_admin
        if enforce_rate_limit is not UNSET:
            field_dict["enforce_rate_limit"] = enforce_rate_limit
        if rate_limit_count is not UNSET:
            field_dict["rate_limit_count"] = rate_limit_count
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        restricted_to_site_admin = d.pop("restricted_to_site_admin", UNSET)

        enforce_rate_limit = d.pop("enforce_rate_limit", UNSET)

        rate_limit_count = d.pop("rate_limit_count", UNSET)

        partial_role_users_response = cls(
            perm_add=perm_add,
        ...
        partial_role_users_response.additional_properties = d
        return partial_role_users_response
