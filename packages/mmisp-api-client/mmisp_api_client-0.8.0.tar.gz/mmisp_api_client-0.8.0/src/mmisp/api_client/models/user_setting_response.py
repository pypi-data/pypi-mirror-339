...
T = TypeVar("T", bound="UserSettingResponse")
...
class UserSettingResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        user_setting = UserSettingSchema.from_dict(d.pop("UserSetting"))

        user_setting_response = cls(
            user_setting=user_setting,
        )

        user_setting_response.additional_properties = d
