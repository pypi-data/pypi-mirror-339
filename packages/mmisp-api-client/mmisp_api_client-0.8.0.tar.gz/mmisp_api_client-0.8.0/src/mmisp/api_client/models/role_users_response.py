...
T = TypeVar("T", bound="RoleUsersResponse")


@_attrs_define
class RoleUsersResponse:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        role_users_response.additional_properties = d
        return role_users_response
