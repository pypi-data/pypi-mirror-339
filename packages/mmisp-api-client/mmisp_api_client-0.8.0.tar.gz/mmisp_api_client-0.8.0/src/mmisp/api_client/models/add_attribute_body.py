...
from ..models.add_attribute_body_type import AddAttributeBodyType
from ..models.attribute_distribution_levels import AttributeDistributionLevels
from ..types import UNSET, Unset

T = TypeVar("T", bound="AddAttributeBody")


@_attrs_define
class AddAttributeBody:
    """
    Attributes:
        type_ (AddAttributeBodyType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = AddAttributeBodyType(d.pop("type"))
        ...
        add_attribute_body.additional_properties = d
        return add_attribute_body
