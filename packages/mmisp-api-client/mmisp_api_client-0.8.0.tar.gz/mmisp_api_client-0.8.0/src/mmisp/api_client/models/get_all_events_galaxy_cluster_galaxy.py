...
T = TypeVar("T", bound="GetAllEventsGalaxyClusterGalaxy")


@_attrs_define
class GetAllEventsGalaxyClusterGalaxy:
    """
    Attributes:
        id (int):
        uuid (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_all_events_galaxy_cluster_galaxy = cls(
            id=id,
            uuid=uuid,
            name=name,
            type_=type_,
        ...
        get_all_events_galaxy_cluster_galaxy.additional_properties = d
        return get_all_events_galaxy_cluster_galaxy
