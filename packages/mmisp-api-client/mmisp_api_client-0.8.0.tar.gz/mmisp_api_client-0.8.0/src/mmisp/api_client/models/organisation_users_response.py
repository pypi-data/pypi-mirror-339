...
T = TypeVar("T", bound="OrganisationUsersResponse")


@_attrs_define
class OrganisationUsersResponse:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organisation_users_response = cls(
            id=id,
            name=name,
        ...
        organisation_users_response.additional_properties = d
        return organisation_users_response
