...
T = TypeVar("T", bound="SearchGetAuthKeysResponseAuthKey")


@_attrs_define
class SearchGetAuthKeysResponseAuthKey:
    """
    Attributes:
        id (int):
        uuid (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_get_auth_keys_response_auth_key = cls(
            id=id,
            uuid=uuid,
            authkey_start=authkey_start,
            authkey_end=authkey_end,
        ...
        search_get_auth_keys_response_auth_key.additional_properties = d
        return search_get_auth_keys_response_auth_key
