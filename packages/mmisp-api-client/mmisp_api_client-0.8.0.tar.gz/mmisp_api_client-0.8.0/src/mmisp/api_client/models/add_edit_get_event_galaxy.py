...
if TYPE_CHECKING:
    from ..models.add_edit_get_event_galaxy_cluster import AddEditGetEventGalaxyCluster


T = TypeVar("T", bound="AddEditGetEventGalaxy")


@_attrs_define
class AddEditGetEventGalaxy:
    """
    Attributes:
        id (int):
        uuid (str):
        ...
        galaxy_cluster (Union[Unset, list['AddEditGetEventGalaxyCluster']]):
    """
    ...
    galaxy_cluster: Union[Unset, list["AddEditGetEventGalaxyCluster"]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        galaxy_cluster: Union[Unset, list[dict[str, Any]]] = UNSET
        if not isinstance(self.galaxy_cluster, Unset):
            galaxy_cluster = []
        ...
        if galaxy_cluster is not UNSET:
            field_dict["GalaxyCluster"] = galaxy_cluster
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        galaxy_cluster = []
        _galaxy_cluster = d.pop("GalaxyCluster", UNSET)
        for galaxy_cluster_item_data in _galaxy_cluster or []:
            galaxy_cluster_item = AddEditGetEventGalaxyCluster.from_dict(galaxy_cluster_item_data)

            galaxy_cluster.append(galaxy_cluster_item)

        add_edit_get_event_galaxy = cls(
            id=id,
            uuid=uuid,
            name=name,
            type_=type_,
        ...
        add_edit_get_event_galaxy.additional_properties = d
        return add_edit_get_event_galaxy
