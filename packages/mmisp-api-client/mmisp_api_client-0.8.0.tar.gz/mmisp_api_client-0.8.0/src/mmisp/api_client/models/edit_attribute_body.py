...
T = TypeVar("T", bound="EditAttributeBody")


@_attrs_define
class EditAttributeBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        edit_attribute_body.additional_properties = d
        return edit_attribute_body
