...
T = TypeVar("T", bound="AddRemoveTagAttributeResponse")


@_attrs_define
class AddRemoveTagAttributeResponse:
    """
    Attributes:
        saved (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_remove_tag_attribute_response = cls(
            saved=saved,
            success=success,
        ...
        add_remove_tag_attribute_response.additional_properties = d
        return add_remove_tag_attribute_response
