...
if TYPE_CHECKING:
    from ..models.add_galaxy_element import AddGalaxyElement


T = TypeVar("T", bound="AddGalaxyClusterRequest")


@_attrs_define
class AddGalaxyClusterRequest:
    """
    Attributes:
        value (str):
        description (str):
        ...
        galaxy_element (list['AddGalaxyElement']):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for galaxy_element_item_data in _galaxy_element:
            galaxy_element_item = AddGalaxyElement.from_dict(galaxy_element_item_data)

            galaxy_element.append(galaxy_element_item)

        add_galaxy_cluster_request = cls(
            value=value,
            description=description,
            source=source,
            authors=authors,
        ...
        add_galaxy_cluster_request.additional_properties = d
        return add_galaxy_cluster_request
