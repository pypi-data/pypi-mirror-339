...
T = TypeVar("T", bound="PartialOrganisationUsersResponse")


@_attrs_define
class PartialOrganisationUsersResponse:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        partial_organisation_users_response = cls(
            id=id,
            name=name,
        ...
        partial_organisation_users_response.additional_properties = d
        return partial_organisation_users_response
