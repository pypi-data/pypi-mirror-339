...
T = TypeVar("T", bound="EditAuthKeyResponseCompleteAuthKey")


@_attrs_define
class EditAuthKeyResponseCompleteAuthKey:
    """
    Attributes:
        id (int):
        uuid (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        edit_auth_key_response_complete_auth_key = cls(
            id=id,
            uuid=uuid,
            authkey_start=authkey_start,
            authkey_end=authkey_end,
        ...
        edit_auth_key_response_complete_auth_key.additional_properties = d
        return edit_auth_key_response_complete_auth_key
