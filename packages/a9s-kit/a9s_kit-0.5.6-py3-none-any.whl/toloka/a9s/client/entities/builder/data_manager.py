...
from toloka.a9s.client.models.data_manager import (
    ...
    MultiValueFilterConditionStrict,
...
class Filter:
    ...
    def include_any_of(cls, field: FilterField, value: Sequence[str]) -> 'Filter':
        ...
        Returns:
            A new Filter object representing the 'INCLUDE_ANY_OF' condition.
        """
        return Filter(MultiValueFilterConditionStrict(field=field, operator='INCLUDE_ANY_OF', value=value))
    ...
    def include_all_of(cls, field: FilterField, value: Sequence[str]) -> 'Filter':
        ...
        Returns:
            A new Filter object representing the 'INCLUDE_ALL_OF' condition.
        """
        return Filter(MultiValueFilterConditionStrict(field=field, operator='INCLUDE_ALL_OF', value=value))
    ...
    def exclude_any_of(cls, field: FilterField, value: Sequence[str]) -> 'Filter':
        ...
        Returns:
            A new Filter object representing the 'EXCLUDE_ANY_OF' condition.
        """
        return Filter(MultiValueFilterConditionStrict(field=field, operator='EXCLUDE_ANY_OF', value=value))
    ...
    def exclude_all_of(cls, field: FilterField, value: Sequence[str]) -> 'Filter':
        ...
        Returns:
            A new Filter object representing the 'EXCLUDE_ALL_OF' condition.
        """
        return Filter(MultiValueFilterConditionStrict(field=field, operator='EXCLUDE_ALL_OF', value=value))

    @classmethod
    def between(cls, field: FilterField, value: Sequence[str]) -> 'Filter':
        ...
        Args:
            field: The field to filter on.
            value: A sequence containing two strings representing the lower and upper bounds.

        Returns:
            A new Filter object representing the 'BETWEEN' condition.
        """
        return Filter(MultiValueFilterConditionStrict(field=field, operator='BETWEEN', value=value))
    ...
    def build_project_form(
        self, project_id: ProjectId, sort_list: Sequence[SearchFormSortStrict] | None = None
    ) -> SearchFormStrictProject:
    ...
    def build_batch_form(
        self, batch_id: BatchId, sort_list: Sequence[SearchFormSortStrict] | None = None
    ) -> SearchFormStrictBatch:
