...
.. warning::
    ...
    Since the creation of triggers within the Model is a functionality developed by MAFw and is not provided directly by :link:`peewee`, it should be tested by us (MAFw developers) for all implementation and for the moment it was not possible due to a lack of available databases.
