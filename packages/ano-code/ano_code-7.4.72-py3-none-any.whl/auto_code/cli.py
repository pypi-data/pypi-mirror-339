...
# @click.argument('url', type=str)
# @click.argument('repo_id', type=str)
def get_files_and_content(directory):
    result = file_handling.get_files_and_content(directory)
    print(result)
...
def modify_file_content(directory: Path, new_content: str):
    result = file_handling.get_files_and_content(directory, new_content)
    print(result)
...
# @click.argument('url', type=str)
@click.argument('new_content', type=str)
def delete_file(directory: Path, new_content: str):
    result = file_handling.delete_file(directory)
    print(result)
...
cli.add_command(get_files_and_content)
