...
class CAF_Analysis:
    def __init__(self, setpoint_file, pmt_folder, avg=5,peak_height=0.01, peak_distance=100, peak_prominence=0.01, show_plot=True, return_peaks=False, polyorder=3, buffer=1000, window_length=51):
