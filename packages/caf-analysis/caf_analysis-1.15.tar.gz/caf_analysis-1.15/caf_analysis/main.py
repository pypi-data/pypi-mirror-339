...
class CAF_Analysis:
    def __init__(self, pmt_folder, avg=5,peak_height=0.01, peak_distance=100, peak_prominence=0.01, show_plot=True, return_peaks=False, polyorder=3, buffer=1000, window_length=501,dpi=400):
    ...
    def FindLaserPositionResiduals(self,p1, p2):
        ...
        fig = plt.figure(figsize=(7,4), dpi=self.dpi)
        ax = fig.add_subplot()
