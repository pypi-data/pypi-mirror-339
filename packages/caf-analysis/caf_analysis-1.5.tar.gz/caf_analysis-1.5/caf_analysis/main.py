...
class CAF_Analysis:
    def __init__(self, pmt_folder, avg=5,peak_height=0.01, peak_distance=100, peak_prominence=0.01, show_plot=True, return_peaks=False, polyorder=3, buffer=1000, window_length=51):
    ...
    def DealWithAllData(self,PMTfilename, avg, SaveData, FindResiduals):
        ...
        try:
            ...
            setpointfilename = os.path.join(PMTfilename, '_Setpoints.csv')
            ...
            try:
                ...
                if HFfixed == False:
                    ...
                    if PlotFreqSpec == True:
                        ...
                        ax1.plot(freq, self.orentz(freq, a, b, c)+d, color='darkgray', linestyle='-.')
