...
class V3FbsPostingDetail(object):
    ...
    swagger_types = {
        ...
        'is_multibox': 'bool',
        'multi_box_qty': 'int',
        'optional': 'V3FbsPostingDetailOptional',
        'order_id': 'int',
        'order_number': 'str',
    ...
    def __init__(self, additional_data=None, addressee=None, analytics_data=None, available_actions=None, barcodes=None, cancellation=None, courier=None, customer=None, delivering_date=None, delivery_method=None, delivery_price=None, financial_data=None, in_process_at=None, is_express=None, is_multibox=None, multi_box_qty=None, optional=None, order_id=None, order_number=None, parent_posting_number=None, pickup_code_verified_at=None, posting_number=None, product_exemplars=None, products=None, provider_status=None, prr_option=None, related_postings=None, requirements=None, shipment_date=None, status=None, substatus=None, previous_substatus=None, tpl_integration_type=None, tracking_number=None, tariffication=None):  # noqa: E501
        ...
        if previous_substatus is not None:
            self.previous_substatus = previous_substatus
    ...
    @property
    def optional(self):
        """Gets the optional of this V3FbsPostingDetail.  # noqa: E501


        :return: The optional of this V3FbsPostingDetail.  # noqa: E501
        :rtype: V3FbsPostingDetailOptional
        """
        return self._optional

    @optional.setter
    def optional(self, optional):
        """Sets the optional of this V3FbsPostingDetail.


        :param optional: The optional of this V3FbsPostingDetail.  # noqa: E501
        :type: V3FbsPostingDetailOptional
        """
    ...
    @property
    def previous_substatus(self):
        """Gets the previous_substatus of this V3FbsPostingDetail.  # noqa: E501
        ...
        :return: The previous_substatus of this V3FbsPostingDetail.  # noqa: E501
        :rtype: str
        """
        return self._previous_substatus

    @previous_substatus.setter
    def previous_substatus(self, previous_substatus):
        """Sets the previous_substatus of this V3FbsPostingDetail.

        Предыдущий подстатус отправления. Возможные значения: - `posting_acceptance_in_progress` — идёт приёмка, - `posting_in_arbitration` — арбитраж, - `posting_created` — создано, - `posting_in_carriage` — в перевозке, - `posting_not_in_carriage` — не добавлено в перевозку, - `posting_registered` — зарегистрировано, - `posting_transferring_to_delivery` (`status=awaiting_deliver`) — передаётся в доставку, - `posting_awaiting_passport_data` — ожидает паспортных данных,  - `posting_created` — создано, - `posting_awaiting_registration` — ожидает регистрации, - `posting_registration_error` — ошибка регистрации, - `posting_transferring_to_delivery` (`status=awaiting_registration`) — передаётся курьеру, - `posting_split_pending` — создано, - `posting_canceled` — отменено, - `posting_in_client_arbitration` — клиентский арбитраж доставки, - `posting_delivered` — доставлено, - `posting_received` — получено, - `posting_conditionally_delivered` — условно доставлено, - `posting_in_courier_service` — курьер в пути, - `posting_in_pickup_point` — в пункте выдачи, - `posting_on_way_to_city` — в пути в ваш город, - `posting_on_way_to_pickup_point` — в пути в пункт выдачи, - `posting_returned_to_warehouse` — возвращено на склад, - `posting_transferred_to_courier_service` — передаётся в службу доставки, - `posting_driver_pick_up` — у водителя, - `posting_not_in_sort_center` — не принято на сортировочном центре, - `sent_by_seller` — отправлено продавцом.   # noqa: E501

        :param previous_substatus: The previous_substatus of this V3FbsPostingDetail.  # noqa: E501
        :type: str
        """

        self._previous_substatus = previous_substatus
