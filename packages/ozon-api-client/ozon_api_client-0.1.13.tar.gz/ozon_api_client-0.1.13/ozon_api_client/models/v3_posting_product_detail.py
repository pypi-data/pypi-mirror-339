...
class V3PostingProductDetail(object):
    ...
    def __init__(self, dimensions=None, mandatory_mark=None, name=None, offer_id=None, price=None, jw_uin=None, currency_code=None, is_blr_traceable=None, quantity=None, sku=None):  # noqa: E501
        ...
        if is_blr_traceable is not None:
            self.is_blr_traceable = is_blr_traceable
    ...
    @property
    def is_blr_traceable(self):
        """Gets the is_blr_traceable of this V3PostingProductDetail.  # noqa: E501

        Признак прослеживаемости товара.  # noqa: E501

        :return: The is_blr_traceable of this V3PostingProductDetail.  # noqa: E501
        :rtype: bool
        """
        return self._is_blr_traceable

    @is_blr_traceable.setter
    def is_blr_traceable(self, is_blr_traceable):
        """Sets the is_blr_traceable of this V3PostingProductDetail.

        Признак прослеживаемости товара.  # noqa: E501

        :param is_blr_traceable: The is_blr_traceable of this V3PostingProductDetail.  # noqa: E501
        :type: bool
        """

        self._is_blr_traceable = is_blr_traceable
