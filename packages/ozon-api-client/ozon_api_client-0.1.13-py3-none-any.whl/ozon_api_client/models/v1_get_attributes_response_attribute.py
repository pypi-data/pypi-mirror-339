...
class V1GetAttributesResponseAttribute(object):
    ...
    attribute_map = {
        ...
        'complex_is_collection': 'complex_is_collection'
    }

    def __init__(self, category_dependent=None, description=None, dictionary_id=None, group_id=None, group_name=None, id=None, is_aspect=None, is_collection=None, is_required=None, name=None, type=None, attribute_complex_id=None, max_value_count=None, complex_is_collection=None):  # noqa: E501
        ...
        self._complex_is_collection = None
        ...
        if complex_is_collection is not None:
            self.complex_is_collection = complex_is_collection
    ...
    @property
    def complex_is_collection(self):
        """Gets the complex_is_collection of this V1GetAttributesResponseAttribute.  # noqa: E501

        Признак, что комплексная характеристика — набор значений: - `true`, если комплексная характеристика — набор значений, - `false`, если комплексная характеристика — одно значение.   # noqa: E501

        :return: The complex_is_collection of this V1GetAttributesResponseAttribute.  # noqa: E501
        :rtype: bool
        """
        return self._complex_is_collection

    @complex_is_collection.setter
    def complex_is_collection(self, complex_is_collection):
        """Sets the complex_is_collection of this V1GetAttributesResponseAttribute.

        Признак, что комплексная характеристика — набор значений: - `true`, если комплексная характеристика — набор значений, - `false`, если комплексная характеристика — одно значение.   # noqa: E501

        :param complex_is_collection: The complex_is_collection of this V1GetAttributesResponseAttribute.  # noqa: E501
        :type: bool
        """

        self._complex_is_collection = complex_is_collection
