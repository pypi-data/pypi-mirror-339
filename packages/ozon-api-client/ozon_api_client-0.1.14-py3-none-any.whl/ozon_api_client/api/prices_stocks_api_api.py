...
class PricesStocksAPIApi(object):
    ...
    def product_api_get_product_info_discounted(self, body, client_id, api_key, **kwargs):  # noqa: E501
        ...
        Метод для получения информации о состоянии и дефектах уценённого товара по его SKU. Работает только с уценёнными товарами по схеме FBO. Также метод возвращает SKU основного товара.  # noqa: E501
