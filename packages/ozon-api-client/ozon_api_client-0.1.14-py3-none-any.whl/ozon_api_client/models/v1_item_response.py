...
class V1ItemResponse(object):
    ...
    def __init__(self, icon_path=None, sku=None, name=None, quantity=None, barcode=None, product_id=None, quant=None, is_quant_editable=None, volume_in_litres=None, total_volume_in_litres=None, contractor_item_code=None, sfbo_attribute=None, shipment_type=None, tags=None):  # noqa: E501
    ...
    @property
    def tags(self):
        """Gets the tags of this V1ItemResponse.  # noqa: E501

        Теги товаров из поставки или заявки на поставку.  Возможные значения: - `EVSD_REQUIRED` — товар с сертификацией «Меркурий»; - `MARKING_REQUIRED` — товар с обязательной маркировкой «Честный ЗНАК»; - `MARKING_POSSIBLE` — товар с возможной маркировкой «Честный ЗНАК»; - `JEWELRY` — товар с признаком ювелирного изделия; - `TRACEABLE` — товар с признаком прослеживаемости; - `ETTN_REQUIRED` — товар с признаком прослеживаемости, для которого необходима электронная ТТН; - `UNDEFINED` — неизвестный тег.   # noqa: E501

        :return: The tags of this V1ItemResponse.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this V1ItemResponse.

        Теги товаров из поставки или заявки на поставку.  Возможные значения: - `EVSD_REQUIRED` — товар с сертификацией «Меркурий»; - `MARKING_REQUIRED` — товар с обязательной маркировкой «Честный ЗНАК»; - `MARKING_POSSIBLE` — товар с возможной маркировкой «Честный ЗНАК»; - `JEWELRY` — товар с признаком ювелирного изделия; - `TRACEABLE` — товар с признаком прослеживаемости; - `ETTN_REQUIRED` — товар с признаком прослеживаемости, для которого необходима электронная ТТН; - `UNDEFINED` — неизвестный тег.   # noqa: E501

        :param tags: The tags of this V1ItemResponse.  # noqa: E501
        :type: list[str]
        """
        allowed_values = ["EVSD_REQUIRED", "MARKING_REQUIRED", "MARKING_POSSIBLE", "JEWELRY", "TRACEABLE", "ETTN_REQUIRED", "UNDEFINED"]  # noqa: E501
        if not set(tags).issubset(set(allowed_values)):
            raise ValueError(
