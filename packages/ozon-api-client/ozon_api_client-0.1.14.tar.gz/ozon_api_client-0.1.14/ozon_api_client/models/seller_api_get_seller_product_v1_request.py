...
class SellerApiGetSellerProductV1Request(object):
    ...
    def __init__(self, action_id=None, limit=None, offset=None, last_id=None):  # noqa: E501
    ...
    def action_id(self):
        ...
        Идентификатор акции. Можно получить с помощью метода [/v1/actions](#operation/Promos).  # noqa: E501
    ...
    @property
    def last_id(self):
        """Gets the last_id of this SellerApiGetSellerProductV1Request.  # noqa: E501

        Идентификатор последнего значения на странице. При первом запросе оставьте это поле пустым.  # noqa: E501

        :return: The last_id of this SellerApiGetSellerProductV1Request.  # noqa: E501
        :rtype: float
        """
    ...
    def last_id(self, last_id):
        """Sets the last_id of this SellerApiGetSellerProductV1Request.

        Идентификатор последнего значения на странице. При первом запросе оставьте это поле пустым.  # noqa: E501

        :param last_id: The last_id of this SellerApiGetSellerProductV1Request.  # noqa: E501
        :type: float
        """
