...
class ProductImportProductsPricesRequestPrice(object):
    ...
    swagger_types = {
        ...
        'auto_add_to_ozon_actions_list_enabled': 'str',
        'currency_code': 'str',
        'min_price': 'str',
    ...
    attribute_map = {
        ...
        'auto_add_to_ozon_actions_list_enabled': 'auto_add_to_ozon_actions_list_enabled',
    ...
    def __init__(self, auto_action_enabled='UNKNOWN', auto_add_to_ozon_actions_list_enabled='UNKNOWN', currency_code=None, min_price=None, min_price_for_auto_actions_enabled=None, net_price=None, offer_id=None, old_price=None, price=None, price_strategy_enabled='UNKNOWN', product_id=None, quant_size=None, vat=None):  # noqa: E501
        """ProductImportProductsPricesRequestPrice - a model defined in Swagger"""  # noqa: E501
        self._auto_action_enabled = None
        self._auto_add_to_ozon_actions_list_enabled = None
        ...
        if auto_add_to_ozon_actions_list_enabled is not None:
            self.auto_add_to_ozon_actions_list_enabled = auto_add_to_ozon_actions_list_enabled
    ...
    @property
    def auto_add_to_ozon_actions_list_enabled(self):
        """Gets the auto_add_to_ozon_actions_list_enabled of this ProductImportProductsPricesRequestPrice.  # noqa: E501

        Атрибут для включения и выключения автодобавления товара в акции: - `ENABLED` — включить; - `DISABLED` — выключить; - `UNKNOWN` — ничего не менять, передаётся по умолчанию.  Например, если ранее вы включили автодобавление товара в акции и не хотите выключать его, передавайте `UNKNOWN`.   # noqa: E501

        :return: The auto_add_to_ozon_actions_list_enabled of this ProductImportProductsPricesRequestPrice.  # noqa: E501
        :rtype: str
        """
        return self._auto_add_to_ozon_actions_list_enabled

    @auto_add_to_ozon_actions_list_enabled.setter
    def auto_add_to_ozon_actions_list_enabled(self, auto_add_to_ozon_actions_list_enabled):
        """Sets the auto_add_to_ozon_actions_list_enabled of this ProductImportProductsPricesRequestPrice.

        Атрибут для включения и выключения автодобавления товара в акции: - `ENABLED` — включить; - `DISABLED` — выключить; - `UNKNOWN` — ничего не менять, передаётся по умолчанию.  Например, если ранее вы включили автодобавление товара в акции и не хотите выключать его, передавайте `UNKNOWN`.   # noqa: E501

        :param auto_add_to_ozon_actions_list_enabled: The auto_add_to_ozon_actions_list_enabled of this ProductImportProductsPricesRequestPrice.  # noqa: E501
        :type: str
        """
        allowed_values = ["UNKNOWN", "ENABLED", "DISABLED"]  # noqa: E501
        if auto_add_to_ozon_actions_list_enabled not in allowed_values:
            raise ValueError(
                "Invalid value for `auto_add_to_ozon_actions_list_enabled` ({0}), must be one of {1}"  # noqa: E501
                .format(auto_add_to_ozon_actions_list_enabled, allowed_values)
            )

        self._auto_add_to_ozon_actions_list_enabled = auto_add_to_ozon_actions_list_enabled
    ...
    @property
    def net_price(self):
        """Gets the net_price of this ProductImportProductsPricesRequestPrice.  # noqa: E501

        Себестоимость товара.  # noqa: E501

        :return: The net_price of this ProductImportProductsPricesRequestPrice.  # noqa: E501
        :rtype: str
        """
    ...
    def net_price(self, net_price):
        """Sets the net_price of this ProductImportProductsPricesRequestPrice.

        Себестоимость товара.  # noqa: E501

        :param net_price: The net_price of this ProductImportProductsPricesRequestPrice.  # noqa: E501
        :type: str
        """
