...
class DeliveryFBSApi(object):
    ...
    def carriage_api_carriage_delivery_list(self, body, client_id, api_key, **kwargs):  # noqa: E501
        """Список методов доставки и отгрузок  # noqa: E501
         ...
         Используйте метод, чтобы получить список созданных отгрузок для метода доставки и их статусы.       # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
