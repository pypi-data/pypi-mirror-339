    ...
    # {
        ...
        # {
            ...
            # {
                ...
                lambda_idx = np.where(np.char.find(member_class, 'lambda') != -1)[0]
                sd_idx = np.where(np.char.find(member_class, 'sd') != -1)[0]
                chol_idx = np.where(np.char.find(member_class, 'chol') != -1)[0]
