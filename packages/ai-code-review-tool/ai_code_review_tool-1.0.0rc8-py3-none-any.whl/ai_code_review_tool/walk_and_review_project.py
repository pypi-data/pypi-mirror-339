import os
from ai_code_review_tool.walk_project import walk_project
from ai_code_review_tool.chunk_file import chunk_file
from ai_code_review_tool.get_code_review_suggestions import get_code_review_suggestions
from ai_code_review_tool.generate_roadmap import generate_roadmap


async def walk_and_review_project(project_root="."):
    """Walk the project directory, review the code, and generate a roadmap."""
    files_to_review = walk_project(project_root)
