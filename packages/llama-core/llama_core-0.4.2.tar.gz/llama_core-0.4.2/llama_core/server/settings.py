...
class ModelSettings(BaseSettings):
    ...
    split_mode: int = Field(
        default=llama_core.LLAMA_SPLIT_MODE_LAYER,
    ...
    use_mmap: bool = Field(
        default=llama_core.llama_supports_mmap(),
        description="Use mmap.",
    )
    use_mlock: bool = Field(
        default=llama_core.llama_supports_mlock(),
    ...
    rope_scaling_type: int = Field(
        default=llama_core.LLAMA_ROPE_SCALING_TYPE_UNSPECIFIED
    )
