...
from llama_core.server.model import (
    LlamaProxy,
)
from llama_core.server.settings import (
    ConfigFileSettings,
    Settings,
    ModelSettings,
    ServerSettings,
)
from llama_core.server.types import (
...
from llama_core.server.errors import RouteErrorHandler
...
def create_app(
    ...
    app = FastAPI(
        ...
        version=llama_core.__version__,
...
def prepare_request_resources(
    ...
    if body.grammar is not None:
        kwargs["grammar"] = llama_core.LlamaGrammar.from_string(body.grammar)

    if body.min_tokens > 0:
        _min_tokens_logits_processor = llama_core.LogitsProcessorList(
            [llama_core.MinTokensLogitsProcessor(body.min_tokens, llama.token_eos())]
        )
...
@router.post(
    ...
    response_model=Union[
        llama_core.CreateCompletionResponse,
        str,
    ],
    responses={
        "200": {
    ...
    if kwargs.get("stream", False):
        ...
        return EventSourceResponse(
            ...
            data_sender_callable=partial(  # type: ignore
                ...
                llama_call=llama_core.Llama.__call__,
                kwargs=kwargs,
            ),
            sep="\n",
...
@router.post(
    ...
    summary="Chat",
    dependencies=[Depends(authenticate)],
    response_model=Union[llama_core.ChatCompletion, str],
    responses={
        "200": {
            "description": "Successful Response",
            "content": {
    ...
    if kwargs.get("stream", False):
        ...
        return EventSourceResponse(
            ...
            data_sender_callable=partial(  # type: ignore
                ...
                body=body,
                body_model=body_model,
                llama_call=llama_core.Llama.create_chat_completion,
                kwargs=kwargs,
            ),
            sep="\n",
            ping_message_factory=_ping_message_factory,
