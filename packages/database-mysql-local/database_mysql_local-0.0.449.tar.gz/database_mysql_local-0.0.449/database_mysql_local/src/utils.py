...
def process_insert_data_dict(data_dict: dict | None) -> Tuple[str, str, tuple]:
    ...
    for key, value in data_dict.items():
        ...
        is_subclass = issubclass(type(value), ToSQLInterface)
        print(f"key: {key}, value: {value}, is_subclass: {is_subclass}")

        is_subclass_1 = issubclass(OurPoint, ToSQLInterface)
        print(f"key: {key}, value: {value}, is_subclass_1: {is_subclass_1}")
