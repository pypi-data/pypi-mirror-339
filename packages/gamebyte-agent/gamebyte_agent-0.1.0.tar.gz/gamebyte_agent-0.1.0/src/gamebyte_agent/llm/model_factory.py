...
from gamebyte_agent.core.exceptions import ModelConfigError
from gamebyte_agent.core.request_params import RequestParams
from gamebyte_agent.llm.augmented_llm_passthrough import PassthroughLLM
from gamebyte_agent.llm.augmented_llm_playback import PlaybackLLM
...
from gamebyte_agent.mcp.interfaces import AugmentedLLMProtocol

# from gamebyte_agent.workflows.llm.augmented_llm_deepseek import DeekSeekAugmentedLLM
...
class ModelFactory:
    ...
    DEFAULT_PROVIDERS = {
        ...
        "llama-scout": Provider.OPENROUTER,
        "llama-maverick": Provider.OPENROUTER,
        "reka-flash": Provider.OPENROUTER,
    ...
    MODEL_ALIASES = {
        ...
        "llama-maverick": "openrouter:meta-llama/llama-4-maverick:free",
    ...
    def parse_model_string(cls, model_string: str) -> ModelConfig:
        ...
        # Check for provider in dot notation if no colon provider was found
        if provider is None and len(model_parts) > 1:
