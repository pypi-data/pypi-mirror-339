...
import gamebyte_agent
import gamebyte_agent.core
import gamebyte_agent.core.prompt
...
class AgentMCPServer:
    ...
    def register_agent_tools(self, agent_name: str, agent) -> None:
        ...
        async def get_history_prompt() -> list:
            ...
            prompt_messages = gamebyte_agent.core.prompt.Prompt.from_multipart(multipart_history)
