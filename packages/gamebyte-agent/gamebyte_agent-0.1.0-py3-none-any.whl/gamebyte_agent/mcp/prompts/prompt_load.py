...
from gamebyte_agent.mcp import mime_utils, resource_utils
from gamebyte_agent.mcp.prompt_message_multipart import PromptMessageMultipart
from gamebyte_agent.mcp.prompts.prompt_template import (
    PromptContent,
    PromptTemplate,
...
def load_prompt(file: Path) -> List[PromptMessage]:
    ...
    if file_str.endswith(".json"):
        ...
        from gamebyte_agent.mcp.prompt_serialization import load_messages_from_json_file
