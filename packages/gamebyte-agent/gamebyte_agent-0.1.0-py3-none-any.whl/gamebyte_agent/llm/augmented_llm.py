...
from gamebyte_agent.context_dependent import ContextDependent
from gamebyte_agent.core.exceptions import PromptExitError
from gamebyte_agent.core.prompt import Prompt
from gamebyte_agent.core.request_params import RequestParams
from gamebyte_agent.event_progress import ProgressAction
from gamebyte_agent.llm.memory import Memory, SimpleMemory
from gamebyte_agent.llm.sampling_format_converter import (
    BasicFormatConverter,
    ProviderFormatConverter,
)
from gamebyte_agent.logging.logger import get_logger
from gamebyte_agent.mcp.interfaces import (
    AugmentedLLMProtocol,
    ModelT,
)
from gamebyte_agent.mcp.mcp_aggregator import MCPAggregator
from gamebyte_agent.mcp.prompt_message_multipart import PromptMessageMultipart
from gamebyte_agent.mcp.prompt_render import render_multipart_message
from gamebyte_agent.ui.console_display import ConsoleDisplay
...
if TYPE_CHECKING:
    from gamebyte_agent.agents.agent import Agent
    from gamebyte_agent.context import Context
...
class AugmentedLLM(ContextDependent, AugmentedLLMProtocol, Generic[MessageParamT, MessageT]):
    ...
    async def _save_history(self, filename: str) -> None:
        ...
        """
        from gamebyte_agent.mcp.prompt_serialization import save_messages_to_file
