...
from gamebyte_agent import config
from gamebyte_agent.app import MCPApp
from gamebyte_agent.context import Context
from gamebyte_agent.core.agent_app import AgentApp
from gamebyte_agent.core.direct_decorators import (
...
from gamebyte_agent.core.direct_factory import (
    create_agents_in_dependency_order,
    get_model_factory,
)
from gamebyte_agent.core.error_handling import handle_error
from gamebyte_agent.core.exceptions import (
    AgentConfigError,
...
from gamebyte_agent.core.validation import (
...
class FastAgent:
    ...
    def _load_config(self) -> None:
        ...
        from gamebyte_agent.config import _settings, get_settings
        ...
        try:
            async with self.app.run():
                ...
                if (
                    ...
                    from gamebyte_agent.progress_display import progress_display
                ...
                if hasattr(self, "args") and self.args.server:
                    try:
                        ...
                        from gamebyte_agent.mcp_server import AgentMCPServer
