...
Feature: Test RabbitMQ module
    ...
    Scenario: Simple queue and multiple messages
        ...
        When wait consumer CONSUMER stops to receive messages (first timeout: 1 s)
    ...
    Scenario: Multiple publishers and consumers (blocking connection)
        ...
        When wait consumer CONSUMER_1 stops to receive messages (first timeout: 1 s)
        When wait consumer CONSUMER_2 stops to receive messages (first timeout: 0.1 s)
        When wait consumer CONSUMER_3 stops to receive messages (first timeout: 0.1 s)
