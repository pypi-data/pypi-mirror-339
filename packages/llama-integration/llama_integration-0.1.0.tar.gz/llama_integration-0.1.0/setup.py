#!/usr/bin/env python3
"""
Llama Integration - Python package for LlamaSearch AI
"""

from setuptools import setup, find_packages

setup(
    name="llama_integration",
    version="0.1.0",
...
[![Python Version](https://img.shields.io/badge/python-3.8+-blue.svg)]() <!-- Add appropriate Python version support -->",
    long_description="""# llama-integration
...
""",
    ...
    url="https://github.com/llamasearchai/llama-integration",
    project_urls={
        "Documentation": "https://github.com/llamasearchai/llama-integration",
        "Bug Tracker": "https://github.com/llamasearchai/llama-integration/issues",
        "Source Code": "https://github.com/llamasearchai/llama-integration",
    },
