...
#   -----------------------------------------------------------------
        ...
        self.tableWidget_auto_channels_settings_TS_veryfications.cellClicked.connect(self.add_sensor_to_measuring_tab)
    ...
    def add_temp_to_tab(self, selected_row):
        if self.auto_measuring_mode != 'veryfication_TS':
            parent = QApplication.instance().sender()
    ...
    def coef_edit(self):
        ...
        coef_val, ok = QInputDialog.getDouble(button, coef, 'Введите новое значение:', coef_val)
    ...
    def set_auto_veryfication_TS_mode(self):
        ...
        self.table_name = 'self.tableWidget_auto_channels_settings_TS_veryfications'
