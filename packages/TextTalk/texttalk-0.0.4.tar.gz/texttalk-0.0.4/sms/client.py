...
class Message:
    ...
    """
    def __init__(self, to_number: str, message: str, message_id):
        """
    ...
    def __repr__(self) -> str:
        ...
        """
        return f"Message(to_number='{self.to_number}', message='{self.message}', message_id='{self.message_id}')"
...
class SMSClient:
    ...
    def send_bulk_sms(
        ...
        payload = [{
            ...
            "clientsmsid": message.message_id,
            "shortcode": self.config.shortcode,
            "pass_type": "plain"
