...
inline constexpr uint32_t kMaxNbDescriptors = 256;
// The number of descriptors to program skipdma external memory
inline constexpr uint8_t kSkipDmaStoreNbMemDescriptors = 4;
inline constexpr uint8_t kSkipDmaLoadNbMemDescriptors = 1;
}  // namespace dma
}  // namespace akida
