...
class ReportLoaderClientImpl(ReportLoaderApi):
    def __init__(
        ...
        self._persister = ReportPersisterClient(client)
    ...
    def delete_persisted(self, name_or_id: list[str | int]) -> None:
        return self._persister.delete_persisted(name_or_id)
...
class AsyncReportLoaderClientImpl(AsyncReportLoaderApi):
    def __init__(
        ...
        self._portfoliohierarchy_api = portfoliohierarchy_api
        self._persister = AsyncReportPersisterClient(client)
    ...
    async def delete_persisted(self, name_or_id: list[str | int]) -> None:
        return await self._persister.delete_persisted(name_or_id)
...
class AsyncReportPersisterClient(AsyncReportPersister):
    ...
    async def load_persisted(
        ...
        if isinstance(name_or_id, int):
            identifier = (await accessor_settings.ids())[name_or_id]
        else:
...
class ReportPersisterClient(ReportPersister):
    ...
    def load_persisted(self, name_or_id: str | int) -> AsyncPortfolioReportAccessor:
        ...
        identifier: str
        if isinstance(name_or_id, int):
            identifier = (accessor_settings.ids())[name_or_id]
        else:
            identifier = name_or_id
