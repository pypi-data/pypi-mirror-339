...
class LLModel(CythonBaseModel):
    ...
    def _stream(self, output: Iterator[LLMResult]) -> Iterator[OutputType]: ...
    def clear(self) -> None: ...
    def close(self) -> None: ...
    ...
    def pretty_parser(self, output: LLMResult) -> OutputType: ...
    def _parser(self, output: LLMResult) -> OutputType: ...
