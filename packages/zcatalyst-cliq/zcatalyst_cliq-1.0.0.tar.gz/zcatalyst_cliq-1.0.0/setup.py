...
meta_file = path.join(path.dirname(path.abspath(__file__)),'zcatalyst_cliq','__version__.py')
meta = {}
...
setup(
    ...
    description='ZCatalyst Cliq SDK for Python',
    ...
    install_requires=['zcatalyst-sdk'],
