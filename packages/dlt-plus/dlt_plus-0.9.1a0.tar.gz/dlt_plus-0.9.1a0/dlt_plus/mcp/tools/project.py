...
def add_source(source_name: str, source_type: str, ctx: Context = None) -> None:
    ...
    cli_helpers.add_source(state, source_name, source_type)
    state.commit()
...
def available_source_templates() -> dict[str, str]:
    """List all available source templates"""
    return cli_helpers.get_available_source_templates()


def available_sources() -> dict[str, dict[str, str]]:
    """List all available source types and templates"""
    return {
        "types": cli_helpers.get_available_source(),
