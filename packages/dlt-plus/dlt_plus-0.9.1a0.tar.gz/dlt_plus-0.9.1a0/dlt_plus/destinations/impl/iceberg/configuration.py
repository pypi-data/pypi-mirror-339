...
IcebergCredentials = Union[IcebergSqlCatalogCredentials, IcebergRESTCatalogCredentials]
CatalogType = Literal["rest", "sql"]  # "glue"
...
class CatalogCapabilities(BaseConfiguration):
    ...
    max_identifier_length: int = (
        255  # applies to destination caps, varies per catalog (255 is for sql catalog)
    )
