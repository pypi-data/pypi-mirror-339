...
class RecordWorker(QObject):
    ...
    def __init__(self, robot: Robot, main_window: MainWindow, config: RecordControlConfig) -> None:
        """
    ...
    def run(self) -> None:
        ...
        """
        try:
            self.main_window.record(self.robot, self.config)  # Invoke the recording method.
