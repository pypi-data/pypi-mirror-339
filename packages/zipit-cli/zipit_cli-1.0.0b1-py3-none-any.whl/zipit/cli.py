...
def zip_project_folder(project_path: Path, zip_name: str = None, verbose: bool = False,
                       ...
                       show_info: bool = False, zip_type: str = 'outer'):
    ...
    for root, dirs, files in os.walk(project_path):
        ...
        for file in files:
            ...
            zip_path_inside = rel_path if zip_type == 'inner' else Path(project_path.name) / rel_path
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            ...
            "  zipit --zip-type inner          # Exclude folder from inside zip\n"
            "\n"
            "Notes:\n"
    ...
    parser.add_argument('--zip-type', choices=['inner', 'outer'], default='outer',
                        help="Control folder structure inside the zip: 'inner' = only contents, 'outer' = include folder (default)")
