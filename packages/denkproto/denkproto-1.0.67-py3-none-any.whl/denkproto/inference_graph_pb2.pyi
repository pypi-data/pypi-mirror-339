...
class ExecutionProvider(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    DML: _ClassVar[ExecutionProvider]
...
class ImagePatchesNode(_message.Message):
    __slots__ = ("name", "input_image", "input_bounding_boxes", "input_target_size", "output_port_name", "input_maximum_iterations", "session_info")
    ...
    session_info: SessionInfo
    def __init__(self, name: _Optional[str] = ..., input_image: _Optional[str] = ..., input_bounding_boxes: _Optional[str] = ..., input_target_size: _Optional[_Union[ImagePatchesNode.TargetSizeSource, _Mapping]] = ..., output_port_name: _Optional[str] = ..., input_maximum_iterations: _Optional[_Union[ImagePatchesNode.MaxIterationsCountSource, _Mapping]] = ..., session_info: _Optional[_Union[SessionInfo, _Mapping]] = ...) -> None: ...
