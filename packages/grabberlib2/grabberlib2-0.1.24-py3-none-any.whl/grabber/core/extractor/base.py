...
from .constants import HEADERS_MAPPING, QUERY_MAPPING, PAGE_TITLE_SPLIT_MAPPING
...
class BaseExtractor(abc.ABC):
    ...
    def run(self) -> None:
        ...
        for idx, source_url in tqdm_sources_iterable:
            ...
            ordered_unique_img_urls = IndexedSet(list(sorted(unique_img_urls, key=lambda x: x[0])))
