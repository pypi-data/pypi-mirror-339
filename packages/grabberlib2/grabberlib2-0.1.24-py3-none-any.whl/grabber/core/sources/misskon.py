...
async def get_pages_from_pagination(url: str, headers: Optional[dict] = None) -> List[str]:
    pagination_query = "div.page-link a.post-page-numbers"
    first_page_query = "div.page-link span.post-page-numbers.current"
...
async def get_sources_for_misskon(
    sources: List[str],
    entity: str,
