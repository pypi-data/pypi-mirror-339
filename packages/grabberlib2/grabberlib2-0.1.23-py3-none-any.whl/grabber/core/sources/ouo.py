...
async def ouo_bypass(sources: List[str]):
    for url in sources:
        ...
        data = {"original_link": url, "bypassed_link": res.headers.get("Location")}
        print(f"Bypassed Link: {data['bypassed_link']}")
