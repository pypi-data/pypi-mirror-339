...
VERSION = "0.0.0.8.6"  # la version doit être supérieure à la précédente sinon la publication sera refusée
...
ENTRY_POINTS = {
    "orange.widgets": (
        "Advanced Artificial Intelligence Tools = orangecontrib.IOIT.widgets",
    )
}
# /!\ les noms de fichier 'orangecontrib.hkh_bot.widgets' doivent correspondre à l'arborescence
