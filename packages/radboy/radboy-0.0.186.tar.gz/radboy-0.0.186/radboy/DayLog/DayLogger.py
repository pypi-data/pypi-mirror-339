...
"PalletCount",]
        ...
        with Session(ENGINE) as session:
            ...
            for num,i in enumerate(query):
                ...
                #else:
                #    pass
        print(f"{Fore.orange_red_1}Total Expense:{Fore.light_magenta}{total_expense}{Style.reset}")    
