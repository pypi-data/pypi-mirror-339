...
const activate = (app, tracker, themeManager, annotationModel, browserFactory, workerRegistry, externalCommandRegistry, contentFactory, editorServices, rendermime, consoleTracker, launcher, palette, drive) => {
    ...
    if (drive) {
        drive.sharedModelFactory.registerDocumentFactory(CONTENT_TYPE, jcadSharedModelFactory);
    }
