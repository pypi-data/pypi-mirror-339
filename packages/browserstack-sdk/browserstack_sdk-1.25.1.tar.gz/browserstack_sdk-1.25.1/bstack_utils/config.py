...
conf = {
    bstack1ll1l1_opy_ (u"ࠬࡧࡰࡱࡡࡤࡹࡹࡵ࡭ࡢࡶࡨࠫᙣ"): False,
    bstack1ll1l1_opy_ (u"࠭ࡢࡴࡶࡤࡧࡰࡥࡳࡦࡵࡶ࡭ࡴࡴࠧᙤ"): True,
    bstack1ll1l1_opy_ (u"ࠧࡴ࡭࡬ࡴࡤࡹࡥࡴࡵ࡬ࡳࡳࡥࡳࡵࡣࡷࡹࡸ࠭ᙥ"): False
}
class Config(object):
    instance = None
    def __init__(self):
    ...
    @classmethod
    def bstack1l11l1l1ll_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name, bstack11lll11l11l_opy_=None):
        return self._11lll111lll_opy_.get(property_name, bstack11lll11l11l_opy_)
    def bstack1ll11111_opy_(self, property_name, bstack11lll11l111_opy_):
        self._11lll111lll_opy_[property_name] = bstack11lll11l111_opy_
    def bstack1l1ll1111_opy_(self, val):
        self._11lll111lll_opy_[bstack1ll1l1_opy_ (u"ࠨࡵ࡮࡭ࡵࡥࡳࡦࡵࡶ࡭ࡴࡴ࡟ࡴࡶࡤࡸࡺࡹࠧᙦ")] = bool(val)
    def bstack111l111lll_opy_(self):
        return self._11lll111lll_opy_.get(bstack1ll1l1_opy_ (u"ࠩࡶ࡯࡮ࡶ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࡠࡵࡷࡥࡹࡻࡳࠨᙧ"), False)