...
extern struct response_wrapper sendScenarioWrapper(char* address, char* dockerNetwork, char* namespace, char* kubePath, char* kubeContext, char* clusterName, char* scenarios, char* until, char* loadTestConfig, char* dependenciesFilePath, char* workerImage, GoUint8 blocked, GoUint8 localImage);
...
extern char* traceCollectWrapper(char* output, char* workerContainerName);
