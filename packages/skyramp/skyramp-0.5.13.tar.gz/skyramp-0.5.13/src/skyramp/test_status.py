...
class TestStat:
    ...
    def __init__(self, options: dict):
        ...
        self.l99th_latency = options.get("L99thLatency", "")
        self.l95th_latency = options.get("L95thLatency", "")
        self.l90th_latency = options.get("L90thLatency", "")
...
class TestResult:
    ...
    def get_response_value(self, json_path=""):
        ...
        return _get_response_value(self.response_body_raw, json_path)
