...
import abc
from typing import Any, Generic, List, Self, TypeVar, Optional
...
class Player(BaseModel[PlayerOriginal], Generic[BaseModelType]):
    ...
    parameters: Optional[BaseModelType] = None
    ...
    def from_original(cls, value: PlayerOriginal) -> Self:
        return Player(
            ...
            parameters=BaseModelType.model_validate(value.parameters) if value.parameters else None
        )
    ...
    def to_original(self) -> PlayerOriginal:
        return PlayerOriginal(
            ...
            parameters=self.parameters.model_dump() if self.parameters else None,
        )
