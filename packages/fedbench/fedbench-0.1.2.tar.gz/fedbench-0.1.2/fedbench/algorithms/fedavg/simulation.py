...
def run_fedavg(
    ...
    fed_avg_client_fn = gen_client_fn(
    ...
    fed_avg_evaluate_fn = gen_evaluate_fn(
    ...
    # Initialize server
    fed_avg_server = Server(
        strategy=fed_avg_strategy,
        client_manager=SimpleClientManager(),
    )

    # Start simulation
    fedavg_history = start_simulation(
