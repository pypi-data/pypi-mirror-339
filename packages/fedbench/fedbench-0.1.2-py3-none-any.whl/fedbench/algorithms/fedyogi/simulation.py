...
def run_fedyogi(
    ...
    """Run the FedYogi server with the provided configuration.
    ...
    fed_yogi_client_fn = gen_client_fn(
    ...
    fed_yogi_evaluate_fn = gen_evaluate_fn(
    ...
    fed_yogi_strategy = FedYogi(
        ...
        evaluate_fn=fed_yogi_evaluate_fn,
    ...
    # Initialize server
    fed_adam_server = Server(
        strategy=fed_yogi_strategy,
        client_manager=SimpleClientManager(),
    )

    # Start simulation
    fedyogi_history = start_simulation(
        server=fed_adam_server,
        client_fn=fed_yogi_client_fn,
