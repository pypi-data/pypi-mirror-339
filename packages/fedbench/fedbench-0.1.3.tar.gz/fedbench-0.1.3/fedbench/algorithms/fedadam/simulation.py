...
def run_fedadam(
    ...
    """Run the Fedadam server with the provided configuration.
    ...
    fed_adam_client_fn = gen_client_fn(
    ...
    fed_adam_evaluate_fn = gen_evaluate_fn(
    ...
    # Start simulation
    fedadam_history = start_simulation(
