...
from dtx.core.models.evaluator import EvaluatorInScope
from dtx.core.models.providers.base import ProviderType
from dtx.core.models.providers.gradio import GradioProvider
from dtx.core.models.providers.hf import HFProvider
from dtx.core.models.providers.http import HttpProvider
from dtx.core.models.providers.ollama import OllamaProvider
...
class ProvidersWithEnvironments(BaseModel):
    providers: Optional[
        List[HttpProvider | HFProvider | GradioProvider | OllamaProvider]
    ...
    def validate_providers(cls, values):
        ...
        for provider_data in providers_data:
            if isinstance(provider_data, dict):
                ...
                elif provider_id == ProviderType.HF_MODEL.value:
