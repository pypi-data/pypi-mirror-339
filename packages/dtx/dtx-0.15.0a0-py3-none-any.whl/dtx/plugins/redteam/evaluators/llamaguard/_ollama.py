...
from dtx.core.models.prompts import BaseMultiTurnConversation
from dtx.core.models.results import EvaluationStatus
...
class Ollama_LlamaGuard(BaseEvaluator):
    ...
    def __init__(
        ...
        if self.client:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    self.logger.error("Failed to connect to the remote endpoint.")
        ...
        # # if ollama available and model name is not provided, select the smallest model
        # if self.available and not self.model_name:
