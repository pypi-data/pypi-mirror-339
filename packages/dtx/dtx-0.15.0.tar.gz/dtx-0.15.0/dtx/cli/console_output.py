...
from dtx.core.models.results import EvalResult
...
class RichResultVisualizer:
    ...
    def add_result(self, result):
        ...
        """
        self.results.append(result)
        self.total_tests += result.stats.total
        self.total_passed += result.stats.success
        self.total_failed += result.stats.failed
