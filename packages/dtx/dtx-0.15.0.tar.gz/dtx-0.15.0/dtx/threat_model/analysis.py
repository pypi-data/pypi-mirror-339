...
from ..core.models.scope import RedTeamScope, Agent
...
class AppRiskAnalysis:
    ...
    def analyze(self, scope: RedTeamScope) -> AnalysisResult:
        ...
        risks = self._fetch_risks_in_batches(plugin_ids, agent_descriptions, max_plugins)
        
        apps_threats = AppRisks(risks=risks)        
        return AnalysisResult(
            threat_analysis=threat_analysis,
            threats=apps_threats
        )
        
    def _fetch_risks_in_batches(self, plugin_ids: List[str], agent_descriptions: str, max_plugins: int) -> List[str]:
        """
    ...
    def _decide_max_plugins(self, user_provided_max_plugins: int, num_of_plugins: int) -> int:
        """
