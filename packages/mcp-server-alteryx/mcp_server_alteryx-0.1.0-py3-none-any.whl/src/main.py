    ...
    def update_workflow_name_or_comment(workflow_id: str, name: str, comment    : str):
        ...
        try:
            ...
            contract = server_client.UpdateWorkflowContract(
                ...
                version_id=workflow_details.version_id, 
                make_published=workflow_details.make_published, 
                owner_id=workflow_details.owner_id, 
                worker_tag=workflow_details.worker_tag, 
                district_tags=workflow_details.district_tags, 
                comment=comment if comment else workflow_details.comment, 
                ...
                workflow_credential_type=workflow_details.workflow_credential_type,
                credential_id=workflow_details.credential_id
            )
