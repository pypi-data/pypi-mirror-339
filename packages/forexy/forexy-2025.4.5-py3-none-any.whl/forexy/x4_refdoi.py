...
def main(file_x4,file_dict,file_doi,email,force0):
...
# Input parameters for X4TOJ4
  ...
  key_keep = "REFERENCE REL-REF MONIT-REF" # keep reference keywords only
...
def get_input(args):
  ...
  return file_x4,file_dict,file_doi,email,force0
...
if __name__ == "__main__":
  args=get_args(ver)
  (file_x4,file_dict,file_doi,email,force0)=get_input(args)
  main(file_x4,file_dict,file_doi,email,force0)
  exit()
