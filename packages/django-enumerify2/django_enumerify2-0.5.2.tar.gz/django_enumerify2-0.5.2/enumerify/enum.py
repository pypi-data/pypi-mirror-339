...
class Enum(object):
    ...
    def get_as_tuple_list(cls):
        """
        Returns an unsorted list of tuples formatted as [('VARIABLE1', 1), ...]
        """
    ...
    def get_as_dict(cls):
        """
        Returns an unsorted dict with class variables
        """
        items = {}
    ...
    @classmethod
    def choicify(cls):
        warnings.warn("Method 'Enum.choicify()' will be deprecated. Use 'Enum.choices()' instead!", DeprecationWarning)
        return cls.choices()
