...
TEST_AZURE_ENDPOINT = os.getenv("AZURE_OPENAI_ENDPOINTS_BACKUP", "")
TEST_AZURE_DEPLOYMENT = os.getenv("AZURE_OPENAI_DEPLOYMENT_NAME_BACKUP", "")
TEST_AZURE_API_VERSION = os.getenv("AZURE_OPENAI_API_VERSION", "")
TEST_EMBEDDING_MODEL_NAME = os.getenv("EMBEDDING_MODEL_NAME", "")
TEST_CHAT_MODEL_NAME = os.getenv("CHAT_MODEL_NAME", "")
...
def workspace() -> Workspace:
    ...
    return Workspace(
        ...
        azure_deployment_chat=TEST_CHAT_MODEL_NAME,
    )
