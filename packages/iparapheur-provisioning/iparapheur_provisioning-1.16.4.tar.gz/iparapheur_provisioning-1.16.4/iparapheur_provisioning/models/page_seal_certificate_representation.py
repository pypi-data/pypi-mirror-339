...
class PageSealCertificateRepresentation(BaseModel):
    """
    ...
    content: Optional[List[Optional[SealCertificateRepresentation]]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageSealCertificateRepresentation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageSealCertificateRepresentation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [SealCertificateRepresentation.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
