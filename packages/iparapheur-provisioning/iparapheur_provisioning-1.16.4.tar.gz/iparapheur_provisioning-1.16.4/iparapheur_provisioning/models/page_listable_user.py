...
class PageListableUser(BaseModel):
    """
    PageListableUser
    """ # noqa: E501
    ...
    content: Optional[List[ListableUser]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageListableUser from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageListableUser from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [ListableUser.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
