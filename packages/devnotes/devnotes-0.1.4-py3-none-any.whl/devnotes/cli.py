...
app_cli = typer.Typer(
    help="DevNotes - Strumento per la gestione di note di sviluppo e task",
    add_completion=True,
)
console = Console()

# Crea un gruppo di comandi per Trello
trello_app = typer.Typer(help="Comandi per l'integrazione con Trello")
...
def setup_completion():
    """
    Mostra istruzioni su come abilitare l'autocompletamento dei comandi.
    
    Supporta Bash, Zsh e Fish.
    """
    console.print("[bold]Istruzioni per abilitare l'autocompletamento dei comandi[/bold]")
    console.print("\n[yellow]Per Bash:[/yellow]")
    console.print("Aggiungi questa riga al tuo file ~/.bashrc:")
    console.print("[cyan]eval \"$(devnotes --completion bash)\"[/cyan]")
    
    console.print("\n[yellow]Per Zsh:[/yellow]")
    console.print("Aggiungi questa riga al tuo file ~/.zshrc:")
    console.print("[cyan]eval \"$(devnotes --completion zsh)\"[/cyan]")
    
    console.print("\n[yellow]Per Fish:[/yellow]")
    console.print("Aggiungi questa riga al tuo file ~/.config/fish/config.fish:")
    console.print("[cyan]eval (devnotes --completion fish)[/cyan]")
    
    console.print("\n[bold green]Dopo aver aggiunto la riga appropriata, riavvia il terminale o esegui 'source' sul file di configurazione.[/bold green]")
    console.print("\nUna volta configurato, puoi digitare 'devnotes' seguito da TAB per vedere i comandi disponibili.")
    console.print("Esempio: 'devnotes t<TAB>' mostrerà task-list, task-add-interactive, task-edit, task-done, trello")
