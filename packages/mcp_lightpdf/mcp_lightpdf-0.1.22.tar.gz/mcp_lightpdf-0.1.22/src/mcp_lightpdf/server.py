...
async def process_edit_file(
    ...
    if edit_type == "decrypt":
        ...
        return await editor.add_watermark(
            ...
            deg=extra_params.get("deg", "-45"),
            range=extra_params.get("range", "all"),
        ...
        return await editor.encrypt_pdf(
            ...
            original_password=extra_params.get("original_password")
        )
        ...
        return await editor.split_pdf(
            file_path=file_path,
            pages=extra_params.get("pages", "all"),
            password=password,
        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "range": {
                        "type": "string",
                        "description": "页面范围，例如 '1,3,5-7' 或 'all' 表示所有页面",
                        "default": "all"
                    },
                    "layout": {
                        "type": "string",
        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "pages": {
                        "type": "string",
                        "description": "指定要拆分的页面范围，例如 '1,3,5-7' 或 'all' 表示所有页面",
                        "default": "all"
                    },
                    "split_type": {
                        "type": "string",
                        "description": "拆分类型: 按页拆分(page)或按范围拆分(range)",
                        "enum": ["page", "range"],
                        "default": "page"
                    },
                    "merge_all": {
                        "type": "integer",
                        "description": "是否将结果合并为一个文件: 0=否，1=是",
                        "enum": [0, 1],
                        "default": 1
                    }
                },
        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "angle": {
                        "type": "object",
                        "description": "旋转角度配置，格式为{页码范围:角度}，如{'1-3':'90','4':'-90'}",
...
async def handle_call_tool(name: str, arguments: dict | None) -> list[types.TextContent | types.ImageContent | types.EmbeddedResource]:
    ...
    TOOL_CONFIG = {
        ...
        "rotate_pdf": {
            ...
            "is_edit_operation": True,  # 标记为编辑操作
            "param_keys": ["angle"]  # 需要从arguments获取的参数
        }
    }
    ...
    if name in TOOL_CONFIG:
        ...
        if "param_keys" in config:
            operation_config["extra_params"] = {
                key: arguments.get(key, DEFAULTS.get(key)) 
                for key in config["param_keys"] if key in arguments or key in DEFAULTS
            }
