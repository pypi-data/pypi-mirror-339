        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "range": {
                        "type": "string",
                        "description": "页面范围，例如 '1,3,5-7' 或 '' 表示所有页面",
                        "default": ""
                    },
                    "layout": {
                        "type": "string",
        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "pages": {
                        "type": "string",
                        "description": "指定要拆分的页面范围，例如 '1,3,5-7' 或 '' 表示所有页面",
                        "default": ""
                    },
                    "split_type": {
                        "type": "string",
        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "angle": {
                        "type": "object",
                        "description": "旋转角度配置，格式为{角度:页码范围}，角度的可选值为90、180、270，如{'90':'1-3','270':'4'}",
                        "additionalProperties": {
                            "type": "string",
                            "description": "页码范围，例如 '1-3'"
                        }
                    }
                },
