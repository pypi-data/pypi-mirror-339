...
class AstralBaseCompletionRequest(AstralBaseRequest):
    ...
    """
    # System Message
    system_message: Optional[SystemMessage] | NotGiven = Field(default=NOT_GIVEN, description="The system message to send to the model. Defaults to model provider's default system message.")
