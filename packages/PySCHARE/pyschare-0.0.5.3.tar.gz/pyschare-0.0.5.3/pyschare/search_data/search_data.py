...
from PySCHARE.pyschare.helpers.constants import search_helper_text, MAIN_TITLE, FPATH
from PySCHARE.pyschare.helpers.create_widgets import create_helper, create_select_dropdown, create_button
from PySCHARE.pyschare.helpers.styles import get_styles, button_style
from PySCHARE.pyschare.helpers.data_functions import get_data_dir, get_search_table_info
    ...
    def update_table(self, search_text):
        ...
        if self.dataset_select.value == "None":
            ...
            for idx, ds in self.dataset_info.iterrows():
                ...
                file_path = str(ds['Dictionary_path'])
                try:
