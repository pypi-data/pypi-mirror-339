...
class AutoClicker:
    def __init__(self):
        ...
        self.click_speed = 0  # No delay between clicks - maximum speed
    ...
    def create_header(self):
        ...
        mode_label = ttk.Label(mode_frame, text=self.translator.get_text("mode_super_fast"), font=self.thai_font_bold, foreground=self.colors["accent"])
    ...
    def create_footer(self):
        ...
        # Version info
        version_label = ttk.Label(footer, text=f"{self.program_name} {self.translator.get_text('version')} 1.0.4", font=("TH Sarabun New", 10))
        ...
        while self.running:
            if self.sequence_mode:
                ...
                for position in self.positions:
                    ...
                    # No delay between clicks in regular mode
