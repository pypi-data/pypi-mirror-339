...
from aliyun.bootstrap.envs import DEFAULT_AGENT_URL
from aliyun.bootstrap.utils import get_agent_path, check_network
...
def _create_sitecustomize(pip_path):
    ...
    load the agent through importing aliyun.opentelemetry.instrumentation.auto_instrumentation
    ...
    with open(sitecustomize_path, 'w') as f:
        f.write('from aliyun.opentelemetry.instrumentation.auto_instrumentation import sitecustomize')
