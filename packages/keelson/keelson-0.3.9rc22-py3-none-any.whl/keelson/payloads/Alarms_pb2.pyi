...
class Visual(_message.Message):
    ...
    timestamp: _timestamp_pb2.Timestamp
    description: str
    image: _Image_pb2.RawImage
    compressed_image: _Image_pb2.CompressedImage
    compressed_video: _Image_pb2.CompressedVideo
    def __init__(self, timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., description: _Optional[str] = ..., image: _Optional[_Union[_Image_pb2.RawImage, _Mapping]] = ..., compressed_image: _Optional[_Union[_Image_pb2.CompressedImage, _Mapping]] = ..., compressed_video: _Optional[_Union[_Image_pb2.CompressedVideo, _Mapping]] = ...) -> None: ...
