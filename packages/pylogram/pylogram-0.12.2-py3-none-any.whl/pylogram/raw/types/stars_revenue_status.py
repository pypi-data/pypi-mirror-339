...
class StarsRevenueStatus(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.StarsRevenueStatus`.
    ...
    Parameters:
        current_balance (:obj:`StarsAmount <pylogram.raw.base.StarsAmount>`):
            N/A

        available_balance (:obj:`StarsAmount <pylogram.raw.base.StarsAmount>`):
            N/A

        overall_revenue (:obj:`StarsAmount <pylogram.raw.base.StarsAmount>`):
            N/A
