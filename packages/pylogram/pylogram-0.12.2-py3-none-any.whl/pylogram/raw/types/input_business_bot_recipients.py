...
class InputBusinessBotRecipients(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.InputBusinessBotRecipients`.
    ...
    Parameters:
        ...
        users (List of :obj:`InputUser <pylogram.raw.base.InputUser>`, *optional*):
            N/A

        exclude_users (List of :obj:`InputUser <pylogram.raw.base.InputUser>`, *optional*):
            N/A
