...
class BusinessAwayMessage(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.BusinessAwayMessage`.
    ...
    Parameters:
        ...
        schedule (:obj:`BusinessAwayMessageSchedule <pylogram.raw.base.BusinessAwayMessageSchedule>`):
            N/A

        recipients (:obj:`BusinessRecipients <pylogram.raw.base.BusinessRecipients>`):
            N/A
