...
from typing import BinaryIO, List, Match, Optional, Union

import pylogram
from pylogram import enums, raw, types, utils
...
from ...raw.types import MessageReplyHeader, MessageReplyStoryHeader
...
class Message(Object[raw.base.Message], Update):
    """A message.
    ...
    Parameters:
        ...
        from_user (:obj:`~pylogram.types.User`, *optional*):
            Sender, empty for messages sent to channels.

        sender_chat (:obj:`~pylogram.types.Chat`, *optional*):
        ...
        chat (:obj:`~pylogram.types.Chat`, *optional*):
            Conversation the message belongs to.

        forward_from (:obj:`~pylogram.types.User`, *optional*):
        ...
        forward_from_chat (:obj:`~pylogram.types.Chat`, *optional*):
        ...
        reply_to_message (:obj:`~pylogram.types.Message`, *optional*):
        ...
        service (:obj:`~pylogram.enums.MessageServiceType`, *optional*):
        ...
        media (:obj:`~pylogram.enums.MessageMediaType`, *optional*):
        ...
        entities (List of :obj:`~pylogram.types.MessageEntity`, *optional*):
            For text messages, special entities like usernames, URLs, bot commands, etc. that appear in the text.

        caption_entities (List of :obj:`~pylogram.types.MessageEntity`, *optional*):
            For messages with a caption, special entities like usernames, URLs, bot commands, etc. that appear
            in the caption.

        audio (:obj:`~pylogram.types.Audio`, *optional*):
            Message is an audio file, information about the file.

        document (:obj:`~pylogram.types.Document`, *optional*):
            Message is a general file, information about the file.

        photo (:obj:`~pylogram.types.Photo`, *optional*):
            Message is a photo, information about the photo.

        sticker (:obj:`~pylogram.types.Sticker`, *optional*):
            Message is a sticker, information about the sticker.

        animation (:obj:`~pylogram.types.Animation`, *optional*):
            Message is an animation, information about the animation.

        game (:obj:`~pylogram.types.Game`, *optional*):
            Message is a game, information about the game.

        video (:obj:`~pylogram.types.Video`, *optional*):
            Message is a video, information about the video.

        voice (:obj:`~pylogram.types.Voice`, *optional*):
            Message is a voice message, information about the file.

        video_note (:obj:`~pylogram.types.VideoNote`, *optional*):
        ...
        contact (:obj:`~pylogram.types.Contact`, *optional*):
            Message is a shared contact, information about the contact.

        location (:obj:`~pylogram.types.Location`, *optional*):
            Message is a shared location, information about the location.

        venue (:obj:`~pylogram.types.Venue`, *optional*):
            Message is a venue, information about the venue.

        web_page (:obj:`~pylogram.types.WebPage`, *optional*):
            Message was sent with a webpage preview.

        poll (:obj:`~pylogram.types.Poll`, *optional*):
            Message is a native poll, information about the poll.

        dice (:obj:`~pylogram.types.Dice`, *optional*):
            A dice containing a value that is randomly generated by Telegram.

        new_chat_members (List of :obj:`~pylogram.types.User`, *optional*):
            New members that were added to the group or supergroup and information about them
            (the bot itself may be one of these members).

        left_chat_member (:obj:`~pylogram.types.User`, *optional*):
            A member was removed from the group, information about them (this member may be the bot itself).

        new_chat_title (``str``, *optional*):
            A chat title was changed to this value.

        new_chat_photo (:obj:`~pylogram.types.Photo`, *optional*):
        ...
        pinned_message (:obj:`~pylogram.types.Message`, *optional*):
            Specified message was pinned.
            Note that the Message object in this field will not contain further reply_to_message fields even if it
            is itself a reply.

        game_high_score (:obj:`~pylogram.types.GameHighScore`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the text of this message. Only applicable when using :obj:`Filters.regex <pylogram.Filters.regex>`.

        command (List of ``str``, *optional*):
            A list containing the command and its arguments, if any.
            E.g.: "/start 1 2 3" would produce ["start", "1", "2", "3"].
            Only applicable when using :obj:`~pylogram.filters.command`.

        video_chat_scheduled (:obj:`~pylogram.types.VideoChatScheduled`, *optional*):
            Service message: voice chat scheduled.

        video_chat_started (:obj:`~pylogram.types.VideoChatStarted`, *optional*):
            Service message: the voice chat started.

        video_chat_ended (:obj:`~pylogram.types.VideoChatEnded`, *optional*):
            Service message: the voice chat has ended.

        video_chat_members_invited (:obj:`~pylogram.types.VoiceChatParticipantsInvited`, *optional*):
            Service message: new members were invited to the voice chat.

        web_app_data (:obj:`~pylogram.types.WebAppData`, *optional*):
    ...
    async def get_media_group(self) -> List["types.Message"]:
        """Bound method *get_media_group* of :obj:`~pylogram.types.Message`.
        ...
        Returns:
            List of :obj:`~pylogram.types.Message`: On success, a list of messages of the media group is returned.
    ...
    async def reply_text(
        ...
        reply_to: Union[
            int, raw.types.InputReplyToMessage, raw.types.InputReplyToStory
        ] = None,
        schedule_date: datetime = None,
        protect_content: bool = None,
        reply_markup=None,
    ) -> "Message":
        """Bound method *reply_text* of :obj:`~pylogram.types.Message`.
    ...
    async def reply_animation(
        ...
        Returns:
            On success, the sent :obj:`~pylogram.types.Message` is returned.
            In case the upload is deliberately stopped with :meth:`~pylogram.Client.stop_transmission`, None is returned
            instead.
    ...
    async def reply_cached_media(
        ...
        """Bound method *reply_cached_media* of :obj:`~pylogram.types.Message`.
    ...
    async def reply_chat_action(self, action: "enums.ChatAction") -> bool:
        """Bound method *reply_chat_action* of :obj:`~pylogram.types.Message`.
    ...
    async def reply_contact(
        ...
        """Bound method *reply_contact* of :obj:`~pylogram.types.Message`.
    ...
    async def reply_game(
        ...
        """Bound method *reply_game* of :obj:`~pylogram.types.Message`.
    ...
    async def reply_inline_bot_result(
        ...
        """Bound method *reply_inline_bot_result* of :obj:`~pylogram.types.Message`.
    ...
    async def reply_location(
        ...
        """Bound method *reply_location* of :obj:`~pylogram.types.Message`.
    ...
    async def reply_media_group(
        ...
        """Bound method *reply_media_group* of :obj:`~pylogram.types.Message`.
        ...
        Parameters:
            media (``list``):
                A list containing either :obj:`~pylogram.types.InputMediaPhoto` or
                :obj:`~pylogram.types.InputMediaVideo` objects
        ...
        Returns:
            On success, a :obj:`~pylogram.types.Messages` object is returned containing all the
    ...
    async def reply_poll(
        ...
        """Bound method *reply_poll* of :obj:`~pylogram.types.Message`.
        ...
        Parameters:
            ...
            type (:obj`~pylogram.enums.PollType`, *optional*):
                Poll type, :obj:`~pylogram.enums.PollType.QUIZ` or :obj:`~pylogram.enums.PollType.REGULAR`.
                Defaults to :obj:`~pylogram.enums.PollType.REGULAR`.
            ...
            explanation_parse_mode (:obj:`~pylogram.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.

            explanation_entities (List of :obj:`~pylogram.types.MessageEntity`):
    ...
    async def reply_venue(
        ...
        """Bound method *reply_venue* of :obj:`~pylogram.types.Message`.
    ...
    async def edit_text(
        ...
        """Bound method *edit_text* of :obj:`~pylogram.types.Message`.
        ...
        Returns:
            On success, the edited :obj:`~pylogram.types.Message` is returned.
    ...
    async def edit_caption(
        ...
        """Bound method *edit_caption* of :obj:`~pylogram.types.Message`.
    ...
    async def edit_media(
        ...
        """Bound method *edit_media* of :obj:`~pylogram.types.Message`.
        ...
        Parameters:
            media (:obj:`~pylogram.types.InputMedia`):
    ...
    async def edit_reply_markup(
        ...
        """Bound method *edit_reply_markup* of :obj:`~pylogram.types.Message`.
        ...
        Parameters:
            reply_markup (:obj:`~pylogram.types.InlineKeyboardMarkup`):
                An InlineKeyboardMarkup object.

        Returns:
            On success, if edited message is sent by the bot, the edited
            :obj:`~pylogram.types.Message` is returned, otherwise True is returned.
    ...
    async def copy(
        ...
        """Bound method *copy* of :obj:`~pylogram.types.Message`.
        ...
        Returns:
            :obj:`~pylogram.types.Message`: On success, the copied message is returned.
    ...
    async def delete(self, revoke: bool = True):
        """Bound method *delete* of :obj:`~pylogram.types.Message`.
    ...
    async def click(
        ...
        """Bound method *click* of :obj:`~pylogram.types.Message`.
        ...
        Returns:
            -   The result of :meth:`~pylogram.Client.request_callback_answer` in case of inline callback button clicks.
    ...
    async def react(self, emoji: str = "", big: bool = False) -> bool:
        """Bound method *react* of :obj:`~pylogram.types.Message`.
    ...
    async def retract_vote(
        ...
        """Bound method *retract_vote* of :obj:`~pylogram.types.Message`.
    ...
    async def vote(
        ...
        """Bound method *vote* of :obj:`~pylogram.types.Message`.
    ...
    async def pin(
        ...
        """Bound method *pin* of :obj:`~pylogram.types.Message`.
        ...
        Returns:
            :obj:`~pylogram.types.Message`: On success, the service message is returned.
    ...
    async def unpin(self) -> bool:
        """Bound method *unpin* of :obj:`~pylogram.types.Message`.
