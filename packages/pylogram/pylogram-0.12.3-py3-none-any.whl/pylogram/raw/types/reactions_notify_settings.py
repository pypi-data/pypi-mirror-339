...
class ReactionsNotifySettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.ReactionsNotifySettings`.
    ...
    Parameters:
        sound (:obj:`NotificationSound <pylogram.raw.base.NotificationSound>`):
            N/A

        show_previews (``bool``):
            N/A

        messages_notify_from (:obj:`ReactionNotificationsFrom <pylogram.raw.base.ReactionNotificationsFrom>`, *optional*):
            N/A

        stories_notify_from (:obj:`ReactionNotificationsFrom <pylogram.raw.base.ReactionNotificationsFrom>`, *optional*):
            N/A
