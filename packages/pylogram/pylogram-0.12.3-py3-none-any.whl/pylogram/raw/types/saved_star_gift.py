...
class SavedStarGift(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.SavedStarGift`.
    ...
    Parameters:
        ...
        gift (:obj:`StarGift <pylogram.raw.base.StarGift>`):
            N/A
        ...
        message (:obj:`TextWithEntities <pylogram.raw.base.TextWithEntities>`, *optional*):
            N/A
    ...
    __slots__: List[str] = ["date", "gift", "name_hidden", "unsaved", "refunded", "can_upgrade", "pinned_to_top", "from_id", "message", "msg_id", "saved_id", "convert_stars", "upgrade_stars", "can_export_at", "transfer_stars"]
