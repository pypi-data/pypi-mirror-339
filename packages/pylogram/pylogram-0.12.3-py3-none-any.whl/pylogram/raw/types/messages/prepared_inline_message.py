...
class PreparedInlineMessage(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.messages.PreparedInlineMessage`.
    ...
    Parameters:
        ...
        result (:obj:`BotInlineResult <pylogram.raw.base.BotInlineResult>`):
            N/A

        peer_types (List of :obj:`InlineQueryPeerType <pylogram.raw.base.InlineQueryPeerType>`):
            N/A
