...
class StarGiftUpgradePreview(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.payments.StarGiftUpgradePreview`.
    ...
    Parameters:
        sample_attributes (List of :obj:`StarGiftAttribute <pylogram.raw.base.StarGiftAttribute>`):
            N/A
