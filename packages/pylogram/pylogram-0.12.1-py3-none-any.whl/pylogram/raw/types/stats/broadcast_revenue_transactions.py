...
class BroadcastRevenueTransactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.stats.BroadcastRevenueTransactions`.
    ...
    Parameters:
        ...
        transactions (List of :obj:`BroadcastRevenueTransaction <pylogram.raw.base.BroadcastRevenueTransaction>`):
            N/A
