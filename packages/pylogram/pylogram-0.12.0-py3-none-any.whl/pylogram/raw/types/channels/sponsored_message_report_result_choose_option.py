...
class SponsoredMessageReportResultChooseOption(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pylogram.raw.base.channels.SponsoredMessageReportResult`.
    ...
    Parameters:
        ...
        options (List of :obj:`SponsoredMessageReportOption <pylogram.raw.base.SponsoredMessageReportOption>`):
            N/A
