...
class StarsStatus(TLObject):  # type: ignore
    ...
    Parameters:
        balance (:obj:`StarsAmount <pylogram.raw.base.StarsAmount>`):
            N/A
        ...
        subscriptions (List of :obj:`StarsSubscription <pylogram.raw.base.StarsSubscription>`, *optional*):
            N/A
        ...
        history (List of :obj:`StarsTransaction <pylogram.raw.base.StarsTransaction>`, *optional*):
            N/A
