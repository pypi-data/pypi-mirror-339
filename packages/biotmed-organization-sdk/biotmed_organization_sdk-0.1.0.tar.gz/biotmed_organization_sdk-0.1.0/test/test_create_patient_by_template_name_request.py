...
class TestCreatePatientByTemplateNameRequest(unittest.TestCase):
    """CreatePatientByTemplateNameRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePatientByTemplateNameRequest:
        """Test CreatePatientByTemplateNameRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePatientByTemplateNameRequest`
        """
        model = CreatePatientByTemplateNameRequest()
        if include_optional:
            return CreatePatientByTemplateNameRequest(
    ...
    def testCreatePatientByTemplateNameRequest(self):
        """Test CreatePatientByTemplateNameRequest"""
