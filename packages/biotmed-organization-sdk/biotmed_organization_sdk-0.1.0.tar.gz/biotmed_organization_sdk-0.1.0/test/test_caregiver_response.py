...
class TestCaregiverResponse(unittest.TestCase):
    """CaregiverResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CaregiverResponse:
        """Test CaregiverResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CaregiverResponse`
        """
        model = CaregiverResponse()
        if include_optional:
    ...
    def testCaregiverResponse(self):
        """Test CaregiverResponse"""
