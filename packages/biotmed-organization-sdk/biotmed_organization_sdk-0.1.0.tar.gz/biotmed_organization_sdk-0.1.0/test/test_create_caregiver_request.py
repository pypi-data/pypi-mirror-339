...
class TestCreateCaregiverRequest(unittest.TestCase):
    """CreateCaregiverRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCaregiverRequest:
        """Test CreateCaregiverRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCaregiverRequest`
        """
        model = CreateCaregiverRequest()
        if include_optional:
            return CreateCaregiverRequest(
    ...
    def testCreateCaregiverRequest(self):
        """Test CreateCaregiverRequest"""
