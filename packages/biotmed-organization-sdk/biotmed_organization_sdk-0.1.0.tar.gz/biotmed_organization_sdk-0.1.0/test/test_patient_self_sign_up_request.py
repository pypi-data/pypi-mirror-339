...
class TestPatientSelfSignUpRequest(unittest.TestCase):
    """PatientSelfSignUpRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatientSelfSignUpRequest:
        """Test PatientSelfSignUpRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatientSelfSignUpRequest`
        """
        model = PatientSelfSignUpRequest()
        if include_optional:
            return PatientSelfSignUpRequest(
    ...
    def testPatientSelfSignUpRequest(self):
        """Test PatientSelfSignUpRequest"""
