...
class TestCreateCaregiverByTemplateNameRequest(unittest.TestCase):
    """CreateCaregiverByTemplateNameRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCaregiverByTemplateNameRequest:
        """Test CreateCaregiverByTemplateNameRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCaregiverByTemplateNameRequest`
        """
        model = CreateCaregiverByTemplateNameRequest()
        if include_optional:
            return CreateCaregiverByTemplateNameRequest(
    ...
    def testCreateCaregiverByTemplateNameRequest(self):
        """Test CreateCaregiverByTemplateNameRequest"""
