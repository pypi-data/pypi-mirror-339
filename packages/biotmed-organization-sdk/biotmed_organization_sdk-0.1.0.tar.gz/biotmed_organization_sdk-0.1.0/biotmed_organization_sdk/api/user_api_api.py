...
class UserAPIApi:
    ...
    def get_self(
        ...
        Get self User by ID from access token    In addition to the common fields between all user types, the specific fields for the user type will be returned as well    This API requires **PROTECTED_API** permission(s).  
