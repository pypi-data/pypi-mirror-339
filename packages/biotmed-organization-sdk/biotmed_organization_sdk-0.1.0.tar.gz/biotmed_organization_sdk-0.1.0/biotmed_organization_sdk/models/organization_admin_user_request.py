...
class OrganizationAdminUserRequest(BaseModel):
    """
    OrganizationAdminUserRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["_name", "_description", "_email", "_phone", "_locale", "_gender", "_dateOfBirth", "_address", "_mfa", "_credentialType", "_employeeId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationAdminUserRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationAdminUserRequest from a dict"""
        if obj is None:
            return None
