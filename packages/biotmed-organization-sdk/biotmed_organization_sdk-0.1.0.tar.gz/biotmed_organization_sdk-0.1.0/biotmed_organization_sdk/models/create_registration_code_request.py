...
class CreateRegistrationCodeRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_code", "_templateId", "_ownerOrganization"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateRegistrationCodeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateRegistrationCodeRequest from a dict"""
        if obj is None:
            return None
