...
class PatientSelfSignUpRequest(BaseModel):
    """
    PatientSelfSignUpRequest
    """ # noqa: E501
    ...
    device_registration_code: Optional[ReferenceAttributeUUIDIdRequest] = Field(default=None, alias="_deviceRegistrationCode")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatientSelfSignUpRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatientSelfSignUpRequest from a dict"""
        if obj is None:
            return None
