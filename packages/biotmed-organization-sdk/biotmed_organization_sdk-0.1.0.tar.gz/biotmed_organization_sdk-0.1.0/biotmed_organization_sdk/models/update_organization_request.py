...
class UpdateOrganizationRequest(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=32)]] = Field(default=None, description="An organization's name", alias="_name")
    ...
    headquarters: Optional[AddressUpdateRequest] = Field(default=None, alias="_headquarters")
    ...
    __properties: ClassVar[List[str]] = ["_name", "_description", "_headquarters", "_phone", "_timezone", "_locale"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_headquarters": AddressUpdateRequest.from_dict(obj["_headquarters"]) if obj.get("_headquarters") is not None else None,
