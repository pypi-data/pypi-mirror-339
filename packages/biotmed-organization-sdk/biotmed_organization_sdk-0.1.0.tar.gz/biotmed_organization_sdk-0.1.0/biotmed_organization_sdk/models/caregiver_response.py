...
class CaregiverResponse(BaseModel):
    ...
    degree: Optional[StrictStr] = Field(default=None, description="An caregiver's name", alias="_degree")
    ...
    __properties: ClassVar[List[str]] = ["_name", "_description", "_email", "_phone", "_locale", "_gender", "_dateOfBirth", "_address", "_mfa", "_credentialType", "_employeeId", "_degree", "_id", "_ownerOrganization", "_creationTime", "_lastModifiedTime", "_invitationAccepted", "_enabled", "_caption"]
    ...
    def degree_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['MEDICAL_DOCTOR', 'DOCTOR_OF_OSTEOPATHY', 'PHYSICIAN_ASSISTANT', 'REGISTERED_NURSE', 'CLINICAL_NURSE_SPECIALISTS', 'NURSE_PRACTITIONER', 'LICENSED_PRACTICAL_NURSE', 'MEDICAL_ASSISTANT', 'NO_DEGREE', 'OTHER']):
            raise ValueError("must be one of enum values ('MEDICAL_DOCTOR', 'DOCTOR_OF_OSTEOPATHY', 'PHYSICIAN_ASSISTANT', 'REGISTERED_NURSE', 'CLINICAL_NURSE_SPECIALISTS', 'NURSE_PRACTITIONER', 'LICENSED_PRACTICAL_NURSE', 'MEDICAL_ASSISTANT', 'NO_DEGREE', 'OTHER')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CaregiverResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CaregiverResponse from a dict"""
        if obj is None:
            return None
