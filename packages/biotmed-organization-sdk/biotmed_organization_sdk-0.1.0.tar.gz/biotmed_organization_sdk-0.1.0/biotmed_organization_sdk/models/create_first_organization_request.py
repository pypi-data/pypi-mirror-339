...
class CreateFirstOrganizationRequest(BaseModel):
    """
    ...
    primary_administrator: FirstOrganizationAdminUserRequest = Field(alias="_primaryAdministrator")
    biot_support_user: FirstOrganizationAdminUserRequest = Field(alias="_biotSupportUser")
    __properties: ClassVar[List[str]] = ["_name", "_description", "_headquarters", "_phone", "_timezone", "_locale", "_primaryAdministrator", "_biotSupportUser"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateFirstOrganizationRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of biot_support_user
        if self.biot_support_user:
            _dict['_biotSupportUser'] = self.biot_support_user.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateFirstOrganizationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "_primaryAdministrator": FirstOrganizationAdminUserRequest.from_dict(obj["_primaryAdministrator"]) if obj.get("_primaryAdministrator") is not None else None,
            "_biotSupportUser": FirstOrganizationAdminUserRequest.from_dict(obj["_biotSupportUser"]) if obj.get("_biotSupportUser") is not None else None
        })
        return _obj
