...
class CreateRegistrationCodeByTemplateNameRequest(BaseModel):
    """
    CreateRegistrationCodeByTemplateNameRequest
    """ # noqa: E501
    code: Annotated[str, Field(min_length=0, strict=True, max_length=128)] = Field(description="The registration code entity that is attached to the device", alias="_code")
    owner_organization: ReferenceAttributeUUIDIdRequest = Field(alias="_ownerOrganization")
    __properties: ClassVar[List[str]] = ["_code", "_ownerOrganization"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateRegistrationCodeByTemplateNameRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateRegistrationCodeByTemplateNameRequest from a dict"""
        if obj is None:
            return None
