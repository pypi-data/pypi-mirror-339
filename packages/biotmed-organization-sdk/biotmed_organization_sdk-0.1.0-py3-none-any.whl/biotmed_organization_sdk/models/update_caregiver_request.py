...
class UpdateCaregiverRequest(BaseModel):
    ...
    employee_id: Optional[StrictStr] = Field(default=None, alias="_employeeId")
    ...
    __properties: ClassVar[List[str]] = ["_name", "_description", "_email", "_phone", "_locale", "_gender", "_dateOfBirth", "_address", "_mfa", "_employeeId", "_degree", "_ownerOrganization"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateCaregiverRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateCaregiverRequest from a dict"""
        if obj is None:
            return None
