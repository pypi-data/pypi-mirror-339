...
class FirstOrganizationAdminUserRequest(BaseModel):
    """
    FirstOrganizationAdminUserRequest
    """ # noqa: E501
    ...
    password: Annotated[str, Field(min_length=1, strict=True, max_length=32)] = Field(description="A password")
    __properties: ClassVar[List[str]] = ["_name", "_description", "_email", "_phone", "_locale", "_gender", "_dateOfBirth", "_address", "_mfa", "_credentialType", "_employeeId", "password"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FirstOrganizationAdminUserRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FirstOrganizationAdminUserRequest from a dict"""
        if obj is None:
            return None
