...
class VersionResponse(BaseModel):
    ...
    spring_version: Optional[StrictStr] = Field(default=None, alias="springVersion")
    trace_id: Optional[StrictStr] = Field(default=None, alias="traceId")
    __properties: ClassVar[List[str]] = ["version", "springVersion", "traceId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "springVersion": obj.get("springVersion"),
