...
class UpdateAlertRequest(BaseModel):
    ...
    UpdateAlertRequest
    """ # noqa: E501
    state: Optional[StrictStr] = Field(default=None, description="The alert wanted state", alias="_state")
    severity: Optional[StrictStr] = Field(default=None, description="The alert wanted severity", alias="_severity")
    ...
    __properties: ClassVar[List[str]] = ["_state", "_severity", "_clearNotes", "_name"]
