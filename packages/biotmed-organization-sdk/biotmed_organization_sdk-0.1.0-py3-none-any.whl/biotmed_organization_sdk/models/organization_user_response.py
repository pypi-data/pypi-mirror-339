...
class OrganizationUserResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_name", "_description", "_email", "_phone", "_locale", "_gender", "_dateOfBirth", "_address", "_mfa", "_credentialType", "_employeeId", "_ownerOrganization", "_id", "_creationTime", "_lastModifiedTime", "_invitationAccepted", "_enabled", "_caption"]
