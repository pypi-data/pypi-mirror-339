...
class OrganizationResponse(BaseModel):
    ...
    primary_administrator: BasicReferencedEntityDataUUIDId = Field(alias="_primaryAdministrator")
    ...
    __properties: ClassVar[List[str]] = ["_name", "_description", "_headquarters", "_phone", "_timezone", "_locale", "_id", "_ownerOrganization", "_creationTime", "_lastModifiedTime", "_primaryAdministrator", "_template", "_referencers", "_caption"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_primaryAdministrator": BasicReferencedEntityDataUUIDId.from_dict(obj["_primaryAdministrator"]) if obj.get("_primaryAdministrator") is not None else None,
