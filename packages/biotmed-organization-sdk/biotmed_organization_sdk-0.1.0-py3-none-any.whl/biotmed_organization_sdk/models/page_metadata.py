...
class PageMetadata(BaseModel):
    ...
    PageMetadata
    """ # noqa: E501
    total_results: Optional[StrictInt] = Field(default=None, description="The total number of items that match the query", alias="totalResults")
    ...
    __properties: ClassVar[List[str]] = ["totalResults", "page", "limit"]
