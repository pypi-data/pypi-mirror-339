...
class CreatePatientRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_name", "_description", "_email", "_phone", "_locale", "_gender", "_dateOfBirth", "_address", "_mfa", "_credentialType", "_additionalPhone", "_nationalId", "_canLogin", "_templateId", "_ownerOrganization", "_caregiver"]
