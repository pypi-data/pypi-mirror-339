...
class OrganizationUserAPIApi:
    ...
    @validate_call
    def change_organization_user_enabled_state(
        self,
        id: Annotated[StrictStr, Field(description="Organization User ID")],
        state: StrictStr,
        ...
        Enable or Disable Organization User    Path Parameters:  | Parameter   |Type   | Mandatory| Description          | Example   | |-------------|-------|----------|----------------------|-----------| |id|string|true|Organization User ID|3fa85f64-5717-4562-b3fc-2c963f66afa6| |state|string|true|null||   This API requires **PROTECTED_API** permission(s).  
        ...
        _param = self._change_organization_user_enabled_state_serialize(
            id=id,
            state=state,
    ...
    @validate_call
    def change_organization_user_enabled_state_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Organization User ID")],
        state: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def change_organization_user_enabled_state_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Organization User ID")],
        state: StrictStr,
        _request_timeout: Union[
    ...
    def _change_organization_user_enabled_state_serialize(
        self,
        id,
        state,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/users/organizations/{id}/enabled-state/{state}',
    ...
    def create_organization_user(
        self,
        create_organization_user_request: CreateOrganizationUserRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._create_organization_user_serialize(
            create_organization_user_request=create_organization_user_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _create_organization_user_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if create_organization_user_request is not None:
            _body_params = create_organization_user_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/users/organizations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def create_organization_user_by_template_name(
        self,
        template_name: StrictStr,
        create_organization_user_by_template_name_request: CreateOrganizationUserByTemplateNameRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._create_organization_user_by_template_name_serialize(
            template_name=template_name,
            create_organization_user_by_template_name_request=create_organization_user_by_template_name_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def create_organization_user_by_template_name_with_http_info(
        self,
        template_name: StrictStr,
        create_organization_user_by_template_name_request: CreateOrganizationUserByTemplateNameRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def create_organization_user_by_template_name_without_preload_content(
        self,
        template_name: StrictStr,
        create_organization_user_by_template_name_request: CreateOrganizationUserByTemplateNameRequest,
        _request_timeout: Union[
    ...
    def _create_organization_user_by_template_name_serialize(
        self,
        template_name,
        create_organization_user_by_template_name_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if create_organization_user_by_template_name_request is not None:
            _body_params = create_organization_user_by_template_name_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/users/organizations/templates/{templateName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_organization_user(
        self,
        id: Annotated[StrictStr, Field(description="Organization User ID that needs to be deleted")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Delete Organization User    Path Parameters:  | Parameter   |Type   | Mandatory| Description          | Example   | |-------------|-------|----------|----------------------|-----------| |id|string|true|Organization User ID that needs to be deleted|3fa85f64-5717-4562-b3fc-2c963f66afa6|   This API requires **PROTECTED_API** permission(s).  

        :param id: Organization User ID that needs to be deleted (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _delete_organization_user_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/users/organizations/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_organization_user(
        self,
        id: Annotated[StrictStr, Field(description="Organization User ID that needs to be fetched")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Get Organization User by ID    Path Parameters:  | Parameter   |Type   | Mandatory| Description          | Example   | |-------------|-------|----------|----------------------|-----------| |id|string|true|Organization User ID that needs to be fetched|3fa85f64-5717-4562-b3fc-2c963f66afa6|   This API requires **PROTECTED_API** permission(s).  

        :param id: Organization User ID that needs to be fetched (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    @validate_call
    def get_organization_user_self(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Get self Organization User by ID from access token      This API requires **PROTECTED_API** permission(s).  
        ...
        _param = self._get_organization_user_self_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_organization_user_self_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_organization_user_self_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_organization_user_self_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/users/organizations/self',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def search_organization_users(
        ...
        _param = self._search_organization_users_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '400': "ErrorResponse",
            '200': "SearchResponseOrganizationUserResponse",
            '500': "ErrorResponse",
            '401': "ErrorResponse",
            '403': "ErrorResponse",
            '504': "ErrorResponse",
    ...
    @validate_call
    def search_organization_users_with_http_info(
        self,
        search_request: Annotated[Optional[SearchRequestV2], Field(description="Search request parameters: filter, sort and page")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SearchResponseOrganizationUserResponse]:
        """Search Organization User entities by filter
    ...
    @validate_call
    def search_organization_users_without_preload_content(
        self,
        search_request: Annotated[Optional[SearchRequestV2], Field(description="Search request parameters: filter, sort and page")] = None,
        _request_timeout: Union[
            None,
    ...
    def _search_organization_users_serialize(
        self,
        search_request,
        _request_auth,
        _content_type,
    ...
    def update_organization_user(
        self,
        id: Annotated[StrictStr, Field(description="Organization User ID that needs to be updated")],
        update_organization_user_request: UpdateOrganizationUserRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_organization_user_serialize(
            id=id,
            update_organization_user_request=update_organization_user_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_organization_user_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_organization_user_request is not None:
            _body_params = update_organization_user_request
