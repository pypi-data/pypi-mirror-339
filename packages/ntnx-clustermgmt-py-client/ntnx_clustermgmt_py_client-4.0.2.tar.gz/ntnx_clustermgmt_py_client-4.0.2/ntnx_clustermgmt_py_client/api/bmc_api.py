...
class BmcApi(object):
    ...
    def get_bmc_info(self, clusterExtId, extId, **kwargs):  # noqa: E501
        """Get BMC details

        >>> response = api.get_bmc_info(clusterExtId, extId)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_bmc_info(clusterExtId, extId, async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.GetBmcInfoResponse`.
        ...
        if ('clusterExtId' not in params or params['clusterExtId'] is None):
            raise ValueError("Missing the required parameter `clusterExtId` when calling `get_bmc_info`")  # noqa: E501
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `get_bmc_info`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.0/config/clusters/{clusterExtId}/hosts/{extId}/bmc-info', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='clustermgmt.v4.config.GetBmcInfoResponse',  # noqa: E501
    ...
    def update_bmc_info(self, clusterExtId, extId, body, **kwargs):  # noqa: E501
        """Update BMC info summary

        >>> response = api.update_bmc_info(clusterExtId, extId, body)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.update_bmc_info(clusterExtId, extId, body, async_req=True)
        >>> result = thread.get()
        ...
        :type extId:
            :class:`str`, required
        :param body: Update BMC info body
        :type body:
            :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.BmcInfo`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::

                           async_req=True
        :return: An instance of class :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.config.UpdateBmcInfoResponse`.
        ...
        # verify the required parameter 'clusterExtId' is set
        if ('clusterExtId' not in params or params['clusterExtId'] is None):
            raise ValueError("Missing the required parameter `clusterExtId` when calling `update_bmc_info`")  # noqa: E501
        # verify the required parameter 'extId' is set
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `update_bmc_info`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_bmc_info`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.0/config/clusters/{clusterExtId}/hosts/{extId}/bmc-info', 'PUT',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    post_params=form_params,
                    files=local_var_files,
                    response_type='clustermgmt.v4.config.UpdateBmcInfoResponse',  # noqa: E501
                    auth_settings=auth_settings,
                    async_req=params.get('async_req'),
                    _return_http_data_only=params.get('_return_http_data_only'),
                    _preload_content=params.get('_preload_content', True),
