...
class VirtualGpuConfig(object):
    ...
    :param licenses: (:attr:`licenses`) GPU license list.
    :type licenses: 
    ...
    :param max_instances_per_vm: (:attr:`max_instances_per_vm`) Maximum instances allowed per VM.
    :type max_instances_per_vm: 
    ...
    def __init__(self, type=None, device_id=None, device_name=None, vendor_name=None, is_in_use=None, sbdf=None, numa_node=None, assignable=None, fraction=None, guest_driver_version=None, licenses=None, number_of_virtual_display_heads=None, frame_buffer_size_bytes=None, max_resolution=None, max_instances_per_vm=None, *args, **kwargs):  # noqa: E501
        self.__type = None
        ...
        self.__max_instances_per_vm = None
        ...
        if max_instances_per_vm is not None:
            self.__max_instances_per_vm = max_instances_per_vm
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.VirtualGpuConfig'
    ...
    def max_resolution(self, max_resolution):
        if max_resolution is not None and len(max_resolution) > 16:
            raise ValueError("Invalid value for `max_resolution`, length must be less than or equal to `16`")  # noqa: E501

        self.__max_resolution = max_resolution

    @property
    def max_instances_per_vm(self):
        """
        ...
        :type:
                :class:`~int`
        """  # noqa: E501
        return self.__max_instances_per_vm

    @max_instances_per_vm.setter
    def max_instances_per_vm(self, max_instances_per_vm):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(VirtualGpuConfig, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VirtualGpuConfig):
            return False
