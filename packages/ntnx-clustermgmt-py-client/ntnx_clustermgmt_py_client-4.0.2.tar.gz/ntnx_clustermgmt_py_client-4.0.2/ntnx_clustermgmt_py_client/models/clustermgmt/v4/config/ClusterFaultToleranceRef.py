...
class ClusterFaultToleranceRef(object):
    ...
    _UNKNOWN = "$UNKNOWN"
    _REDACTED = "$REDACTED"
    CFT_0N_AND_0D = "CFT_0N_AND_0D"
    CFT_1N_OR_1D = "CFT_1N_OR_1D"
    CFT_2N_OR_2D = "CFT_2N_OR_2D"
    CFT_1N_AND_1D = "CFT_1N_AND_1D"
    ...
    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.ClusterFaultToleranceRef'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ClusterFaultToleranceRef, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ClusterFaultToleranceRef):
            return False
