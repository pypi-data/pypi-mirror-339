...
class PIIScrubbingLevel(object):
    ...
    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.PIIScrubbingLevel'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(PIIScrubbingLevel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PIIScrubbingLevel):
            return False
