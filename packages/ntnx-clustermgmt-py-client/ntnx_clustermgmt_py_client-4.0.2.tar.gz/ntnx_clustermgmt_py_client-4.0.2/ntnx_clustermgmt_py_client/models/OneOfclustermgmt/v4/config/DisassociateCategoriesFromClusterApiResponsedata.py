...
class DisassociateCategoriesFromClusterApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.config.DisassociateCategoriesFromClusterApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DisassociateCategoriesFromClusterApiResponsedata.discriminator_value_class_map.values():
            return list(DisassociateCategoriesFromClusterApiResponsedata.discriminator_value_class_map.keys())[list(DisassociateCategoriesFromClusterApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DisassociateCategoriesFromClusterApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DisassociateCategoriesFromClusterApiResponsedata):
            return False
