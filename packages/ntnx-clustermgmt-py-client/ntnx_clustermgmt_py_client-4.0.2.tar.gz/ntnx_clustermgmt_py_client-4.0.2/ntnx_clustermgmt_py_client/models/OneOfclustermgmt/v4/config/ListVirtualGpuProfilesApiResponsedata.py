...
class ListVirtualGpuProfilesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<clustermgmt.v4.config.VirtualGpuProfile>': 'list[clustermgmt.v4.config.VirtualGpuProfile]',
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.config.ListVirtualGpuProfilesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListVirtualGpuProfilesApiResponsedata.discriminator_value_class_map.values():
            return list(ListVirtualGpuProfilesApiResponsedata.discriminator_value_class_map.keys())[list(ListVirtualGpuProfilesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListVirtualGpuProfilesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListVirtualGpuProfilesApiResponsedata):
            return False
