...
class ListPhysicalGpuProfilesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<clustermgmt.v4.config.PhysicalGpuProfile>': 'list[clustermgmt.v4.config.PhysicalGpuProfile]',
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.config.ListPhysicalGpuProfilesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListPhysicalGpuProfilesApiResponsedata.discriminator_value_class_map.values():
            return list(ListPhysicalGpuProfilesApiResponsedata.discriminator_value_class_map.keys())[list(ListPhysicalGpuProfilesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListPhysicalGpuProfilesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListPhysicalGpuProfilesApiResponsedata):
            return False
