...
class GetBmcInfoResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'clustermgmt.v4.config.BmcInfo': 'clustermgmt.v4.config.BmcInfo',
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.config.GetBmcInfoResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetBmcInfoResponsedata.discriminator_value_class_map.values():
            return list(GetBmcInfoResponsedata.discriminator_value_class_map.keys())[list(GetBmcInfoResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetBmcInfoResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetBmcInfoResponsedata):
            return False
