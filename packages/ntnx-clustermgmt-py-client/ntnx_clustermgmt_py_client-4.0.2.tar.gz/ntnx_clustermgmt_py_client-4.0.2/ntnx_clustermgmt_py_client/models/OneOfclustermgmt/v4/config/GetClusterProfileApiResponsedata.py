...
class GetClusterProfileApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'clustermgmt.v4.config.ClusterProfile': 'clustermgmt.v4.config.ClusterProfile',
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.config.GetClusterProfileApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetClusterProfileApiResponsedata.discriminator_value_class_map.values():
            return list(GetClusterProfileApiResponsedata.discriminator_value_class_map.keys())[list(GetClusterProfileApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetClusterProfileApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetClusterProfileApiResponsedata):
            return False
