...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    """A class for the configuration of :class:`~ntnx_clustermgmt_py_client.api_client.ApiClient`.
    ...
    def __init__(self):
        ...
        self.__user_agent = 'Nutanix-ntnx_clustermgmt_py_client/4.0.2'
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("ntnx_clustermgmt_py_client")
        # Log format
