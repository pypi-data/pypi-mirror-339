...
class ExitHostMaintenanceApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.operations.ExitHostMaintenanceApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ExitHostMaintenanceApiResponsedata.discriminator_value_class_map.values():
            return list(ExitHostMaintenanceApiResponsedata.discriminator_value_class_map.keys())[list(ExitHostMaintenanceApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ExitHostMaintenanceApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExitHostMaintenanceApiResponsedata):
            return False
