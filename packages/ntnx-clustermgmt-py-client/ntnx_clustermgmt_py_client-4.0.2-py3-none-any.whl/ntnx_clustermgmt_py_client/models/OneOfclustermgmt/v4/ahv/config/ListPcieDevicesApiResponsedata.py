...
class ListPcieDevicesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<clustermgmt.v4.ahv.config.PcieDevice>': 'list[clustermgmt.v4.ahv.config.PcieDevice]',
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.ahv.config.ListPcieDevicesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListPcieDevicesApiResponsedata.discriminator_value_class_map.values():
            return list(ListPcieDevicesApiResponsedata.discriminator_value_class_map.keys())[list(ListPcieDevicesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListPcieDevicesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListPcieDevicesApiResponsedata):
            return False
