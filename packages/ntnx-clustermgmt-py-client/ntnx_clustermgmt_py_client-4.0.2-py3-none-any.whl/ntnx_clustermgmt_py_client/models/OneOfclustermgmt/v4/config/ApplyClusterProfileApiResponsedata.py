...
class ApplyClusterProfileApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.config.ApplyClusterProfileApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ApplyClusterProfileApiResponsedata.discriminator_value_class_map.values():
            return list(ApplyClusterProfileApiResponsedata.discriminator_value_class_map.keys())[list(ApplyClusterProfileApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ApplyClusterProfileApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApplyClusterProfileApiResponsedata):
            return False
