...
class ManagedCluster(object):
    ...
    :param ext_id: (:attr:`ext_id`) Cluster UUID.
    :type ext_id: required
    
    
    :param is_compliant: (:attr:`is_compliant`) Indicates if attached cluster is compliant with cluster profile or not
    :type is_compliant: 
    
    
    :param last_synced_time: (:attr:`last_synced_time`) Most recent date and time when the cluster profile was monitored across all attached clusters
    :type last_synced_time: 
    
    
    :param config_drifts: (:attr:`config_drifts`) Drifted settings information
    :type config_drifts: 
    ...
    swagger_types = {
        ...
        'config_drifts': 'list[clustermgmt.v4.config.ConfigType]',
    ...
    def __init__(self, ext_id=None, is_compliant=None, last_synced_time=None, config_drifts=None, *args, **kwargs):  # noqa: E501
        self.__ext_id = None
        self.__is_compliant = None
        self.__last_synced_time = None
        self.__config_drifts = None
        self.discriminator = None
        self.__ext_id = ext_id
        if is_compliant is not None:
            self.__is_compliant = is_compliant
        if last_synced_time is not None:
            self.__last_synced_time = last_synced_time
        if config_drifts is not None:
            self.__config_drifts = config_drifts
        # populate hidden vars if not empty
        self._populate_hidden_vars(kwargs)

    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.ManagedCluster'
    ...
    def last_synced_time(self):
        ...
        :type:
                :class:`~datetime`
        """  # noqa: E501
        return self.__last_synced_time
    ...
    def config_drifts(self):
        ...
        """  # noqa: E501
        return self.__config_drifts

    @config_drifts.setter
    def config_drifts(self, config_drifts):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ManagedCluster, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ManagedCluster):
            return False
