...
class TaskResponseType(object):
    ...
    NON_COMPATIBLE_CLUSTERS = "NON_COMPATIBLE_CLUSTERS"
    ...
    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.TaskResponseType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(TaskResponseType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskResponseType):
            return False
