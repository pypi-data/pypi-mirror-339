...
class NonCompatibleClusterReference(object):

    """Non compatible cluster reference

    :param cluster_ext_id: (:attr:`cluster_ext_id`) Cluster Profile UUID
    :type cluster_ext_id: 
    
    
    :param config_drifts: (:attr:`config_drifts`) Cluster profile setting
    :type config_drifts: 
    ...
    def __init__(self, cluster_ext_id=None, config_drifts=None, *args, **kwargs):  # noqa: E501
    ...
    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.NonCompatibleClusterReference'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(NonCompatibleClusterReference, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NonCompatibleClusterReference):
            return False
