...
class HttpProxyWhiteListTargetType(object):
    ...
    IPV4_NETWORK_MASK = "IPV4_NETWORK_MASK"
    ...
    def _initialize_object_type(self):
        return 'clustermgmt.v4.config.HttpProxyWhiteListTargetType'
        ...
        for attr in vars(self):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(HttpProxyWhiteListTargetType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HttpProxyWhiteListTargetType):
            return False
