...
class PcieDevicesApi(object):
    ...
    def list_pcie_devices(self, _page=None, _limit=None, _filter=None, _select=None, **kwargs):  # noqa: E501
        """Fetch the PCIe devices

        >>> response = api.list_pcie_devices((optional) _page, (optional) _limit, (optional) _filter, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.list_pcie_devices(async_req=True)
        >>> result = thread.get()
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_clustermgmt_py_client.models.clustermgmt.v4.ahv.config.ListPcieDevicesApiResponse`.
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/clustermgmt/v4.0/ahv/config/pcie-devices', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='clustermgmt.v4.ahv.config.ListPcieDevicesApiResponse',  # noqa: E501
