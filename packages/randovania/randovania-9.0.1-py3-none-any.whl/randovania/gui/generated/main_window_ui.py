...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.intro_games_layout.setSizeConstraint(QLayout.SizeConstraint.SetMaximumSize)
        ...
        self.games_supported_label.setTextFormat(Qt.TextFormat.MarkdownText)
        ...
        self.games_experimental_label.setTextFormat(Qt.TextFormat.MarkdownText)
        self.games_experimental_label.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.game_list_contents.setGeometry(QRect(0, 0, 682, 451))
