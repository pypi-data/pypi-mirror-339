...
class SajadKhaErrorBase(Exception):
    pass


class SajadKhaNodeError(SajadKhaErrorBase):
    ...
    def __str__(self):
        try:
            ...
            return "<SajadKhaNodeError failed with %r>" % e


class SajadKhaOptimizationError(SajadKhaNodeError):
    pass


class SajadKhaAssumptionError(AssertionError):
    pass


class SajadKhaCodeDeficit(SajadKhaErrorBase):
    pass


class SajadKhaNodeDesignError(Exception):
    pass


class SajadKhaForbiddenImportEncounter(Exception):
...
class SajadKhaForbiddenDLLEncounter(Exception):
    """This DLL is not allowed to be included."""


class SajadKhaSyntaxError(Exception):
