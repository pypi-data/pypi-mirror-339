...
def _getAnonBuiltins():
    ...
    # anon_codes["compiled_function"] =  "&SajadKha_Function_Type"
    # anon_codes["compiled_generator"] =  "&SajadKha_Generator_Type"
    ...
    if python_version >= 0x270:
        ...
        anon_codes["version_info"] = 'Py_TYPE(SajadKha_SysGetObject("version_info"))'
    ...
    if python_version >= 0x3A0:
        ...
        anon_codes["UnionType"] = "SajadKha_PyUnion_Type"
