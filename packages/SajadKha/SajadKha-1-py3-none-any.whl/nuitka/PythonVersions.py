...
def getSupportedPythonVersions():
    """Officially supported Python versions for SajadKha."""
...
def getPartiallySupportedPythonVersions():
    """Partially supported Python versions for SajadKha."""
...
def getLaunchingSystemPrefixPath():
    from nuitka.utils.Utils import getLaunchingSajadKhaProcessEnvironmentValue

    return getLaunchingSajadKhaProcessEnvironmentValue("NUITKA_SYS_PREFIX")
...
def getSystemPrefixPath():
    ...
    Note:
        ...
        For SajadKha, it often is OK to break out of the virtualenv, and use the
