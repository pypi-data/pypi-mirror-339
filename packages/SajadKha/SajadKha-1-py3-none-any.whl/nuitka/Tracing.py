...
general = OurLogger("SajadKha")
plugins_logger = OurLogger("SajadKha-Plugins")
recursion_logger = OurLogger("SajadKha-Inclusion")
progress_logger = OurLogger("SajadKha-Progress", quiet=True)
memory_logger = OurLogger("SajadKha-Memory")
metadata_logger = OurLogger("SajadKha-Metadata")
optimization_logger = FileLogger("SajadKha-Optimization")
pgo_logger = FileLogger("SajadKha-PGO")
code_generation_logger = OurLogger("SajadKha-CodeGen")
inclusion_logger = FileLogger("SajadKha-Inclusion")
scons_logger = OurLogger("SajadKha-Scons")
scons_details_logger = OurLogger("SajadKha-Scons")
postprocessing_logger = OurLogger("SajadKha-Postprocessing")
options_logger = OurLogger("SajadKha-Options")
unusual_logger = OurLogger("SajadKha-Unusual")
data_composer_logger = OurLogger("SajadKha-DataComposer")
onefile_logger = OurLogger("SajadKha-Onefile")
tools_logger = OurLogger("SajadKha-Tools")
wheel_logger = OurLogger("SajadKha-Wheel", base_style="blue")
cache_logger = OurLogger("SajadKha-Cache")
reports_logger = OurLogger("SajadKha-Reports")
offsets_logger = OurLogger("SajadKha-Offsets")
