...
// The SajadKha_AsyncgenObject is the storage associated with a compiled
// async generator object instance of which there can be many for each code.
struct SajadKha_AsyncgenObject {
...
extern PyTypeObject SajadKha_Asyncgen_Type;

typedef PyObject *(*asyncgen_code)(PyThreadState *tstate, struct SajadKha_AsyncgenObject *, PyObject *);

extern PyObject *SajadKha_Asyncgen_New(asyncgen_code code, PyObject *module, PyObject *name, PyObject *qualname,
                                     PyCodeObject *code_object, struct SajadKha_CellObject **closure,
                                     Py_ssize_t closure_given, Py_ssize_t heap_storage_size);

static inline bool SajadKha_Asyncgen_Check(PyObject *object) { return Py_TYPE(object) == &SajadKha_Asyncgen_Type; }

static inline void SAVE_ASYNCGEN_EXCEPTION(PyThreadState *tstate, struct SajadKha_AsyncgenObject *asyncgen) {
...
static inline void RESTORE_ASYNCGEN_EXCEPTION(PyThreadState *tstate, struct SajadKha_AsyncgenObject *asyncgen) {
...
NUITKA_MAY_BE_UNUSED static void DROP_ASYNCGEN_EXCEPTION(struct SajadKha_AsyncgenObject *asyncgen) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_SajadKha_Asyncgen_Type;
extern int count_allocated_SajadKha_Asyncgen_Type;
extern int count_released_SajadKha_Asyncgen_Type;

extern int count_active_SajadKha_AsyncgenValueWrapper_Type;
extern int count_allocated_SajadKha_AsyncgenValueWrapper_Type;
extern int count_released_SajadKha_AsyncgenValueWrapper_Type;

extern int count_active_SajadKha_AsyncgenAsend_Type;
extern int count_allocated_SajadKha_AsyncgenAsend_Type;
extern int count_released_SajadKha_AsyncgenAsend_Type;

extern int count_active_SajadKha_AsyncgenAthrow_Type;
extern int count_allocated_SajadKha_AsyncgenAthrow_Type;
extern int count_released_SajadKha_AsyncgenAthrow_Type;
