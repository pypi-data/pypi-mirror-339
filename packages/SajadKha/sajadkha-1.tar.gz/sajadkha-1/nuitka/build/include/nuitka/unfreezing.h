...
struct SajadKha_MetaPathBasedLoaderEntry;

typedef PyObject *(*module_init_func)(PyThreadState *tstate, PyObject *module,
                                      struct SajadKha_MetaPathBasedLoaderEntry const *loader_entry);
 ...
 */
extern void registerMetaPathBasedLoader(struct SajadKha_MetaPathBasedLoaderEntry *loader_entries,
...
extern PyObject *SajadKha_Loader_New(struct SajadKha_MetaPathBasedLoaderEntry const *entry);

// Create a distribution object from the given metadata.
extern PyObject *SajadKha_Distribution_New(PyThreadState *tstate, PyObject *name);

// Check if we provide a distribution object ourselves.
extern bool SajadKha_DistributionNext(Py_ssize_t *pos, PyObject **distribution_name_ptr);
