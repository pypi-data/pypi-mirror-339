...
// The SajadKha_CoroutineObject is the storage associated with a compiled
// coroutine object instance of which there can be many for each code.
struct SajadKha_CoroutineObject {
...
extern PyTypeObject SajadKha_Coroutine_Type;

typedef PyObject *(*coroutine_code)(PyThreadState *tstate, struct SajadKha_CoroutineObject *, PyObject *);

extern PyObject *SajadKha_Coroutine_New(PyThreadState *tstate, coroutine_code code, PyObject *module, PyObject *name,
...
static inline bool SajadKha_Coroutine_Check(PyObject *object) { return Py_TYPE(object) == &SajadKha_Coroutine_Type; }

struct SajadKha_CoroutineWrapperObject {
    /* Python object folklore: */
    PyObject_HEAD

        struct SajadKha_CoroutineObject *m_coroutine;
};

extern PyTypeObject SajadKha_CoroutineWrapper_Type;

static inline bool SajadKha_CoroutineWrapper_Check(PyObject *object) {
    return Py_TYPE(object) == &SajadKha_CoroutineWrapper_Type;
}

static inline void SAVE_COROUTINE_EXCEPTION(PyThreadState *tstate, struct SajadKha_CoroutineObject *coroutine) {
...
static inline void RESTORE_COROUTINE_EXCEPTION(PyThreadState *tstate, struct SajadKha_CoroutineObject *coroutine) {
...
NUITKA_MAY_BE_UNUSED static void DROP_COROUTINE_EXCEPTION(struct SajadKha_CoroutineObject *coroutine) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_SajadKha_Coroutine_Type;
extern int count_allocated_SajadKha_Coroutine_Type;
extern int count_released_SajadKha_Coroutine_Type;

extern int count_active_SajadKha_CoroutineWrapper_Type;
extern int count_allocated_SajadKha_CoroutineWrapper_Type;
extern int count_released_SajadKha_CoroutineWrapper_Type;

extern int count_active_SajadKha_AIterWrapper_Type;
extern int count_allocated_SajadKha_AIterWrapper_Type;
extern int count_released_SajadKha_AIterWrapper_Type;
#endif
