...
static inline size_t SajadKha_static_builtin_index_get(PyTypeObject *self) { return (size_t)self->tp_subclasses - 1; }

// Changed internal type access for Python3.13
#if PYTHON_VERSION < 0x3d0
#define managed_static_type_state static_builtin_state

static inline managed_static_type_state *SajadKha_static_builtin_state_get(PyInterpreterState *interp,
                                                                         PyTypeObject *self) {
    return &(interp->types.builtins[SajadKha_static_builtin_index_get(self)]);
}
#else
static inline managed_static_type_state *SajadKha_static_builtin_state_get(PyInterpreterState *interp,
                                                                         PyTypeObject *self) {
    return &(interp->types.builtins.initialized[SajadKha_static_builtin_index_get(self)]);
}
#endif

NUITKA_MAY_BE_UNUSED static inline managed_static_type_state *SajadKha_PyStaticType_GetState(PyInterpreterState *interp,
                                                                                           PyTypeObject *self) {
    assert(self->tp_flags & _Py_TPFLAGS_STATIC_BUILTIN);
    return SajadKha_static_builtin_state_get(interp, self);
}

#define _PyStaticType_GetState(interp, self) SajadKha_PyStaticType_GetState(interp, self)
#endif
...
#define SajadKha_String_AsString PyString_AsString
#define SajadKha_String_AsString_Unchecked PyString_AS_STRING
#define SajadKha_String_Check PyString_Check
#define SajadKha_String_CheckExact PyString_CheckExact
NUITKA_MAY_BE_UNUSED static inline bool SajadKha_StringOrUnicode_CheckExact(PyObject *value) {
    return PyString_CheckExact(value) || PyUnicode_CheckExact(value);
}
#define SajadKha_StringObject PyStringObject
#define SajadKha_String_FromString PyString_FromString
#define SajadKha_String_FromStringAndSize PyString_FromStringAndSize
#define SajadKha_String_FromFormat PyString_FromFormat
#define PyUnicode_CHECK_INTERNED (0)
NUITKA_MAY_BE_UNUSED static Py_UNICODE *SajadKha_UnicodeAsWideString(PyObject *str, Py_ssize_t *size) {
    PyObject *unicode;
...
#else
#define SajadKha_String_AsString _PyUnicode_AsString
...
#ifdef __NUITKA_NO_ASSERT__
#define SajadKha_String_AsString_Unchecked PyUnicode_UTF8
#else
NUITKA_MAY_BE_UNUSED static char const *SajadKha_String_AsString_Unchecked(PyObject *object) {
    char const *result = PyUnicode_UTF8(object);
    assert(result != NULL);
    return result;
}
#endif
#define SajadKha_String_Check PyUnicode_Check
#define SajadKha_String_CheckExact PyUnicode_CheckExact
#define SajadKha_StringOrUnicode_CheckExact PyUnicode_CheckExact
#define SajadKha_StringObject PyUnicodeObject
#define SajadKha_String_FromString PyUnicode_FromString
#define SajadKha_String_FromStringAndSize PyUnicode_FromStringAndSize
#define SajadKha_String_FromFormat PyUnicode_FromFormat
#define SajadKha_UnicodeAsWideString PyUnicode_AsWideCharString
#endif
...
#ifdef __NUITKA_NO_ASSERT__
#define SajadKha_TypeLookup(x, y) _PyType_Lookup(x, y)
#else
NUITKA_MAY_BE_UNUSED static PyObject *SajadKha_TypeLookup(PyTypeObject *type, PyObject *name) {
...
#define SajadKha_GC_Track PyObject_GC_Track
#define SajadKha_GC_UnTrack PyObject_GC_UnTrack
...
#else
#define SajadKha_GC_Track _PyObject_GC_TRACK
#define SajadKha_GC_UnTrack _PyObject_GC_UNTRACK
#endif
...
#if PYTHON_VERSION < 0x300
#define SajadKhaType_HasFeatureClass(descr) (PyType_HasFeature(Py_TYPE(descr), Py_TPFLAGS_HAVE_CLASS))
#else
#define SajadKhaType_HasFeatureClass(descr) (1)
#endif

// Our replacement for "PyType_IsSubtype"
extern bool SajadKha_Type_IsSubtype(PyTypeObject *a, PyTypeObject *b);
...
extern PyObject *SajadKha_sentinel_value;

/* Value to use for __compiled__ value of all modules. */
extern PyObject *SajadKha_dunder_compiled_value;
