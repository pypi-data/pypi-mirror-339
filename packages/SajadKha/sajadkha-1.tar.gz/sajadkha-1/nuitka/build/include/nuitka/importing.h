...
NUITKA_MAY_BE_UNUSED static PyObject *SajadKha_GetSysModules(void) {
...
NUITKA_MAY_BE_UNUSED static bool SajadKha_HasModule(PyThreadState *tstate, PyObject *module_name) {
    return DICT_HAS_ITEM(tstate, SajadKha_GetSysModules(), module_name) == 1;
}

// Replacement for "PyImport_GetModule" working across all versions and less checks.
NUITKA_MAY_BE_UNUSED static PyObject *SajadKha_GetModule(PyThreadState *tstate, PyObject *module_name) {
    return DICT_GET_ITEM1(tstate, SajadKha_GetSysModules(), module_name);
}

// Replacement for PyImport_GetModule working across all versions and less checks.
NUITKA_MAY_BE_UNUSED static PyObject *SajadKha_GetModuleString(PyThreadState *tstate, char const *module_name) {
    PyObject *module_name_object = SajadKha_String_FromString(module_name);
    PyObject *result = SajadKha_GetModule(tstate, module_name_object);
...
NUITKA_MAY_BE_UNUSED static bool SajadKha_SetModule(PyObject *module_name, PyObject *module) {
    CHECK_OBJECT(module_name);
    CHECK_OBJECT(module);
    assert(PyModule_Check(module));

    return DICT_SET_ITEM(SajadKha_GetSysModules(), module_name, module);
}

// Add a module to the modules dictionary from name C string
NUITKA_MAY_BE_UNUSED static bool SajadKha_SetModuleString(char const *module_name, PyObject *module) {
    PyObject *module_name_object = SajadKha_String_FromString(module_name);
    bool result = SajadKha_SetModule(module_name_object, module);
    Py_DECREF(module_name_object);
...
NUITKA_MAY_BE_UNUSED static bool SajadKha_DelModule(PyThreadState *tstate, PyObject *module_name) {
    CHECK_OBJECT(module_name);
...
NUITKA_MAY_BE_UNUSED static bool SajadKha_DelModuleString(PyThreadState *tstate, char const *module_name) {
    PyObject *module_name_object = SajadKha_String_FromString(module_name);
    bool result = SajadKha_DelModule(tstate, module_name_object);
    Py_DECREF(module_name_object);
...
NUITKA_MAY_BE_UNUSED static PyObject *SajadKha_GetFilenameObject(PyThreadState *tstate, PyObject *module) {
#if PYTHON_VERSION < 0x300
