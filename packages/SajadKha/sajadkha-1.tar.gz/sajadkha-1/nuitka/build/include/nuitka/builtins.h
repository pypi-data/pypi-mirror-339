...
NUITKA_MAY_BE_UNUSED static PyObject *LOOKUP_BUILTIN(PyObject *name) {
    ...
    CHECK_OBJECT(name);
    assert(SajadKha_String_CheckExact(name));

    PyObject *result = GET_STRING_DICT_VALUE(dict_builtin, (SajadKha_StringObject *)name);
...
NUITKA_MAY_BE_UNUSED static PyObject *SajadKha_SysGetObject(char const *name) { return PySys_GetObject((char *)name); }

NUITKA_MAY_BE_UNUSED static void SajadKha_SysSetObject(char const *name, PyObject *value) {
