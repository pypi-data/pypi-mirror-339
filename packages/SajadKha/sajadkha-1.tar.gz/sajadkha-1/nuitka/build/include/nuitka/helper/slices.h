...
extern PyObject *SajadKha_Slice_New(PyThreadState *tstate, PyObject *start, PyObject *stop, PyObject *step);
#else
#define SajadKha_Slice_New(tstate, start, stop, step) PySlice_New(start, stop, step)
#endif
...
static inline bool IS_INDEXABLE(PyObject *value) {
    return value == Py_None ||
           ...
           PyInt_Check(value) ||
#endif
           PyLong_Check(value) || SajadKha_Index_Check(value);
}
...
static Py_ssize_t CONVERT_TO_INDEX(PyThreadState *tstate, PyObject *value) {
    ...
    } else if (SajadKha_Index_Check(value)) {
