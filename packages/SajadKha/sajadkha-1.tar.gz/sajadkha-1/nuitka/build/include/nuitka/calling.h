...
NUITKA_MAY_BE_UNUSED static inline PyObject *SajadKha_CheckFunctionResult(PyThreadState *tstate, PyObject *callable,
                                                                        PyObject *result) {
    if (result == NULL) {
        ...
        // Some buggy C functions do this, and SajadKha inner workings can get
        // upset from it.
...
NUITKA_MAY_BE_UNUSED static PyObject *CALL_FUNCTION(PyThreadState *tstate, PyObject *function_object,
    ...
    return SajadKha_CheckFunctionResult(tstate, function_object, result);
}
