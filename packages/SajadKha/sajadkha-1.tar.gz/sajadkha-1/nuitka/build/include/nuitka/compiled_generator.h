...
// The SajadKha_GeneratorObject is the storage associated with a compiled
// generator object instance of which there can be many for each code.
struct SajadKha_GeneratorObject {
...
#if PYTHON_VERSION >= 0x300
    struct SajadKha_ExceptionStackItem m_resume_exception;
#endif
...
extern PyTypeObject SajadKha_Generator_Type;

typedef PyObject *(*generator_code)(PyThreadState *tstate, struct SajadKha_GeneratorObject *, PyObject *);

extern PyObject *SajadKha_Generator_New(generator_code code, PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                      PyObject *qualname,
#endif
...
extern PyObject *SajadKha_Generator_NewEmpty(PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                           PyObject *qualname,
#endif
                                           PyCodeObject *code_object, struct SajadKha_CellObject **closure,
...
extern PyObject *SajadKha_Generator_qiter(PyThreadState *tstate, struct SajadKha_GeneratorObject *generator,
                                        bool *finished);

static inline bool SajadKha_Generator_Check(PyObject *object) { return Py_TYPE(object) == &SajadKha_Generator_Type; }

static inline PyObject *SajadKha_Generator_GetName(PyObject *object) {
    return ((struct SajadKha_GeneratorObject *)object)->m_name;
}

static inline void SAVE_GENERATOR_EXCEPTION(PyThreadState *tstate, struct SajadKha_GeneratorObject *generator) {
...
static inline void RESTORE_GENERATOR_EXCEPTION(PyThreadState *tstate, struct SajadKha_GeneratorObject *generator) {
...
extern void SajadKha_PreserveHeap(void *dest, ...);
extern void SajadKha_RestoreHeap(void *source, ...);
...
NUITKA_MAY_BE_UNUSED static void DROP_GENERATOR_EXCEPTION(struct SajadKha_GeneratorObject *generator) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_SajadKha_Generator_Type;
extern int count_allocated_SajadKha_Generator_Type;
extern int count_released_SajadKha_Generator_Type;
#endif
