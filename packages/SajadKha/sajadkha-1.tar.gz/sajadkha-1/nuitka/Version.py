...
#
""" SajadKha version related stuff.
...
def getSajadKhaVersion():
    """Return SajadKha version as a string.
...
# Sanity check.
assert getSajadKhaVersion()[-1].isdigit(), getSajadKhaVersion()


def parseSajadKhaVersionToTuple(version):
    """Return SajadKha version as a tuple.
...
def getSajadKhaVersionTuple():
    ...
    return parseSajadKhaVersionToTuple(version=getSajadKhaVersion())


def getSajadKhaVersionYear():
    """The year of SajadKha copyright for use in generations."""

    return int(version_string.split()[4])


def getCommercialVersion():
    """Return SajadKha commercial version if installed."""
    try:
