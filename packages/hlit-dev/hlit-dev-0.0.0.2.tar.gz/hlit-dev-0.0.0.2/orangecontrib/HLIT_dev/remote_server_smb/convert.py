...
if "site-packages/Orange/widgets" in os.path.dirname(os.path.abspath(__file__)).replace("\\", "/"):
    from Orange.widgets.orangecontrib.IO4IT.remote_server_smb import convert
else:
    from Orange.widgets.orangecontrib.IO44IT.remote_server_smb import convert
...
def convert_data_table_to_json(data):
    ...
    if data.domain == None or (data.domain.attributes == None and data.domain.metas == None):
        print("Pas de domain en entree")
        return 1
