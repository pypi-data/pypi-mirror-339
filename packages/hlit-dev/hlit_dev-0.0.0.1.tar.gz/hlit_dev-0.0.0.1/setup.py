...
PACKAGES = [pack for pack in PACKAGES if "orangecontrib" in pack and "OWInterface_dev" in pack]
...
PACKAGE_DATA = {
    ...
    "orangecontrib.HLIT_dev": ["remote_server_smb/*"]
}
# /!\ les noms de fichier 'orangecontrib.hkh_bot.widgets' doivent correspondre à l'arborescence

# Dépendances
INSTALL_REQUIRES = [ "uvicorn", "fastapi", "psutil", "json", "socket"]
