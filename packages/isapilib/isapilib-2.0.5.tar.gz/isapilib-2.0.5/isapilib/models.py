...
class Cte(BaseModel, CteMixin):
    ...
    tipo = models.CharField(db_column='Tipo', max_length=15, blank=True, null=True)
    situacion = models.CharField(db_column='Situacion', max_length=50, blank=True, null=True)
    agente = models.ForeignKey(Agente, db_column='agente', to_field='agente', on_delete=models.PROTECT,
...
class Vin(BaseModel):
    ...
    articulo = models.ForeignKey(Art, db_column='Articulo', to_field='articulo', on_delete=models.PROTECT,
                                 related_name='vins')
...
class Venta(BaseModel, VentaMixin):
    ...
    agente = models.ForeignKey(Agente, db_column='agente', to_field='agente', on_delete=models.PROTECT,
                               related_name='ventas')
    empresa = ForeignKey(Empresa, db_column='Empresa', to_field='empresa', on_delete=models.PROTECT,
                         related_name='ventas')
    ...
    cliente = models.ForeignKey(Cte, db_column='Cliente', to_field='cliente', on_delete=models.PROTECT,
                                related_name='ventas')
    almacen = models.ForeignKey(Almacen, db_column='Almacen', to_field='almacen', on_delete=models.PROTECT,
                                related_name='ventas')
    ...
    servicio_articulo = models.ForeignKey(Art, db_column='ServicioArticulo', to_field='articulo',
    ...
    sucursal = models.ForeignKey(Sucursal, db_column='Sucursal', to_field='sucursal', on_delete=models.PROTECT,
                                 related_name='ventas')
...
class VentaD(BaseModel):
    venta = models.ForeignKey(Venta, db_column='ID', to_field='id', on_delete=models.PROTECT, related_name='details')
    ...
    sucursal = models.ForeignKey(Sucursal, db_column='Sucursal', to_field='sucursal', on_delete=models.PROTECT,
                                 related_name='details', blank=True, null=True)
    sucursal_origen = models.ForeignKey(Sucursal, db_column='SucursalOrigen', to_field='sucursal',
                                        on_delete=models.PROTECT,
...
class ListaPreciosD(models.Model):
