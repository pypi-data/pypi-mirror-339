...
ospf_int_name = input_data["ospf_int_name"]
ospf_int_data = input_data["ospf_int_data"]
...
message, status, changed = vrf_instance.create_ospf_interface(
    name=ospf_int_name, **ospf_int_data
)
