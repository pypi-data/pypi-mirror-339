...
class AcquisitionTestCase(BasePoolTestCase, BaseAcquisition, unittest.TestCase):
    ...
    def test_invalid_moveable_on_input_str(self):
        self.tgs["_test_tg_1_1"].moveable_on_input = "invalid_mot"
        with self.assertRaises(PoolException):
            self.meas_contpos_acquisition(
                config=config_1,
                synch_description=synch_description3,
                moveable="_test_mot_1_1"
            )
    
    def test_valid_moveable_on_input_str(self):
        self.tgs["_test_tg_1_1"].moveable_on_input = "_test_mot_1_1"
        self.meas_contpos_acquisition(
            config=config_1,
            synch_description=synch_description3,
            moveable="_test_mot_1_1"
    ...
    def test_invalid_moveable_on_input_dict(self):
        self.tgs["_test_tg_1_1"].moveable_on_input = {"invalid_mot": 1}
        with self.assertRaises(PoolException):
            self.meas_contpos_acquisition(
                config=config_1,
                synch_description=synch_description3,
    ...
    def test_valid_moveable_on_input_dict(self):
        self.tgs["_test_tg_1_1"].moveable_on_input = {"_test_mot_1_1": 1}
        self.meas_contpos_acquisition(
            config=config_1,
            synch_description=synch_description3,
            moveable="_test_mot_1_1"
