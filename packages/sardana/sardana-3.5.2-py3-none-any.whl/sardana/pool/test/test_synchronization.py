...
class SynchronizationTestCase(object):
    ...
    def tggeneration(self, ctrl_lib: str, ctrl_klass: str, ctrl_props: Any,
    ...
    def abort_tggeneration(self, ctrl_lib: str, ctrl_klass: str, ctrl_props: Any,
                           synchronization: Any, abort_time: float) -> None:
        """Helper method to verify trigger element states before and after
