...
class IORegister(PoolElementDevice):
    ...
    ignore_memorized_attrs_during_initialization = ("Value", )
    ...
    def init_device(self):
        ...
        id_ = self.get_id()
        try:
            self.ior = ior = self.pool.get_element_by_id(id_)
        except KeyError:
            ...
            ctrl = self.ior.get_controller()
            ctrl.add_element(self.ior, propagate=0)
