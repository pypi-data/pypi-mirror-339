...
"""
Auto-generated by CVXPYgen on October 24, 2024 at 17:50:16.
...
cpg = Extension('cpg_module',
                ...
                include_dirs=['c',
                              ...
                              os.path.join('c', 'osqp_code'),
                              os.path.join('c', 'osqp_code', 'inc', 'public'),
                              os.path.join('c', 'osqp_code', 'inc', 'private'),
