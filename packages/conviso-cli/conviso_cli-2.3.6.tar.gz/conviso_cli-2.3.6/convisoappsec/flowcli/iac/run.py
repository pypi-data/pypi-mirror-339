...
def run(context, flow_context, project_code, asset_id, company_id, repository_dir, send_to_flow, scanner_timeout,
        parallel_workers, deploy_id, experimental, asset_name, from_ast, cleanup):
    """
    ...
    perform_command(
        ...
        context.params['deploy_id'], context.params['experimental'], context.params['cleanup'], from_ast
    )
...
def perform_command(
        flow_context, project_code, asset_id, company_id, repository_dir, send_to_flow, scanner_timeout,
        deploy_id, experimental, cleanup, from_ast
):
