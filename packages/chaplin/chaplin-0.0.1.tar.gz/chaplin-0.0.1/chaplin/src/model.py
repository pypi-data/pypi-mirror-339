...
class NN_Single(nn.Module):
	...
	def load(self):
		self.bert = transformers.BertModel.from_pretrained("chaplin/marshalled/final_modelBert.hugg_m")
		self.final.load_state_dict(t.load("chaplin/marshalled/final_modelFinalLayer.stateDict"))
