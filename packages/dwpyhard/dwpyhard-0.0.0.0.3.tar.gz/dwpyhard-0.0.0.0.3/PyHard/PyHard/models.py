...
class Subscription:
    ...
    def remaining_days(self) -> int:
        ...
        ...
class SubscriptionBank:
    """
    # Хранилище подписок

    Обеспечивает быстрое взаимодействие и проверку значений подписок
    """
    def getAllSubscriptions(self) -> _typing.List[Subscription]:
        """
    ...
    def getSubscription(self, name: str) -> Subscription:
        """
    ...
    class __user:
        ...
        class __subscriptions:
            def setProductGwisid(self, gwisid: int):
                ...
                """
                ...
            async def createSubscriptionBank(self) -> SubscriptionBank:
                """
