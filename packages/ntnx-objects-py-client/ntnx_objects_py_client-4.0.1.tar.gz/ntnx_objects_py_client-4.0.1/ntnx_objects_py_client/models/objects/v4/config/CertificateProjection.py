...
from ntnx_objects_py_client.models.objects.v4.config.Certificate import Certificate  # noqa: F401,E501

class CertificateProjection(Certificate):
    ...
    def __init__(self, metadata=None, public_cert=None, private_key=None, ca=None, alternate_fqdns=None, should_generate=False, alternate_ips=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        Certificate.__init__(self, metadata, public_cert, private_key, ca, alternate_fqdns, should_generate, alternate_ips, ext_id, links, tenant_id, *args, **kwargs)
        self.discriminator = None

    def _initialize_object_type(self):
        return 'objects.v4.config.CertificateProjection'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CertificateProjection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CertificateProjection):
            return False
