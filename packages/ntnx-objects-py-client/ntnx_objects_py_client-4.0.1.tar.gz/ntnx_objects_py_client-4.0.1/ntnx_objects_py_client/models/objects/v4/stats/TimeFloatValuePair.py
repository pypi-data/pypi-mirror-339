...
class TimeFloatValuePair(object):
    ...
    def _initialize_object_type(self):
        return 'objects.v4.stats.TimeFloatValuePair'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(TimeFloatValuePair, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TimeFloatValuePair):
            return False
