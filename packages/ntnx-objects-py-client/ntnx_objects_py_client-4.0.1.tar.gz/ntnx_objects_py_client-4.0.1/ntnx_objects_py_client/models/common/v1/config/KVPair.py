...
from ntnx_objects_py_client.models.OneOfcommon.v1.config.KVPairvalue import KVPairvalue  # noqa: F401,E501
...
class KVPair(object):
    ...
    def value(self):
        ...
        :type:
                ...
                :class:`~list[str]` | 
                :class:`~dict(str, str)` | 
                :class:`~ntnx_objects_py_client.models.common.v1.config.MapOfStringWrapper` | 
                :class:`~list[int]`
        """  # noqa: E501
        return self.__value
