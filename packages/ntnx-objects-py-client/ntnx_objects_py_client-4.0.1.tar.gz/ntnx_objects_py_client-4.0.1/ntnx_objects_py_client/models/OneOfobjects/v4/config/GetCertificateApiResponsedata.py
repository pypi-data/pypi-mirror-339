...
class GetCertificateApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'objects.v4.config.Certificate': 'objects.v4.config.Certificate',
    ...
    def _initialize_object_type(self):
        return 'OneOfobjects.v4.config.GetCertificateApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetCertificateApiResponsedata.discriminator_value_class_map.values():
            return list(GetCertificateApiResponsedata.discriminator_value_class_map.keys())[list(GetCertificateApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetCertificateApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetCertificateApiResponsedata):
            return False
