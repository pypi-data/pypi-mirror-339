...
class ListObjectstoresApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<objects.v4.config.ObjectStore>': 'list[objects.v4.config.ObjectStore]',
        'objects.v4.error.ErrorResponse': 'objects.v4.error.ErrorResponse',
        'List<objects.v4.config.ObjectStoreProjection>': 'list[objects.v4.config.ObjectStoreProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfobjects.v4.config.ListObjectstoresApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListObjectstoresApiResponsedata.discriminator_value_class_map.values():
            return list(ListObjectstoresApiResponsedata.discriminator_value_class_map.keys())[list(ListObjectstoresApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListObjectstoresApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListObjectstoresApiResponsedata):
            return False
