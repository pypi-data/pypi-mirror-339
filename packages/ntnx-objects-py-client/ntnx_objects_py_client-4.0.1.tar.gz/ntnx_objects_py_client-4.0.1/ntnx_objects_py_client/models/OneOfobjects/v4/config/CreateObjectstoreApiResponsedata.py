...
class CreateObjectstoreApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfobjects.v4.config.CreateObjectstoreApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateObjectstoreApiResponsedata.discriminator_value_class_map.values():
            return list(CreateObjectstoreApiResponsedata.discriminator_value_class_map.keys())[list(CreateObjectstoreApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateObjectstoreApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateObjectstoreApiResponsedata):
            return False
