...
class ErrorResponseerror(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<objects.v4.error.AppMessage>': 'list[objects.v4.error.AppMessage]',
        'objects.v4.error.SchemaValidationError': 'objects.v4.error.SchemaValidationError'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfobjects.v4.error.ErrorResponseerror'
