...
class GetObjectstoreStatsApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'objects.v4.stats.ObjectstoreStats': 'objects.v4.stats.ObjectstoreStats',
    ...
    def _initialize_object_type(self):
        return 'OneOfobjects.v4.stats.GetObjectstoreStatsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetObjectstoreStatsApiResponsedata.discriminator_value_class_map.values():
            return list(GetObjectstoreStatsApiResponsedata.discriminator_value_class_map.keys())[list(GetObjectstoreStatsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetObjectstoreStatsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetObjectstoreStatsApiResponsedata):
            return False
