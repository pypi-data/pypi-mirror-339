...
import ntnx_objects_py_client.models
from ntnx_objects_py_client import rest
...
class ApiClient(object):
    ...
    # Populated if multiple schemas exist with the same name
        'objects.v4.config.DeleteObjectstoreApiResponse' : 'DeleteObjectstoreApiResponse',
        ...
        'OneOfobjects.v4.config.CreateCertificateApiResponsedata' : 'CreateCertificateApiResponsedata',
        'objects.v4.stats.GetObjectstoreStatsApiResponse' : 'GetObjectstoreStatsApiResponse',
        'OneOfobjects.v4.config.CreateObjectstoreApiResponsedata' : 'CreateObjectstoreApiResponsedata',
        'objects.v4.config.CreateObjectstoreApiResponse' : 'CreateObjectstoreApiResponse',
        'common.v1.config.Flag' : 'Flag',
        'objects.v4.error.ErrorResponse' : 'ErrorResponse',
        'objects.v4.config.GetObjectstoreApiResponse' : 'GetObjectstoreApiResponse',
        'objects.v4.error.SchemaValidationErrorMessage' : 'SchemaValidationErrorMessage',
        'objects.v4.config.ObjectStore' : 'ObjectStore',
        'OneOfobjects.v4.error.ErrorResponseerror' : 'ErrorResponseerror',
        'common.v1.config.MessageSeverity' : 'MessageSeverity',
        'prism.v4.config.TaskReference' : 'TaskReference',
        'objects.v4.config.GetCaApiResponse' : 'GetCaApiResponse',
        'objects.v4.config.GetCertificateApiResponse' : 'GetCertificateApiResponse',
        'objects.v4.config.ListCertificatesApiResponse' : 'ListCertificatesApiResponse',
        'common.v1.response.ApiLink' : 'ApiLink',
        'OneOfobjects.v4.config.ListCertificatesApiResponsedata' : 'ListCertificatesApiResponsedata',
        'objects.v4.config.ListObjectstoresApiResponse' : 'ListObjectstoresApiResponse',
        'objects.v4.stats.TimeFloatValuePair' : 'TimeFloatValuePair',
        'objects.v4.config.State' : 'State',
        'common.v1.config.Metadata' : 'Metadata',
        'objects.v4.stats.ObjectstoreStats' : 'ObjectstoreStats',
        'objects.v4.config.Certificate' : 'Certificate',
        'objects.v4.config.UpdateObjectstoreApiResponse' : 'UpdateObjectstoreApiResponse',
        'OneOfobjects.v4.config.DeleteObjectstoreApiResponsedata' : 'DeleteObjectstoreApiResponsedata',
        'common.v1.stats.TimeIntValuePair' : 'TimeIntValuePair',
        'common.v1.config.MapOfStringWrapper' : 'MapOfStringWrapper',
        'OneOfobjects.v4.config.ListObjectstoresApiResponsedata' : 'ListObjectstoresApiResponsedata',
        'common.v1.response.ApiResponseMetadata' : 'ApiResponseMetadata',
        'OneOfobjects.v4.stats.GetObjectstoreStatsApiResponsedata' : 'GetObjectstoreStatsApiResponsedata',
        'OneOfobjects.v4.config.GetObjectstoreApiResponsedata' : 'GetObjectstoreApiResponsedata',
        'common.v1.config.IPAddress' : 'IPAddress',
        'common.v1.config.TenantAwareModel' : 'TenantAwareModel',
        'OneOfobjects.v4.config.GetCertificateApiResponsedata' : 'GetCertificateApiResponsedata',
        'objects.v4.config.ObjectStoreProjection' : 'ObjectStoreProjection',
        'OneOfobjects.v4.config.GetCaApiResponsedata' : 'GetCaApiResponsedata',
        'objects.v4.error.SchemaValidationError' : 'SchemaValidationError',
        'OneOfobjects.v4.config.UpdateObjectstoreApiResponsedata' : 'UpdateObjectstoreApiResponsedata',
        'common.v1.response.ExternalizableAbstractModel' : 'ExternalizableAbstractModel',
        'objects.v4.config.CertificateProjection' : 'CertificateProjection',
        'objects.v4.config.CreateCertificateApiResponse' : 'CreateCertificateApiResponse',
        'objects.v4.error.AppMessage' : 'AppMessage',
    ...
    def __call_api(
        ...
        if response_data.status == 401:
            ...
            if response_data.status == 401:
                raise ntnx_objects_py_client.rest.ApiException(http_resp=response_data)
    ...
    def __deserialize_response(self, response, response_type):
        ...
        :type response: :class:`~ntnx_objects_py_client.rest.RESTResponse`, required
    ...
    def _call_api(self, resource_path, method,
        ...
        :param _request_timeout: Timeout setting for this request. It needs to be a pair (list) of
            ...
            the timeouts will be derived from the :class:`~ntnx_objects_py_client.configuration.Configuration`.
    ...
    def __deserialize_file(self, response):
        ...
        :param response: :class:`~ntnx_objects_py_client.rest.RESTResponse`
        :return: File path
        """
    ...
    def __deserialize_date(self, string):
        ...
        :param string:
        :type string: str
        :raises :class:`~ntnx_objects_py_client.rest.ApiException` if provided string is not a valid date
        :return: date object
        """
    ...
    def __deserialize_datatime(self, string):
        ...
        :raises :class:`~ntnx_objects_py_client.rest.ApiException` if provided string is not a valid datetime
    ...
    def __getattr(self, name):
        if name in self.DUPLICATE_SCHEMA_MAPPING:
            return getattr(ntnx_objects_py_client.models, self.DUPLICATE_SCHEMA_MAPPING[name])
        if hasattr(ntnx_objects_py_client.models, name.split('.')[-1]):
            return getattr(ntnx_objects_py_client.models, name.split('.')[-1])
        else:
            return getattr(ntnx_objects_py_client.models, name)
