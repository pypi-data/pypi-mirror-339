...
class ListCertificatesApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'List<objects.v4.config.Certificate>': 'list[objects.v4.config.Certificate]',
        'objects.v4.error.ErrorResponse': 'objects.v4.error.ErrorResponse',
        'List<objects.v4.config.CertificateProjection>': 'list[objects.v4.config.CertificateProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfobjects.v4.config.ListCertificatesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ListCertificatesApiResponsedata.discriminator_value_class_map.values():
            return list(ListCertificatesApiResponsedata.discriminator_value_class_map.keys())[list(ListCertificatesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ListCertificatesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ListCertificatesApiResponsedata):
            return False
