...
class UpdateObjectstoreApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfobjects.v4.config.UpdateObjectstoreApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateObjectstoreApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateObjectstoreApiResponsedata.discriminator_value_class_map.keys())[list(UpdateObjectstoreApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateObjectstoreApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateObjectstoreApiResponsedata):
            return False
