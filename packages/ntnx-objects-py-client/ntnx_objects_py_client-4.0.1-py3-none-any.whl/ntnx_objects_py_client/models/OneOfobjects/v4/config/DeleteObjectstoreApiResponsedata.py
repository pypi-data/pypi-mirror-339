...
class DeleteObjectstoreApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfobjects.v4.config.DeleteObjectstoreApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeleteObjectstoreApiResponsedata.discriminator_value_class_map.values():
            return list(DeleteObjectstoreApiResponsedata.discriminator_value_class_map.keys())[list(DeleteObjectstoreApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteObjectstoreApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteObjectstoreApiResponsedata):
            return False
