...
class GetCaApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfobjects.v4.config.GetCaApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetCaApiResponsedata.discriminator_value_class_map.values():
            return list(GetCaApiResponsedata.discriminator_value_class_map.keys())[list(GetCaApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetCaApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetCaApiResponsedata):
            return False
