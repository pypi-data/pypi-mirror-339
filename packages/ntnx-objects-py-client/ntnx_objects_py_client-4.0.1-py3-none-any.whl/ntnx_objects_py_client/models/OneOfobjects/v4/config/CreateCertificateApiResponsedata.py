...
class CreateCertificateApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfobjects.v4.config.CreateCertificateApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateCertificateApiResponsedata.discriminator_value_class_map.values():
            return list(CreateCertificateApiResponsedata.discriminator_value_class_map.keys())[list(CreateCertificateApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateCertificateApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateCertificateApiResponsedata):
            return False
