...
class GetObjectstoreApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'objects.v4.config.ObjectStore': 'objects.v4.config.ObjectStore',
    ...
    def _initialize_object_type(self):
        return 'OneOfobjects.v4.config.GetObjectstoreApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in GetObjectstoreApiResponsedata.discriminator_value_class_map.values():
            return list(GetObjectstoreApiResponsedata.discriminator_value_class_map.keys())[list(GetObjectstoreApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(GetObjectstoreApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetObjectstoreApiResponsedata):
            return False
