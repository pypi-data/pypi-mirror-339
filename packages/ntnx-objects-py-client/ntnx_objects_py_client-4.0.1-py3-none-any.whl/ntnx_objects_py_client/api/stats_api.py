...
class StatsApi(object):
    ...
    def get_objectstore_stats_by_id(self, extId, _startTime, _endTime, _samplingInterval=None, _statType=None, _select=None, **kwargs):  # noqa: E501
        """Get the Object store stats

        >>> response = api.get_objectstore_stats_by_id(extId, _startTime, _endTime, (optional) _samplingInterval, (optional) _statType, (optional) _select)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_objectstore_stats_by_id(extId, _startTime, _endTime, async_req=True)
        >>> result = thread.get()
        ...
        :param _select: A URL query parameter that allows clients to request a specific set of properties for each entity or complex type. Expression specified with the $select must conform to the [OData V4.01](https://docs.oasis-open.org/odata/odata/v4.01/odata-v4.01-part1-protocol.html) URL conventions. If a $select expression consists of a single select item that is an asterisk (i.e., *), then all properties on the matching resource will be returned. - bucketCount - deleteRequestsPerSecond - getBucketOperationsPerSecond - getObjectTtfbMsecs - getRequestThroughputBytesPerSecond - getRequestsPerSecond - headRequestsPerSecond - inboundBytesPerSecond - listMultipartUploadsOperationsPerSecond - multipartUploadStartOperationsPerSecond - nfsReadRequestsPerSecond - nfsReadThroughputBytesPerSecond - nfsWriteRequestsPerSecond - nfsWriteThroughputBytesPerSecond - objectCount - objectOperationsPerSecond - outboundBytesPerSecond - postRequestsPerSecond - putRequestThroughputBytesPerSecond - putRequestsPerSecond - selectObjectContentOperationsPerSecond - storageUsageBytes 
        :type _select:
            :class:`str`
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_objects_py_client.models.objects.v4.stats.GetObjectstoreStatsApiResponse`.
        ...
        if ('extId' not in params or params['extId'] is None):
            raise ValueError("Missing the required parameter `extId` when calling `get_objectstore_stats_by_id`")  # noqa: E501
        # verify the required parameter '_startTime' is set
        if ('_startTime' not in params or params['_startTime'] is None):
            raise ValueError("Missing the required parameter `_startTime` when calling `get_objectstore_stats_by_id`")  # noqa: E501
        # verify the required parameter '_endTime' is set
        if ('_endTime' not in params or params['_endTime'] is None):
            raise ValueError("Missing the required parameter `_endTime` when calling `get_objectstore_stats_by_id`")  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/objects/v4.0/stats/object-stores/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
                    ...
                    response_type='objects.v4.stats.GetObjectstoreStatsApiResponse',  # noqa: E501
