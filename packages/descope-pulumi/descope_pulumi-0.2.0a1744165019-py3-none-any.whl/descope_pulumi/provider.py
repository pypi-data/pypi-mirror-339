...
class ProviderArgs:
    ...
    def management_key(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "management_key")

    @management_key.setter
    def management_key(self, value: Optional[pulumi.Input[str]]):
...
class Provider(pulumi.ProviderResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["management_key"] = None if management_key is None else pulumi.Output.secret(management_key)
            __props__.__dict__["project_id"] = project_id
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["managementKey"])
    ...
    @property
    @pulumi.getter(name="managementKey")
    def management_key(self) -> pulumi.Output[Optional[str]]:
        return pulumi.get(self, "management_key")
