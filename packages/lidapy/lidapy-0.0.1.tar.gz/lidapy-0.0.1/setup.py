...
setup(
    ...
    #
    packages=find_packages(where="src", include="Configs"),  # Required
    ...
    package_data={  # Optional
        "lidapy": ["Configs/DEFAULT_PROCESSORS.yaml",
                   "Configs/DEFAULT_SENSORS.yaml",
                   "Configs/module_locations.yaml"],
    },
    # If there are data files included in your packages that need to be
    # installed, specify them here.
