...
def create_ass_subtitles(
    ...
    try:
        ...
        font_path = font_manager.get_font_path(style.font)
        font_name = style.font  # Default to the requested font name

        # If font path was found, use the exact name from the TTF file
        if font_path:
        ...
        with open(output_path, 'w', encoding='utf-8') as f:
            ...
            # Write default style
            f.write(
                f"Style: Default,{font_name},{style.font_size},"  # Use exact font name 
