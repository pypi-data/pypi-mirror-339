...
class IReviewDoc(BaseModel):
    ...
    collection_id: Optional[NumberType] = Field(default=None, description="The collection ID of the collection that was reviewed. Only applicable to collection reviews.", alias="collectionId")
