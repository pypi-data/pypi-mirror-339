...
class GetCollectionRequestBody(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["viewsToFetch", "fetchTotalBalances", "challengeTrackersToFetch", "disableDefaults", "approvalTrackersToFetch", "fetchPrivateParams", "metadataToFetch", "collectionId"]
