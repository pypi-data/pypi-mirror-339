...
class CreateClaimRequest(BaseModel):
    ...
    collection_id: Optional[NumberType] = Field(default=None, description="Collection ID that the claim is for (if applicable - collection claims).", alias="collectionId")
