...
class IGetSearchPayload(BaseModel):
    ...
    specific_collection_id: Optional[NumberType] = Field(default=None, description="If true, we will limit collection-based results to a single collection.", alias="specificCollectionId")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of specific_collection_id
        if self.specific_collection_id:
            _dict['specificCollectionId'] = self.specific_collection_id.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "specificCollectionId": NumberType.from_dict(obj["specificCollectionId"]) if obj.get("specificCollectionId") is not None else None
        })
