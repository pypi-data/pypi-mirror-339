...
class IInheritMetadataFrom(BaseModel):
    ...
    collection_id: Optional[NumberType] = Field(default=None, description="The collection ID to link to", alias="collectionId")
    ...
    badge_id: Optional[StrictStr] = Field(default=None, description="The badge ID to link to \"collectionId:badgeId\"", alias="badgeId")
