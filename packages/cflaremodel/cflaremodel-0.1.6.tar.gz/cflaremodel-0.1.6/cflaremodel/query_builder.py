...
class QueryBuilder:
    ...
    def join(self, table: str, left: str, right: str) -> "QueryBuilder":
        ...
        Returns:
            QueryBuilder: The current QueryBuilder instance.
        """
        self._joins.append(f"JOIN {table} ON {left} = {right}")
        return self

    def left_join(self, table: str, left: str, right: str) -> "QueryBuilder":
        """
    ...
    def right_join(self, table: str, left: str, right: str) -> "QueryBuilder":
        """
        ...
        Returns:
            QueryBuilder: The current QueryBuilder instance.
        """
        self._joins.append(f"RIGHT JOIN {table} ON {left} = {right}")
        return self
