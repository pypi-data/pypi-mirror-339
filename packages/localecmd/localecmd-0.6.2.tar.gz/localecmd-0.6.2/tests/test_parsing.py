...
def test_complete_command(capsys):
    ...
    assert complete_command("list ar".split(), flist, dist)[0] == "list_args"
    assert complete_command("li ar".split(), flist, dist)[0] == "list_args"
    ...
    assert complete_command("list a".split(), flist, dist)[0] == ""
    assert "could be" in capsys.readouterr().out.strip()
