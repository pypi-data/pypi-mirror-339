...
import { B as Block, S as Static, f as BlockLabel, y as File$1, h as Empty, U as UploadText, i as IconButtonWrapper, j as IconButton, J as Undo, k as Download } from './2-aR-7a0xn.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-Mx4wIkG_.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-B2hRwa9P.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-BdW6rfzU.js');
  return module.default;
}
...
//# sourceMappingURL=Index55-BZsm9lY_.js.map
