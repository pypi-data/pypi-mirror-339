const __vite__fileDeps=["./index.Bq5mFuDo.js","./preload-helper.DpQnamwV.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { r as resolve_wasm_src } from "./2.DunTbUMl.js";
...
function instance($$self, $$props, $$invalidate) {
  ...
  onMount(() => {
    const initViewer = async () => {
      BABYLON_VIEWER = await __vitePreload(() => import("./index.Bq5mFuDo.js").then((n) => n.bX), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url);
