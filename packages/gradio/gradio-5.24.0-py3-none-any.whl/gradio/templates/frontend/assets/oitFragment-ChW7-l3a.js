import{j as e}from"./index-D5JzhMbY.js";const t="prePassDeclaration",w=`#ifdef PREPASS
...
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=X);const a="lightFragmentDeclaration",x=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=x);const r="lightUboDeclaration",C=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=C);const s="samplerFragmentDeclaration",L=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=L);const n="imageProcessingDeclaration",E=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=E);const l="imageProcessingFunctions",T=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=T);const d="shadowsFragmentFunctions",I=`#ifdef SHADOWS
...
//# sourceMappingURL=oitFragment-ChW7-l3a.js.map
