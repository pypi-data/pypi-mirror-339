...
class FormAgent:
    ...
    async def _extract_form_info(
        ...
        try:
            ...
            [MESSAGE_HISTORY]
            {Helper.data_to_yaml(history_data)}
            [/MESSAGE_HISTORY]
            ...
            - Thank them and ask the next logical question.

            If the message is unclear or not related to previous ones:
            - Politely ask the user to clarify or restate their answer.

            Other:
            - Try to ask next logical group of questions, that will help to fill the form faster.
