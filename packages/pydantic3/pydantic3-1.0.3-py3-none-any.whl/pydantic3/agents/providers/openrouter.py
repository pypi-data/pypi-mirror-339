...
from ..utils.logging_config import SimpleLogger  # Import SimpleLogger
...
class OpenRouterProvider:
    ...
    def __init__(
        ...
        Args:
            ...
            model_name: The default model identifier to use (e.g., 'openai/gpt-4o-2024-11-20-mini-2024-07-18').
