...
class CommandFieldBase(ICommand):
    ...
    _rate: float = 1
    _state: int = 1
    _approach: Union[ApproachEnum, int] = ApproachEnum.no_overshoot
    ...
    def set_state_server(self, arg_string) -> Union[str, int]:
        ...
        if set_approach > len(ApproachEnum) - 1:
        ...
        if self.instrument_name != 'PPMS':
            ...
            if set_driven > len(drivenEnum) - 1:
        ...
        error = self.set_state_imp(field,
                                   set_rate_per_sec,
                                   set_approach,
                                   set_driven
                                   )
...
class CommandFieldImp(ICommandImp, CommandFieldBase):
    ...
    def set_state_imp(self,
        ...
        self.driven_mode = drivenEnum(set_driven)
    ...
    def test(self) -> bool:
        ...
        if state_name == 'Holding (driven)' or state_name == 'Stable':
            steady = self.floats_equal(self.current_val,
                                       self.set_point,
                                       accept_pct,
                                       abs_tol,
                                       )
...
class CommandFieldSim(CommandFieldBase,
    ...
    def set_state_imp(self,
        ...
        self.change_thread = self.get_sim_instance()
        ...
        self.driven_mode = drivenEnum(set_driven)
        self.change_thread.driven_mode = self.driven_mode
