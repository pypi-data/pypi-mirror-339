...
class StlNode(groupdocs.metadata.common.CustomPackage):
...
class StlPackage(groupdocs.metadata.common.CustomPackage):
    ...
    @property
    def nodes(self) -> List[groupdocs.metadata.formats.threed.stl.StlNode]:
        '''Gets an array of :py:class:`groupdocs.metadata.formats.threed.stl.StlNode` entries inside the 3ds file.'''
        raise NotImplementedError()
    

class StlRootPackage(groupdocs.metadata.common.RootMetadataPackage):
    '''Represents .stl file metadata.'''
    ...
    @property
    def stl_package(self) -> groupdocs.metadata.formats.threed.stl.StlPackage:
