...
class TorrentPackage(groupdocs.metadata.common.CustomPackage):
    ...
    @property
    def shared_files(self) -> List[groupdocs.metadata.formats.peer2peer.TorrentSharedFilePackage]:
        '''Gets an array containing shared file information entries.'''
        raise NotImplementedError()
    
    @property
    def piece_length(self) -> int:
        '''Gets the number of bytes in each piece. For more information please see :py:attr:`groupdocs.metadata.formats.peer2peer.TorrentPackage.pieces`.'''
        raise NotImplementedError()
...
class TorrentRootPackage(groupdocs.metadata.common.RootMetadataPackage):
    ...
    @property
    def torrent_package(self) -> groupdocs.metadata.formats.peer2peer.TorrentPackage:
        '''Gets the TORRENT file metadata package.'''
        raise NotImplementedError()
    

class TorrentSharedFilePackage(groupdocs.metadata.common.CustomPackage):
