...
class DaeNode(groupdocs.metadata.common.CustomPackage):
    '''Represents metadata associated with an .dae file.'''
...
class DaePackage(groupdocs.metadata.common.CustomPackage):
    ...
    def modification_time(self, value : datetime) -> None:
        '''Gets or Sets the modification time of this asset.'''
        raise NotImplementedError()
    ...
    @property
    def nodes(self) -> List[groupdocs.metadata.formats.threed.dae.DaeNode]:
        '''Gets an array of :py:class:`groupdocs.metadata.formats.threed.dae.DaeNode` entries inside the dae file.'''
        raise NotImplementedError()
    

class DaeRootPackage(groupdocs.metadata.common.RootMetadataPackage):
    '''Represents .dae file metadata.'''
    ...
    @property
    def dae_package(self) -> groupdocs.metadata.formats.threed.dae.DaePackage:
