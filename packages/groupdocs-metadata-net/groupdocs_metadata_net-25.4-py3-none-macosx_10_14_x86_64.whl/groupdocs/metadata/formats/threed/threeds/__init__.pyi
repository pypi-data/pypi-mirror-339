...
class ThreeDSNode(groupdocs.metadata.common.CustomPackage):
...
class ThreeDSPackage(groupdocs.metadata.common.CustomPackage):
    ...
    @property
    def nodes(self) -> List[groupdocs.metadata.formats.threed.threeds.ThreeDSNode]:
        '''Gets an array of :py:class:`groupdocs.metadata.formats.threed.threeds.ThreeDSNode` entries inside the 3ds file.'''
        raise NotImplementedError()
    

class ThreeDSRootPackage(groupdocs.metadata.common.RootMetadataPackage):
    '''Represents .3ds file metadata.'''
    ...
    @property
    def three_ds_package(self) -> groupdocs.metadata.formats.threed.threeds.ThreeDSPackage:
