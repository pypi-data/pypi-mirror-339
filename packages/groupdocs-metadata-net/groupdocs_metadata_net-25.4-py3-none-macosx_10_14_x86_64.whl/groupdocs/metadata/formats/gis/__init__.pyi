...
class GisAttribute(groupdocs.metadata.common.CustomPackage):
...
class GisFeature(groupdocs.metadata.common.CustomPackage):
    '''Represents metadata associated with feature.'''
    ...
    @property
    def attributes(self) -> List[groupdocs.metadata.formats.gis.GisAttribute]:
        '''Gets an array of :py:class:`groupdocs.metadata.formats.gis.GisAttribute`.'''
        raise NotImplementedError()
    

class GisPackage(groupdocs.metadata.common.CustomPackage):
    ...
    @property
    def features(self) -> List[groupdocs.metadata.formats.gis.GisFeature]:
        '''Gets an array of :py:class:`groupdocs.metadata.formats.gis.GisFeature`.'''
        raise NotImplementedError()
    

class GisRootPackage(groupdocs.metadata.common.RootMetadataPackage):
    '''Represents gis metadata.'''
    ...
    @property
    def gis_package(self) -> groupdocs.metadata.formats.gis.GisPackage:
