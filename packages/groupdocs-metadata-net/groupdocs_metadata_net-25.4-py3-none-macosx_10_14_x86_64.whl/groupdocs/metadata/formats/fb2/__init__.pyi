...
class Fb2Package(groupdocs.metadata.common.CustomPackage):
    ...
    @property
    def title_info(self) -> groupdocs.metadata.formats.ebook.fb2.Fb2TitleInfo:
        '''Description of information about the work (including translation, but excluding publication).'''
        raise NotImplementedError()
    
    @property
    def src_title_info(self) -> groupdocs.metadata.formats.ebook.fb2.Fb2TitleInfo:
        '''Description of information about the work in the original language (not available for the original book).'''
        raise NotImplementedError()
    
    @property
    def document_info(self) -> groupdocs.metadata.formats.ebook.fb2.Fb2DocumentInfo:
        '''Description of information about a specific FB2.x document (creator(s), history, etc.).'''
        raise NotImplementedError()
    
    @property
    def publish_info(self) -> groupdocs.metadata.formats.ebook.fb2.Fb2PublishInfo:
