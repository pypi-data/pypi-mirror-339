...
class CadCustomPropertyPackage(groupdocs.metadata.common.CustomPackage):
...
class CadPackage(groupdocs.metadata.common.CustomPackage):
    ...
    @property
    def acad_version(self) -> groupdocs.metadata.formats.cad.CadAcadVersion:
    ...
    @property
    def custom_properties(self) -> groupdocs.metadata.formats.cad.CadCustomPropertyPackage:
        '''Gets the package containing custom metadata properties.'''
        raise NotImplementedError()
    

class CadRootPackage(groupdocs.metadata.common.RootMetadataPackage):
    ...
    @property
    def cad_package(self) -> groupdocs.metadata.formats.cad.CadPackage:
        '''Gets the CAD metadata package.'''
        raise NotImplementedError()
    

class DwgRootPackage(CadRootPackage):
...
class DxfRootPackage(CadRootPackage):
