...
class RarFile(groupdocs.metadata.common.CustomPackage):
    ...
    @property
    def modification_date_time(self) -> datetime:
        '''Gets the last modification date and time.'''
        raise NotImplementedError()
    

class RarPackage(groupdocs.metadata.common.CustomPackage):
    ...
    @property
    def files(self) -> List[groupdocs.metadata.formats.archive.RarFile]:
        '''Gets an array of :py:class:`groupdocs.metadata.formats.archive.ZipFile` entries inside the ZIP archive.'''
        raise NotImplementedError()
...
class RarRootPackage(groupdocs.metadata.common.RootMetadataPackage):
    ...
    @property
    def rar_package(self) -> groupdocs.metadata.formats.archive.RarPackage:
        '''Gets the ZIP metadata package.'''
        raise NotImplementedError()
    

class SevenZipFile(groupdocs.metadata.common.CustomPackage):
    '''Represents metadata associated with an archived file or directory.'''
...
class SevenZipPackage(groupdocs.metadata.common.CustomPackage):
    '''Represents ZIP archive metadata.'''
    ...
    @property
    def files(self) -> List[groupdocs.metadata.formats.archive.SevenZipFile]:
        '''Gets an array of :py:class:`groupdocs.metadata.formats.archive.ZipFile` entries inside the ZIP archive.'''
        raise NotImplementedError()
...
class SevenZipRootPackage(groupdocs.metadata.common.RootMetadataPackage):
    '''Represents the root package allowing working with metadata in a ZIP archive.'''
    ...
    @property
    def seven_zip_package(self) -> groupdocs.metadata.formats.archive.SevenZipPackage:
        '''Gets the ZIP metadata package.'''
        raise NotImplementedError()
    

class TarFile(groupdocs.metadata.common.CustomPackage):
    '''Represents metadata associated with an archived file or directory.'''
...
class TarPackage(groupdocs.metadata.common.CustomPackage):
    '''Represents ZIP archive metadata.'''
    ...
    @property
    def files(self) -> List[groupdocs.metadata.formats.archive.TarFile]:
        '''Gets an array of :py:class:`groupdocs.metadata.formats.archive.ZipFile` entries inside the ZIP archive.'''
        raise NotImplementedError()
...
class TarRootPackage(groupdocs.metadata.common.RootMetadataPackage):
    '''Represents the root package allowing working with metadata in a ZIP archive.'''
    ...
    @property
    def tar_package(self) -> groupdocs.metadata.formats.archive.TarPackage:
        '''Gets the ZIP metadata package.'''
        raise NotImplementedError()
    

class ZipFile(groupdocs.metadata.common.CustomPackage):
    '''Represents metadata associated with an archived file or directory.'''
    ...
    @property
    def compression_method(self) -> groupdocs.metadata.formats.archive.ZipCompressionMethod:
...
class ZipPackage(groupdocs.metadata.common.CustomPackage):
    '''Represents ZIP archive metadata.'''
    ...
    @property
    def files(self) -> List[groupdocs.metadata.formats.archive.ZipFile]:
        '''Gets an array of :py:class:`groupdocs.metadata.formats.archive.ZipFile` entries inside the ZIP archive.'''
        raise NotImplementedError()
...
class ZipRootPackage(groupdocs.metadata.common.RootMetadataPackage):
    '''Represents the root package allowing working with metadata in a ZIP archive.'''
    ...
    @property
    def zip_package(self) -> groupdocs.metadata.formats.archive.ZipPackage:
        '''Gets the ZIP metadata package.'''
        raise NotImplementedError()
...
class ZipCompressionMethod:
    ...
    NO_COMPRESSION : ZipCompressionMethod
    '''The file is stored (no compression).'''
    SHRUNK : ZipCompressionMethod
    '''The file is Shrunk.'''
    IMPLODED : ZipCompressionMethod
    '''The file is Imploded.'''
    RESERVED : ZipCompressionMethod
    '''A reserved compression method.'''
    DEFLATED : ZipCompressionMethod
    '''The file is Deflated.'''
    B_ZIP2 : ZipCompressionMethod
    '''The file is compressed with the BZip2 algorithm.'''
    LZMA : ZipCompressionMethod
