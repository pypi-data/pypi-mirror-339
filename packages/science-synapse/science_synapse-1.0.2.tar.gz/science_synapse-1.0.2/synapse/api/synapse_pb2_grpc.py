...
class SynapseDeviceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.Info = channel.unary_unary('/synapse.SynapseDevice/Info', request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString, response_deserializer=api_dot_synapse__pb2.DeviceInfo.FromString, _registered_method=True)
        self.Configure = channel.unary_unary('/synapse.SynapseDevice/Configure', request_serializer=api_dot_synapse__pb2.DeviceConfiguration.SerializeToString, response_deserializer=api_dot_status__pb2.Status.FromString, _registered_method=True)
...
class SynapseDevice(object):
    ...
    def Info(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/synapse.SynapseDevice/Info', google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString, api_dot_synapse__pb2.DeviceInfo.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata, _registered_method=True)
    ...
    def Configure(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/synapse.SynapseDevice/Configure', api_dot_synapse__pb2.DeviceConfiguration.SerializeToString, api_dot_status__pb2.Status.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata, _registered_method=True)
