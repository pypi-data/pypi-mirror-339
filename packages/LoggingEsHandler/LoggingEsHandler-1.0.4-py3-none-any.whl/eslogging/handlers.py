...
from eslogging.serializers import CMRESSerializer
...
class LoggingEsHandler(logging.Handler):
    ...
    def __init__(self,
        ...
        self.auto_stack_info = auto_stack_info
    ...
    def emit(self, record):
        ...
        if self.auto_stack_info and not record.stack_info:
