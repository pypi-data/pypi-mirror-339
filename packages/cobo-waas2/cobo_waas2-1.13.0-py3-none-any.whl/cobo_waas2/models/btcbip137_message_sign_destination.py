...
class BTCBIP137MessageSignDestination(BaseModel):
    """
    ...
    message_bip137: StrictStr = Field(description="Message to be signed, in hexadecimal format.")
    __properties: ClassVar[List[str]] = ["destination_type", "message_bip137"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "message_bip137": obj.get("message_bip137")
        })
        return _obj
