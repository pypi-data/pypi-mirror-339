...
def task(store_result: bool = True, unique_key_generator: Callable = None, retry: bool = True,
         error_eta_max: int | None = None, max_retries: int | None = None, error_expires: int | None = None,
         result_expires: int | None = 604800, error_eta_inc: int | None = 15):
    ...
    def inner(f):
        class EventixTask(EventixTaskBase):
            ...
            def delay(
                ...
                **kwargs,
                ...
                tm = self.make_task_model(
                    args, kwargs, priority=_priority * -1, eta=_eta
                )
            ...
            def make_task_model(self, args, kwargs, priority, eta) -> TEventixTask:
