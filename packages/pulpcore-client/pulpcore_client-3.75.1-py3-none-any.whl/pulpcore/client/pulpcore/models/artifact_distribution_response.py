...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_url", "hidden", "content_guard", "name", "base_path", "pulp_labels", "pulp_href", "pulp_created", "prn", "no_content_change_since", "pulp_last_updated"]
