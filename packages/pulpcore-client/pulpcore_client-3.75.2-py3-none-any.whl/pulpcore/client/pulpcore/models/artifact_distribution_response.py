...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_path", "no_content_change_since", "pulp_last_updated", "pulp_created", "base_url", "prn", "name", "hidden", "pulp_labels", "pulp_href", "content_guard"]
