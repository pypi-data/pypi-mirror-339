...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_last_updated=None, pulp_href=None, prn=None, hidden=False, pulp_labels=None, base_path=None, base_url=None, content_guard=None, name=None, no_content_change_since=None, local_vars_configuration=None):  # noqa: E501
