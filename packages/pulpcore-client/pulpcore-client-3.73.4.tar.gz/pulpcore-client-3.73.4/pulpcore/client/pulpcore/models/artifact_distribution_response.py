...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_href", "no_content_change_since", "name", "base_url", "prn", "pulp_last_updated", "content_guard", "pulp_labels", "pulp_created", "hidden", "base_path"]
