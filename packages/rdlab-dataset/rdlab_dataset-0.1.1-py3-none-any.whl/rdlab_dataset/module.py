...
class KhmerWordLoader:
    def __init__(self, filepath='./data/wild_khmer_data.pkl'):
...
class KhmerAddressLoader:
    def __init__(self, filepath='./data/address_kh_data.pkl'):
        self.filepath = filepath
...
class KhmerSentencesLoader:
    def __init__(self, filepath='./data/wild_khmer_sentences.pkl'):
        self.filepath = filepath
