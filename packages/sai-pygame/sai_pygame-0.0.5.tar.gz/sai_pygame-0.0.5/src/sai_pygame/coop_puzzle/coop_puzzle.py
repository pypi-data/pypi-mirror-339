...
class CoopPuzzleEnv(ArenaXGameBase):
    ...
    def step(self, action):
        ...
        truncated = done or self.frame > 7200  # Truncate at 2 min (at 60fps)
    ...
    def add_asset(self, AssetClass, sprite, x, y, random_rotation, group):
        tile = AssetClass(sprite, self.map.tile_size, random_rotation, group)
    ...
    def get_asset_key(self, group, num_variations):
        variation = random.randint(1, num_variations)
