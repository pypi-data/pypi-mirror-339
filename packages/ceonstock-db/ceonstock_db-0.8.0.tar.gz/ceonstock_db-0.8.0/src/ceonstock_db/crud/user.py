...
from ceonstock_db.models import user as user_models

# from ceonstock_db.auth import security
...
#         user_models.UserTbl.uuid == user_uuid
#     )
#     try:
...
def create(
    ...
    logger.debug(f"Flushing new user.")
    db.flush()
