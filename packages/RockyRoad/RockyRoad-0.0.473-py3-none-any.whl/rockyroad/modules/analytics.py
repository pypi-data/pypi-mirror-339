...
class _Analytics(Consumer):
    ...
    def form_results(self, form_type: Query = None, form_name: Query = None, model: Query = None):
        """Return list of form results"""

    @returns.json
    @http_get("analytics/forms/columns")
    def form_columns(self, form_type: Query = None, form_name: Query = None, model: Query = None):
