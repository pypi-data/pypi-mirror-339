...
endpoint = lambda: f'https://project-finance-backend.onrender.com/index-us-nasdaq100'
...
sample_req = 'https://project-finance-backend.onrender.com/index-us-nasdaq100'
