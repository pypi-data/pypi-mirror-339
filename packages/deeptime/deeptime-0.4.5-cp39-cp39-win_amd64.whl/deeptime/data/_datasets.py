...
def lorenz_system(h: float = 2e-5, n_steps: int = 100):
    r""" The Lorenz system. :footcite:`lorenz1963deterministic`
    ...
    .. footbibliography::
    """
    from ._data_bindings import Lorenz
    return TimeIndependentSystem(Lorenz(), h, n_steps)


def thomas_attractor(b: float = 0.15, h: float = 1e-3, n_steps: int = 1000):
    r""" The Thomas attractor. :footcite:`thomas1999deterministic`
    ...
    .. footbibliography::
    """
    from ._data_bindings import ThomasAttractor
    return TimeIndependentSystem(ThomasAttractor(), h, n_steps, props={'b': b})
