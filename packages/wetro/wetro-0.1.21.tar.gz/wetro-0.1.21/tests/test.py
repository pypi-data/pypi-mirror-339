...
def main():
    ...
    insert_resp = wetro_client.collection.insert_resource(resource="https://medium.com/@wetrocloud/are-image-models-getting-out-of-hand-068b13090556", type="web", collection_id="test_collection_sdk")
    # print("SDK Insert Response: %s", insert_resp.model_dump())
    print(os.path.abspath("test-resources/1.pdf"))
   
    # insert_resp = wetro_client.collection.insert_resource(resource="./test-resources/1.pdf", type="file", collection_id="test__sdk040425")
    # print("SDK Insert Response: %s", insert_resp.model_dump())
