...
class ServiceClient:
    ...
    def get_host(
        ...
        if isinstance(service_description, ServiceDescription):
            if ne(service_description.port):
                return FormatTool.domain(DH.ROOT.domain_dns, service_description.host)
        value: nstr = (
    ...
    def check_availability(
        ...
        return ne(self.ping(service_object))
...
class UnaryServicer(pb2_grpc.UnaryServicer):
    ...
    def internal_call_handler(self, sc: SC | str, parameters: Any, context) -> Any:
        try:
            ...
            DH.ROOT.global_except_hook(exception)
        ...
        if sc in self.subscriber_information_map:
            for service_information_name in list(self.subscriber_information_map[sc]):
                ...
                if (
                    ...
                    subscriber_information.available = self.client.check_availability(
                        service_information
                    )
    ...
    def call_subscribers_after(
        ...
        def internal_call_subscribers_after_sequentially(
            ...
            for subscriber in subscriber_list:
                ...
                subscriber.available = self.client.check_availability(
...
class Service(IService):
    ...
    def detect_error(self):
        try:
            ...
            DH.ROOT.error_detect_handler(error)
        finally:
            pass
    ...
    def create_subscribtions(
        ...
        for description_item in (
            ...
            if self.client.check_on_accessibility(description_item):
    ...
    def subscribe_on(
        ...
        if ne(service_description):
            if service_description != self.description:
                ...
                subscribtion.available = self.client.check_on_accessibility(
                    service_description
                )
