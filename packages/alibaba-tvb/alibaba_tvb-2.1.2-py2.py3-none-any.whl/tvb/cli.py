...
''' % (__date__)
    ...
    try:
        ...
        # hprof_thread = DumpHProf(args=args)
        try:
            # hprof_thread.start()
...
if __name__ == '__main__':
    ...
    main(['-v', '-d', '192.168.10.177:5555', '-c', 'meminfo', 'cpuinfo', 'top', '-p', 'com.youku.taitan.tv', '-l', '/Users/wjh/Documents/output/tvb',
          '-mem','600' ,'700','800','-a','com.youku.taitan.tv/com.youku.android.devtools.activities.BasicInfoActivity'])
