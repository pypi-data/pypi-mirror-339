...
class VNC_recognition:
    ...
    def capture_full_screen_as_numpy(self, debug: bool = False, retries: int = 3, delay: float = 0.5,image_w: int = 1440, image_h: int = 900,screen_num:int=2) -> np.ndarray:
    ...
    def capture_region_as_numpy(self, x1: int, y1: int, x2: int, y2: int, debug: bool = False,image_w: int = 1440, image_h: int = 900,screen_num:int=2):
    ...
    async def async_capture_full_screen_as_numpy(self, interval: float = 0.3, debug: bool = False,image_w: int = 1440, image_h: int = 900,screen_num:int=2):
        """
