...
try:
    print("Creating testcase2")
    response = cfn.create_stack(
        StackName='testcase2',
        TemplateURL='https://cfn-ap-southeast-5.s3.ap-southeast-5.amazonaws.com/test2/main.yaml',
        Capabilities=[
            'CAPABILITY_IAM',
    ...
    print("SG deleted")
    print("Updating testcase2 stack")
    response = cfn.update_stack(
        StackName='testcase2',
        TemplateURL='https://cfn-ap-southeast-5.s3.ap-southeast-5.amazonaws.com/test2/updated_main.yaml',
        Capabilities=[
            'CAPABILITY_IAM',
            'CAPABILITY_NAMED_IAM',
            'CAPABILITY_AUTO_EXPAND'
