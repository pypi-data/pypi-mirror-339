...
def is_valid_audio_format(instance, attribute, value):
    ...
    if value not in torchbiosound.common.constants.VALID_AUDIO_FORMATS:
        raise ValueError(
            f"Not a valid audio format: {value}. Valid audio formats are: {torchbiosound.common.constants.VALID_AUDIO_FORMATS}"
        )
...
def is_valid_spect_format(instance, attribute, value):
    ...
    if value not in torchbiosound.common.constants.VALID_SPECT_FORMATS:
        raise ValueError(
            f"Not a valid spectrogram format: {value}. "
            f"Valid spectrogram formats are: {torchbiosound.common.constants.VALID_SPECT_FORMATS}"
        )
