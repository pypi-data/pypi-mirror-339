...
class Datapipe(Dataset):
    ...
    def from_dataset_path(
        ...
        """
        import torchbiosound.datapipes  # import here just to make classmethod more explicit

        dataset_path = pathlib.Path(dataset_path)
        metadata = torchbiosound.datapipes.parametric_umap.Metadata.from_dataset_path(
            dataset_path
        )
