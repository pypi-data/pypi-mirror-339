...
class TestEval:
    ...
    def test_init(self, config_dict):
        ...
        eval_config = torchbiosound.config.EvalConfig(**config_dict)

        assert isinstance(eval_config, torchbiosound.config.EvalConfig)
    ...
    def test_from_config_dict(self, config_dict):
        eval_config = torchbiosound.config.EvalConfig.from_config_dict(config_dict)
    ...
    def test_from_config_dict_with_real_config(self, a_generated_eval_config_dict):
        ...
        eval_config = torchbiosound.config.eval.EvalConfig.from_config_dict(eval_table)

        assert isinstance(eval_config, torchbiosound.config.eval.EvalConfig)
    ...
    def test_from_config_dict_raises(self, config_dict, expected_exception):
        with pytest.raises(expected_exception):
            torchbiosound.config.EvalConfig.from_config_dict(config_dict)