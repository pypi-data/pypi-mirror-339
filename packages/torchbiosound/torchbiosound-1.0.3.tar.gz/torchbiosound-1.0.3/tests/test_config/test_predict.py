...
import torchbiosound.config.predict
...
class TestPredictConfig:
    ...
    def test_init(self, config_dict):
        ...
        predict_config = torchbiosound.config.PredictConfig(**config_dict)

        assert isinstance(predict_config, torchbiosound.config.PredictConfig)
    ...
    def test_from_config_dict(self, config_dict):
        predict_config = torchbiosound.config.PredictConfig.from_config_dict(config_dict)
    ...
    def test_from_config_dict_with_real_config(self, a_generated_predict_config_dict):
        ...
        predict_config = torchbiosound.config.predict.PredictConfig.from_config_dict(predict_table)

        assert isinstance(predict_config, torchbiosound.config.predict.PredictConfig)
    ...
    def test_from_config_dict_raises(self, config_dict, expected_exception):
        with pytest.raises(expected_exception):
            torchbiosound.config.PredictConfig.from_config_dict(config_dict)
