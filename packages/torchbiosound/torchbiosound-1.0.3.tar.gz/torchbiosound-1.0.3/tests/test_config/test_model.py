...
import torchbiosound.config.model
...
class TestModelConfig:
    ...
    def test_init(self, config_dict):
        ...
        model_config = torchbiosound.config.model.ModelConfig(
            name=name,
            **config_dict_from_name
            )

        assert isinstance(model_config, torchbiosound.config.model.ModelConfig)
    ...
    def test_from_config_dict(self, config_dict):
        model_config = torchbiosound.config.model.ModelConfig.from_config_dict(config_dict)
    ...
    def test_from_config_dict_raises(self, config_dict, expected_exception):
        with pytest.raises(expected_exception):
            torchbiosound.config.model.ModelConfig.from_config_dict(config_dict)
