...
import torchbiosound.config.learncurve
...
class TestLearncurveConfig:
    ...
    def test_init(self, config_dict):
        ...
        learncurve_config = torchbiosound.config.LearncurveConfig(**config_dict)

        assert isinstance(learncurve_config, torchbiosound.config.LearncurveConfig)
    ...
    def test_from_config_dict(self, config_dict):
        learncurve_config = torchbiosound.config.LearncurveConfig.from_config_dict(config_dict)
    ...
    def test_from_config_dict_with_real_config(self, a_generated_learncurve_config_dict):
        ...
        config = torchbiosound.config.learncurve.LearncurveConfig.from_config_dict(
            learncurve_table
        )

        assert isinstance(config, torchbiosound.config.learncurve.LearncurveConfig)
    ...
    def test_from_config_dict_raises(self, config_dict, expected_exception):
        with pytest.raises(expected_exception):
            torchbiosound.config.LearncurveConfig.from_config_dict(config_dict)
