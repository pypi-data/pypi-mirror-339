...
def test_purpose_from_toml(
    ...
    config_toml = torchbiosound.config.load._load_toml_from_path(toml_path)
    torchbiosound.cli.prep.purpose_from_toml(config_toml)
...
def test_prep(
    ...
    with mock.patch('vak.prep.prep', autospec=True) as mock_core_prep:
        ...
        torchbiosound.cli.prep.prep(toml_path)
