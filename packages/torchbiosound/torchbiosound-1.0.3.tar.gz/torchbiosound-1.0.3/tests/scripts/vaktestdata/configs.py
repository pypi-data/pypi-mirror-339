...
def add_dataset_path_from_prepped_configs():
    ...
    for config_metadata in configs_to_change:
        ...
        config_dict = torchbiosound.config.load._load_toml_from_path(config_dataset_path)
        ...
        dataset_config_section = torchbiosound.cli.prep.purpose_from_toml(config_dict)
