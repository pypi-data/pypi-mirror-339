...
def set_up_source_files_and_csv_files_for_frame_classification_models():
    ...
    for config_metadata in configs_to_make_spectrograms:
        ...
        cfg = torchbiosound.config.Config.from_toml_path(config_path, tables_to_parse='prep')

        source_files_df: pd.DataFrame = torchbiosound.prep.frame_classification.get_or_make_source_files(
        ...
        config_toml: dict = torchbiosound.config.load._load_toml_from_path(config_path)
        purpose = torchbiosound.cli.prep.purpose_from_toml(config_toml, config_path)
        dataset_df: pd.DataFrame = torchbiosound.prep.frame_classification.assign_samples_to_splits(
            purpose,
            source_files_df,
