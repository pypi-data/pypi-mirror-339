...
import torchbiosound.train


def assert_train_output_matches_expected(cfg: torchbiosound.config.config.Config, model_name: str,
...
def test_train_frame_classification_model(
    ...
    torchbiosound.train.frame_classification.train_frame_classification_model(
