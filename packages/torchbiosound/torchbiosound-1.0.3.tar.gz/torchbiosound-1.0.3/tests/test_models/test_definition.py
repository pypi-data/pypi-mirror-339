...
import torch
from torchbiosound import metrics
from torchbiosound.nets import TweetyNet
...
class TestModelDefinition:
    ...
    def test_validate(self, definition):
        ...
        after = torchbiosound.models.definition.validate(definition)
        ...
        if not hasattr(before, 'default_config'):
            ...
            assert after.default_config == torchbiosound.models.definition.DEFAULT_DEFAULT_CONFIG

        elif hasattr(before, 'default_config'):
            for key in torchbiosound.models.definition.DEFAULT_DEFAULT_CONFIG:
    ...
    def test_validate_raises(self, definition, expected_error):
        with pytest.raises(expected_error):
            torchbiosound.models.definition.validate(definition)
