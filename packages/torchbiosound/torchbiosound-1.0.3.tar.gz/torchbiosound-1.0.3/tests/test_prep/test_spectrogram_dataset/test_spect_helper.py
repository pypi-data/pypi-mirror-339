...
def test_make_dataframe_of_spect_files(
    ...
    dataset_df = torchbiosound.prep.spectrogram_dataset.spect_helper.make_dataframe_of_spect_files(
...
def test_make_dataframe_of_spect_files_no_spect_dir_files_or_map_raises(annot_list_yarden):
    ...
    with pytest.raises(ValueError):
        torchbiosound.prep.spectrogram_dataset.spect_helper.make_dataframe_of_spect_files(
            spect_format="mat",
            spect_dir=None,
            spect_files=None,
