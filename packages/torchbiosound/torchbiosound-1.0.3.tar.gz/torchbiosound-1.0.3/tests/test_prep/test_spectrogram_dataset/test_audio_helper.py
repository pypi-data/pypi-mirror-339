...
import torchbiosound.prep.spectrogram_dataset.audio_helper
...
def test_make_spectrogram_files_from_audio_files_audio_dir_annot_cbin_with_labelset(
    ...
    spect_files = torchbiosound.prep.spectrogram_dataset.audio_helper.make_spectrogram_files_from_audio_files(
        audio_format="cbin",
        annot_format="notmat",
...
def test_missing_inputs_raise(
    ...
    with pytest.raises(ValueError):
        torchbiosound.prep.spectrogram_dataset.audio_helper.make_spectrogram_files_from_audio_files(
            audio_format="ape",
            annot_format="notmat",
            spect_params=default_spect_params,
            output_dir=tmp_path,
