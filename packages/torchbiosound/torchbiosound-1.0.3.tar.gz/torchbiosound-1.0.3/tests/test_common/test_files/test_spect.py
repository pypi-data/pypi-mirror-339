...
import torchbiosound.common.files
from torchbiosound.common.constants import VALID_AUDIO_FORMATS
...
def test_find_audio_fname_with_mat(spect_path, audio_ext, spect_ext):
    ...
    out = torchbiosound.common.files.spect.find_audio_fname(spect_path, audio_ext)
