...
class TestDiceLoss:
    def test_smoke(self, device, dtype):
        ...
        criterion = torchbiosound.nn.loss.DiceLoss()
    ...
    def test_gradcheck(self, device, dtype):
        ...
        assert gradcheck(torchbiosound.nn.dice_loss, (logits, labels), raise_exception=True)
    ...
    def test_module(self, device, dtype):
        ...
        op = torchbiosound.nn.dice_loss
        op_module = torchbiosound.nn.loss.DiceLoss()
