...
class TestTweetyNet:
    ...
    def test_init(self, num_classes, num_input_channels, num_freqbins):
        ...
        if num_input_channels is None or num_freqbins is None:
            init_sig = inspect.signature(torchbiosound.nets.TweetyNet.__init__)
        ...
        net = torchbiosound.nets.TweetyNet(num_classes, num_input_channels, num_freqbins)
        assert isinstance(net, torchbiosound.nets.TweetyNet)
