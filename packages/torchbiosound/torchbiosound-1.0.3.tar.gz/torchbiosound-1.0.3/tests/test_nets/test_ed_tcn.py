...
class TestED_TCN:
    ...
    def test_init(self, num_classes, num_input_channels, num_freqbins):
        ...
        if num_input_channels is None or num_freqbins is None:
            init_sig = inspect.signature(torchbiosound.nets.ED_TCN.__init__)
        ...
        net = torchbiosound.nets.ED_TCN(num_classes, num_input_channels, num_freqbins)
        assert isinstance(net, torchbiosound.nets.ED_TCN)
