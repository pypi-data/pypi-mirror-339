...
**Web documentation:** `<https://edinburgh-genome-foundry.github.io/Primavera/>`_

**Github page:** `<https://github.com/Edinburgh-Genome-Foundry/Primavera>`_

**Live demo:** `<http://cuba.genomefoundry.org/select_primers>`_
