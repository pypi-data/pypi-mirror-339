...
print("a",end="")
time.sleep(1)
bar=TerminalBar(1024*1024,0,100)
loader=TerminalLoader(bar,"Byte")
loader.setStyle(
    barStartPart="\033[35mDownloading Configs: \033[0m",
    barEndPart=" | {full_part}/{length} {value} downloaded {percent:.2f} %",
    barFullPart="\033[32m█\033[0m",
    barEmptyPart=" ",
    finishStartPart="Downloaded: ",
    finishEndPart=" | {length} {value} downloaded"
)
speed = 1024 * 100
iterations = (1024 * 1024) // (speed // 10) 
for _ in range(iterations):
    if loader.bar.full_part > 1024 * 256:
        loader.setStyle(barStartPart="\033[31;1mDownloading Images: \033[0m")
    elif loader.bar.full_part > 1024 * 512:
        loader.setStyle(barStartPart="\033[32;1mDownloading Videos: \033[0m")
    elif loader.bar.full_part > 1024 * 768:
        loader.setStyle(barStartPart="\033[34;1mDownloading Audio: \033[0m")

    loader.upgrade(speed / 10)
    time.sleep(0.1)
```
